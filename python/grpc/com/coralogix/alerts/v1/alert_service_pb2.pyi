...
class AlertEventCountType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    ALERT_EVENT_COUNT_TYPE_UNSPECIFIED: _ClassVar[AlertEventCountType]
    ALERT_EVENT_COUNT_TYPE_ALERT: _ClassVar[AlertEventCountType]
    ALERT_EVENT_COUNT_TYPE_ANOMALY: _ClassVar[AlertEventCountType]
ALERT_EVENT_COUNT_TYPE_UNSPECIFIED: AlertEventCountType
ALERT_EVENT_COUNT_TYPE_ALERT: AlertEventCountType
ALERT_EVENT_COUNT_TYPE_ANOMALY: AlertEventCountType
...
class CreateAlertRequest(_message.Message):
    __slots__ = ("name", "description", "is_active", "severity", "expiration", "condition", "notifications", "filters", "notify_every", "active_when", "notification_payload_filters", "meta_labels", "meta_labels_strings", "tracing_alert")
...
class AlertEventsCountBySeverity(_message.Message):
    ...
    def __init__(self, severity: _Optional[_Union[_alert_severity_pb2.AlertSeverity, str]] = ..., type: _Optional[_Union[AlertEventCountType, str]] = ..., sub_type: _Optional[_Union[_alert_event_pb2.AlertEvent.AlertEventSubType, str]] = ..., count: _Optional[_Union[_wrappers_pb2.Int32Value, _Mapping]] = ...) -> None: ...
