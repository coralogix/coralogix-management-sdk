...
mod tests {
    ...
    async fn test_views() {
        ...
        // Update view name
        created_view.name = Some("AViewUpdated".to_string());
        views_client
    ...
    async fn test_view_folders() {
        ...
        let folder = ViewFolder {
            name: Some("AViewFolder".to_string()),
            id: None,
        };
        ...
        // Update folder name
        created_folder.name = Some("AViewFolderUpdated".to_string());
        client
        ...
        assert_eq!(updated_folder.name.unwrap(), "AViewFolderUpdated");
