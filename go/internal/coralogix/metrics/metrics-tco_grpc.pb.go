...
// UnimplementedMetricsTcoServiceServer must be embedded to have
...
func (UnimplementedMetricsTcoServiceServer) testEmbeddedByValue()                           {}
...
func RegisterMetricsTcoServiceServer(s grpc.ServiceRegistrar, srv MetricsTcoServiceServer) {
	// If the following call pancis, it indicates UnimplementedMetricsTcoServiceServer was
