...
var file_com_coralogix_metrics_metrics_tco_proto_goTypes = []interface{}{
...
func file_com_coralogix_metrics_metrics_tco_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_metrics_metrics_tco_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Rule); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogix_metrics_metrics_tco_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_metrics_metrics_tco_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_metrics_metrics_tco_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
