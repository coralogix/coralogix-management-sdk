...
func file_com_coralogix_openapi_v1_annotations_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_com_coralogix_openapi_v1_annotations_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_openapi_v1_annotations_proto_msgTypes[11].Exporter = func(v any, i int) any {
