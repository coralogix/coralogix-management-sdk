...
type ApiError struct {
	...
	Trace      *wrappers.StringValue `protobuf:"bytes,2,opt,name=trace,proto3" json:"trace,omitempty"`
	StatusCode *wrappers.Int32Value  `protobuf:"bytes,3,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"` // HTTP status code associated with the error.
}
...
func (x *ApiError) GetTrace() *wrappers.StringValue {
	if x != nil {
		return x.Trace
	}
	return nil
...
func (x *ApiError) GetStatusCode() *wrappers.Int32Value {
	if x != nil {
		return x.StatusCode
	}
	return nil
...
type ApiError_Error struct {
	...
	Message  *wrappers.StringValue    `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`                   // Human-readable error message.
	MoreInfo *wrappers.StringValue    `protobuf:"bytes,3,opt,name=more_info,json=moreInfo,proto3" json:"more_info,omitempty"` // Additional information about the error.
}
...
func (x *ApiError_Error) GetMessage() *wrappers.StringValue {
	if x != nil {
		return x.Message
	}
	return nil
...
func (x *ApiError_Error) GetMoreInfo() *wrappers.StringValue {
	if x != nil {
		return x.MoreInfo
	}
	return nil
...
var file_com_coralogix_openapi_v1_annotations_proto_goTypes = []any{
	...
	(*descriptor.MessageOptions)(nil), // 16: google.protobuf.MessageOptions
	(*descriptor.EnumOptions)(nil),    // 17: google.protobuf.EnumOptions
	(*descriptor.FieldOptions)(nil),   // 18: google.protobuf.FieldOptions
}
