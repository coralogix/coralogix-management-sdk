...
type PaginationData struct {
	...
	OrderByMeasurement *wrappers.StringValue `protobuf:"bytes,4,opt,name=order_by_measurement,json=orderByMeasurement,proto3" json:"order_by_measurement,omitempty"`
}
...
func (x *PaginationData) GetPageSize() *wrappers.Int32Value {
	if x != nil {
		return x.PageSize
	}
	return nil
...
func (x *PaginationData) GetPageIndex() *wrappers.Int32Value {
	if x != nil {
		return x.PageIndex
	}
	return nil
...
func (x *PaginationData) GetOrderByMeasurement() *wrappers.StringValue {
	if x != nil {
