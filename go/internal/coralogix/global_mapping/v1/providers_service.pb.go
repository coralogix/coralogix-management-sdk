...
type GetCompanyProvidersResponse struct {
	...
	CompanyProviders []*wrappers.StringValue `protobuf:"bytes,1,rep,name=company_providers,json=companyProviders,proto3" json:"company_providers,omitempty"`
}
...
func (x *GetCompanyProvidersResponse) GetCompanyProviders() []*wrappers.StringValue {
	if x != nil {
