...
type LabelMapping struct {
	...
	ExtractionTemplate  *wrappers.StringValue   `protobuf:"bytes,3,opt,name=extraction_template,json=extractionTemplate,proto3" json:"extraction_template,omitempty"`
	...
	DisplayName         *wrappers.StringValue   `protobuf:"bytes,7,opt,name=display_name,json=displayName,proto3" json:"display_name,omitempty"`
	ExtractionTemplates []*wrappers.StringValue `protobuf:"bytes,8,rep,name=extraction_templates,json=extractionTemplates,proto3" json:"extraction_templates,omitempty"`
	IsCustomLabel       *wrappers.BoolValue     `protobuf:"bytes,9,opt,name=is_custom_label,json=isCustomLabel,proto3" json:"is_custom_label,omitempty"`
...
func (x *LabelMapping) GetLabel() *wrappers.StringValue {
	if x != nil {
		return x.Label
	}
	return nil
...
// Deprecated: Marked as deprecated in com/coralogix/global_mapping/v1/label_mapping.proto.
func (x *LabelMapping) GetExtractionTemplate() *wrappers.StringValue {
	if x != nil {
...
func (x *LabelMapping) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *LabelMapping) GetDescription() *wrappers.StringValue {
	if x != nil {
...
func (x *LabelMapping) GetDisplayName() *wrappers.StringValue {
	if x != nil {
...
func (x *LabelMapping) GetExtractionTemplates() []*wrappers.StringValue {
	if x != nil {
...
func (x *LabelMapping) GetIsCustomLabel() *wrappers.BoolValue {
	if x != nil {
