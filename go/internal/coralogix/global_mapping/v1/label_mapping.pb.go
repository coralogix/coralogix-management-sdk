...
const file_com_coralogix_global_mapping_v1_label_mapping_proto_rawDesc = "" +
	"\n" +
	"3com/coralogix/global_mapping/v1/label_mapping.proto\x12\x1fcom.coralogix.global_mapping.v1\x1a\x1egoogle/protobuf/wrappers.proto\x1a6com/coralogix/global_mapping/v1/data_source_type.proto\x1a1com/coralogix/global_mapping/v1/data_source.proto\"\x9e\x05\n" +
	"\fLabelMapping\x122\n" +
	"\x05label\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x05label\x12Y\n" +
	"\x10data_source_type\x18\x02 \x01(\x0e2/.com.coralogix.global_mapping.v1.DataSourceTypeR\x0edataSourceType\x12Q\n" +
	"\x13extraction_template\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueB\x02\x18\x01R\x12extractionTemplate\x12,\n" +
	"\x02id\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueR\x02id\x12>\n" +
	"\vdescription\x18\x06 \x01(\v2\x1c.google.protobuf.StringValueR\vdescription\x12?\n" +
	"\fdisplay_name\x18\a \x01(\v2\x1c.google.protobuf.StringValueR\vdisplayName\x12O\n" +
	"\x14extraction_templates\x18\b \x03(\v2\x1c.google.protobuf.StringValueR\x13extractionTemplates\x12B\n" +
	"\x0fis_custom_label\x18\t \x01(\v2\x1a.google.protobuf.BoolValueR\risCustomLabel\x12L\n" +
	"\vdata_source\x18\n" +
	" \x01(\v2+.com.coralogix.global_mapping.v1.DataSourceR\n" +
	"dataSourceJ\x04\b\x04\x10\x05R\x14data_source_providerb\x06proto3"

var (
	file_com_coralogix_global_mapping_v1_label_mapping_proto_rawDescOnce sync.Once
	file_com_coralogix_global_mapping_v1_label_mapping_proto_rawDescData []byte
)
...
func file_com_coralogix_global_mapping_v1_label_mapping_proto_rawDescGZIP() []byte {
	file_com_coralogix_global_mapping_v1_label_mapping_proto_rawDescOnce.Do(func() {
		file_com_coralogix_global_mapping_v1_label_mapping_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogix_global_mapping_v1_label_mapping_proto_rawDesc), len(file_com_coralogix_global_mapping_v1_label_mapping_proto_rawDesc)))
	})
...
func file_com_coralogix_global_mapping_v1_label_mapping_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogix_global_mapping_v1_label_mapping_proto_rawDesc), len(file_com_coralogix_global_mapping_v1_label_mapping_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
