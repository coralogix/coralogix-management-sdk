...
var file_com_coralogix_global_mapping_v1_data_source_proto_goTypes = []interface{}{
...
func file_com_coralogix_global_mapping_v1_data_source_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_global_mapping_v1_data_source_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
