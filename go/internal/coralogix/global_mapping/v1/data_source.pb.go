...
type DataSource struct {
	...
	LabelsMetric *wrappers.StringValue `protobuf:"bytes,3,opt,name=labels_metric,json=labelsMetric,proto3" json:"labels_metric,omitempty"`
}
...
func (x *DataSource) GetLabelsMetric() *wrappers.StringValue {
	if x != nil {
...
var file_com_coralogix_global_mapping_v1_data_source_proto_rawDesc = []byte{
...
var (
	...
	file_com_coralogix_global_mapping_v1_data_source_proto_rawDescData = file_com_coralogix_global_mapping_v1_data_source_proto_rawDesc
)
...
func file_com_coralogix_global_mapping_v1_data_source_proto_rawDescGZIP() []byte {
	file_com_coralogix_global_mapping_v1_data_source_proto_rawDescOnce.Do(func() {
		file_com_coralogix_global_mapping_v1_data_source_proto_rawDescData = protoimpl.X.CompressGZIP(file_com_coralogix_global_mapping_v1_data_source_proto_rawDescData)
	})
...
func file_com_coralogix_global_mapping_v1_data_source_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_com_coralogix_global_mapping_v1_data_source_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_com_coralogix_global_mapping_v1_data_source_proto_rawDesc = nil
