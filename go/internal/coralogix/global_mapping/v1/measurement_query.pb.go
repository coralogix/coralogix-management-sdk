...
type QueryResult struct {
	...
	Metric map[string]*wrappers.StringValue `protobuf:"bytes,1,rep,name=metric,proto3" json:"metric,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Values []*_struct.ListValue             `protobuf:"bytes,2,rep,name=values,proto3" json:"values,omitempty"`
}
...
func (x *QueryResult) GetMetric() map[string]*wrappers.StringValue {
	if x != nil {
		return x.Metric
	}
	return nil
...
func (x *QueryResult) GetValues() []*_struct.ListValue {
	if x != nil {
		return x.Values
	}
	return nil
...
type TopkAggregation struct {
	...
	Topk        *wrappers.UInt32Value `protobuf:"bytes,2,opt,name=topk,proto3" json:"topk,omitempty"`
}
...
func (x *TopkAggregation) GetTopk() *wrappers.UInt32Value {
	if x != nil {
		return x.Topk
	}
	return nil
...
type MeasurementMetadata struct {
	...
	MeasurementName          *wrappers.StringValue `protobuf:"bytes,1,opt,name=measurement_name,json=measurementName,proto3" json:"measurement_name,omitempty"`
	...
	Step                     *wrappers.Int32Value  `protobuf:"bytes,4,opt,name=step,proto3" json:"step,omitempty"`
	AggregationWindowSeconds *wrappers.Int32Value  `protobuf:"bytes,5,opt,name=aggregation_window_seconds,json=aggregationWindowSeconds,proto3" json:"aggregation_window_seconds,omitempty"`
...
func (x *MeasurementMetadata) GetMeasurementName() *wrappers.StringValue {
	if x != nil {
...
func (x *MeasurementMetadata) GetStep() *wrappers.Int32Value {
	if x != nil {
		return x.Step
	}
	return nil
...
func (x *MeasurementMetadata) GetAggregationWindowSeconds() *wrappers.Int32Value {
	if x != nil {
...
type MeasurementQuery struct {
	...
	LogicalGroup             *wrappers.StringValue `protobuf:"bytes,5,opt,name=logical_group,json=logicalGroup,proto3" json:"logical_group,omitempty"`
	QueryResults             []*QueryResult        `protobuf:"bytes,6,rep,name=query_results,json=queryResults,proto3" json:"query_results,omitempty"`
	OrderingQuery            *wrappers.StringValue `protobuf:"bytes,7,opt,name=ordering_query,json=orderingQuery,proto3" json:"ordering_query,omitempty"`
	...
	Step                     *wrappers.Int32Value  `protobuf:"bytes,11,opt,name=step,proto3" json:"step,omitempty"`
	AggregationWindowSeconds *wrappers.Int32Value  `protobuf:"bytes,12,opt,name=aggregation_window_seconds,json=aggregationWindowSeconds,proto3" json:"aggregation_window_seconds,omitempty"`
}
...
func (x *MeasurementQuery) GetQuery() *wrappers.StringValue {
	if x != nil {
		return x.Query
	}
	return nil
...
func (x *MeasurementQuery) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *MeasurementQuery) GetDescription() *wrappers.StringValue {
	if x != nil {
...
func (x *MeasurementQuery) GetDisplayName() *wrappers.StringValue {
	if x != nil {
...
func (x *MeasurementQuery) GetLogicalGroup() *wrappers.StringValue {
	if x != nil {
...
func (x *MeasurementQuery) GetOrderingQuery() *wrappers.StringValue {
	if x != nil {
...
func (x *MeasurementQuery) GetStep() *wrappers.Int32Value {
	if x != nil {
		return x.Step
	}
	return nil
...
func (x *MeasurementQuery) GetAggregationWindowSeconds() *wrappers.Int32Value {
	if x != nil {
		return x.AggregationWindowSeconds
	}
	return nil
