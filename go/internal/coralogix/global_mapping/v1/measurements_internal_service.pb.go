...
type RemoveGlobalMeasurementsInternalResponse struct {
	...
	NumberOfDeletedMeasurements *wrappers.Int32Value `protobuf:"bytes,1,opt,name=number_of_deleted_measurements,json=numberOfDeletedMeasurements,proto3" json:"number_of_deleted_measurements,omitempty"`
}
...
func (x *RemoveGlobalMeasurementsInternalResponse) GetNumberOfDeletedMeasurements() *wrappers.Int32Value {
	if x != nil {
...
type GetMeasurementsInternalRequest struct {
	...
	MeasurementNames []*wrappers.StringValue `protobuf:"bytes,1,rep,name=measurement_names,json=measurementNames,proto3" json:"measurement_names,omitempty"`
	...
	Labels           []*wrappers.StringValue `protobuf:"bytes,4,rep,name=labels,proto3" json:"labels,omitempty"`
...
func (x *GetMeasurementsInternalRequest) GetMeasurementNames() []*wrappers.StringValue {
	if x != nil {
...
func (x *GetMeasurementsInternalRequest) GetLabels() []*wrappers.StringValue {
	if x != nil {
		return x.Labels
	}
	return nil
...
type UpsertCompanyProvidersInternalRequest struct {
	...
	Providers   []*wrappers.StringValue `protobuf:"bytes,1,rep,name=providers,proto3" json:"providers,omitempty"`
...
// Deprecated: Marked as deprecated in com/coralogix/global_mapping/v1/measurements_internal_service.proto.
func (x *UpsertCompanyProvidersInternalRequest) GetProviders() []*wrappers.StringValue {
	if x != nil {
		return x.Providers
	}
	return nil
...
// Deprecated: Marked as deprecated in com/coralogix/global_mapping/v1/measurements_internal_service.proto.
func (x *UpsertCompanyProvidersInternalResponse) GetProviders() []*wrappers.StringValue {
	if x != nil {
		return x.Providers
	}
	return nil
