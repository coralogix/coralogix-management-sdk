...
type Span struct {
	...
	ProcessTags map[string]*wrappers.StringValue `protobuf:"bytes,2,rep,name=process_tags,json=processTags,proto3" json:"process_tags,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *Span) GetTags() map[string]*wrappers.StringValue {
	if x != nil {
		return x.Tags
	}
	return nil
...
func (x *Span) GetProcessTags() map[string]*wrappers.StringValue {
	if x != nil {
...
type Log struct {
	...
	Metadata map[string]*wrappers.StringValue `protobuf:"bytes,1,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *Log) GetMetadata() map[string]*wrappers.StringValue {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *Log) GetText() *wrappers.StringValue {
	if x != nil {
		return x.Text
	}
	return nil
