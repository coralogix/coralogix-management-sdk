...
func file_com_coralogix_global_mapping_v1_context_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_global_mapping_v1_context_data_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Span); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogix_global_mapping_v1_context_data_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Log); i {
			case 0:
				return &v.state
			case 1:
