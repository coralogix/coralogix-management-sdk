...
var file_com_coralogix_global_mapping_v1_data_source_internal_service_proto_goTypes = []interface{}{
...
func file_com_coralogix_global_mapping_v1_data_source_internal_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_global_mapping_v1_data_source_internal_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCompanyDataSourcesInternalRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_global_mapping_v1_data_source_internal_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCompanyDataSourcesInternalResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
