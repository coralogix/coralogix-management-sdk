...
type Measurement struct {
	...
	Id           *wrappers.StringValue   `protobuf:"bytes,6,opt,name=id,proto3" json:"id,omitempty"`
	...
	LogicalGroup *wrappers.StringValue   `protobuf:"bytes,9,opt,name=logical_group,json=logicalGroup,proto3" json:"logical_group,omitempty"`
	// Deprecated: Marked as deprecated in com/coralogix/global_mapping/v1/measurement.proto.
	OrderingQuery     *wrappers.StringValue   `protobuf:"bytes,10,opt,name=ordering_query,json=orderingQuery,proto3" json:"ordering_query,omitempty"`
	AppendableMetrics []*wrappers.StringValue `protobuf:"bytes,11,rep,name=appendable_metrics,json=appendableMetrics,proto3" json:"appendable_metrics,omitempty"`
	DataSource        *DataSource             `protobuf:"bytes,12,opt,name=data_source,json=dataSource,proto3" json:"data_source,omitempty"`
	GroupLeft         *wrappers.StringValue   `protobuf:"bytes,13,opt,name=group_left,json=groupLeft,proto3" json:"group_left,omitempty"`
	JoinOn            *wrappers.StringValue   `protobuf:"bytes,14,opt,name=join_on,json=joinOn,proto3" json:"join_on,omitempty"`
	SubjectLabel      *wrappers.StringValue   `protobuf:"bytes,15,opt,name=subject_label,json=subjectLabel,proto3" json:"subject_label,omitempty"`
}
...
func (x *Measurement) GetMeasurementName() *wrappers.StringValue {
	if x != nil {
...
func (x *Measurement) GetQuery() *wrappers.StringValue {
	if x != nil {
		return x.Query
	}
	return nil
...
// Deprecated: Marked as deprecated in com/coralogix/global_mapping/v1/measurement.proto.
func (x *Measurement) GetLabels() []*wrappers.StringValue {
	if x != nil {
		return x.Labels
	}
	return nil
...
func (x *Measurement) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *Measurement) GetDescription() *wrappers.StringValue {
	if x != nil {
...
func (x *Measurement) GetDisplayName() *wrappers.StringValue {
	if x != nil {
...
func (x *Measurement) GetLogicalGroup() *wrappers.StringValue {
	if x != nil {
...
// Deprecated: Marked as deprecated in com/coralogix/global_mapping/v1/measurement.proto.
func (x *Measurement) GetOrderingQuery() *wrappers.StringValue {
	if x != nil {
...
func (x *Measurement) GetAppendableMetrics() []*wrappers.StringValue {
	if x != nil {
...
func (x *Measurement) GetGroupLeft() *wrappers.StringValue {
	if x != nil {
		return x.GroupLeft
	}
	return nil
...
func (x *Measurement) GetJoinOn() *wrappers.StringValue {
	if x != nil {
		return x.JoinOn
	}
	return nil
...
func (x *Measurement) GetSubjectLabel() *wrappers.StringValue {
	if x != nil {
