...
type Tag struct {
	...
	CompanyId   *wrappers.UInt32Value   `protobuf:"bytes,4,opt,name=company_id,json=companyId,proto3" json:"company_id,omitempty"`
...
func (x *Tag) GetId() *wrappers.UInt64Value {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *Tag) GetKey() *wrappers.StringValue {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *Tag) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *Tag) GetCompanyId() *wrappers.UInt32Value {
	if x != nil {
		return x.CompanyId
	}
	return nil
...
func (x *Tag) GetIconUrl() *wrappers.StringValue {
	if x != nil {
		return x.IconUrl
	}
	return nil
...
func (x *Tag) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *Tag) GetApplication() []*wrappers.StringValue {
	if x != nil {
...
func (x *Tag) GetSubsystem() []*wrappers.StringValue {
	if x != nil {
		return x.Subsystem
	}
	return nil
