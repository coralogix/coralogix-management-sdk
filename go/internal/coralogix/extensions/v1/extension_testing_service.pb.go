...
const file_com_coralogix_extensions_v1_extension_testing_service_proto_rawDesc = "" +
	"\n" +
	";com/coralogix/extensions/v1/extension_testing_service.proto\x12\x1bcom.coralogix.extensions.v1\x1a'com/coralogix/common/v1/audit_log.proto\x1a+com/coralogix/extensions/v1/extension.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a google/protobuf/descriptor.proto\x1a\x1cgoogle/api/annotations.proto\"u\n" +
	" InitializeTestingRevisionRequest\x12Q\n" +
	"\x0eextension_data\x18\x01 \x01(\v2*.com.coralogix.extensions.v1.ExtensionDataR\rextensionData\"#\n" +
	"!InitializeTestingRevisionResponse\"M\n" +
	"\x1dCleanupTestingRevisionRequest\x12,\n" +
	"\x02id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x02id\" \n" +
	"\x1eCleanupTestingRevisionResponse\"\xbb\x01\n" +
	"\x1cTestExtensionRevisionRequest\x12Q\n" +
	"\x0eextension_data\x18\x01 \x01(\v2*.com.coralogix.extensions.v1.ExtensionDataR\rextensionData\x12H\n" +
	"\x12cleanup_after_test\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\x10cleanupAfterTest\"\x1f\n" +
	"\x1dTestExtensionRevisionResponse2\xb0\x05\n" +
	"\x17ExtensionTestingService\x12\xe9\x01\n" +
	"\x19InitializeTestingRevision\x12=.com.coralogix.extensions.v1.InitializeTestingRevisionRequest\x1a>.com.coralogix.extensions.v1.InitializeTestingRevisionResponse\"M¸\x02\x1d\n" +
	"\x1bInitialize testing revision\x82\xd3\xe4\x93\x02&:\x01*\"!/extensions-testing/v1/initialize\x12\xdb\x01\n" +
	"\x16CleanupTestingRevision\x12:.com.coralogix.extensions.v1.CleanupTestingRevisionRequest\x1a;.com.coralogix.extensions.v1.CleanupTestingRevisionResponse\"H¸\x02\x1b\n" +
	"\x19Cleanup testing extension\x82\xd3\xe4\x93\x02#:\x01*\"\x1e/extensions-testing/v1/cleanup\x12\xca\x01\n" +
	"\x15TestExtensionRevision\x129.com.coralogix.extensions.v1.TestExtensionRevisionRequest\x1a:.com.coralogix.extensions.v1.TestExtensionRevisionResponse\":¸\x02\x10\n" +
	"\x0eTest extension\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/extensions-testing/v1/testb\x06proto3"
