...
func (x *CleanupTestingRevisionRequest) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
type TestExtensionRevisionRequest struct {
	...
	ExtensionData    *ExtensionData      `protobuf:"bytes,1,opt,name=extension_data,json=extensionData,proto3" json:"extension_data,omitempty"`
	CleanupAfterTest *wrappers.BoolValue `protobuf:"bytes,2,opt,name=cleanup_after_test,json=cleanupAfterTest,proto3" json:"cleanup_after_test,omitempty"`
}
...
func (x *TestExtensionRevisionRequest) GetCleanupAfterTest() *wrappers.BoolValue {
	if x != nil {
