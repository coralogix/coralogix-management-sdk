...
const file_com_coralogix_extensions_v1_extension_deployment_service_proto_rawDesc = "" +
	"\n" +
	">com/coralogix/extensions/v1/extension_deployment_service.proto\x12\x1bcom.coralogix.extensions.v1\x1a'com/coralogix/common/v1/audit_log.proto\x1a+com/coralogix/extensions/v1/extension.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a google/protobuf/descriptor.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"l\n" +
	"\x1cGetDeployedExtensionsRequest:L\x92AI\n" +
	"G*\x1cGetDeployedExtensionsRequest2'Request to list all deployed extensions\"\xf0\x06\n" +
	"\x1dGetDeployedExtensionsResponse\x12}\n" +
	"\x13deployed_extensions\x18\x01 \x03(\v2L.com.coralogix.extensions.v1.GetDeployedExtensionsResponse.DeployedExtensionR\x12deployedExtensions\x1a\xd2\x01\n" +
	"\x18DeployedExtensionSummary\x12Y\n" +
	"\x14deployed_item_counts\x18\x01 \x01(\v2'.com.coralogix.extensions.v1.ItemCountsR\x12deployedItemCounts:[\x92AX\n" +
	"V*\x18DeployedExtensionSummary2#Information about the deployed item\xd2\x01\x14deployed_item_counts\x1a\xa1\x03\n" +
	...
	"\fapplications\x18\x03 \x03(\v2\x1c.google.protobuf.StringValueR\fapplications\x12<\n" +
	"\n" +
	"subsystems\x18\x04 \x03(\v2\x1c.google.protobuf.StringValueR\n" +
	"subsystems\x127\n" +
	"\bitem_ids\x18\x05 \x03(\v2\x1c.google.protobuf.StringValueR\aitemIds\x12m\n" +
	"\asummary\x18\x06 \x01(\v2S.com.coralogix.extensions.v1.GetDeployedExtensionsResponse.DeployedExtensionSummaryR\asummary:W\x92AT\n" +
	"R*\x1dGetDeployedExtensionsResponse2\x1bList of deployed extensions\xd2\x01\x13deployed_extensions\"\xb4\x02\n" +
	"\x13ExtensionDeployment\x12,\n" +
	"\x02id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x02id\x126\n" +
	"\aversion\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\aversion\x127\n" +
	"\bitem_ids\x18\x03 \x03(\v2\x1c.google.protobuf.StringValueR\aitemIds\x12@\n" +
	"\fapplications\x18\x04 \x03(\v2\x1c.google.protobuf.StringValueR\fapplications\x12<\n" +
	"\n" +
	"subsystems\x18\x05 \x03(\v2\x1c.google.protobuf.StringValueR\n" +
	"subsystems\"\xba\x03\n" +
	...
	"subsystems\x18\x05 \x03(\v2\x1c.google.protobuf.StringValueR\n" +
	"subsystems\x12h\n" +
	"\x14extension_deployment\x18\x06 \x01(\v20.com.coralogix.extensions.v1.ExtensionDeploymentH\x00R\x13extensionDeployment\x88\x01\x01B\x17\n" +
	"\x15_extension_deployment\"~\n" +
	"\x17DeployExtensionResponse\x12c\n" +
	"\x14extension_deployment\x18\x01 \x01(\v20.com.coralogix.extensions.v1.ExtensionDeploymentR\x13extensionDeployment\"\xba\x03\n" +
	...
	"\x14extension_deployment\x18\x01 \x01(\v20.com.coralogix.extensions.v1.ExtensionDeploymentR\x13extensionDeployment\"\x98\x01\n" +
	"\x18UndeployExtensionRequest\x12,\n" +
	"\x02id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x02id\x12N\n" +
	"\x14kept_extension_items\x18\x02 \x03(\v2\x1c.google.protobuf.StringValueR\x12keptExtensionItems\"\xbb\x03\n" +
	"\x19UndeployExtensionResponse\x12d\n" +
	"\ffailed_items\x18\x01 \x03(\v2A.com.coralogix.extensions.v1.UndeployExtensionResponse.FailedItemR\vfailedItems\x12h\n" +
	"\x14extension_deployment\x18\x02 \x01(\v20.com.coralogix.extensions.v1.ExtensionDeploymentH\x00R\x13extensionDeployment\x88\x01\x01\x1a\xb4\x01\n" +
	"\n" +
	"FailedItem\x125\n" +
	...
	"\x06reason\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\x06reasonB\x17\n" +
	"\x15_extension_deployment2\xc6\x06\n" +
	"\x1aExtensionDeploymentService\x12\xd7\x01\n" +
	"\x15GetDeployedExtensions\x129.com.coralogix.extensions.v1.GetDeployedExtensionsRequest\x1a:.com.coralogix.extensions.v1.GetDeployedExtensionsResponse\"G¸\x02\x19\n" +
	"\x17Get deployed extensions\x82\xd3\xe4\x93\x02$\x12\"/extensions-deployment/v1/deployed\x12\xbf\x01\n" +
	"\x0fDeployExtension\x123.com.coralogix.extensions.v1.DeployExtensionRequest\x1a4.com.coralogix.extensions.v1.DeployExtensionResponse\"A¸\x02\x12\n" +
	"\x10Deploy extension\x82\xd3\xe4\x93\x02%:\x01*\" /extensions-deployment/v1/deploy\x12\xbf\x01\n" +
	"\x0fUpdateExtension\x123.com.coralogix.extensions.v1.UpdateExtensionRequest\x1a4.com.coralogix.extensions.v1.UpdateExtensionResponse\"A¸\x02\x12\n" +
	"\x10Update extension\x82\xd3\xe4\x93\x02%:\x01*\" /extensions-deployment/v1/update\x12\xc9\x01\n" +
	"\x11UndeployExtension\x125.com.coralogix.extensions.v1.UndeployExtensionRequest\x1a6.com.coralogix.extensions.v1.UndeployExtensionResponse\"E¸\x02\x14\n" +
	"\x12Undeploy extension\x82\xd3\xe4\x93\x02':\x01*\"\"/extensions-deployment/v1/undeployb\x06proto3"
