...
func file_com_coralogix_extensions_v1_extension_deployment_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_com_coralogix_extensions_v1_extension_deployment_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExtensionDeployment); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_extensions_v1_extension_deployment_service_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_coralogix_extensions_v1_extension_deployment_service_proto_msgTypes[3].OneofWrappers = []interface{}{}
	file_com_coralogix_extensions_v1_extension_deployment_service_proto_msgTypes[5].OneofWrappers = []interface{}{}
	file_com_coralogix_extensions_v1_extension_deployment_service_proto_msgTypes[8].OneofWrappers = []interface{}{}
	type x struct{}
