...
func (x *GetQuotasResponse) GetCompanyId() *wrappers.StringValue {
	if x != nil {
		return x.CompanyId
	}
	return nil
...
type GetQuotasResponse_Usage struct {
	...
	Used  *wrappers.Int32Value `protobuf:"bytes,1,opt,name=used,proto3" json:"used,omitempty"`
...
func (x *GetQuotasResponse_Usage) GetUsed() *wrappers.Int32Value {
	if x != nil {
		return x.Used
	}
	return nil
...
func (x *GetQuotasResponse_Usage) GetLimit() *wrappers.Int32Value {
	if x != nil {
		return x.Limit
	}
	return nil
...
type GetQuotasResponse_Events2MetricsUsage struct {
	...
	LabelsLimit  *wrappers.Int32Value     `protobuf:"bytes,1,opt,name=labels_limit,json=labelsLimit,proto3" json:"labels_limit,omitempty"`
...
func (x *GetQuotasResponse_Events2MetricsUsage) GetLabelsLimit() *wrappers.Int32Value {
	if x != nil {
