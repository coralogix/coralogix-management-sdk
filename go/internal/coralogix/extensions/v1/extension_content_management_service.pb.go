...
type ValidateExtensionItemsResponse_InvalidExtension struct {
	...
	ExtensionId *wrappers.StringValue `protobuf:"bytes,1,opt,name=extension_id,json=extensionId,proto3" json:"extension_id,omitempty"`
	// Includes extension item parsing errors.
	ErrorMessage *wrappers.StringValue `protobuf:"bytes,2,opt,name=error_message,json=errorMessage,proto3" json:"error_message,omitempty"`
}
...
func (x *ValidateExtensionItemsResponse_InvalidExtension) GetExtensionId() *wrappers.StringValue {
	if x != nil {
...
func (x *ValidateExtensionItemsResponse_InvalidExtension) GetErrorMessage() *wrappers.StringValue {
	if x != nil {
