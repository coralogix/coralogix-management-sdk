...
const file_com_coralogix_extensions_v1_extension_service_proto_rawDesc = "" +
	"\n" +
	"3com/coralogix/extensions/v1/extension_service.proto\x12\x1bcom.coralogix.extensions.v1\x1a'com/coralogix/common/v1/audit_log.proto\x1a+com/coralogix/extensions/v1/extension.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a google/protobuf/descriptor.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\x87\x03\n" +
	"\x17GetAllExtensionsRequest\x12V\n" +
	"\x19include_hidden_extensions\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x17includeHiddenExtensions\x12S\n" +
	"\x06filter\x18\x02 \x01(\v2;.com.coralogix.extensions.v1.GetAllExtensionsRequest.FilterR\x06filter\x1a\x7f\n" +
	"\x06Filter\x12\"\n" +
	"\fintegrations\x18\x01 \x03(\tR\fintegrations:Q\x92AN\n" +
	"L* GetAllExtensionsRequest - Filter2\x19Filter by integration ids\xd2\x01\fintegrations:>\x92A;\n" +
	"9*\x17GetAllExtensionsRequest2\x1eRequest to list all extensions\"\x9b\n" +
	"\n" +
	"\x18GetAllExtensionsResponse\x12_\n" +
	"\n" +
	"extensions\x18\x01 \x03(\v2?.com.coralogix.extensions.v1.GetAllExtensionsResponse.ExtensionR\n" +
	"extensions\x1a\x8e\x01\n" +
	"\x0fRevisionSummary\x12H\n" +
	"\vitem_counts\x18\x01 \x01(\v2'.com.coralogix.extensions.v1.ItemCountsR\n" +
	"itemCounts\x121\n" +
	"\x06is_new\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\x05isNew\x1a\xb2\x03\n" +
	"\bRevision\x126\n" +
	...
	"\x13integration_details\x18\x05 \x03(\v2..com.coralogix.extensions.v1.IntegrationDetailR\x12integrationDetails\x12_\n" +
	"\asummary\x18\x06 \x01(\v2E.com.coralogix.extensions.v1.GetAllExtensionsResponse.RevisionSummaryR\asummary\x1a\x88\x04\n" +
	"\tExtension\x12,\n" +
	...
	"\x0fdark_mode_image\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\rdarkModeImage\x12\\\n" +
	"\trevisions\x18\x05 \x03(\v2>.com.coralogix.extensions.v1.GetAllExtensionsResponse.RevisionR\trevisions\x127\n" +
	"\tis_hidden\x18\x06 \x01(\v2\x1a.google.protobuf.BoolValueR\bisHidden\x12\"\n" +
	"\fintegrations\x18\a \x03(\tR\fintegrations\x12\x1a\n" +
	"\bkeywords\x18\b \x03(\tR\bkeywords\x12J\n" +
	"\vdeprecation\x18\t \x01(\v2(.com.coralogix.extensions.v1.DeprecationR\vdeprecation:M\x92AJ\n" +
	"H*\x18GetAllExtensionsResponse2\x1fResponse to list all extensions\xd2\x01\n" +
	"extensions\"\xf3\x01\n" +
	"\x13GetExtensionRequest\x12,\n" +
	"\x02id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x02id\x12X\n" +
	"\x1ainclude_dashboard_binaries\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\x18includeDashboardBinaries\x12T\n" +
	"\x18include_testing_revision\x18\x03 \x01(\v2\x1a.google.protobuf.BoolValueR\x16includeTestingRevision\"\\\n" +
	"\x14GetExtensionResponse\x12D\n" +
	"\textension\x18\x01 \x01(\v2&.com.coralogix.extensions.v1.ExtensionR\textension2\x82\x03\n" +
	"\x10ExtensionService\x12\xb6\x01\n" +
	"\x10GetAllExtensions\x124.com.coralogix.extensions.v1.GetAllExtensionsRequest\x1a5.com.coralogix.extensions.v1.GetAllExtensionsResponse\"5¸\x02\x14\n" +
	"\x12Get all extensions\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/extensions/v1/all\x12\xb4\x01\n" +
	"\fGetExtension\x120.com.coralogix.extensions.v1.GetExtensionRequest\x1a1.com.coralogix.extensions.v1.GetExtensionResponse\"?¸\x02\x15\n" +
	"\x13Get extension by id\x82\xd3\xe4\x93\x02 b\textension\x12\x13/extensions/v1/{id}b\x06proto3"
