...
const file_com_coralogix_extensions_v1_extension_proto_rawDesc = "" +
	"\n" +
	"+com/coralogix/extensions/v1/extension.proto\x12\x1bcom.coralogix.extensions.v1\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xf0\x02\n" +
	...
	"\x1eCX_CUSTOM_DASHBOARD_DEFINITION\x10\x04\"\xa6\b\n" +
	"\rExtensionItem\x12,\n" +
	...
	"\x04data\x18\x05 \x01(\v2\x17.google.protobuf.StructR\x04data\x12L\n" +
	"\bbinaries\x18\x06 \x03(\v20.com.coralogix.extensions.v1.ExtensionItemBinaryR\bbinaries\x12=\n" +
	"\fis_mandatory\x18\a \x01(\v2\x1a.google.protobuf.BoolValueR\visMandatory\x12n\n" +
	...
	"\x16LOGS_EVENTS_TO_METRICS\x10\x0eJ\x04\b\b\x10\tR\vinternal_id\"\xb5\x05\n" +
	"\n" +
	"ItemCounts\x126\n" +
	"\aactions\x18\x01 \x01(\v2\x1c.google.protobuf.UInt32ValueR\aactions\x124\n" +
	"\x06alerts\x18\x02 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x06alerts\x12I\n" +
	"\x11custom_dashboards\x18\x03 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x10customDashboards\x12>\n" +
	"\venrichments\x18\x04 \x01(\v2\x1c.google.protobuf.UInt32ValueR\venrichments\x12H\n" +
	"\x11events_to_metrics\x18\x05 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x0feventsToMetrics\x12K\n" +
	"\x12grafana_dashboards\x18\x06 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x11grafanaDashboards\x12I\n" +
	"\x11kibana_dashboards\x18\a \x01(\v2\x1c.google.protobuf.UInt32ValueR\x10kibanaDashboards\x12J\n" +
	"\x12metrics_rule_group\x18\b \x01(\v2\x1c.google.protobuf.UInt32ValueR\x10metricsRuleGroup\x12A\n" +
	"\rparsing_rules\x18\t \x01(\v2\x1c.google.protobuf.UInt32ValueR\fparsingRules\x12=\n" +
	"\vsaved_views\x18\n" +
	" \x01(\v2\x1c.google.protobuf.UInt32ValueR\n" +
	"savedViews\"w\n" +
	"\x11IntegrationDetail\x120\n" +
	"\x04name\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x04name\x120\n" +
	"\x04link\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x04link\"\xb8\x01\n" +
	...
	"\n" +
	"BinaryType\x12\x18\n" +
	"\x14KIBANA_INDEX_PATTERN\x10\x00\"\x8d\x01\n" +
	"\x0eChangelogEntry\x126\n" +
	"\aversion\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\aversion\x12C\n" +
	"\x0edescription_md\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\rdescriptionMd\"\x98\x01\n" +
	"\vDeprecation\x124\n" +
	"\x06reason\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x06reason\x12S\n" +
	"\x16replacement_extensions\x18\x02 \x03(\v2\x1c.google.protobuf.StringValueR\x15replacementExtensions\"\x85\x05\n" +
	...
	"\aexcerpt\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\aexcerpt\x124\n" +
	"\x06labels\x18\x04 \x03(\v2\x1c.google.protobuf.StringValueR\x06labels\x12_\n" +
	"\x13integration_details\x18\x05 \x03(\v2..com.coralogix.extensions.v1.IntegrationDetailR\x12integrationDetails\x12@\n" +
	"\x05items\x18\x06 \x03(\v2*.com.coralogix.extensions.v1.ExtensionItemR\x05items\x12H\n" +
	"\bbinaries\x18\a \x03(\v2,.com.coralogix.extensions.v1.ExtensionBinaryR\bbinaries\x12b\n" +
	"\x17permission_denied_items\x18\b \x03(\v2*.com.coralogix.extensions.v1.ExtensionItemR\x15permissionDeniedItems\x129\n" +
	"\n" +
	"is_testing\x18\t \x01(\v2\x1a.google.protobuf.BoolValueR\tisTesting\"\xd1\x05\n" +
	"\tExtension\x12,\n" +
	"\x02id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x02id\x120\n" +
	...
	"\x0fdark_mode_image\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\rdarkModeImage\x12L\n" +
	"\trevisions\x18\x05 \x03(\v2..com.coralogix.extensions.v1.ExtensionRevisionR\trevisions\x127\n" +
	"\tis_hidden\x18\x06 \x01(\v2\x1a.google.protobuf.BoolValueR\bisHidden\x12\"\n" +
	"\fintegrations\x18\a \x03(\tR\fintegrations\x128\n" +
	"\bkeywords\x18\b \x03(\v2\x1c.google.protobuf.StringValueR\bkeywords\x12n\n" +
	"\x1bpermission_denied_revisions\x18\t \x03(\v2..com.coralogix.extensions.v1.ExtensionRevisionR\x19permissionDeniedRevisions\x12I\n" +
	"\tchangelog\x18\n" +
	" \x03(\v2+.com.coralogix.extensions.v1.ChangelogEntryR\tchangelog\x12J\n" +
	"\vdeprecation\x18\v \x01(\v2(.com.coralogix.extensions.v1.DeprecationR\vdeprecation\"\xe3\t\n" +
	"\rExtensionData\x12Y\n" +
	"\x02id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueB+\x92A(J&\"076f4188-05e0-4ed3-afeb-653ad182ccb7\"R\x02id\x12I\n" +
	"\x04name\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueB\x17\x92A\x14J\x12\"I love chocolate\"R\x04name\x12`\n" +
	"\vdescription\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueB \x92A\x1dJ\x1b\"Chocolate is full of love\"R\vdescription\x12X\n" +
	"\aexcerpt\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueB \x92A\x1dJ\x1b\"Chocolate is full of love\"R\aexcerpt\x122\n" +
	"\x05image\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueR\x05image\x12D\n" +
	"\x0fdark_mode_image\x18\x06 \x01(\v2\x1c.google.protobuf.StringValueR\rdarkModeImage\x12L\n" +
	"\x06labels\x18\a \x03(\v2\x1c.google.protobuf.StringValueB\x16\x92A\x13J\x11[\"cocoa\",\"sugar\"]R\x06labels\x12F\n" +
	"\aversion\x18\b \x01(\v2\x1c.google.protobuf.StringValueB\x0e\x92A\vJ\t\"v1.0.13\"R\aversion\x12D\n" +
	"\x05items\x18\t \x03(\v2..com.coralogix.extensions.v1.ExtensionItemDataR\x05items\x12_\n" +
	"\x13integration_details\x18\n" +
	" \x03(\v2..com.coralogix.extensions.v1.IntegrationDetailR\x12integrationDetails\x12C\n" +
	"\tis_hidden\x18\v \x01(\v2\x1a.google.protobuf.BoolValueB\n" +
	"\x92A\aJ\x05falseR\bisHidden\x12H\n" +
	"\bbinaries\x18\f \x03(\v2,.com.coralogix.extensions.v1.ExtensionBinaryR\bbinaries\x12\"\n" +
	"\fintegrations\x18\r \x03(\tR\fintegrations\x128\n" +
	"\bkeywords\x18\x0e \x03(\v2\x1c.google.protobuf.StringValueR\bkeywords\x12I\n" +
	"\tchangelog\x18\x0f \x03(\v2+.com.coralogix.extensions.v1.ChangelogEntryR\tchangelog\x12J\n" +
	"\vdeprecation\x18\x10 \x01(\v2(.com.coralogix.extensions.v1.DeprecationR\vdeprecation:5\x92A2\n" +
	"0*\rExtensionData2\x1fResponse to list all extensions\"\xb9\x05\n" +
	...
	"\x04data\x18\x04 \x01(\v2\x17.google.protobuf.StructR\x04data\x12L\n" +
	"\bbinaries\x18\x05 \x03(\v20.com.coralogix.extensions.v1.ExtensionItemBinaryR\bbinaries\x12H\n" +
	"\fis_mandatory\x18\x06 \x01(\v2\x1a.google.protobuf.BoolValueB\t\x92A\x06J\x04trueR\visMandatory\x12<\n" +
	"\vinternal_id\x18\a \x01(\v2\x1b.google.protobuf.Int32ValueR\n" +
	"internalId\x129\n" +
	"\tunique_id\x18\b \x01(\v2\x1c.google.protobuf.StringValueR\buniqueId\x12n\n" +
	"\x13permission_resource\x18\t \x01(\x0e2=.com.coralogix.extensions.v1.ExtensionItem.PermissionResourceR\x12permissionResource*\xf1\x01\n" +
	"\fTargetDomain\x12\n" +
	"\n" +
