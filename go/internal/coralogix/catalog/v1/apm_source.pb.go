...
var file_com_coralogixapis_service_catalog_v1_apm_source_proto_rawDesc = string([]byte{
...
var (
	...
	file_com_coralogixapis_service_catalog_v1_apm_source_proto_rawDescData []byte
)
...
func file_com_coralogixapis_service_catalog_v1_apm_source_proto_rawDescGZIP() []byte {
	file_com_coralogixapis_service_catalog_v1_apm_source_proto_rawDescOnce.Do(func() {
		file_com_coralogixapis_service_catalog_v1_apm_source_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogixapis_service_catalog_v1_apm_source_proto_rawDesc), len(file_com_coralogixapis_service_catalog_v1_apm_source_proto_rawDesc)))
	})
...
func file_com_coralogixapis_service_catalog_v1_apm_source_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogixapis_service_catalog_v1_apm_source_proto_rawDesc), len(file_com_coralogixapis_service_catalog_v1_apm_source_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
