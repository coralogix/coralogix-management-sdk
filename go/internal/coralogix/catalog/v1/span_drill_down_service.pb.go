...
var file_com_coralogix_catalog_v1_span_drill_down_service_proto_goTypes = []interface{}{
...
func file_com_coralogix_catalog_v1_span_drill_down_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_catalog_v1_span_drill_down_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetServiceSideModelGraphsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_catalog_v1_span_drill_down_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetServiceSideModelGraphsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_com_coralogix_catalog_v1_span_drill_down_service_proto_msgTypes[1].OneofWrappers = []interface{}{
