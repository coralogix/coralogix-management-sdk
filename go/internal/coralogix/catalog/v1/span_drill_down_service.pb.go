...
type GetServiceSideModelGraphsRequest struct {
	...
	Method                *wrappers.StringValue `protobuf:"bytes,6,opt,name=method,proto3" json:"method,omitempty"`
}
...
func (x *GetServiceSideModelGraphsRequest) GetServiceName() *wrappers.StringValue {
	if x != nil {
...
func (x *GetServiceSideModelGraphsRequest) GetOperation() *wrappers.StringValue {
	if x != nil {
		return x.Operation
	}
	return nil
...
func (x *GetServiceSideModelGraphsRequest) GetMethod() *wrappers.StringValue {
	if x != nil {
		return x.Method
	}
	return nil
