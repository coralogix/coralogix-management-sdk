...
func (x *GetServiceSideModelGraphsResponse) GetRequestsAndErrorsByServiceVersion() *RepeatedLineChart {
	if x != nil {
		if x, ok := x.Widget.(*GetServiceSideModelGraphsResponse_RequestsAndErrorsByServiceVersion); ok {
...
func (x *GetServiceSideModelGraphsResponse) GetLatencyPercentilesByServiceVersion() *RepeatedLineChart {
	if x != nil {
		if x, ok := x.Widget.(*GetServiceSideModelGraphsResponse_LatencyPercentilesByServiceVersion); ok {
...
func (x *GetServiceSideModelGraphsResponse) GetRequestsAndErrorsPerSecondByServiceVersion() *RepeatedLineChart {
	if x != nil {
		if x, ok := x.Widget.(*GetServiceSideModelGraphsResponse_RequestsAndErrorsPerSecondByServiceVersion); ok {
...
func (x *GetServiceSideModelGraphsResponse) GetLatencyPercentilesPerSecondByServiceVersion() *RepeatedLineChart {
	if x != nil {
		if x, ok := x.Widget.(*GetServiceSideModelGraphsResponse_LatencyPercentilesPerSecondByServiceVersion); ok {
