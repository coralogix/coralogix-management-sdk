...
func (x *GetOverviewRequest) GetServiceName() *wrappers.StringValue {
	if x != nil {
...
func (x *GetOverviewRequest) GetFilters() map[string]*_struct.ListValue {
	if x != nil {
		return x.Filters
	}
	return nil
...
type GetOverviewStreamRequest struct {
	...
	Filters     map[string]*_struct.ListValue `protobuf:"bytes,3,rep,name=filters,proto3" json:"filters,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	ApmSource   ApmSource                     `protobuf:"varint,4,opt,name=apm_source,json=apmSource,proto3,enum=com.coralogixapis.service_catalog.v1.ApmSource" json:"apm_source,omitempty"`
	TrendOffset *wrappers.Int64Value          `protobuf:"bytes,5,opt,name=trend_offset,json=trendOffset,proto3" json:"trend_offset,omitempty"`
	Widgets     []*wrappers.StringValue       `protobuf:"bytes,6,rep,name=widgets,proto3" json:"widgets,omitempty"`
}
...
func (x *GetOverviewStreamRequest) GetServiceName() *wrappers.StringValue {
	if x != nil {
		return x.ServiceName
	}
	return nil
...
func (x *GetOverviewStreamRequest) GetFilters() map[string]*_struct.ListValue {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *GetOverviewStreamRequest) GetTrendOffset() *wrappers.Int64Value {
	if x != nil {
...
func (x *GetOverviewStreamRequest) GetWidgets() []*wrappers.StringValue {
	if x != nil {
		return x.Widgets
	}
	return nil
...
func (x *GetApdexRequest) GetServiceName() *wrappers.StringValue {
	if x != nil {
		return x.ServiceName
	}
	return nil
...
func (x *GetApdexRequest) GetFilters() map[string]*_struct.ListValue {
	if x != nil {
		return x.Filters
	}
	return nil
...
type GetApdexResponse struct {
	...
	HasBucketsError *wrappers.BoolValue `protobuf:"bytes,2,opt,name=has_buckets_error,json=hasBucketsError,proto3" json:"has_buckets_error,omitempty"`
}
...
func (x *GetApdexResponse) GetHasBucketsError() *wrappers.BoolValue {
	if x != nil {
