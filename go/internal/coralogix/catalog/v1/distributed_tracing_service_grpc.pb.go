...
type DistributedTracingServiceClient interface {
	...
	OperationsColumnsStream(ctx context.Context, in *OperationsColumnsStreamRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[OperationsColumnsStreamResponse], error)
...
func (c *distributedTracingServiceClient) OperationsColumnsStream(ctx context.Context, in *OperationsColumnsStreamRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[OperationsColumnsStreamResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &DistributedTracingService_ServiceDesc.Streams[1], DistributedTracingService_OperationsColumnsStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[OperationsColumnsStreamRequest, OperationsColumnsStreamResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type DistributedTracingService_OperationsColumnsStreamClient = grpc.ServerStreamingClient[OperationsColumnsStreamResponse]
...
func (c *distributedTracingServiceClient) GetLatencyGraph(ctx context.Context, in *GetLatencyGraphRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetLatencyGraphResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &DistributedTracingService_ServiceDesc.Streams[2], DistributedTracingService_GetLatencyGraph_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type DistributedTracingServiceServer interface {
	...
	OperationsColumnsStream(*OperationsColumnsStreamRequest, grpc.ServerStreamingServer[OperationsColumnsStreamResponse]) error
...
func (UnimplementedDistributedTracingServiceServer) OperationsColumnsStream(*OperationsColumnsStreamRequest, grpc.ServerStreamingServer[OperationsColumnsStreamResponse]) error {
...
func _DistributedTracingService_OperationsColumnsStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DistributedTracingServiceServer).OperationsColumnsStream(m, &grpc.GenericServerStream[OperationsColumnsStreamRequest, OperationsColumnsStreamResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type DistributedTracingService_OperationsColumnsStreamServer = grpc.ServerStreamingServer[OperationsColumnsStreamResponse]
