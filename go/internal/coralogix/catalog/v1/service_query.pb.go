...
type ServiceQuery struct {
	...
	TrendOffset           *wrappers.Int64Value    `protobuf:"bytes,3,opt,name=trend_offset,json=trendOffset,proto3" json:"trend_offset,omitempty"`
	Columns               []*wrappers.StringValue `protobuf:"bytes,4,rep,name=columns,proto3" json:"columns,omitempty"`
}
...
func (x *ServiceQuery) GetTrendOffset() *wrappers.Int64Value {
	if x != nil {
...
func (x *ServiceQuery) GetColumns() []*wrappers.StringValue {
	if x != nil {
		return x.Columns
	}
	return nil
