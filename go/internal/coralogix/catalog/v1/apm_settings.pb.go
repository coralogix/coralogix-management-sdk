...
type CatalogSettings struct {
	...
	MigrationPeriodEndDate *timestamp.Timestamp `protobuf:"bytes,2,opt,name=migration_period_end_date,json=migrationPeriodEndDate,proto3" json:"migration_period_end_date,omitempty"`
	RetentionPolicy        *wrappers.Int32Value `protobuf:"bytes,3,opt,name=retention_policy,json=retentionPolicy,proto3" json:"retention_policy,omitempty"`
...
func (x *CatalogSettings) GetMigrationPeriodEndDate() *timestamp.Timestamp {
	if x != nil {
...
func (x *CatalogSettings) GetRetentionPolicy() *wrappers.Int32Value {
	if x != nil {
