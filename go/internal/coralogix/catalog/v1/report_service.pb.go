...
func (x *GetReportRequest) GetCompanyId() *wrappers.StringValue {
	if x != nil {
		return x.CompanyId
	}
	return nil
...
type CompanyReport struct {
	...
	CompanyId                     *wrappers.Int64Value  `protobuf:"bytes,1,opt,name=company_id,json=companyId,proto3" json:"company_id,omitempty"`
	...
	Environment                   *wrappers.StringValue `protobuf:"bytes,3,opt,name=environment,proto3" json:"environment,omitempty"`
	ServiceRetentionPeriod        *wrappers.Int64Value  `protobuf:"bytes,4,opt,name=service_retention_period,json=serviceRetentionPeriod,proto3" json:"service_retention_period,omitempty"`
	...
	MigrationPeriod               *wrappers.StringValue `protobuf:"bytes,6,opt,name=migration_period,json=migrationPeriod,proto3" json:"migration_period,omitempty"`
	ServiceCount                  *wrappers.Int64Value  `protobuf:"bytes,7,opt,name=service_count,json=serviceCount,proto3" json:"service_count,omitempty"`
	ActiveServiceCount            *wrappers.Int64Value  `protobuf:"bytes,8,opt,name=active_service_count,json=activeServiceCount,proto3" json:"active_service_count,omitempty"`
	DatabaseCount                 *wrappers.Int64Value  `protobuf:"bytes,9,opt,name=database_count,json=databaseCount,proto3" json:"database_count,omitempty"`
	ActiveDatabaseCount           *wrappers.Int64Value  `protobuf:"bytes,10,opt,name=active_database_count,json=activeDatabaseCount,proto3" json:"active_database_count,omitempty"`
	ServerlessCount               *wrappers.Int64Value  `protobuf:"bytes,11,opt,name=serverless_count,json=serverlessCount,proto3" json:"serverless_count,omitempty"`
	ServiceFlowsCount             *wrappers.Int64Value  `protobuf:"bytes,12,opt,name=service_flows_count,json=serviceFlowsCount,proto3" json:"service_flows_count,omitempty"`
	ServiceFlowsInstrumentedCount *wrappers.Int64Value  `protobuf:"bytes,13,opt,name=service_flows_instrumented_count,json=serviceFlowsInstrumentedCount,proto3" json:"service_flows_instrumented_count,omitempty"`
	SloCount                      *wrappers.Int64Value  `protobuf:"bytes,14,opt,name=slo_count,json=sloCount,proto3" json:"slo_count,omitempty"`
	AlertCount                    *wrappers.Int64Value  `protobuf:"bytes,15,opt,name=alert_count,json=alertCount,proto3" json:"alert_count,omitempty"`
	DbRetentionPeriod             *wrappers.Int64Value  `protobuf:"bytes,16,opt,name=db_retention_period,json=dbRetentionPeriod,proto3" json:"db_retention_period,omitempty"`
	...
	DbMigrationPeriod             *wrappers.StringValue `protobuf:"bytes,18,opt,name=db_migration_period,json=dbMigrationPeriod,proto3" json:"db_migration_period,omitempty"`
}
...
func (x *CompanyReport) GetCompanyId() *wrappers.Int64Value {
	if x != nil {
		return x.CompanyId
	}
	return nil
...
func (x *CompanyReport) GetCompanyName() *wrappers.StringValue {
	if x != nil {
...
func (x *CompanyReport) GetEnvironment() *wrappers.StringValue {
	if x != nil {
...
func (x *CompanyReport) GetServiceRetentionPeriod() *wrappers.Int64Value {
	if x != nil {
...
func (x *CompanyReport) GetMigrationPeriod() *wrappers.StringValue {
	if x != nil {
...
func (x *CompanyReport) GetServiceCount() *wrappers.Int64Value {
	if x != nil {
...
func (x *CompanyReport) GetActiveServiceCount() *wrappers.Int64Value {
	if x != nil {
...
func (x *CompanyReport) GetDatabaseCount() *wrappers.Int64Value {
	if x != nil {
...
func (x *CompanyReport) GetActiveDatabaseCount() *wrappers.Int64Value {
	if x != nil {
...
func (x *CompanyReport) GetServerlessCount() *wrappers.Int64Value {
	if x != nil {
...
func (x *CompanyReport) GetServiceFlowsCount() *wrappers.Int64Value {
	if x != nil {
...
func (x *CompanyReport) GetServiceFlowsInstrumentedCount() *wrappers.Int64Value {
	if x != nil {
...
func (x *CompanyReport) GetSloCount() *wrappers.Int64Value {
	if x != nil {
		return x.SloCount
	}
	return nil
...
func (x *CompanyReport) GetAlertCount() *wrappers.Int64Value {
	if x != nil {
		return x.AlertCount
	}
	return nil
...
func (x *CompanyReport) GetDbRetentionPeriod() *wrappers.Int64Value {
	if x != nil {
...
func (x *CompanyReport) GetDbMigrationPeriod() *wrappers.StringValue {
	if x != nil {
