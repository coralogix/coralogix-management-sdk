...
func (c *serviceOverviewServiceClient) GetServiceOverview(ctx context.Context, in *GetServiceOverviewRequest, opts ...grpc.CallOption) (*GetServiceOverviewResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceOverviewService_GetServiceOverview_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedServiceOverviewServiceServer must be embedded to have
...
func (UnimplementedServiceOverviewServiceServer) testEmbeddedByValue() {}
...
func RegisterServiceOverviewServiceServer(s grpc.ServiceRegistrar, srv ServiceOverviewServiceServer) {
	// If the following call pancis, it indicates UnimplementedServiceOverviewServiceServer was
