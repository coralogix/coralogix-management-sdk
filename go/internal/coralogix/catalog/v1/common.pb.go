...
func (x *TimeRange) GetStart() *wrappers.Int64Value {
	if x != nil {
		return x.Start
	}
	return nil
...
func (x *TimeRange) GetEnd() *wrappers.Int64Value {
	if x != nil {
		return x.End
	}
	return nil
...
type ApmFilter struct {
	...
	LabelKey        *wrappers.StringValue   `protobuf:"bytes,2,opt,name=label_key,json=labelKey,proto3" json:"label_key,omitempty"`
	LabelValues     []*wrappers.StringValue `protobuf:"bytes,3,rep,name=label_values,json=labelValues,proto3" json:"label_values,omitempty"`
	CreatedAt       *wrappers.Int64Value    `protobuf:"bytes,4,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	UpdatedAt       *wrappers.Int64Value    `protobuf:"bytes,5,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"`
	MetricLabelName *wrappers.StringValue   `protobuf:"bytes,6,opt,name=metric_label_name,json=metricLabelName,proto3" json:"metric_label_name,omitempty"`
}
...
func (x *ApmFilter) GetLabelName() *wrappers.StringValue {
	if x != nil {
		return x.LabelName
	}
	return nil
...
func (x *ApmFilter) GetLabelKey() *wrappers.StringValue {
	if x != nil {
		return x.LabelKey
	}
	return nil
...
func (x *ApmFilter) GetLabelValues() []*wrappers.StringValue {
	if x != nil {
...
func (x *ApmFilter) GetCreatedAt() *wrappers.Int64Value {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *ApmFilter) GetUpdatedAt() *wrappers.Int64Value {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
func (x *ApmFilter) GetMetricLabelName() *wrappers.StringValue {
	if x != nil {
