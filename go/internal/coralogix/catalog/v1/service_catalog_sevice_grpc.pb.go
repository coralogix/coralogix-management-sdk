...
import (
	context "context"
	v1 "github.com/coralogix/coralogix-management-sdk/internal/coralogix/schemastore/v1"
...
func (c *serviceCatalogServiceClient) GetServicesColumnsStream(ctx context.Context, in *GetServicesColumnsStreamRequest, opts ...grpc.CallOption) (ServiceCatalogService_GetServicesColumnsStreamClient, error) {
	...
	x := &serviceCatalogServiceGetServicesColumnsStreamClient{ClientStream: stream}
...
func _ServiceCatalogService_GetServicesColumnsStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ServiceCatalogServiceServer).GetServicesColumnsStream(m, &serviceCatalogServiceGetServicesColumnsStreamServer{ServerStream: stream})
}
