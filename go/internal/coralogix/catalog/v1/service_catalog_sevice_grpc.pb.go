...
import (
	context "context"
	v1 "coralogix-management-sdk/go/internal/coralogix/schemastore/v1"
...
type ServiceCatalogServiceClient interface {
	...
	GetServicesColumnsStream(ctx context.Context, in *GetServicesColumnsStreamRequest, opts ...grpc.CallOption) (ServiceCatalogService_GetServicesColumnsStreamClient, error)
...
func (c *serviceCatalogServiceClient) GetServices(ctx context.Context, in *GetServicesRequest, opts ...grpc.CallOption) (*GetServicesResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceCatalogService_GetServices_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceCatalogServiceClient) GetServicesColumnsStream(ctx context.Context, in *GetServicesColumnsStreamRequest, opts ...grpc.CallOption) (ServiceCatalogService_GetServicesColumnsStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &ServiceCatalogService_ServiceDesc.Streams[0], ServiceCatalogService_GetServicesColumnsStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &serviceCatalogServiceGetServicesColumnsStreamClient{stream}
...
type ServiceCatalogService_GetServicesColumnsStreamClient interface {
	Recv() (*GetServicesColumnsStreamResponse, error)
	grpc.ClientStream
}

type serviceCatalogServiceGetServicesColumnsStreamClient struct {
	grpc.ClientStream
}

func (x *serviceCatalogServiceGetServicesColumnsStreamClient) Recv() (*GetServicesColumnsStreamResponse, error) {
	m := new(GetServicesColumnsStreamResponse)
...
func (c *serviceCatalogServiceClient) GetService(ctx context.Context, in *GetServiceRequest, opts ...grpc.CallOption) (*GetServiceResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceCatalogService_GetService_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceCatalogServiceClient) GetServiceCatalogFilters(ctx context.Context, in *GetServiceCatalogFiltersRequest, opts ...grpc.CallOption) (*GetServiceCatalogFiltersResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceCatalogService_GetServiceCatalogFilters_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceCatalogServiceClient) UpdateServiceCatalogFilters(ctx context.Context, in *UpdateServiceCatalogFiltersRequest, opts ...grpc.CallOption) (*UpdateServiceCatalogFiltersResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceCatalogService_UpdateServiceCatalogFilters_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceCatalogServiceClient) GetTracingLabels(ctx context.Context, in *v1.TracingFieldsRequest, opts ...grpc.CallOption) (*v1.TracingFieldsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceCatalogService_GetTracingLabels_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceCatalogServiceClient) GetSpanMetricBuckets(ctx context.Context, in *GetSpanMetricBucketsRequest, opts ...grpc.CallOption) (*GetSpanMetricBucketsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceCatalogService_GetSpanMetricBuckets_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceCatalogServiceClient) GetAffectedAlerts(ctx context.Context, in *GetAffectedAlertsRequest, opts ...grpc.CallOption) (*GetAffectedAlertsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceCatalogService_GetAffectedAlerts_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServiceCatalogServiceServer interface {
	...
	GetServicesColumnsStream(*GetServicesColumnsStreamRequest, ServiceCatalogService_GetServicesColumnsStreamServer) error
...
// UnimplementedServiceCatalogServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedServiceCatalogServiceServer) GetServicesColumnsStream(*GetServicesColumnsStreamRequest, ServiceCatalogService_GetServicesColumnsStreamServer) error {
...
func _ServiceCatalogService_GetServicesColumnsStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ServiceCatalogServiceServer).GetServicesColumnsStream(m, &serviceCatalogServiceGetServicesColumnsStreamServer{stream})
}

type ServiceCatalogService_GetServicesColumnsStreamServer interface {
	Send(*GetServicesColumnsStreamResponse) error
	grpc.ServerStream
}

type serviceCatalogServiceGetServicesColumnsStreamServer struct {
	grpc.ServerStream
}

func (x *serviceCatalogServiceGetServicesColumnsStreamServer) Send(m *GetServicesColumnsStreamResponse) error {
