...
type ServiceAction struct {
	...
	ActionName                *wrappers.StringValue `protobuf:"bytes,1,opt,name=action_name,json=actionName,proto3" json:"action_name,omitempty"`
	...
	TimeConsumingPercentage   *wrappers.Int64Value  `protobuf:"bytes,4,opt,name=time_consuming_percentage,json=timeConsumingPercentage,proto3" json:"time_consuming_percentage,omitempty"`
	TimeConsuming             *wrappers.Int64Value  `protobuf:"bytes,5,opt,name=time_consuming,json=timeConsuming,proto3" json:"time_consuming,omitempty"`
	ErrorsPercentage          *wrappers.Int64Value  `protobuf:"bytes,6,opt,name=errors_percentage,json=errorsPercentage,proto3" json:"errors_percentage,omitempty"`
	Errors                    *wrappers.Int64Value  `protobuf:"bytes,7,opt,name=errors,proto3" json:"errors,omitempty"`
	NumberOfRequest           *wrappers.Int64Value  `protobuf:"bytes,8,opt,name=number_of_request,json=numberOfRequest,proto3" json:"number_of_request,omitempty"`
	NumberOfRequestPercentage *wrappers.Int64Value  `protobuf:"bytes,9,opt,name=number_of_request_percentage,json=numberOfRequestPercentage,proto3" json:"number_of_request_percentage,omitempty"`
	P95Latency                *wrappers.Int64Value  `protobuf:"bytes,10,opt,name=p95_latency,json=p95Latency,proto3" json:"p95_latency,omitempty"`
	P99Latency                *wrappers.Int64Value  `protobuf:"bytes,11,opt,name=p99_latency,json=p99Latency,proto3" json:"p99_latency,omitempty"`
}
...
func (x *ServiceAction) GetActionName() *wrappers.StringValue {
	if x != nil {
		return x.ActionName
	}
	return nil
...
func (x *ServiceAction) GetServiceName() *wrappers.StringValue {
	if x != nil {
...
func (x *ServiceAction) GetMethod() *wrappers.StringValue {
	if x != nil {
		return x.Method
	}
	return nil
...
func (x *ServiceAction) GetTimeConsumingPercentage() *wrappers.Int64Value {
	if x != nil {
...
func (x *ServiceAction) GetTimeConsuming() *wrappers.Int64Value {
	if x != nil {
...
func (x *ServiceAction) GetErrorsPercentage() *wrappers.Int64Value {
	if x != nil {
...
func (x *ServiceAction) GetErrors() *wrappers.Int64Value {
	if x != nil {
		return x.Errors
	}
	return nil
...
func (x *ServiceAction) GetNumberOfRequest() *wrappers.Int64Value {
	if x != nil {
...
func (x *ServiceAction) GetNumberOfRequestPercentage() *wrappers.Int64Value {
	if x != nil {
...
func (x *ServiceAction) GetP95Latency() *wrappers.Int64Value {
	if x != nil {
		return x.P95Latency
	}
	return nil
...
func (x *ServiceAction) GetP99Latency() *wrappers.Int64Value {
	if x != nil {
		return x.P99Latency
	}
	return nil
