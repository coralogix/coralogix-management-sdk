...
var file_com_coralogix_catalog_v1_service_action_proto_goTypes = []interface{}{
...
func file_com_coralogix_catalog_v1_service_action_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_catalog_v1_service_action_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
