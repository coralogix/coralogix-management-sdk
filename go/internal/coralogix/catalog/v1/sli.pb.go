...
type Sli struct {
	...
	HasBucketsError      *wrapperspb.BoolValue     `protobuf:"bytes,20,opt,name=has_buckets_error,json=hasBucketsError,proto3" json:"has_buckets_error,omitempty"`
	FloatSloPercentage   *wrapperspb.FloatValue    `protobuf:"bytes,21,opt,name=float_slo_percentage,json=floatSloPercentage,proto3" json:"float_slo_percentage,omitempty"`
	SloCurrentPercentage *wrapperspb.FloatValue    `protobuf:"bytes,22,opt,name=slo_current_percentage,json=sloCurrentPercentage,proto3" json:"slo_current_percentage,omitempty"`
	SloViolations        *wrapperspb.FloatValue    `protobuf:"bytes,23,opt,name=slo_violations,json=sloViolations,proto3" json:"slo_violations,omitempty"`
	SloAllowedViolations *wrapperspb.FloatValue    `protobuf:"bytes,24,opt,name=slo_allowed_violations,json=sloAllowedViolations,proto3" json:"slo_allowed_violations,omitempty"`
	Total                *wrapperspb.FloatValue    `protobuf:"bytes,25,opt,name=total,proto3" json:"total,omitempty"`
...
func (x *Sli) GetHasBucketsError() *wrapperspb.BoolValue {
	if x != nil {
...
func (x *Sli) GetFloatSloPercentage() *wrapperspb.FloatValue {
	if x != nil {
...
func (x *Sli) GetSloCurrentPercentage() *wrapperspb.FloatValue {
	if x != nil {
...
func (x *Sli) GetSloViolations() *wrapperspb.FloatValue {
	if x != nil {
...
func (x *Sli) GetSloAllowedViolations() *wrapperspb.FloatValue {
	if x != nil {
...
func (x *Sli) GetTotal() *wrapperspb.FloatValue {
	if x != nil {
		return x.Total
	}
	return nil
...
var file_com_coralogix_catalog_v1_sli_proto_rawDesc = string([]byte{
...
var (
	...
	file_com_coralogix_catalog_v1_sli_proto_rawDescData []byte
)

func file_com_coralogix_catalog_v1_sli_proto_rawDescGZIP() []byte {
	file_com_coralogix_catalog_v1_sli_proto_rawDescOnce.Do(func() {
		file_com_coralogix_catalog_v1_sli_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogix_catalog_v1_sli_proto_rawDesc), len(file_com_coralogix_catalog_v1_sli_proto_rawDesc)))
	})
...
func file_com_coralogix_catalog_v1_sli_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogix_catalog_v1_sli_proto_rawDesc), len(file_com_coralogix_catalog_v1_sli_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
