...
func file_com_coralogix_catalog_v1_sli_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_catalog_v1_sli_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Sli); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogix_catalog_v1_sli_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_catalog_v1_sli_proto_msgTypes[2].Exporter = func(v any, i int) any {
