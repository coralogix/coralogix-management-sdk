...
type GraphMetadata struct {
	...
	Topk            *wrappers.Int32Value `protobuf:"bytes,2,opt,name=topk,proto3" json:"topk,omitempty"`
...
func (x *GraphMetadata) GetTopk() *wrappers.Int32Value {
	if x != nil {
		return x.Topk
	}
	return nil
...
type ServiceOverviewQuery struct {
	...
	SubjectLabel          *wrappers.StringValue `protobuf:"bytes,6,opt,name=subject_label,json=subjectLabel,proto3" json:"subject_label,omitempty"`
}
...
func (x *ServiceOverviewQuery) GetServiceName() *wrappers.StringValue {
	if x != nil {
...
func (x *ServiceOverviewQuery) GetSubjectLabel() *wrappers.StringValue {
	if x != nil {
