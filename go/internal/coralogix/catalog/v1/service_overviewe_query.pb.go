...
var file_com_coralogix_catalog_v1_service_overviewe_query_proto_goTypes = []interface{}{
...
func file_com_coralogix_catalog_v1_service_overviewe_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_catalog_v1_service_overviewe_query_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_catalog_v1_service_overviewe_query_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
