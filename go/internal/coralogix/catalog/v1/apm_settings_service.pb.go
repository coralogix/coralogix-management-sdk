...
type ReplaceRetentionPeriodRequest struct {
	...
	RetentionPeriodInDays *wrappers.Int32Value `protobuf:"bytes,1,opt,name=retention_period_in_days,json=retentionPeriodInDays,proto3" json:"retention_period_in_days,omitempty"`
...
func (x *ReplaceRetentionPeriodRequest) GetRetentionPeriodInDays() *wrappers.Int32Value {
	if x != nil {
...
func (x *ReplaceRetentionPeriodResponse) GetRetentionPeriodInDays() *wrappers.Int32Value {
	if x != nil {
		return x.RetentionPeriodInDays
	}
	return nil
...
type GetSpanMetricDimensionsByServiceNamesRequest struct {
	...
	ServiceNames []*wrappers.StringValue `protobuf:"bytes,1,rep,name=service_names,json=serviceNames,proto3" json:"service_names,omitempty"`
}
...
func (x *GetSpanMetricDimensionsByServiceNamesRequest) GetServiceNames() []*wrappers.StringValue {
	if x != nil {
...
type GetSpanMetricDimensionsResponse struct {
	...
	Dimensions       []*wrappers.StringValue       `protobuf:"bytes,1,rep,name=dimensions,proto3" json:"dimensions,omitempty"`
	DimensionsValues map[string]*_struct.ListValue `protobuf:"bytes,2,rep,name=dimensions_values,json=dimensionsValues,proto3" json:"dimensions_values,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *GetSpanMetricDimensionsResponse) GetDimensions() []*wrappers.StringValue {
	if x != nil {
		return x.Dimensions
	}
	return nil
...
func (x *GetSpanMetricDimensionsResponse) GetDimensionsValues() map[string]*_struct.ListValue {
	if x != nil {
...
func (x *GetSpanMetricDimensionsByServiceNamesResponse) GetDimensions() []*wrappers.StringValue {
	if x != nil {
		return x.Dimensions
	}
	return nil
