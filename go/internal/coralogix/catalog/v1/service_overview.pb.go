...
var file_com_coralogix_catalog_v1_service_overview_proto_goTypes = []interface{}{
...
func file_com_coralogix_catalog_v1_service_overview_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_catalog_v1_service_overview_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SeriesResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_catalog_v1_service_overview_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OperationSeriesResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_catalog_v1_service_overview_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ClientTimeConsumingSeriesResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_catalog_v1_service_overview_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
