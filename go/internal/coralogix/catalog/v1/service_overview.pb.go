...
type SeriesResult struct {
	...
	DataPoint *wrappers.StringValue `protobuf:"bytes,2,opt,name=data_point,json=dataPoint,proto3" json:"data_point,omitempty"`
}
...
func (x *SeriesResult) GetTimestamp() *wrappers.Int64Value {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *SeriesResult) GetDataPoint() *wrappers.StringValue {
	if x != nil {
		return x.DataPoint
	}
	return nil
...
type OperationSeriesResult struct {
	...
	OperationName *wrappers.StringValue `protobuf:"bytes,1,opt,name=operation_name,json=operationName,proto3" json:"operation_name,omitempty"`
	Values        []*SeriesResult       `protobuf:"bytes,2,rep,name=values,proto3" json:"values,omitempty"`
	Steps         *wrappers.Int32Value  `protobuf:"bytes,3,opt,name=steps,proto3" json:"steps,omitempty"`
}
...
func (x *OperationSeriesResult) GetOperationName() *wrappers.StringValue {
	if x != nil {
...
func (x *OperationSeriesResult) GetSteps() *wrappers.Int32Value {
	if x != nil {
		return x.Steps
	}
	return nil
...
type ClientTimeConsumingSeriesResult struct {
	...
	PeerService *wrappers.StringValue `protobuf:"bytes,1,opt,name=peer_service,json=peerService,proto3" json:"peer_service,omitempty"`
	Values      []*SeriesResult       `protobuf:"bytes,2,rep,name=values,proto3" json:"values,omitempty"`
	Steps       *wrappers.Int32Value  `protobuf:"bytes,3,opt,name=steps,proto3" json:"steps,omitempty"`
}
...
func (x *ClientTimeConsumingSeriesResult) GetPeerService() *wrappers.StringValue {
	if x != nil {
...
func (x *ClientTimeConsumingSeriesResult) GetSteps() *wrappers.Int32Value {
	if x != nil {
		return x.Steps
	}
	return nil
...
type ServiceOverview struct {
	...
	RequestPerSecondNumberOfOperations    *wrappers.Int32Value               `protobuf:"bytes,6,opt,name=request_per_second_number_of_operations,json=requestPerSecondNumberOfOperations,proto3" json:"request_per_second_number_of_operations,omitempty"`
	ErrorRateNumberOfOperations           *wrappers.Int32Value               `protobuf:"bytes,7,opt,name=error_rate_number_of_operations,json=errorRateNumberOfOperations,proto3" json:"error_rate_number_of_operations,omitempty"`
	ClientTimeConsumingNumberOfOperations *wrappers.Int32Value               `protobuf:"bytes,8,opt,name=client_time_consuming_number_of_operations,json=clientTimeConsumingNumberOfOperations,proto3" json:"client_time_consuming_number_of_operations,omitempty"`
}
...
func (x *ServiceOverview) GetServiceName() *wrappers.StringValue {
	if x != nil {
...
func (x *ServiceOverview) GetRequestPerSecondNumberOfOperations() *wrappers.Int32Value {
	if x != nil {
...
func (x *ServiceOverview) GetErrorRateNumberOfOperations() *wrappers.Int32Value {
	if x != nil {
...
func (x *ServiceOverview) GetClientTimeConsumingNumberOfOperations() *wrappers.Int32Value {
	if x != nil {
