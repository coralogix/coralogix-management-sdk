...
const file_com_coralogix_archive_dataset_v1_dataset_proto_rawDesc = "" +
	"\n" +
	".com/coralogix/archive/dataset/v1/dataset.proto\x12 com.coralogix.archive.dataset.v1\"\xdd\x02\n" +
	"\aDataset\x12!\n" +
	"\fnamespace_id\x18\x01 \x01(\tR\vnamespaceId\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12I\n" +
	"\bclass_id\x18\x03 \x01(\x0e2..com.coralogix.archive.dataset.v1.DatasetClassR\aclassId\x12\x17\n" +
	"\ateam_id\x18\x04 \x01(\x04R\x06teamId\x12e\n" +
	"\x13partitioning_scheme\x18\x05 \x01(\x0e24.com.coralogix.archive.dataset.v1.PartitioningSchemeR\x12partitioningScheme\x121\n" +
	"\x15split_by_event_labels\x18\x06 \x03(\tR\x12splitByEventLabels\x12!\n" +
	"\fdataspace_id\x18\a \x01(\tR\vdataspaceId*x\n" +
	"\fDatasetClass\x12\x1d\n" +
	"\x19DATASET_CLASS_UNSPECIFIED\x10\x00\x12#\n" +
	"\x1fDATASET_CLASS_ENV_LEVEL_DATASET\x10\x01\x12$\n" +
	" DATASET_CLASS_TEAM_LEVEL_DATASET\x10\x02*X\n" +
...
var (
	...
	file_com_coralogix_archive_dataset_v1_dataset_proto_rawDescData []byte
)
...
func file_com_coralogix_archive_dataset_v1_dataset_proto_rawDescGZIP() []byte {
	file_com_coralogix_archive_dataset_v1_dataset_proto_rawDescOnce.Do(func() {
		file_com_coralogix_archive_dataset_v1_dataset_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogix_archive_dataset_v1_dataset_proto_rawDesc), len(file_com_coralogix_archive_dataset_v1_dataset_proto_rawDesc)))
	})
...
func file_com_coralogix_archive_dataset_v1_dataset_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogix_archive_dataset_v1_dataset_proto_rawDesc), len(file_com_coralogix_archive_dataset_v1_dataset_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
