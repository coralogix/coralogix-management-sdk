...
const (
	KafkaOutTargetService_GetKafkaOutTargets_FullMethodName      = "/com.coralogix.archive.kafka_out_targets.v3.KafkaOutTargetService/GetKafkaOutTargets"
	KafkaOutTargetService_UpsertKafkaOutTarget_FullMethodName    = "/com.coralogix.archive.kafka_out_targets.v3.KafkaOutTargetService/UpsertKafkaOutTarget"
	KafkaOutTargetService_DeleteKafkaOutTarget_FullMethodName    = "/com.coralogix.archive.kafka_out_targets.v3.KafkaOutTargetService/DeleteKafkaOutTarget"
	KafkaOutTargetService_SendKafkaOutTestMessage_FullMethodName = "/com.coralogix.archive.kafka_out_targets.v3.KafkaOutTargetService/SendKafkaOutTestMessage"
)
...
func (c *kafkaOutTargetServiceClient) GetKafkaOutTargets(ctx context.Context, in *GetKafkaOutTargetsRequest, opts ...grpc.CallOption) (*GetKafkaOutTargetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, KafkaOutTargetService_GetKafkaOutTargets_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *kafkaOutTargetServiceClient) UpsertKafkaOutTarget(ctx context.Context, in *UpsertKafkaOutTargetRequest, opts ...grpc.CallOption) (*UpsertKafkaOutTargetResponse, error) {
	...
	err := c.cc.Invoke(ctx, KafkaOutTargetService_UpsertKafkaOutTarget_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *kafkaOutTargetServiceClient) DeleteKafkaOutTarget(ctx context.Context, in *DeleteKafkaOutTargetRequest, opts ...grpc.CallOption) (*DeleteKafkaOutTargetResponse, error) {
	...
	err := c.cc.Invoke(ctx, KafkaOutTargetService_DeleteKafkaOutTarget_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *kafkaOutTargetServiceClient) SendKafkaOutTestMessage(ctx context.Context, in *SendKafkaOutTestMessageRequest, opts ...grpc.CallOption) (*SendKafkaOutTestMessageResponse, error) {
	...
	err := c.cc.Invoke(ctx, KafkaOutTargetService_SendKafkaOutTestMessage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedKafkaOutTargetServiceServer must be embedded to have forward compatible implementations.
...
var KafkaOutTargetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.coralogix.archive.kafka_out_targets.v3.KafkaOutTargetService",
	...
	Metadata: "com/coralogix/archive/kafka_out_targets/v3/kafka_out_target_service.proto",
}
