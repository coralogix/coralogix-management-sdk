...
const (
	KafkaOutTargetService_GetKafkaOutTargets_FullMethodName      = "/com.coralogix.archive.kafka_out_targets.v1.KafkaOutTargetService/GetKafkaOutTargets"
	KafkaOutTargetService_UpsertKafkaOutTarget_FullMethodName    = "/com.coralogix.archive.kafka_out_targets.v1.KafkaOutTargetService/UpsertKafkaOutTarget"
	KafkaOutTargetService_DeleteKafkaOutTarget_FullMethodName    = "/com.coralogix.archive.kafka_out_targets.v1.KafkaOutTargetService/DeleteKafkaOutTarget"
	KafkaOutTargetService_SendKafkaOutTestMessage_FullMethodName = "/com.coralogix.archive.kafka_out_targets.v1.KafkaOutTargetService/SendKafkaOutTestMessage"
)
...
var KafkaOutTargetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.coralogix.archive.kafka_out_targets.v1.KafkaOutTargetService",
