...
const file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_proto_rawDesc = "" +
	"\n" +
	"Acom/coralogix/archive/kafka_out_targets/v2/kafka_out_target.proto\x12*com.coralogix.archive.kafka_out_targets.v2\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb1\x02\n" +
	"\x06Target\x12M\n" +
	"\aaws_msk\x18\x01 \x01(\v22.com.coralogix.archive.kafka_out_targets.v2.AwsMskH\x00R\x06awsMsk\x12i\n" +
	"\x11ibm_event_streams\x18\x02 \x01(\v2;.com.coralogix.archive.kafka_out_targets.v2.IbmEventStreamsH\x00R\x0fibmEventStreams\x12^\n" +
	"\x0ekafka_out_spec\x18\x04 \x01(\v28.com.coralogix.archive.kafka_out_targets.v2.KafkaOutSpecR\fkafkaOutSpecB\r\n" +
	"\vtarget_spec\"I\n" +
	"\x06AwsMsk\x12)\n" +
	...
	"\x05topic\x18\x02 \x01(\tR\x05topic\"\xfc\x02\n" +
	"\fKafkaOutSpec\x12\x13\n" +
	"\x02id\x18\x01 \x01(\rH\x00R\x02id\x88\x01\x01\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1b\n" +
	"\tis_active\x18\x03 \x01(\bR\bisActive\x12'\n" +
	"\x0fdpxl_expression\x18\x04 \x01(\tR\x0edpxlExpression\x129\n" +
	"\n" +
	"created_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x129\n" +
	"\n" +
	"updated_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\x12k\n" +
	"\x10compression_type\x18\a \x01(\x0e2;.com.coralogix.archive.kafka_out_targets.v2.CompressionTypeH\x01R\x0fcompressionType\x88\x01\x01B\x05\n" +
	"\x03_idB\x13\n" +
...
var (
	...
	file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_proto_rawDescData []byte
)
...
func file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_proto_rawDescGZIP() []byte {
	file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_proto_rawDescOnce.Do(func() {
		file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_proto_rawDesc), len(file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_proto_rawDesc)))
	})
...
func file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_proto_rawDesc), len(file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
