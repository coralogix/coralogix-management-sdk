...
var file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_proto_goTypes = []interface{}{
...
func file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Target); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AwsMsk); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IbmEventStreams); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*KafkaOutSpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Target_AwsMsk)(nil),
		(*Target_IbmEventStreams)(nil),
	}
	file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
