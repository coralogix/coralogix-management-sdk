...
const file_com_coralogix_archive_kafka_out_targets_v2_kafka_out_target_service_proto_rawDesc = "" +
	"\n" +
	"Icom/coralogix/archive/kafka_out_targets/v2/kafka_out_target_service.proto\x12*com.coralogix.archive.kafka_out_targets.v2\x1a'com/coralogix/common/v1/audit_log.proto\x1aAcom/coralogix/archive/kafka_out_targets/v2/kafka_out_target.proto\"\x1b\n" +
	"\x19GetKafkaOutTargetsRequest\"j\n" +
	"\x1aGetKafkaOutTargetsResponse\x12L\n" +
	"\atargets\x18\x01 \x03(\v22.com.coralogix.archive.kafka_out_targets.v2.TargetR\atargets\"i\n" +
	"\x1bUpsertKafkaOutTargetRequest\x12J\n" +
	"\x06target\x18\x01 \x01(\v22.com.coralogix.archive.kafka_out_targets.v2.TargetR\x06target\"j\n" +
	"\x1cUpsertKafkaOutTargetResponse\x12J\n" +
	"\x06target\x18\x01 \x01(\v22.com.coralogix.archive.kafka_out_targets.v2.TargetR\x06target\"-\n" +
	...
	"\x12GetKafkaOutTargets\x12E.com.coralogix.archive.kafka_out_targets.v2.GetKafkaOutTargetsRequest\x1aF.com.coralogix.archive.kafka_out_targets.v2.GetKafkaOutTargetsResponse\"\x1b¸\x02\x17\n" +
	"\x15Get kafka out targets\x12\xc8\x01\n" +
	"\x14UpsertKafkaOutTarget\x12G.com.coralogix.archive.kafka_out_targets.v2.UpsertKafkaOutTargetRequest\x1aH.com.coralogix.archive.kafka_out_targets.v2.UpsertKafkaOutTargetResponse\"\x1d¸\x02\x19\n" +
	"\x17Upsert kafka out target\x12\xc8\x01\n" +
	"\x14DeleteKafkaOutTarget\x12G.com.coralogix.archive.kafka_out_targets.v2.DeleteKafkaOutTargetRequest\x1aH.com.coralogix.archive.kafka_out_targets.v2.DeleteKafkaOutTargetResponse\"\x1d¸\x02\x19\n" +
	"\x17Delete kafka out target\x12\xd5\x01\n" +
	"\x17SendKafkaOutTestMessage\x12J.com.coralogix.archive.kafka_out_targets.v2.SendKafkaOutTestMessageRequest\x1aK.com.coralogix.archive.kafka_out_targets.v2.SendKafkaOutTestMessageResponse\"!¸\x02\x1d\n" +
