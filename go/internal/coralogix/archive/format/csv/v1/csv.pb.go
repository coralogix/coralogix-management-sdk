...
const file_com_coralogix_archive_format_csv_v1_csv_proto_rawDesc = "" +
	"\n" +
	"-com/coralogix/archive/format/csv/v1/csv.proto\x12#com.coralogix.archive.format.csv.v1\"M\n" +
	"\x03Csv\x12F\n" +
	"\aversion\x18\x01 \x01(\x0e2,.com.coralogix.archive.format.csv.v1.VersionR\aversion*2\n" +
	"\aVersion\x12\x17\n" +
...
var (
	...
	file_com_coralogix_archive_format_csv_v1_csv_proto_rawDescData []byte
)
...
func file_com_coralogix_archive_format_csv_v1_csv_proto_rawDescGZIP() []byte {
	file_com_coralogix_archive_format_csv_v1_csv_proto_rawDescOnce.Do(func() {
		file_com_coralogix_archive_format_csv_v1_csv_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogix_archive_format_csv_v1_csv_proto_rawDesc), len(file_com_coralogix_archive_format_csv_v1_csv_proto_rawDesc)))
	})
...
func file_com_coralogix_archive_format_csv_v1_csv_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogix_archive_format_csv_v1_csv_proto_rawDesc), len(file_com_coralogix_archive_format_csv_v1_csv_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
