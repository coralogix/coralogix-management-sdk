...
var file_com_coralogix_archive_dataset_v2_dataset_proto_goTypes = []interface{}{
...
func file_com_coralogix_archive_dataset_v2_dataset_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_archive_dataset_v2_dataset_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_archive_dataset_v2_dataset_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
