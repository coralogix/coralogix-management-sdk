...
func (c *schemaRuleServiceClient) SetSchemaRule(ctx context.Context, in *SetSchemaRuleRequest, opts ...grpc.CallOption) (*SetSchemaRuleResponse, error) {
	...
	err := c.cc.Invoke(ctx, SchemaRuleService_SetSchemaRule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *schemaRuleServiceClient) GetSchemaRule(ctx context.Context, in *GetSchemaRuleRequest, opts ...grpc.CallOption) (*GetSchemaRuleResponse, error) {
	...
	err := c.cc.Invoke(ctx, SchemaRuleService_GetSchemaRule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSchemaRuleServiceServer must be embedded to have
...
func (UnimplementedSchemaRuleServiceServer) testEmbeddedByValue()                           {}
...
func RegisterSchemaRuleServiceServer(s grpc.ServiceRegistrar, srv SchemaRuleServiceServer) {
	// If the following call pancis, it indicates UnimplementedSchemaRuleServiceServer was
