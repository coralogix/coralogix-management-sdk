...
const file_com_coralogix_archive_v2_target_service_proto_rawDesc = "" +
	"\n" +
	"-com/coralogix/archive/v2/target_service.proto\x12\x18com.coralogix.archive.v2\x1a%com/coralogix/archive/v2/target.proto\x1a'com/coralogix/common/v1/audit_log.proto\x1a3com/coralogix/archive/v2/internal_get_targets.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x1cgoogle/api/annotations.proto\"\x12\n" +
	...
	"\x0fValidate target\x82\xd3\xe4\x93\x02\x18:\x01*\"\x13/v2/target:validate2\xf5\x02\n" +
	"\x15InternalTargetService\x12\xa4\x01\n" +
	"\n" +
	"GetTargets\x12@.com.coralogix.archive.v2.InternalTargetServiceGetTargetsRequest\x1aA.com.coralogix.archive.v2.InternalTargetServiceGetTargetsResponse\"\x11¸\x02\r\n" +
	"\vGet targets\x12\xb4\x01\n" +
	"\x11SetExternalTarget\x122.com.coralogix.archive.v2.SetExternalTargetRequest\x1a3.com.coralogix.archive.v2.SetExternalTargetResponse\"6¸\x022\n" +
	"0Set target with external region for internal useb\x06proto3"
