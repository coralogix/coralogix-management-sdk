...
func file_com_coralogix_archive_v2_target_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_com_coralogix_archive_v2_target_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_archive_v2_target_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_archive_v2_target_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_archive_v2_target_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_archive_v2_target_service_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_coralogix_archive_v2_target_service_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*SetExternalTargetRequest_S3)(nil),
		(*SetExternalTargetRequest_IbmCos)(nil),
	}
	file_com_coralogix_archive_v2_target_service_proto_msgTypes[7].OneofWrappers = []interface{}{
