...
type GetAllDatasetRulesRequest struct {
	...
	LastUpdateTime *timestamp.Timestamp `protobuf:"bytes,1,opt,name=last_update_time,json=lastUpdateTime,proto3,oneof" json:"last_update_time,omitempty"`
...
func (x *GetAllDatasetRulesRequest) GetLastUpdateTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *GetAllDatasetRulesResponse) GetLastUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.LastUpdateTime
	}
	return nil
