...
func file_com_coralogix_archive_v2_format_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_archive_v2_format_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_archive_v2_format_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_archive_v2_format_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Format); i {
			case 0:
				return &v.state
			case 1:
