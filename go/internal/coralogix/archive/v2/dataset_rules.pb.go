...
func file_com_coralogix_archive_dataset_v2_dataset_rules_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_archive_dataset_v2_dataset_rules_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_archive_dataset_v2_dataset_rules_proto_msgTypes[1].Exporter = func(v any, i int) any {
