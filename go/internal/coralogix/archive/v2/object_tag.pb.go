...
var file_com_coralogix_archive_v2_object_tag_proto_goTypes = []interface{}{
...
func file_com_coralogix_archive_v2_object_tag_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_archive_v2_object_tag_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
