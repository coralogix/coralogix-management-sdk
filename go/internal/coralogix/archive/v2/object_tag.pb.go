...
const file_com_coralogix_archive_v2_object_tag_proto_rawDesc = "" +
	"\n" +
	")com/coralogix/archive/v2/object_tag.proto\x12\x18com.coralogix.archive.v2\"3\n" +
	"\tObjectTag\x12\x10\n" +
...
var (
	...
	file_com_coralogix_archive_v2_object_tag_proto_rawDescData []byte
)
...
func file_com_coralogix_archive_v2_object_tag_proto_rawDescGZIP() []byte {
	file_com_coralogix_archive_v2_object_tag_proto_rawDescOnce.Do(func() {
		file_com_coralogix_archive_v2_object_tag_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogix_archive_v2_object_tag_proto_rawDesc), len(file_com_coralogix_archive_v2_object_tag_proto_rawDesc)))
	})
...
func file_com_coralogix_archive_v2_object_tag_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogix_archive_v2_object_tag_proto_rawDesc), len(file_com_coralogix_archive_v2_object_tag_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
