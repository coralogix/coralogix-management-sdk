...
var file_com_coralogix_archive_v2_schema_proto_goTypes = []interface{}{
...
func file_com_coralogix_archive_v2_schema_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_archive_v2_schema_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Field); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogix_archive_v2_schema_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SubSchema); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_archive_v2_schema_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Schema); i {
			case 0:
				return &v.state
			case 1:
