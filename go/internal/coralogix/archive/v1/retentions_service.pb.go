...
func (x *RetentionUpdateElement) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *RetentionUpdateElement) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
type ActivateRetentionsResponse struct {
	...
	ActivateRetentions *wrappers.BoolValue `protobuf:"bytes,1,opt,name=activate_retentions,json=activateRetentions,proto3" json:"activate_retentions,omitempty"`
}
...
func (x *ActivateRetentionsResponse) GetActivateRetentions() *wrappers.BoolValue {
	if x != nil {
...
type GetRetentionsEnabledResponse struct {
	...
	EnableTags *wrappers.BoolValue `protobuf:"bytes,1,opt,name=enable_tags,json=enableTags,proto3" json:"enable_tags,omitempty"`
}
...
func (x *GetRetentionsEnabledResponse) GetEnableTags() *wrappers.BoolValue {
	if x != nil {
		return x.EnableTags
	}
	return nil
