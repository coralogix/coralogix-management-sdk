...
type Target struct {
	...
	ArchivingFormatId *wrappers.StringValue `protobuf:"bytes,1,opt,name=archiving_format_id,json=archivingFormatId,proto3" json:"archiving_format_id,omitempty"`
	...
	Bucket            *wrappers.StringValue `protobuf:"bytes,4,opt,name=bucket,proto3" json:"bucket,omitempty"`
	EnableTags        *wrappers.BoolValue   `protobuf:"bytes,5,opt,name=enable_tags,json=enableTags,proto3" json:"enable_tags,omitempty"`
}
...
func (x *Target) GetArchivingFormatId() *wrappers.StringValue {
	if x != nil {
...
func (x *Target) GetIsActive() *wrappers.BoolValue {
	if x != nil {
		return x.IsActive
	}
	return nil
...
func (x *Target) GetRegion() *wrappers.StringValue {
	if x != nil {
		return x.Region
	}
	return nil
...
func (x *Target) GetBucket() *wrappers.StringValue {
	if x != nil {
		return x.Bucket
	}
	return nil
...
func (x *Target) GetEnableTags() *wrappers.BoolValue {
	if x != nil {
		return x.EnableTags
	}
	return nil
