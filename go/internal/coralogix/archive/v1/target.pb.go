...
const file_com_coralogix_archive_v1_target_proto_rawDesc = "" +
	"\n" +
	"%com/coralogix/archive/v1/target.proto\x12\x18com.coralogix.archive.v1\x1a\x1egoogle/protobuf/wrappers.proto\"\xb8\x02\n" +
	"\x06Target\x12L\n" +
	"\x13archiving_format_id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x11archivingFormatId\x127\n" +
	"\tis_active\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\bisActive\x124\n" +
	"\x06region\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\x06region\x124\n" +
	"\x06bucket\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\x06bucket\x12;\n" +
	"\venable_tags\x18\x05 \x01(\v2\x1a.google.protobuf.BoolValueR\n" +
	"enableTagsb\x06proto3"

var (
	file_com_coralogix_archive_v1_target_proto_rawDescOnce sync.Once
	file_com_coralogix_archive_v1_target_proto_rawDescData []byte
)
...
func file_com_coralogix_archive_v1_target_proto_rawDescGZIP() []byte {
	file_com_coralogix_archive_v1_target_proto_rawDescOnce.Do(func() {
		file_com_coralogix_archive_v1_target_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogix_archive_v1_target_proto_rawDesc), len(file_com_coralogix_archive_v1_target_proto_rawDesc)))
	})
...
func file_com_coralogix_archive_v1_target_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogix_archive_v1_target_proto_rawDesc), len(file_com_coralogix_archive_v1_target_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
