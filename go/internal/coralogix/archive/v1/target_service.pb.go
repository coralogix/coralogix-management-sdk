...
type SetTargetRequest struct {
	...
	Bucket   *wrappers.StringValue `protobuf:"bytes,1,opt,name=bucket,proto3" json:"bucket,omitempty"`
...
func (x *SetTargetRequest) GetBucket() *wrappers.StringValue {
	if x != nil {
		return x.Bucket
	}
	return nil
...
func (x *SetTargetRequest) GetIsActive() *wrappers.BoolValue {
	if x != nil {
		return x.IsActive
	}
	return nil
