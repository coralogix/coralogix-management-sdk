...
type Retention struct {
	...
	Order    *wrappers.Int32Value  `protobuf:"bytes,2,opt,name=order,proto3" json:"order,omitempty"`
	Name     *wrappers.StringValue `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`
	Editable *wrappers.BoolValue   `protobuf:"bytes,4,opt,name=editable,proto3" json:"editable,omitempty"`
}
...
func (x *Retention) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *Retention) GetOrder() *wrappers.Int32Value {
	if x != nil {
		return x.Order
	}
	return nil
...
func (x *Retention) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *Retention) GetEditable() *wrappers.BoolValue {
	if x != nil {
		return x.Editable
	}
	return nil
...
var file_com_coralogix_archive_v1_retention_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x52, 0x08, 0x65, 0x64, 0x69, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x62, 0x06, 0x70,
