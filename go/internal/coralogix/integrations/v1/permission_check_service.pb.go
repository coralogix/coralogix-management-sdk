...
func (x *ResourceId) GetId() *wrappers.UInt32Value {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *ActionId) GetId() *wrappers.UInt32Value {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *ApiKeyValue) GetKey() *wrappers.StringValue {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *ApiKeyId) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *PermissionId) GetId() *wrappers.UInt32Value {
	if x != nil {
		return x.Id
	}
	return nil
