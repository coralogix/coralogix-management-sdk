...
// UnimplementedPermissionCheckServiceServer must be embedded to have
...
func (UnimplementedPermissionCheckServiceServer) testEmbeddedByValue() {}
...
func RegisterPermissionCheckServiceServer(s grpc.ServiceRegistrar, srv PermissionCheckServiceServer) {
	// If the following call pancis, it indicates UnimplementedPermissionCheckServiceServer was
