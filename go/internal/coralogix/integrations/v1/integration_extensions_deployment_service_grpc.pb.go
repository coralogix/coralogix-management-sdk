...
func (c *integrationExtensionsDeploymentServiceClient) DeployIntegrationExtensions(ctx context.Context, in *DeployIntegrationExtensionsRequest, opts ...grpc.CallOption) (*DeployIntegrationExtensionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, IntegrationExtensionsDeploymentService_DeployIntegrationExtensions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedIntegrationExtensionsDeploymentServiceServer must be embedded to have
...
func (UnimplementedIntegrationExtensionsDeploymentServiceServer) testEmbeddedByValue() {}
...
func RegisterIntegrationExtensionsDeploymentServiceServer(s grpc.ServiceRegistrar, srv IntegrationExtensionsDeploymentServiceServer) {
	// If the following call pancis, it indicates UnimplementedIntegrationExtensionsDeploymentServiceServer was
