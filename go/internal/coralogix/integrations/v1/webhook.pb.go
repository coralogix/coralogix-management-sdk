...
func (x *TimestampFormatCustom) GetFormat() *wrappers.StringValue {
	if x != nil {
		return x.Format
	}
	return nil
...
type TimestampSourceJsonPath struct {
	...
	JsonPath *wrappers.StringValue `protobuf:"bytes,1,opt,name=json_path,json=jsonPath,proto3" json:"json_path,omitempty"`
...
func (x *TimestampSourceJsonPath) GetJsonPath() *wrappers.StringValue {
	if x != nil {
		return x.JsonPath
	}
	return nil
...
func (x *TimestampSourceRegex) GetRegex() *wrappers.StringValue {
	if x != nil {
		return x.Regex
	}
	return nil
