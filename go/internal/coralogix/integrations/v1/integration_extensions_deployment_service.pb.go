...
type DeployIntegrationExtensionsRequest struct {
	...
	IntegrationKey *wrappers.StringValue `protobuf:"bytes,1,opt,name=integration_key,json=integrationKey,proto3" json:"integration_key,omitempty"`
}
...
func (x *DeployIntegrationExtensionsRequest) GetIntegrationKey() *wrappers.StringValue {
	if x != nil {
