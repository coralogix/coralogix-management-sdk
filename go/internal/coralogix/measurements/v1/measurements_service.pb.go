...
type GetQueriesRequest struct {
	...
	// Deprecated: Marked as deprecated in com/coralogix/measurements/v1/measurements_service.proto.
	DataSourceProvider *wrappers.StringValue `protobuf:"bytes,8,opt,name=data_source_provider,json=dataSourceProvider,proto3" json:"data_source_provider,omitempty"`
...
// Deprecated: Marked as deprecated in com/coralogix/measurements/v1/measurements_service.proto.
func (x *GetQueriesRequest) GetDataSourceProvider() *wrappers.StringValue {
	if x != nil {
...
type GetMeasurementsTableRequest struct {
	...
	// Deprecated: Marked as deprecated in com/coralogix/measurements/v1/measurements_service.proto.
	DataSourceProvider *wrappers.StringValue `protobuf:"bytes,9,opt,name=data_source_provider,json=dataSourceProvider,proto3" json:"data_source_provider,omitempty"`
...
// Deprecated: Marked as deprecated in com/coralogix/measurements/v1/measurements_service.proto.
func (x *GetMeasurementsTableRequest) GetDataSourceProvider() *wrappers.StringValue {
	if x != nil {
		return x.DataSourceProvider
	}
	return nil
...
func (x *GetHierarchyRequest) GetProvider() *wrappers.StringValue {
	if x != nil {
		return x.Provider
	}
	return nil
...
type GetHierarchyResponse struct {
	...
	Exporters []*wrappers.StringValue `protobuf:"bytes,1,rep,name=exporters,proto3" json:"exporters,omitempty"`
}
...
func (x *GetHierarchyResponse) GetExporters() []*wrappers.StringValue {
	if x != nil {
		return x.Exporters
	}
	return nil
