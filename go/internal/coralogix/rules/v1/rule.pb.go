...
var file_com_coralogix_rules_v1_rule_proto_rawDesc = []byte{
	...
	0x72, 0x72, 0x69, 0x64, 0x65, 0x44, 0x65, 0x73, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
func file_com_coralogix_rules_v1_rule_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_rules_v1_rule_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Rule); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogix_rules_v1_rule_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_rules_v1_rule_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_rules_v1_rule_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_rules_v1_rule_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_rules_v1_rule_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_rules_v1_rule_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_rules_v1_rule_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_rules_v1_rule_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_rules_v1_rule_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_rules_v1_rule_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_rules_v1_rule_proto_msgTypes[11].Exporter = func(v any, i int) any {
