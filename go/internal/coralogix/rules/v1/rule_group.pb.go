...
type RuleGroup struct {
	...
	Hidden        *wrappers.BoolValue   `protobuf:"bytes,8,opt,name=hidden,proto3" json:"hidden,omitempty"`
	...
	Order         *wrappers.UInt32Value `protobuf:"bytes,11,opt,name=order,proto3" json:"order,omitempty"`
}
...
func (x *RuleGroup) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *RuleGroup) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *RuleGroup) GetDescription() *wrappers.StringValue {
	if x != nil {
...
func (x *RuleGroup) GetCreator() *wrappers.StringValue {
	if x != nil {
		return x.Creator
	}
	return nil
...
func (x *RuleGroup) GetEnabled() *wrappers.BoolValue {
	if x != nil {
		return x.Enabled
	}
	return nil
...
func (x *RuleGroup) GetHidden() *wrappers.BoolValue {
	if x != nil {
		return x.Hidden
	}
	return nil
...
func (x *RuleGroup) GetOrder() *wrappers.UInt32Value {
	if x != nil {
		return x.Order
	}
	return nil
