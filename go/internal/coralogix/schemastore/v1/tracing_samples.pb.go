...
var file_com_coralogix_schemastore_v1_tracing_samples_proto_goTypes = []interface{}{
...
func file_com_coralogix_schemastore_v1_tracing_samples_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_schemastore_v1_tracing_samples_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_schemastore_v1_tracing_samples_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_schemastore_v1_tracing_samples_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_schemastore_v1_tracing_samples_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_schemastore_v1_tracing_samples_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
