...
var file_com_coralogix_schemastore_v1_metrics_proto_goTypes = []interface{}{
...
func file_com_coralogix_schemastore_v1_metrics_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_schemastore_v1_metrics_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_schemastore_v1_metrics_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_schemastore_v1_metrics_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MetricLabelsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_schemastore_v1_metrics_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MetricLabelsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_schemastore_v1_metrics_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MetricLabelsByName); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_schemastore_v1_metrics_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_schemastore_v1_metrics_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
