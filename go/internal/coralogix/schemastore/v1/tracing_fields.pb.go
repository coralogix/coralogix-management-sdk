...
var file_com_coralogix_schemastore_v1_tracing_fields_proto_goTypes = []interface{}{
...
func file_com_coralogix_schemastore_v1_tracing_fields_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_schemastore_v1_tracing_fields_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TracingFieldsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_schemastore_v1_tracing_fields_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TracingFieldsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_schemastore_v1_tracing_fields_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TracingField); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_schemastore_v1_tracing_fields_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TracingFieldMetadata); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
