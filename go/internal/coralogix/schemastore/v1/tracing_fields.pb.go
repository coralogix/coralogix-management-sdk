...
const file_com_coralogix_schemastore_v1_tracing_fields_proto_rawDesc = "" +
	"\n" +
	"1com/coralogix/schemastore/v1/tracing_fields.proto\x12\x1ccom.coralogix.schemastore.v1\x1a)com/coralogix/schemastore/v1/common.proto\"\xee\x03\n" +
	"\x14TracingFieldsRequest\x12\x19\n" +
	"\bteam_ids\x18\x01 \x03(\rR\ateamIds\x12F\n" +
	"\n" +
	"time_range\x18\x02 \x01(\v2'.com.coralogix.schemastore.v1.TimeRangeR\ttimeRange\x12!\n" +
	"\fresult_limit\x18\x03 \x01(\x05R\vresultLimit\x12N\n" +
	"\rlabel_filters\x18\x04 \x03(\v2).com.coralogix.schemastore.v1.LabelFilterR\flabelFilters\x12Q\n" +
	"\x0eschema_filters\x18\x05 \x03(\v2*.com.coralogix.schemastore.v1.SchemaFilterR\rschemaFilters\x12\x16\n" +
	"\x04path\x18\x06 \x01(\tB\x02\x18\x01R\x04path\x12\x14\n" +
	"\x05paths\x18\n" +
	" \x03(\tR\x05paths\x12U\n" +
	"\x0ftime_resolution\x18\a \x01(\x0e2,.com.coralogix.schemastore.v1.TimeResolutionR\x0etimeResolution\x12(\n" +
	"\x10exact_path_match\x18\b \x01(\bR\x0eexactPathMatch\"[\n" +
	"\x15TracingFieldsResponse\x12B\n" +
	"\x06fields\x18\x01 \x03(\v2*.com.coralogix.schemastore.v1.TracingFieldR\x06fields\"r\n" +
	"\fTracingField\x12\x12\n" +
	"\x04path\x18\x01 \x03(\tR\x04path\x12N\n" +
	"\bmetadata\x18\x02 \x03(\v22.com.coralogix.schemastore.v1.TracingFieldMetadataR\bmetadata\"\x87\x01\n" +
	"\x14TracingFieldMetadata\x12C\n" +
	"\tdata_type\x18\x01 \x01(\x0e2&.com.coralogix.schemastore.v1.DataTypeR\bdataType\x12*\n" +
	"\x11logical_data_type\x18\x02 \x01(\tR\x0flogicalDataTypeb\x06proto3"
