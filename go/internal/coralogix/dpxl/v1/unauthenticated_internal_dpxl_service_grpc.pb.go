...
// UnimplementedUnauthenticatedInternalDpxlServiceServer must be embedded to have
...
func (UnimplementedUnauthenticatedInternalDpxlServiceServer) testEmbeddedByValue() {}
...
func RegisterUnauthenticatedInternalDpxlServiceServer(s grpc.ServiceRegistrar, srv UnauthenticatedInternalDpxlServiceServer) {
	// If the following call pancis, it indicates UnimplementedUnauthenticatedInternalDpxlServiceServer was
