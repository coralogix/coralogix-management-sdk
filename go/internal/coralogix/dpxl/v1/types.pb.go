...
var file_com_coralogix_dpxl_v1_types_proto_goTypes = []any{
...
func file_com_coralogix_dpxl_v1_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_dpxl_v1_types_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_com_coralogix_dpxl_v1_types_proto_msgTypes[0].OneofWrappers = []any{
