...
// 	protoc        v5.28.1
// source: com/coralogix/dpxl/v1/types.proto
...
func (Datatype_PrimitiveType) Descriptor() protoreflect.EnumDescriptor {
	return file_com_coralogix_dpxl_v1_types_proto_enumTypes[0].Descriptor()
}

func (Datatype_PrimitiveType) Type() protoreflect.EnumType {
	return &file_com_coralogix_dpxl_v1_types_proto_enumTypes[0]
}
...
func (Datatype_PrimitiveType) EnumDescriptor() ([]byte, []int) {
	return file_com_coralogix_dpxl_v1_types_proto_rawDescGZIP(), []int{0, 0}
}
...
const (
	...
	Datatype_COMPOSITE_TYPE_OBJECT      Datatype_CompositeType = 1
)
...
func (Datatype_CompositeType) Descriptor() protoreflect.EnumDescriptor {
	return file_com_coralogix_dpxl_v1_types_proto_enumTypes[1].Descriptor()
}

func (Datatype_CompositeType) Type() protoreflect.EnumType {
	return &file_com_coralogix_dpxl_v1_types_proto_enumTypes[1]
}
...
func (Datatype_CompositeType) EnumDescriptor() ([]byte, []int) {
	return file_com_coralogix_dpxl_v1_types_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *Datatype) Reset() {
	*x = Datatype{}
	if protoimpl.UnsafeEnabled {
		mi := &file_com_coralogix_dpxl_v1_types_proto_msgTypes[0]
...
func (*Datatype) Descriptor() ([]byte, []int) {
	return file_com_coralogix_dpxl_v1_types_proto_rawDescGZIP(), []int{0}
}
...
type Datatype_PrimitiveType_ struct {
	PrimitiveType Datatype_PrimitiveType `protobuf:"varint,1,opt,name=primitive_type,json=primitiveType,proto3,enum=com.coralogix.dpxl.v1.Datatype_PrimitiveType,oneof"`
}

type Datatype_CompositeType_ struct {
	CompositeType Datatype_CompositeType `protobuf:"varint,2,opt,name=composite_type,json=compositeType,proto3,enum=com.coralogix.dpxl.v1.Datatype_CompositeType,oneof"`
}
...
var File_com_coralogix_dpxl_v1_types_proto protoreflect.FileDescriptor

var file_com_coralogix_dpxl_v1_types_proto_rawDesc = []byte{
	0x0a, 0x21, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x6f, 0x72, 0x61, 0x6c, 0x6f, 0x67, 0x69, 0x78, 0x2f,
	0x64, 0x70, 0x78, 0x6c, 0x2f, 0x76, 0x31, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x12, 0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x72, 0x61, 0x6c, 0x6f, 0x67,
	0x69, 0x78, 0x2e, 0x64, 0x70, 0x78, 0x6c, 0x2e, 0x76, 0x31, 0x22, 0xae, 0x03, 0x0a, 0x08, 0x44,
	0x61, 0x74, 0x61, 0x74, 0x79, 0x70, 0x65, 0x12, 0x56, 0x0a, 0x0e, 0x70, 0x72, 0x69, 0x6d, 0x69,
	...
	0x64, 0x70, 0x78, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x74, 0x79, 0x70, 0x65,
	...
	0x56, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x65, 0x5f, 0x74, 0x79, 0x70,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2d, 0x2e, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f,
	...
	0x50, 0x10, 0x04, 0x22, 0x4a, 0x0a, 0x0d, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x65,
	...
	0x45, 0x44, 0x10, 0x00, 0x12, 0x19, 0x0a, 0x15, 0x43, 0x4f, 0x4d, 0x50, 0x4f, 0x53, 0x49, 0x54,
	0x45, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x4f, 0x42, 0x4a, 0x45, 0x43, 0x54, 0x10, 0x01, 0x42,
	0x0a, 0x0a, 0x08, 0x64, 0x61, 0x74, 0x61, 0x74, 0x79, 0x70, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}

var (
	file_com_coralogix_dpxl_v1_types_proto_rawDescOnce sync.Once
	file_com_coralogix_dpxl_v1_types_proto_rawDescData = file_com_coralogix_dpxl_v1_types_proto_rawDesc
)

func file_com_coralogix_dpxl_v1_types_proto_rawDescGZIP() []byte {
	file_com_coralogix_dpxl_v1_types_proto_rawDescOnce.Do(func() {
		file_com_coralogix_dpxl_v1_types_proto_rawDescData = protoimpl.X.CompressGZIP(file_com_coralogix_dpxl_v1_types_proto_rawDescData)
	})
	return file_com_coralogix_dpxl_v1_types_proto_rawDescData
}

var file_com_coralogix_dpxl_v1_types_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_com_coralogix_dpxl_v1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_com_coralogix_dpxl_v1_types_proto_goTypes = []interface{}{
	(Datatype_PrimitiveType)(0), // 0: com.coralogix.dpxl.v1.Datatype.PrimitiveType
	(Datatype_CompositeType)(0), // 1: com.coralogix.dpxl.v1.Datatype.CompositeType
	(*Datatype)(nil),            // 2: com.coralogix.dpxl.v1.Datatype
}
var file_com_coralogix_dpxl_v1_types_proto_depIdxs = []int32{
	0, // 0: com.coralogix.dpxl.v1.Datatype.primitive_type:type_name -> com.coralogix.dpxl.v1.Datatype.PrimitiveType
	1, // 1: com.coralogix.dpxl.v1.Datatype.composite_type:type_name -> com.coralogix.dpxl.v1.Datatype.CompositeType
...
func init() { file_com_coralogix_dpxl_v1_types_proto_init() }
func file_com_coralogix_dpxl_v1_types_proto_init() {
	if File_com_coralogix_dpxl_v1_types_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_dpxl_v1_types_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_coralogix_dpxl_v1_types_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_com_coralogix_dpxl_v1_types_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_com_coralogix_dpxl_v1_types_proto_goTypes,
		DependencyIndexes: file_com_coralogix_dpxl_v1_types_proto_depIdxs,
		EnumInfos:         file_com_coralogix_dpxl_v1_types_proto_enumTypes,
		MessageInfos:      file_com_coralogix_dpxl_v1_types_proto_msgTypes,
	}.Build()
	File_com_coralogix_dpxl_v1_types_proto = out.File
	file_com_coralogix_dpxl_v1_types_proto_rawDesc = nil
	file_com_coralogix_dpxl_v1_types_proto_goTypes = nil
	file_com_coralogix_dpxl_v1_types_proto_depIdxs = nil
}
