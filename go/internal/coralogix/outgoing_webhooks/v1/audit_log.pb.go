...
var (
	// optional com.coralogix.outgoing_webhooks.v1.AuditLogDescription audit_log_description = 5002;
...
var file_com_coralogix_outgoing_webhooks_v1_audit_log_proto_rawDesc = string([]byte{
	...
	0x6e, 0x73, 0x18, 0x8a, 0x27, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x37, 0x2e, 0x63, 0x6f, 0x6d, 0x2e,
...
var (
	...
	file_com_coralogix_outgoing_webhooks_v1_audit_log_proto_rawDescData []byte
)
...
func file_com_coralogix_outgoing_webhooks_v1_audit_log_proto_rawDescGZIP() []byte {
	file_com_coralogix_outgoing_webhooks_v1_audit_log_proto_rawDescOnce.Do(func() {
		file_com_coralogix_outgoing_webhooks_v1_audit_log_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogix_outgoing_webhooks_v1_audit_log_proto_rawDesc), len(file_com_coralogix_outgoing_webhooks_v1_audit_log_proto_rawDesc)))
	})
...
func file_com_coralogix_outgoing_webhooks_v1_audit_log_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogix_outgoing_webhooks_v1_audit_log_proto_rawDesc), len(file_com_coralogix_outgoing_webhooks_v1_audit_log_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 1,
			NumServices:   0,
