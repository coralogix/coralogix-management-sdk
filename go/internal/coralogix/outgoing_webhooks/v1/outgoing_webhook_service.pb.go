...
func (x *GetOutgoingWebhookRequest) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *CreateOutgoingWebhookResponse) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *DeleteOutgoingWebhookRequest) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *TestExistingOutgoingWebhookRequest) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
type ListOutgoingWebhookTypesResponse_OutgoingWebhookType struct {
	...
	Count *wrappers.UInt32Value `protobuf:"bytes,3,opt,name=count,proto3" json:"count,omitempty"`
}
...
func (x *ListOutgoingWebhookTypesResponse_OutgoingWebhookType) GetLabel() *wrappers.StringValue {
	if x != nil {
		return x.Label
	}
	return nil
...
func (x *ListOutgoingWebhookTypesResponse_OutgoingWebhookType) GetCount() *wrappers.UInt32Value {
	if x != nil {
		return x.Count
	}
	return nil
...
type TestOutgoingWebhookResponse_Failure struct {
	...
	DisplayMessage *wrappers.StringValue `protobuf:"bytes,2,opt,name=display_message,json=displayMessage,proto3" json:"display_message,omitempty"`
	StatusCode     *wrappers.UInt32Value `protobuf:"bytes,3,opt,name=status_code,json=statusCode,proto3,oneof" json:"status_code,omitempty"`
}
...
func (x *TestOutgoingWebhookResponse_Failure) GetErrorMessage() *wrappers.StringValue {
	if x != nil {
...
func (x *TestOutgoingWebhookResponse_Failure) GetDisplayMessage() *wrappers.StringValue {
	if x != nil {
...
func (x *TestOutgoingWebhookResponse_Failure) GetStatusCode() *wrappers.UInt32Value {
	if x != nil {
		return x.StatusCode
	}
	return nil
