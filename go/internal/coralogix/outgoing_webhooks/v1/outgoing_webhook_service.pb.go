...
func file_com_coralogix_outgoing_webhooks_v1_outgoing_webhook_service_proto_init() {
	...
	file_com_coralogix_outgoing_webhooks_v1_outgoing_webhook_service_proto_msgTypes[18].OneofWrappers = []any{
		(*TestOutgoingWebhookResponse_Success_)(nil),
		(*TestOutgoingWebhookResponse_Failure_)(nil),
	}
	file_com_coralogix_outgoing_webhooks_v1_outgoing_webhook_service_proto_msgTypes[23].OneofWrappers = []any{}
	type x struct{}
