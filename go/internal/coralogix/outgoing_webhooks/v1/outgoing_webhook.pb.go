...
func file_com_coralogix_outgoing_webhooks_v1_outgoing_webhook_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_com_coralogix_outgoing_webhooks_v1_outgoing_webhook_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_coralogix_outgoing_webhooks_v1_outgoing_webhook_proto_msgTypes[13].OneofWrappers = []interface{}{
