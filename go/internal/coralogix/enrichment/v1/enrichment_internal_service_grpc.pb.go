...
func (c *enrichmentInternalServiceClient) GetInternalEnrichments(ctx context.Context, in *GetInternalEnrichmentsRequest, opts ...grpc.CallOption) (*GetInternalEnrichmentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, EnrichmentInternalService_GetInternalEnrichments_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *enrichmentInternalServiceClient) AddInternalEnrichments(ctx context.Context, in *AddInternalEnrichmentsRequest, opts ...grpc.CallOption) (*AddInternalEnrichmentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, EnrichmentInternalService_AddInternalEnrichments_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *enrichmentInternalServiceClient) RemoveInternalEnrichments(ctx context.Context, in *RemoveInternalEnrichmentsRequest, opts ...grpc.CallOption) (*RemoveInternalEnrichmentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, EnrichmentInternalService_RemoveInternalEnrichments_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedEnrichmentInternalServiceServer must be embedded to have
...
func (UnimplementedEnrichmentInternalServiceServer) testEmbeddedByValue() {}
...
func RegisterEnrichmentInternalServiceServer(s grpc.ServiceRegistrar, srv EnrichmentInternalServiceServer) {
	// If the following call pancis, it indicates UnimplementedEnrichmentInternalServiceServer was
