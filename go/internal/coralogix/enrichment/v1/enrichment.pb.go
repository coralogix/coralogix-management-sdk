...
type Enrichment struct {
	...
	EnrichedFieldName *wrappers.StringValue `protobuf:"bytes,4,opt,name=enriched_field_name,json=enrichedFieldName,proto3,oneof" json:"enriched_field_name,omitempty"`
}
...
func (x *Enrichment) GetEnrichedFieldName() *wrappers.StringValue {
	if x != nil {
