...
func file_com_coralogix_enrichment_v1_custom_enrichment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_enrichment_v1_custom_enrichment_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_enrichment_v1_custom_enrichment_proto_msgTypes[1].Exporter = func(v any, i int) any {
