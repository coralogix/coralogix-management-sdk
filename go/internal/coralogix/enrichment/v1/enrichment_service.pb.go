...
type RemoveEnrichmentsRequest struct {
	...
	EnrichmentIds []*wrappers.UInt32Value `protobuf:"bytes,1,rep,name=enrichment_ids,json=enrichmentIds,proto3" json:"enrichment_ids,omitempty"`
}
...
func (x *RemoveEnrichmentsRequest) GetEnrichmentIds() []*wrappers.UInt32Value {
	if x != nil {
