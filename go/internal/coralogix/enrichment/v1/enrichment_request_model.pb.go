...
type EnrichmentRequestModel struct {
	...
	FieldName         *wrappers.StringValue `protobuf:"bytes,1,opt,name=field_name,json=fieldName,proto3" json:"field_name,omitempty"`
	...
	EnrichedFieldName *wrappers.StringValue `protobuf:"bytes,3,opt,name=enriched_field_name,json=enrichedFieldName,proto3,oneof" json:"enriched_field_name,omitempty"`
}
...
func (x *EnrichmentRequestModel) GetFieldName() *wrappers.StringValue {
	if x != nil {
		return x.FieldName
	}
	return nil
...
func (x *EnrichmentRequestModel) GetEnrichedFieldName() *wrappers.StringValue {
	if x != nil {
...
func (x *EnrichmentFieldDefinition) GetFieldName() *wrappers.StringValue {
	if x != nil {
		return x.FieldName
	}
	return nil
...
func (x *EnrichmentFieldDefinition) GetEnrichedFieldName() *wrappers.StringValue {
	if x != nil {
		return x.EnrichedFieldName
	}
	return nil
