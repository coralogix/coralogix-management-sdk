...
func (c *awsEnrichmentServiceClient) GetSupportedAwsResourceTypes(ctx context.Context, in *GetSupportedAwsResourceTypesRequest, opts ...grpc.CallOption) (*GetSupportedAwsResourceTypesResponse, error) {
	...
	err := c.cc.Invoke(ctx, AwsEnrichmentService_GetSupportedAwsResourceTypes_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedAwsEnrichmentServiceServer must be embedded to have
...
func RegisterAwsEnrichmentServiceServer(s grpc.ServiceRegistrar, srv AwsEnrichmentServiceServer) {
	// If the following call pancis, it indicates UnimplementedAwsEnrichmentServiceServer was
