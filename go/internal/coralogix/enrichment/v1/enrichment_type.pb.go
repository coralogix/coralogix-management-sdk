...
type AwsType struct {
	...
	ResourceType *wrappers.StringValue `protobuf:"bytes,1,opt,name=resource_type,json=resourceType,proto3" json:"resource_type,omitempty"`
}
...
func (x *AwsType) GetResourceType() *wrappers.StringValue {
	if x != nil {
...
func (x *CustomEnrichmentType) GetId() *wrappers.UInt32Value {
	if x != nil {
		return x.Id
	}
	return nil
