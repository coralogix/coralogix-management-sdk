...
type CompileRequest struct {
	...
	SourceCode *wrappers.StringValue `protobuf:"bytes,1,opt,name=source_code,json=sourceCode,proto3" json:"source_code,omitempty"`
	...
	DefaultSource    *wrappers.StringValue `protobuf:"bytes,4,opt,name=default_source,json=defaultSource,proto3,oneof" json:"default_source,omitempty"`
	...
	NowDate *timestamp.Timestamp `protobuf:"bytes,9,opt,name=now_date,json=nowDate,proto3,oneof" json:"now_date,omitempty"`
}
...
func (x *CompileRequest) GetSourceCode() *wrappers.StringValue {
	if x != nil {
		return x.SourceCode
	}
	return nil
...
func (x *CompileRequest) GetDefaultSource() *wrappers.StringValue {
	if x != nil {
...
func (x *CompileRequest) GetNowDate() *timestamp.Timestamp {
	if x != nil {
		return x.NowDate
	}
	return nil
...
type CompilationResponse_Error struct {
	...
	Msg      *wrappers.StringValue         `protobuf:"bytes,1,opt,name=msg,proto3" json:"msg,omitempty"`
...
func (x *CompilationResponse_Error) GetMsg() *wrappers.StringValue {
	if x != nil {
		return x.Msg
	}
	return nil
...
func (x *CompilationResponse_Warning) GetMsg() *wrappers.StringValue {
	if x != nil {
		return x.Msg
	}
	return nil
...
type CompilationResponse_Position struct {
	...
	Line *wrappers.UInt32Value `protobuf:"bytes,1,opt,name=line,proto3" json:"line,omitempty"`
	Col  *wrappers.UInt32Value `protobuf:"bytes,2,opt,name=col,proto3" json:"col,omitempty"`
}
...
func (x *CompilationResponse_Position) GetLine() *wrappers.UInt32Value {
	if x != nil {
		return x.Line
	}
	return nil
...
func (x *CompilationResponse_Position) GetCol() *wrappers.UInt32Value {
	if x != nil {
		return x.Col
	}
	return nil
