...
func (x *UntypedKeypath) GetPathElements() []*wrappers.StringValue {
	if x != nil {
...
func (x *KeyValue) GetKey() *wrappers.StringValue {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *KeyValue) GetValue() *wrappers.StringValue {
	if x != nil {
		return x.Value
	}
	return nil
...
type Interval struct {
	...
	From *wrappers.Int64Value `protobuf:"bytes,1,opt,name=from,proto3" json:"from,omitempty"`
	To   *wrappers.Int64Value `protobuf:"bytes,2,opt,name=to,proto3" json:"to,omitempty"`
}
...
func (x *Interval) GetFrom() *wrappers.Int64Value {
	if x != nil {
		return x.From
	}
	return nil
...
func (x *Interval) GetTo() *wrappers.Int64Value {
	if x != nil {
		return x.To
	}
	return nil
...
var file_com_coralogix_dataprime_v1_common_proto_goTypes = []any{
