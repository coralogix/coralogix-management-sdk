...
// UnimplementedFeatureControlServiceServer must be embedded to have
...
func (UnimplementedFeatureControlServiceServer) testEmbeddedByValue()                               {}
...
func RegisterFeatureControlServiceServer(s grpc.ServiceRegistrar, srv FeatureControlServiceServer) {
	// If the following call pancis, it indicates UnimplementedFeatureControlServiceServer was
