...
func file_com_coralogix_dataprime_v1_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_com_coralogix_dataprime_v1_query_proto_msgTypes[47].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_coralogix_dataprime_v1_query_proto_msgTypes[20].OneofWrappers = []interface{}{
