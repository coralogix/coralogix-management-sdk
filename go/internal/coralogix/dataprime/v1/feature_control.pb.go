...
func file_com_coralogix_dataprime_v1_feature_control_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_dataprime_v1_feature_control_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_dataprime_v1_feature_control_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_dataprime_v1_feature_control_proto_msgTypes[2].Exporter = func(v any, i int) any {
