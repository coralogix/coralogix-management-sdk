...
type FeatureControl struct {
	...
	OnQueryDurationGt *wrappers.StringValue   `protobuf:"bytes,2,opt,name=on_query_duration_gt,json=onQueryDurationGt,proto3,oneof" json:"on_query_duration_gt,omitempty"`
...
func (x *FeatureControl) GetOnQueryDurationGt() *wrappers.StringValue {
	if x != nil {
