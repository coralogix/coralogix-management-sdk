...
type RunDataprimeQueryRequest struct {
	...
	NowDate *timestamppb.Timestamp `protobuf:"bytes,15,opt,name=now_date,json=nowDate,proto3,oneof" json:"now_date,omitempty"`
}
...
func (x *RunDataprimeQueryRequest) GetNowDate() *timestamppb.Timestamp {
	if x != nil {
		return x.NowDate
	}
	return nil
...
type TracingMetadata struct {
	...
	QueryTextBase64 *wrapperspb.StringValue `protobuf:"bytes,3,opt,name=query_text_base64,json=queryTextBase64,proto3" json:"query_text_base64,omitempty"`
}
...
func (x *TracingMetadata) GetQueryTextBase64() *wrapperspb.StringValue {
	if x != nil {
