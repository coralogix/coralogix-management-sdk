...
func (c *dataprimeLanguageServiceClient) Compile(ctx context.Context, in *CompileRequest, opts ...grpc.CallOption) (*CompileResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataprimeLanguageService_Compile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataprimeLanguageServiceClient) Check(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (*CheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataprimeLanguageService_Check_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedDataprimeLanguageServiceServer must be embedded to have
...
func (UnimplementedDataprimeLanguageServiceServer) testEmbeddedByValue() {}
...
func RegisterDataprimeLanguageServiceServer(s grpc.ServiceRegistrar, srv DataprimeLanguageServiceServer) {
	// If the following call pancis, it indicates UnimplementedDataprimeLanguageServiceServer was
