...
type DataprimeServiceClient interface {
	...
	GetQueryResults(ctx context.Context, in *GetQueryResultsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetQueryResultsResponse], error)
	GetDataset(ctx context.Context, in *GetDatasetRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetDatasetResponse], error)
...
func (c *dataprimeServiceClient) SubmitQuery(ctx context.Context, in *SubmitQueryRequest, opts ...grpc.CallOption) (*SubmitQueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataprimeService_SubmitQuery_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataprimeServiceClient) SubmitDdlQuery(ctx context.Context, in *SubmitDdlQueryRequest, opts ...grpc.CallOption) (*SubmitDdlQueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataprimeService_SubmitDdlQuery_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataprimeServiceClient) ExplainQuery(ctx context.Context, in *ExplainQueryRequest, opts ...grpc.CallOption) (*ExplainQueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataprimeService_ExplainQuery_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataprimeServiceClient) AwaitReady(ctx context.Context, in *AwaitReadyRequest, opts ...grpc.CallOption) (*AwaitReadyResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataprimeService_AwaitReady_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataprimeServiceClient) GetMetrics(ctx context.Context, in *GetMetricsRequest, opts ...grpc.CallOption) (*GetMetricsResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataprimeService_GetMetrics_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataprimeServiceClient) GetQueryResults(ctx context.Context, in *GetQueryResultsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetQueryResultsResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &DataprimeService_ServiceDesc.Streams[0], DataprimeService_GetQueryResults_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetQueryResultsRequest, GetQueryResultsResponse]{ClientStream: stream}
...
type DataprimeService_GetQueryResultsClient = grpc.ServerStreamingClient[GetQueryResultsResponse]

func (c *dataprimeServiceClient) GetDataset(ctx context.Context, in *GetDatasetRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetDatasetResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &DataprimeService_ServiceDesc.Streams[1], DataprimeService_GetDataset_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetDatasetRequest, GetDatasetResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type DataprimeService_GetDatasetClient = grpc.ServerStreamingClient[GetDatasetResponse]
...
func (c *dataprimeServiceClient) GetPresignedDownloadUrl(ctx context.Context, in *GetPresignedDownloadUrlRequest, opts ...grpc.CallOption) (*GetPresignedDownloadUrlResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataprimeService_GetPresignedDownloadUrl_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataprimeServiceClient) DropDataset(ctx context.Context, in *DropDatasetRequest, opts ...grpc.CallOption) (*DropDatasetResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataprimeService_DropDataset_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataprimeServiceClient) GetQueryStatus(ctx context.Context, in *GetQueryStatusRequest, opts ...grpc.CallOption) (*GetQueryStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataprimeService_GetQueryStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataprimeServiceClient) CancelQuery(ctx context.Context, in *CancelQueryRequest, opts ...grpc.CallOption) (*CancelQueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataprimeService_CancelQuery_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataprimeServiceClient) ListQuery(ctx context.Context, in *ListQueryRequest, opts ...grpc.CallOption) (*ListQueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataprimeService_ListQuery_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DataprimeServiceServer interface {
	...
	GetQueryResults(*GetQueryResultsRequest, grpc.ServerStreamingServer[GetQueryResultsResponse]) error
	GetDataset(*GetDatasetRequest, grpc.ServerStreamingServer[GetDatasetResponse]) error
...
// UnimplementedDataprimeServiceServer must be embedded to have
...
func (UnimplementedDataprimeServiceServer) GetQueryResults(*GetQueryResultsRequest, grpc.ServerStreamingServer[GetQueryResultsResponse]) error {
	return status.Errorf(codes.Unimplemented, "method GetQueryResults not implemented")
}
func (UnimplementedDataprimeServiceServer) GetDataset(*GetDatasetRequest, grpc.ServerStreamingServer[GetDatasetResponse]) error {
...
func (UnimplementedDataprimeServiceServer) testEmbeddedByValue()                          {}
...
func RegisterDataprimeServiceServer(s grpc.ServiceRegistrar, srv DataprimeServiceServer) {
	// If the following call pancis, it indicates UnimplementedDataprimeServiceServer was
...
func _DataprimeService_GetQueryResults_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DataprimeServiceServer).GetQueryResults(m, &grpc.GenericServerStream[GetQueryResultsRequest, GetQueryResultsResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type DataprimeService_GetQueryResultsServer = grpc.ServerStreamingServer[GetQueryResultsResponse]
...
func _DataprimeService_GetDataset_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DataprimeServiceServer).GetDataset(m, &grpc.GenericServerStream[GetDatasetRequest, GetDatasetResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type DataprimeService_GetDatasetServer = grpc.ServerStreamingServer[GetDatasetResponse]
