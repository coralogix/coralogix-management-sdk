...
func file_com_coralogix_dataprime_v1_archive_query_proto_init() {
	...
	file_com_coralogix_dataprime_v1_archive_query_proto_msgTypes[4].OneofWrappers = []any{}
	file_com_coralogix_dataprime_v1_archive_query_proto_msgTypes[5].OneofWrappers = []any{}
