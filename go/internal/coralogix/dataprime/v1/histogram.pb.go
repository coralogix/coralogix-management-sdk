...
type Data struct {
	...
	DocCount *wrappers.Int64Value  `protobuf:"bytes,2,opt,name=doc_count,json=docCount,proto3" json:"doc_count,omitempty"`
	AggVal   *wrappers.DoubleValue `protobuf:"bytes,3,opt,name=agg_val,json=aggVal,proto3" json:"agg_val,omitempty"`
...
func (x *Data) GetKey() *wrappers.StringValue {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *Data) GetDocCount() *wrappers.Int64Value {
	if x != nil {
		return x.DocCount
	}
	return nil
...
func (x *Data) GetAggVal() *wrappers.DoubleValue {
	if x != nil {
		return x.AggVal
	}
	return nil
...
type ComparedData struct {
	...
	HistoricalDocCount *wrappers.Int64Value  `protobuf:"bytes,1,opt,name=historical_doc_count,json=historicalDocCount,proto3" json:"historical_doc_count,omitempty"`
	HistoricalAggVal   *wrappers.DoubleValue `protobuf:"bytes,2,opt,name=historical_agg_val,json=historicalAggVal,proto3" json:"historical_agg_val,omitempty"`
}
...
func (x *ComparedData) GetHistoricalDocCount() *wrappers.Int64Value {
	if x != nil {
...
func (x *ComparedData) GetHistoricalAggVal() *wrappers.DoubleValue {
	if x != nil {
...
func (x *HistogramSlice) GetValue() *wrappers.Int64Value {
	if x != nil {
		return x.Value
	}
	return nil
