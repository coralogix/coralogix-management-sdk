...
type QueryStats struct {
	...
	ExecutionTime *duration.Duration `protobuf:"bytes,3,opt,name=execution_time,json=executionTime,proto3" json:"execution_time,omitempty"`
}
...
func (x *QueryStats) GetExecutionTime() *duration.Duration {
	if x != nil {
