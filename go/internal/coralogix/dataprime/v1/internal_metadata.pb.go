...
type QueryMetadata struct {
	...
	NowDate *timestamp.Timestamp `protobuf:"bytes,7,opt,name=now_date,json=nowDate,proto3,oneof" json:"now_date,omitempty"`
}
...
func (x *QueryMetadata) GetStartDate() *timestamp.Timestamp {
	if x != nil {
		return x.StartDate
	}
	return nil
...
func (x *QueryMetadata) GetEndDate() *timestamp.Timestamp {
	if x != nil {
		return x.EndDate
	}
	return nil
...
func (x *QueryMetadata) GetNowDate() *timestamp.Timestamp {
	if x != nil {
		return x.NowDate
	}
	return nil
...
type TextQueryMetadata struct {
	...
	DefaultSource *wrappers.StringValue `protobuf:"bytes,2,opt,name=default_source,json=defaultSource,proto3,oneof" json:"default_source,omitempty"`
}
...
func (x *TextQueryMetadata) GetDefaultSource() *wrappers.StringValue {
	if x != nil {
