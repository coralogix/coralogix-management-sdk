...
func (c *backgroundQueryServiceClient) QueryResult(ctx context.Context, in *QueryResultRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[QueryResultResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type BackgroundQueryService_QueryResultClient = grpc.ServerStreamingClient[QueryResultResponse]
...
func (UnimplementedBackgroundQueryServiceServer) QueryResult(*QueryResultRequest, grpc.ServerStreamingServer[QueryResultResponse]) error {
...
func _BackgroundQueryService_QueryResult_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(BackgroundQueryServiceServer).QueryResult(m, &grpc.GenericServerStream[QueryResultRequest, QueryResultResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BackgroundQueryService_QueryResultServer = grpc.ServerStreamingServer[QueryResultResponse]
