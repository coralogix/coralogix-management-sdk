...
var file_com_coralogix_dataprime_ast_restricted_v1_types_proto_goTypes = []interface{}{
...
func file_com_coralogix_dataprime_ast_restricted_v1_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_dataprime_ast_restricted_v1_types_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_coralogix_dataprime_ast_restricted_v1_types_proto_msgTypes[0].OneofWrappers = []interface{}{
