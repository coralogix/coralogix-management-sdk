...
func file_com_coralogix_dataprime_ast_v1_query_proto_init() {
	...
	file_com_coralogix_dataprime_ast_v1_query_proto_msgTypes[32].OneofWrappers = []interface{}{
	...
	file_com_coralogix_dataprime_ast_v1_query_proto_msgTypes[48].OneofWrappers = []interface{}{}
	type x struct{}
