...
type Operator_Stitch struct {
	...
	Query *Query                `protobuf:"bytes,1,opt,name=query,proto3" json:"query,omitempty"`
	Into  *Expression_Keypath   `protobuf:"bytes,2,opt,name=into,proto3" json:"into,omitempty"`
	Merge *wrapperspb.BoolValue `protobuf:"bytes,3,opt,name=merge,proto3" json:"merge,omitempty"`
}
...
func (x *Operator_Stitch) GetMerge() *wrapperspb.BoolValue {
	if x != nil {
		return x.Merge
	}
	return nil
...
type Operator_DedupeBy_Condition_Keep struct {
	...
	N *wrapperspb.Int32Value `protobuf:"bytes,1,opt,name=n,proto3" json:"n,omitempty"`
}
...
func (x *Operator_DedupeBy_Condition_Keep) GetN() *wrapperspb.Int32Value {
	if x != nil {
		return x.N
	}
	return nil
