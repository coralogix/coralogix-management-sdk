...
func file_com_coralogix_dataprime_ast_v1_ast_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_dataprime_ast_v1_ast_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Ast); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogix_dataprime_ast_v1_ast_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*DdlAst); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogix_dataprime_ast_v1_ast_proto_msgTypes[2].Exporter = func(v any, i int) any {
