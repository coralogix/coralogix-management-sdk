...
func (x *UpdatePolicyRequest) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *UpdatePolicyRequest) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *UpdatePolicyRequest) GetDescription() *wrappers.StringValue {
	if x != nil {
...
func (x *UpdatePolicyRequest) GetEnabled() *wrappers.BoolValue {
	if x != nil {
		return x.Enabled
	}
	return nil
