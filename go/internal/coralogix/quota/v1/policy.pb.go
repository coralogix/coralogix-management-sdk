...
type Policy struct {
	...
	CompanyId       *wrappers.Int32Value  `protobuf:"bytes,2,opt,name=company_id,json=companyId,proto3" json:"company_id,omitempty"`
	...
	Deleted         *wrappers.BoolValue   `protobuf:"bytes,6,opt,name=deleted,proto3" json:"deleted,omitempty"`
	Enabled         *wrappers.BoolValue   `protobuf:"bytes,7,opt,name=enabled,proto3" json:"enabled,omitempty"`
	Order           *wrappers.Int32Value  `protobuf:"bytes,8,opt,name=order,proto3" json:"order,omitempty"`
	...
	CreatedAt        *wrappers.StringValue    `protobuf:"bytes,13,opt,name=created_at,json=createdAt,proto3,oneof" json:"created_at,omitempty"`
	UpdatedAt        *wrappers.StringValue    `protobuf:"bytes,14,opt,name=updated_at,json=updatedAt,proto3,oneof" json:"updated_at,omitempty"`
...
func (x *Policy) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *Policy) GetCompanyId() *wrappers.Int32Value {
	if x != nil {
		return x.CompanyId
	}
	return nil
...
func (x *Policy) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *Policy) GetDescription() *wrappers.StringValue {
	if x != nil {
...
func (x *Policy) GetDeleted() *wrappers.BoolValue {
	if x != nil {
		return x.Deleted
	}
	return nil
...
func (x *Policy) GetEnabled() *wrappers.BoolValue {
	if x != nil {
		return x.Enabled
	}
	return nil
...
func (x *Policy) GetOrder() *wrappers.Int32Value {
	if x != nil {
		return x.Order
	}
	return nil
...
func (x *Policy) GetCreatedAt() *wrappers.StringValue {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *Policy) GetUpdatedAt() *wrappers.StringValue {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
