...
func (x *CreateGenericPolicyRequest) GetDisabled() bool {
	if x != nil {
		return x.Disabled
	}
	return false
...
const file_com_coralogix_quota_v1_atomic_overwrite_policies_request_proto_rawDesc = "" +
	"\n" +
	">com/coralogix/quota/v1/atomic_overwrite_policies_request.proto\x12\x16com.coralogix.quota.v1\x1a.com/coralogix/quota/v1/archive_retention.proto\x1a\"com/coralogix/quota/v1/enums.proto\x1a&com/coralogix/quota/v1/log_rules.proto\x1a!com/coralogix/quota/v1/rule.proto\x1a'com/coralogix/quota/v1/span_rules.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\x96\x03\n" +
	"!AtomicOverwriteLogPoliciesRequest\x12J\n" +
	"\bpolicies\x18\x01 \x03(\v2..com.coralogix.quota.v1.CreateLogPolicyRequestR\bpolicies:\xa4\x02\x9aA\xa0\x02\n" +
	...
	"\bpolicies\x18\x01 \x03(\v2/.com.coralogix.quota.v1.CreateSpanPolicyRequestR\bpolicies:\xa6\x02\x9aA\xa2\x02\n" +
	...
	"\n" +
	"span_rules\x18\x02 \x01(\v2!.com.coralogix.quota.v1.SpanRulesR\tspanRules:\xfc\x01\x9aA\xf8\x01\n" +
	...
	"\x06policy\x18\x01 \x01(\v22.com.coralogix.quota.v1.CreateGenericPolicyRequestR\x06policy\x12=\n" +
	"\tlog_rules\x18\x02 \x01(\v2 .com.coralogix.quota.v1.LogRulesR\blogRules:\xf9\x01\x9aA\xf5\x01\n" +
	...
	"%Find out more about quota management.\x12_https://coralogix.com/docs/user-guides/account-management/payment-and-billing/quota-management/\"\xd1\x06\n" +
	"\x1aCreateGenericPolicyRequest\x12B\n" +
	"\x04name\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueB\x10\x9aA\rJ\v\"My Policy\"R\x04name\x12\\\n" +
	"\vdescription\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueB\x1c\x9aA\x19J\x17\"My Policy Description\"R\vdescription\x12<\n" +
	...
	"\x11archive_retention\x18\x06 \x01(\v2(.com.coralogix.quota.v1.ArchiveRetentionH\x02R\x10archiveRetention\x88\x01\x01\x12\x1a\n" +
	"\bdisabled\x18\a \x01(\bR\bdisabled:\x84\x02\x9aA\x80\x02\n" +
