...
const file_com_coralogix_quota_v1_log_rules_proto_rawDesc = "" +
	"\n" +
	"&com/coralogix/quota/v1/log_rules.proto\x12\x16com.coralogix.quota.v1\x1a\"com/coralogix/quota/v1/enums.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\x91\x02\n" +
	"\bLogRules\x12@\n" +
	"\n" +
	"severities\x18\x01 \x03(\x0e2 .com.coralogix.quota.v1.SeverityR\n" +
	"severities:\xc2\x01\x9aA\xbe\x01\n" +
