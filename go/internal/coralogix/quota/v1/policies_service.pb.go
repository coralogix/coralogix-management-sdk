...
const file_com_coralogix_quota_v1_policies_service_proto_rawDesc = "" +
	...
	"\fCreatePolicy\x12+.com.coralogix.quota.v1.CreatePolicyRequest\x1a,.com.coralogix.quota.v1.CreatePolicyResponse\"\xc3\x01\x9aAy\n" +
	"\x10Policies Service\x12\x10Get Policy by IDJ\x14\n" +
	"\x03400\x12\r\n" +
	"\vBad RequestJ\x1d\n" +
	"\x03401\x12\x16\n" +
	...
	"PDeletes all existing span policies and creates the newly provided one atomically\x82\xd3\xe4\x93\x02f:\x01*Z-:\x01*\"(/v1/policies:atomicOverwriteSpanPolicies\"2/dataplans/policies/v1/atomicOverwriteSpanPolicies\x1a8\x9aA5\n" +
