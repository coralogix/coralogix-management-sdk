...
const file_com_coralogix_quota_v1_bulk_create_policy_request_proto_rawDesc = "" +
	"\n" +
	"7com/coralogix/quota/v1/bulk_create_policy_request.proto\x12\x16com.coralogix.quota.v1\x1a2com/coralogix/quota/v1/create_policy_request.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\x85\x03\n" +
	"\x1eAtomicBatchCreatePolicyRequest\x12T\n" +
	"\x0fpolicy_requests\x18\x01 \x03(\v2+.com.coralogix.quota.v1.CreatePolicyRequestR\x0epolicyRequests:\x8c\x02\x9aA\x88\x02\n" +
