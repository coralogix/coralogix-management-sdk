...
const file_com_coralogix_quota_v1_bulk_create_policy_request_proto_rawDesc = "" +
	"\n" +
	"7com/coralogix/quota/v1/bulk_create_policy_request.proto\x12\x16com.coralogix.quota.v1\x1a2com/coralogix/quota/v1/create_policy_request.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\x85\x03\n" +
	"\x1eAtomicBatchCreatePolicyRequest\x12T\n" +
	"\x0fpolicy_requests\x18\x01 \x03(\v2+.com.coralogix.quota.v1.CreatePolicyRequestR\x0epolicyRequests:\x8c\x02\x92A\x88\x02\n" +
	"{*\"Atomic Batch Create Policy Request2CThis data structure is used to create multiple policies atomically.\xd2\x01\x0fpolicy_requests*\x88\x01\n" +
...
var (
	...
	file_com_coralogix_quota_v1_bulk_create_policy_request_proto_rawDescData []byte
)
...
func file_com_coralogix_quota_v1_bulk_create_policy_request_proto_rawDescGZIP() []byte {
	file_com_coralogix_quota_v1_bulk_create_policy_request_proto_rawDescOnce.Do(func() {
		file_com_coralogix_quota_v1_bulk_create_policy_request_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogix_quota_v1_bulk_create_policy_request_proto_rawDesc), len(file_com_coralogix_quota_v1_bulk_create_policy_request_proto_rawDesc)))
	})
...
func file_com_coralogix_quota_v1_bulk_create_policy_request_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogix_quota_v1_bulk_create_policy_request_proto_rawDesc), len(file_com_coralogix_quota_v1_bulk_create_policy_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
