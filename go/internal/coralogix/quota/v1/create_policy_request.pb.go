...
type CreatePolicyRequest struct {
	...
	Placement       *Placement                            `protobuf:"bytes,10,opt,name=placement,proto3" json:"placement,omitempty"`
...
func (x *CreatePolicyRequest) GetSourceTypeRules() isCreatePolicyRequest_SourceTypeRules {
	if x != nil {
...
func (x *CreatePolicyRequest) GetLogRules() *LogRules {
	if x != nil {
		if x, ok := x.SourceTypeRules.(*CreatePolicyRequest_LogRules); ok {
			return x.LogRules
		}
	}
	return nil
...
func (x *CreatePolicyRequest) GetSpanRules() *SpanRules {
	if x != nil {
		if x, ok := x.SourceTypeRules.(*CreatePolicyRequest_SpanRules); ok {
			return x.SpanRules
		}
	}
	return nil
...
func (x *CreatePolicyRequest) GetPlacement() *Placement {
	if x != nil {
		return x.Placement
	}
	return nil
...
const file_com_coralogix_quota_v1_create_policy_request_proto_rawDesc = "" +
	"\n" +
	"2com/coralogix/quota/v1/create_policy_request.proto\x12\x16com.coralogix.quota.v1\x1a.com/coralogix/quota/v1/archive_retention.proto\x1a\"com/coralogix/quota/v1/enums.proto\x1a&com/coralogix/quota/v1/log_rules.proto\x1a&com/coralogix/quota/v1/placement.proto\x1a!com/coralogix/quota/v1/rule.proto\x1a'com/coralogix/quota/v1/span_rules.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\x8f\b\n" +
	...
	"\x10application_rule\x18\x04 \x01(\v2\x1c.com.coralogix.quota.v1.RuleH\x01R\x0fapplicationRule\x88\x01\x01\x12H\n" +
	"\x0esubsystem_rule\x18\x05 \x01(\v2\x1c.com.coralogix.quota.v1.RuleH\x02R\rsubsystemRule\x88\x01\x01\x12Z\n" +
	...
	"\tplacement\x18\n" +
	" \x01(\v2!.com.coralogix.quota.v1.PlacementR\tplacement:\xee\x01\x9aA\xea\x01\n" +
...
var (
	...
	file_com_coralogix_quota_v1_create_policy_request_proto_rawDescData []byte
)
...
func file_com_coralogix_quota_v1_create_policy_request_proto_rawDescGZIP() []byte {
	file_com_coralogix_quota_v1_create_policy_request_proto_rawDescOnce.Do(func() {
		file_com_coralogix_quota_v1_create_policy_request_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogix_quota_v1_create_policy_request_proto_rawDesc), len(file_com_coralogix_quota_v1_create_policy_request_proto_rawDesc)))
	})
...
var file_com_coralogix_quota_v1_create_policy_request_proto_goTypes = []any{
	...
	(*Placement)(nil),              // 7: com.coralogix.quota.v1.Placement
}
var file_com_coralogix_quota_v1_create_policy_request_proto_depIdxs = []int32{
	...
	7, // 8: com.coralogix.quota.v1.CreatePolicyRequest.placement:type_name -> com.coralogix.quota.v1.Placement
...
func file_com_coralogix_quota_v1_create_policy_request_proto_init() {
	...
	file_com_coralogix_quota_v1_placement_proto_init()
	file_com_coralogix_quota_v1_rule_proto_init()
	file_com_coralogix_quota_v1_span_rules_proto_init()
	file_com_coralogix_quota_v1_create_policy_request_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogix_quota_v1_create_policy_request_proto_rawDesc), len(file_com_coralogix_quota_v1_create_policy_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
