...
const file_com_coralogix_quota_v1_policy_order_proto_rawDesc = "" +
	"\n" +
	")com/coralogix/quota/v1/policy_order.proto\x12\x16com.coralogix.quota.v1\x1a\x1egoogle/protobuf/wrappers.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\xc4\x02\n" +
	"\vPolicyOrder\x129\n" +
	"\x05order\x18\x01 \x01(\v2\x1b.google.protobuf.Int32ValueB\x06\x9aA\x03J\x011R\x05order\x127\n" +
	"\x02id\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueB\t\x9aA\x06J\x04\"id\"R\x02id:\xc0\x01\x9aA\xbc\x01\n" +
