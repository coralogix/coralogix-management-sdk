...
type PolicyOrder struct {
	...
	Order *wrappers.Int32Value  `protobuf:"bytes,1,opt,name=order,proto3" json:"order,omitempty"`
...
func (x *PolicyOrder) GetOrder() *wrappers.Int32Value {
	if x != nil {
		return x.Order
	}
	return nil
...
func (x *PolicyOrder) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
