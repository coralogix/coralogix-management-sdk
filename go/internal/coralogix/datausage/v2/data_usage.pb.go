...
type Team struct {
	...
	Id *wrappers.UInt64Value `protobuf:"bytes,2,opt,name=id,proto3" json:"id,omitempty"`
}
...
func (x *Team) GetId() *wrappers.UInt64Value {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *DateRange) GetFromDate() *timestamp.Timestamp {
	if x != nil {
		return x.FromDate
	}
	return nil
...
func (x *DateRange) GetToDate() *timestamp.Timestamp {
	if x != nil {
		return x.ToDate
	}
	return nil
