...
func (x *ExportTeamsDetailedUsageRequest) GetResolution() *duration.Duration {
	if x != nil {
		return x.Resolution
	}
	return nil
...
func (x *DataUsage) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *DataUsage) GetSizeGb() *wrappers.FloatValue {
	if x != nil {
		return x.SizeGb
	}
	return nil
