...
type GetDetailedDataUsageResponse struct {
	...
	Quota      *wrappers.FloatValue `protobuf:"bytes,3,opt,name=quota,proto3" json:"quota,omitempty"`
	Dimensions []*Dimension         `protobuf:"bytes,4,rep,name=dimensions,proto3" json:"dimensions,omitempty"`
}
...
func (x *GetDetailedDataUsageResponse) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *GetDetailedDataUsageResponse) GetSize() *wrappers.FloatValue {
	if x != nil {
		return x.Size
	}
	return nil
...
func (x *GetDetailedDataUsageResponse) GetQuota() *wrappers.FloatValue {
	if x != nil {
		return x.Quota
	}
	return nil
...
var file_com_coralogix_datausage_v1_data_usage_service_proto_goTypes = []any{
	...
	(*wrappers.FloatValue)(nil), // 31: google.protobuf.FloatValue
