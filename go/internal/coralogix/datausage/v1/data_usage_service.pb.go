...
func file_com_coralogix_datausage_v1_data_usage_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_com_coralogix_datausage_v1_data_usage_service_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_datausage_v1_data_usage_service_proto_msgTypes[15].Exporter = func(v any, i int) any {
