...
type DataUsageServiceClient interface {
	...
	GetTeamsDetailedUsage(ctx context.Context, in *GetTeamsDetailedUsageRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetTeamsDetailedUsageResponse], error)
...
// Deprecated: Do not use.
func (c *dataUsageServiceClient) GetTeamsDetailedUsage(ctx context.Context, in *GetTeamsDetailedUsageRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetTeamsDetailedUsageResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &DataUsageService_ServiceDesc.Streams[0], DataUsageService_GetTeamsDetailedUsage_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetTeamsDetailedUsageRequest, GetTeamsDetailedUsageResponse]{ClientStream: stream}
...
type DataUsageService_GetTeamsDetailedUsageClient = grpc.ServerStreamingClient[GetTeamsDetailedUsageResponse]
...
func (c *dataUsageServiceClient) GetDetailedDataUsage(ctx context.Context, in *GetDetailedDataUsageRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetDetailedDataUsageResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &DataUsageService_ServiceDesc.Streams[1], DataUsageService_GetDetailedDataUsage_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *dataUsageServiceClient) GetDetailedDataUsageChunked(ctx context.Context, in *GetDetailedDataUsageChunkedRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetDetailedDataUsageChunkedResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &DataUsageService_ServiceDesc.Streams[2], DataUsageService_GetDetailedDataUsageChunked_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type DataUsageServiceServer interface {
	...
	// Deprecated: Do not use.
	GetTeamsDetailedUsage(*GetTeamsDetailedUsageRequest, grpc.ServerStreamingServer[GetTeamsDetailedUsageResponse]) error
	// / Returns a list of data usage for a given set of teams, time_range and resolution
...
func (UnimplementedDataUsageServiceServer) GetTeamsDetailedUsage(*GetTeamsDetailedUsageRequest, grpc.ServerStreamingServer[GetTeamsDetailedUsageResponse]) error {
...
func _DataUsageService_GetTeamsDetailedUsage_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DataUsageServiceServer).GetTeamsDetailedUsage(m, &grpc.GenericServerStream[GetTeamsDetailedUsageRequest, GetTeamsDetailedUsageResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type DataUsageService_GetTeamsDetailedUsageServer = grpc.ServerStreamingServer[GetTeamsDetailedUsageResponse]
