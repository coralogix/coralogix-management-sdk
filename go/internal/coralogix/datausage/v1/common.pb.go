...
func file_com_coralogix_datausage_v1_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_datausage_v1_common_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Team); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogix_datausage_v1_common_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Unit); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogix_datausage_v1_common_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*GB); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogix_datausage_v1_common_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_com_coralogix_datausage_v1_common_proto_msgTypes[4].Exporter = func(v any, i int) any {
