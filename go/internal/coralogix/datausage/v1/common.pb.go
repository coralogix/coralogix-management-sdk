...
func (x *Unit) GetValue() *wrappers.FloatValue {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *GB) GetValue() *wrappers.FloatValue {
	if x != nil {
		return x.Value
	}
	return nil
...
type Retention struct {
	...
	Value *wrappers.UInt64Value `protobuf:"bytes,1,opt,name=value,proto3" json:"value,omitempty"`
}
...
func (x *Retention) GetValue() *wrappers.UInt64Value {
	if x != nil {
		return x.Value
	}
	return nil
