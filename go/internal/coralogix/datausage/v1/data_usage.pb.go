...
func (x *TeamsAndTime) GetTime() *timestamp.Timestamp {
	if x != nil {
		return x.Time
	}
	return nil
...
func (x *DailyUsageMetrics) GetDate() *timestamp.Timestamp {
	if x != nil {
		return x.Date
	}
	return nil
...
type BlockEvent struct {
	...
	BlockedFrom *timestamp.Timestamp `protobuf:"bytes,3,opt,name=blocked_from,json=blockedFrom,proto3" json:"blocked_from,omitempty"`
}
...
func (x *BlockEvent) GetBlockedFrom() *timestamp.Timestamp {
	if x != nil {
...
func (x *QuotaHistoryEntry) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
type DataUsageReport struct {
	...
	Application *wrappers.StringValue `protobuf:"bytes,5,opt,name=application,proto3" json:"application,omitempty"`
	Subsystem   *wrappers.StringValue `protobuf:"bytes,6,opt,name=subsystem,proto3" json:"subsystem,omitempty"`
	...
	UsageInGb   *wrappers.DoubleValue `protobuf:"bytes,8,opt,name=usage_in_gb,json=usageInGb,proto3" json:"usage_in_gb,omitempty"`
...
func (x *DataUsageReport) GetDate() *timestamp.Timestamp {
	if x != nil {
		return x.Date
	}
	return nil
...
func (x *DataUsageReport) GetApplication() *wrappers.StringValue {
	if x != nil {
...
func (x *DataUsageReport) GetSubsystem() *wrappers.StringValue {
	if x != nil {
		return x.Subsystem
	}
	return nil
...
func (x *DataUsageReport) GetUsageInGb() *wrappers.DoubleValue {
	if x != nil {
		return x.UsageInGb
	}
	return nil
...
type DataUsage_Usage struct {
	...
	Size      *wrappers.FloatValue `protobuf:"bytes,2,opt,name=size,proto3" json:"size,omitempty"`
}
...
func (x *DataUsage_Usage) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *DataUsage_Usage) GetSize() *wrappers.FloatValue {
	if x != nil {
		return x.Size
	}
	return nil
...
var file_com_coralogix_datausage_v1_data_usage_proto_goTypes = []any{
	...
	(*wrappers.FloatValue)(nil),  // 29: google.protobuf.FloatValue
}
