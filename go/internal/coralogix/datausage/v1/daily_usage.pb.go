...
type DetailedDailyUsage struct {
	...
	StatsDate *timestamp.Timestamp `protobuf:"bytes,1,opt,name=stats_date,json=statsDate,proto3" json:"stats_date,omitempty"`
	// blocked data in GB
	Block *wrappers.FloatValue `protobuf:"bytes,2,opt,name=block,proto3" json:"block,omitempty"`
	// blocked quota in units
	BlockCountQuota *wrappers.FloatValue `protobuf:"bytes,3,opt,name=block_count_quota,json=blockCountQuota,proto3" json:"block_count_quota,omitempty"`
	// low TCO traffic data in GB
	Low *wrappers.FloatValue `protobuf:"bytes,4,opt,name=low,proto3" json:"low,omitempty"`
	// low TCO traffic data in units
	LowCountQuota *wrappers.FloatValue `protobuf:"bytes,5,opt,name=low_count_quota,json=lowCountQuota,proto3" json:"low_count_quota,omitempty"`
	// medium TCO traffic data in GB
	Medium *wrappers.FloatValue `protobuf:"bytes,6,opt,name=medium,proto3" json:"medium,omitempty"`
	// medium TCO traffic data in units
	MediumCountQuota *wrappers.FloatValue `protobuf:"bytes,7,opt,name=medium_count_quota,json=mediumCountQuota,proto3" json:"medium_count_quota,omitempty"`
	// normal traffic data in GB
	High *wrappers.FloatValue `protobuf:"bytes,8,opt,name=high,proto3" json:"high,omitempty"`
	// normal traffic data in units
	HighCountQuota *wrappers.FloatValue `protobuf:"bytes,9,opt,name=high_count_quota,json=highCountQuota,proto3" json:"high_count_quota,omitempty"`
	// total consumed bytes in GB
	Total *wrappers.FloatValue `protobuf:"bytes,10,opt,name=total,proto3" json:"total,omitempty"`
	// total consumed quota in units
	TotalCountQuota *wrappers.FloatValue `protobuf:"bytes,11,opt,name=total_count_quota,json=totalCountQuota,proto3" json:"total_count_quota,omitempty"`
	// total consumed quota in units for metrics
	HighMetricsCountQuota *wrappers.FloatValue `protobuf:"bytes,12,opt,name=high_metrics_count_quota,json=highMetricsCountQuota,proto3" json:"high_metrics_count_quota,omitempty"`
	// total consumed quota in GB for metrics
	HighMetricsQuota *wrappers.FloatValue `protobuf:"bytes,13,opt,name=high_metrics_quota,json=highMetricsQuota,proto3" json:"high_metrics_quota,omitempty"`
	// total consumed quota in units for high tracing
	HighTracingCountQuota *wrappers.FloatValue `protobuf:"bytes,14,opt,name=high_tracing_count_quota,json=highTracingCountQuota,proto3" json:"high_tracing_count_quota,omitempty"`
	// total consumed quota in GB for high tracing
	HighTracingQuota *wrappers.FloatValue `protobuf:"bytes,15,opt,name=high_tracing_quota,json=highTracingQuota,proto3" json:"high_tracing_quota,omitempty"`
	// total consumed quota in units for medium tracing
	MediumTracingCountQuota *wrappers.FloatValue `protobuf:"bytes,16,opt,name=medium_tracing_count_quota,json=mediumTracingCountQuota,proto3" json:"medium_tracing_count_quota,omitempty"`
	// total consumed quota in GB for medium tracing
	MediumTracingQuota *wrappers.FloatValue `protobuf:"bytes,17,opt,name=medium_tracing_quota,json=mediumTracingQuota,proto3" json:"medium_tracing_quota,omitempty"`
	// total consumed quota in units for low tracing
	LowTracingCountQuota *wrappers.FloatValue `protobuf:"bytes,18,opt,name=low_tracing_count_quota,json=lowTracingCountQuota,proto3" json:"low_tracing_count_quota,omitempty"`
	// total consumed quota in GB for low tracing
	LowTracingQuota *wrappers.FloatValue `protobuf:"bytes,19,opt,name=low_tracing_quota,json=lowTracingQuota,proto3" json:"low_tracing_quota,omitempty"`
	// total consumed quota in units for low session recording
	LowSessionRecordingCountQuota *wrappers.FloatValue `protobuf:"bytes,20,opt,name=low_session_recording_count_quota,json=lowSessionRecordingCountQuota,proto3" json:"low_session_recording_count_quota,omitempty"`
	// total consumed quota in GB for low session recording
	LowSessionRecordingQuota *wrappers.FloatValue `protobuf:"bytes,21,opt,name=low_session_recording_quota,json=lowSessionRecordingQuota,proto3" json:"low_session_recording_quota,omitempty"`
}
...
func (x *DetailedDailyUsage) GetStatsDate() *timestamp.Timestamp {
	if x != nil {
		return x.StatsDate
	}
	return nil
...
func (x *DetailedDailyUsage) GetBlock() *wrappers.FloatValue {
	if x != nil {
		return x.Block
	}
	return nil
...
func (x *DetailedDailyUsage) GetBlockCountQuota() *wrappers.FloatValue {
	if x != nil {
...
func (x *DetailedDailyUsage) GetLow() *wrappers.FloatValue {
	if x != nil {
		return x.Low
	}
	return nil
...
func (x *DetailedDailyUsage) GetLowCountQuota() *wrappers.FloatValue {
	if x != nil {
...
func (x *DetailedDailyUsage) GetMedium() *wrappers.FloatValue {
	if x != nil {
		return x.Medium
	}
	return nil
...
func (x *DetailedDailyUsage) GetMediumCountQuota() *wrappers.FloatValue {
	if x != nil {
...
func (x *DetailedDailyUsage) GetHigh() *wrappers.FloatValue {
	if x != nil {
		return x.High
	}
	return nil
...
func (x *DetailedDailyUsage) GetHighCountQuota() *wrappers.FloatValue {
	if x != nil {
...
func (x *DetailedDailyUsage) GetTotal() *wrappers.FloatValue {
	if x != nil {
		return x.Total
	}
	return nil
...
func (x *DetailedDailyUsage) GetTotalCountQuota() *wrappers.FloatValue {
	if x != nil {
...
func (x *DetailedDailyUsage) GetHighMetricsCountQuota() *wrappers.FloatValue {
	if x != nil {
...
func (x *DetailedDailyUsage) GetHighMetricsQuota() *wrappers.FloatValue {
	if x != nil {
...
func (x *DetailedDailyUsage) GetHighTracingCountQuota() *wrappers.FloatValue {
	if x != nil {
...
func (x *DetailedDailyUsage) GetHighTracingQuota() *wrappers.FloatValue {
	if x != nil {
...
func (x *DetailedDailyUsage) GetMediumTracingCountQuota() *wrappers.FloatValue {
	if x != nil {
...
func (x *DetailedDailyUsage) GetMediumTracingQuota() *wrappers.FloatValue {
	if x != nil {
...
func (x *DetailedDailyUsage) GetLowTracingCountQuota() *wrappers.FloatValue {
	if x != nil {
...
func (x *DetailedDailyUsage) GetLowTracingQuota() *wrappers.FloatValue {
	if x != nil {
...
func (x *DetailedDailyUsage) GetLowSessionRecordingCountQuota() *wrappers.FloatValue {
	if x != nil {
...
func (x *DetailedDailyUsage) GetLowSessionRecordingQuota() *wrappers.FloatValue {
	if x != nil {
...
type OverageDailyReport struct {
	...
	OverageUnit *wrappers.UInt64Value `protobuf:"bytes,2,opt,name=overage_unit,json=overageUnit,proto3" json:"overage_unit,omitempty"`
}
...
func (x *OverageDailyReport) GetDate() *timestamp.Timestamp {
	if x != nil {
		return x.Date
	}
	return nil
...
func (x *OverageDailyReport) GetOverageUnit() *wrappers.UInt64Value {
	if x != nil {
