...
type CreateViewRequest struct {
	...
	FolderId      *wrappers.StringValue `protobuf:"bytes,5,opt,name=folder_id,json=folderId,proto3" json:"folder_id,omitempty"`
}
...
func (x *CreateViewRequest) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *CreateViewRequest) GetFolderId() *wrappers.StringValue {
	if x != nil {
		return x.FolderId
	}
	return nil
...
func (x *GetViewRequest) GetId() *wrappers.Int32Value {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *DeleteViewRequest) GetId() *wrappers.Int32Value {
	if x != nil {
		return x.Id
	}
	return nil
...
type View struct {
	...
	FolderId      *wrappers.StringValue `protobuf:"bytes,6,opt,name=folder_id,json=folderId,proto3" json:"folder_id,omitempty"`
}
...
func (x *View) GetId() *wrappers.Int32Value {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *View) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *View) GetFolderId() *wrappers.StringValue {
	if x != nil {
		return x.FolderId
	}
	return nil
