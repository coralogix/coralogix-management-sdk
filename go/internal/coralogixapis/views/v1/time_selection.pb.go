...
const file_com_coralogixapis_views_v1_time_selection_proto_rawDesc = "" +
	...
	"\aseconds\x18\x03 \x01(\rB\x16\x92A\x132\vFolder nameJ\x043600R\aseconds:\x19\x92A\x16\n" +
	"\x14\xd2\x01\acaption\xd2\x01\aseconds\"\xe8\x01\n" +
