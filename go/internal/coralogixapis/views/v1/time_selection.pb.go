...
type QuickTimeSelection struct {
	...
	Caption *wrappers.StringValue `protobuf:"bytes,2,opt,name=caption,proto3" json:"caption,omitempty"`
...
// Deprecated: Marked as deprecated in com/coralogixapis/views/v1/time_selection.proto.
func (x *QuickTimeSelection) GetCaption() *wrappers.StringValue {
	if x != nil {
		return x.Caption
	}
	return nil
...
func (x *CustomTimeSelection) GetFromTime() *timestamp.Timestamp {
	if x != nil {
		return x.FromTime
	}
	return nil
...
func (x *CustomTimeSelection) GetToTime() *timestamp.Timestamp {
	if x != nil {
		return x.ToTime
	}
	return nil
