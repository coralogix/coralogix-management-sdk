...
type GridQueryInfo struct {
	...
	Column        *wrapperspb.StringValue `protobuf:"bytes,2,opt,name=column,proto3" json:"column,omitempty"`
...
func (x *GridQueryInfo) GetQuery() *wrapperspb.StringValue {
	if x != nil {
		return x.Query
	}
	return nil
...
func (x *GridQueryInfo) GetColumn() *wrapperspb.StringValue {
	if x != nil {
		return x.Column
	}
	return nil
...
func (x *QueryInfo) GetQuery() *wrapperspb.StringValue {
	if x != nil {
		return x.Query
	}
	return nil
...
func (x *QueryInfo) GetName() *wrapperspb.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
var file_com_coralogixapis_apm_shared_common_queries_proto_rawDesc = string([]byte{
...
var (
	...
	file_com_coralogixapis_apm_shared_common_queries_proto_rawDescData []byte
)
...
func file_com_coralogixapis_apm_shared_common_queries_proto_rawDescGZIP() []byte {
	file_com_coralogixapis_apm_shared_common_queries_proto_rawDescOnce.Do(func() {
		file_com_coralogixapis_apm_shared_common_queries_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogixapis_apm_shared_common_queries_proto_rawDesc), len(file_com_coralogixapis_apm_shared_common_queries_proto_rawDesc)))
	})
...
func file_com_coralogixapis_apm_shared_common_queries_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogixapis_apm_shared_common_queries_proto_rawDesc), len(file_com_coralogixapis_apm_shared_common_queries_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
