...
func file_com_coralogixapis_metrics_rule_manager_v1_tasks_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_metrics_rule_manager_v1_tasks_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_metrics_rule_manager_v1_tasks_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_metrics_rule_manager_v1_tasks_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*RuleGroupEval); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_metrics_rule_manager_v1_tasks_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_metrics_rule_manager_v1_tasks_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Rule); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogixapis_metrics_rule_manager_v1_tasks_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*TaskCompletedRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_metrics_rule_manager_v1_tasks_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*TaskCompletedResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_metrics_rule_manager_v1_tasks_proto_msgTypes[8].Exporter = func(v any, i int) any {
			switch v := v.(*TaskCompletedRequest_Success); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_metrics_rule_manager_v1_tasks_proto_msgTypes[9].Exporter = func(v any, i int) any {
			switch v := v.(*TaskCompletedRequest_Failure); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
