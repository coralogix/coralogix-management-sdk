...
const file_com_coralogixapis_dashboards_v1_ast_widgets_common_legend_proto_rawDesc = "" +
	"\n" +
	"?com/coralogixapis/dashboards/v1/ast/widgets/common/legend.proto\x122com.coralogixapis.dashboards.v1.ast.widgets.common\x1a\x1egoogle/protobuf/wrappers.proto\"\xb4\x05\n" +
	"\x06Legend\x129\n" +
	"\n" +
	"is_visible\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\tisVisible\x12a\n" +
	"\acolumns\x18\x02 \x03(\x0e2G.com.coralogixapis.dashboards.v1.ast.widgets.common.Legend.LegendColumnR\acolumns\x12@\n" +
	"\x0egroup_by_query\x18\x03 \x01(\v2\x1a.google.protobuf.BoolValueR\fgroupByQuery\x12h\n" +
	"\tplacement\x18\x04 \x01(\x0e2J.com.coralogixapis.dashboards.v1.ast.widgets.common.Legend.LegendPlacementR\tplacement\"\xb9\x01\n" +
