...
const (
	LegendBy_LEGEND_BY_GROUPS     LegendBy = 0
...
type Legend struct {
	...
	IsVisible    *wrappers.BoolValue    `protobuf:"bytes,1,opt,name=is_visible,json=isVisible,proto3" json:"is_visible,omitempty"`
	...
	GroupByQuery *wrappers.BoolValue    `protobuf:"bytes,3,opt,name=group_by_query,json=groupByQuery,proto3" json:"group_by_query,omitempty"`
...
func (x *Legend) GetIsVisible() *wrappers.BoolValue {
	if x != nil {
		return x.IsVisible
	}
	return nil
...
func (x *Legend) GetGroupByQuery() *wrappers.BoolValue {
	if x != nil {
...
var file_com_coralogixapis_dashboards_v1_ast_widgets_common_legend_proto_rawDesc = []byte{
	...
	0x45, 0x4e, 0x54, 0x5f, 0x48, 0x49, 0x44, 0x44, 0x45, 0x4e, 0x10, 0x04, 0x2a, 0x3a, 0x0a, 0x08,
	0x4c, 0x65, 0x67, 0x65, 0x6e, 0x64, 0x42, 0x79, 0x12, 0x14, 0x0a, 0x10, 0x4c, 0x45, 0x47, 0x45,
	0x4e, 0x44, 0x5f, 0x42, 0x59, 0x5f, 0x47, 0x52, 0x4f, 0x55, 0x50, 0x53, 0x10, 0x00, 0x12, 0x18,
	0x0a, 0x14, 0x4c, 0x45, 0x47, 0x45, 0x4e, 0x44, 0x5f, 0x42, 0x59, 0x5f, 0x54, 0x48, 0x52, 0x45,
	0x53, 0x48, 0x4f, 0x4c, 0x44, 0x53, 0x10, 0x01, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
