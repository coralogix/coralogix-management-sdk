...
func (x *SearchDataprimeRequest) GetLimit() *wrappers.Int32Value {
	if x != nil {
		return x.Limit
	}
	return nil
...
type SearchDataprimeArchiveRequest struct {
	...
	TimeFrame         *TimeFrame                `protobuf:"bytes,3,opt,name=time_frame,json=timeFrame,proto3" json:"time_frame,omitempty"`
	Limit             *wrappers.Int32Value      `protobuf:"bytes,4,opt,name=limit,proto3" json:"limit,omitempty"`
	WidgetId          *wrappers.StringValue     `protobuf:"bytes,5,opt,name=widget_id,json=widgetId,proto3" json:"widget_id,omitempty"`
}
...
func (x *SearchDataprimeArchiveRequest) GetLimit() *wrappers.Int32Value {
	if x != nil {
		return x.Limit
	}
	return nil
...
func (x *SearchDataprimeArchiveRequest) GetWidgetId() *wrappers.StringValue {
	if x != nil {
		return x.WidgetId
	}
	return nil
