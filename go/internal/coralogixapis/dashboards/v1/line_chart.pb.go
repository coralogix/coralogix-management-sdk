...
type LineChart_QueryDefinition struct {
	...
	SeriesNameTemplate *wrappers.StringValue `protobuf:"bytes,3,opt,name=series_name_template,json=seriesNameTemplate,proto3" json:"series_name_template,omitempty"`
	SeriesCountLimit   *wrappers.Int64Value  `protobuf:"bytes,4,opt,name=series_count_limit,json=seriesCountLimit,proto3" json:"series_count_limit,omitempty"`
	...
	IsVisible          *wrappers.BoolValue   `protobuf:"bytes,8,opt,name=is_visible,json=isVisible,proto3" json:"is_visible,omitempty"`
	...
	CustomUnit         *wrappers.StringValue `protobuf:"bytes,12,opt,name=custom_unit,json=customUnit,proto3" json:"custom_unit,omitempty"`
	Decimal            *wrappers.Int32Value  `protobuf:"bytes,13,opt,name=decimal,proto3" json:"decimal,omitempty"`
}
...
func (x *LineChart_QueryDefinition) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *LineChart_QueryDefinition) GetSeriesNameTemplate() *wrappers.StringValue {
	if x != nil {
...
func (x *LineChart_QueryDefinition) GetSeriesCountLimit() *wrappers.Int64Value {
	if x != nil {
...
func (x *LineChart_QueryDefinition) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *LineChart_QueryDefinition) GetIsVisible() *wrappers.BoolValue {
	if x != nil {
		return x.IsVisible
	}
	return nil
...
func (x *LineChart_QueryDefinition) GetColorScheme() *wrappers.StringValue {
	if x != nil {
...
func (x *LineChart_QueryDefinition) GetCustomUnit() *wrappers.StringValue {
	if x != nil {
		return x.CustomUnit
	}
	return nil
...
func (x *LineChart_QueryDefinition) GetDecimal() *wrappers.Int32Value {
	if x != nil {
		return x.Decimal
	}
	return nil
...
type LineChart_Tooltip struct {
	...
	ShowLabels *wrappers.BoolValue   `protobuf:"bytes,1,opt,name=show_labels,json=showLabels,proto3" json:"show_labels,omitempty"`
...
func (x *LineChart_Tooltip) GetShowLabels() *wrappers.BoolValue {
	if x != nil {
		return x.ShowLabels
	}
	return nil
...
type LineChart_LogsQuery struct {
	...
	GroupBy      []*wrappers.StringValue `protobuf:"bytes,2,rep,name=group_by,json=groupBy,proto3" json:"group_by,omitempty"`
...
func (x *LineChart_LogsQuery) GetGroupBy() []*wrappers.StringValue {
	if x != nil {
		return x.GroupBy
	}
	return nil
...
func (x *LineChart_Resolution) GetInterval() *duration.Duration {
	if x != nil {
		return x.Interval
	}
	return nil
...
func (x *LineChart_Resolution) GetBucketsPresented() *wrappers.Int32Value {
	if x != nil {
