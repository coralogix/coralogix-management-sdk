...
func (x *TimeFrameSelect) GetRelativeTimeFrame() *duration.Duration {
...
type TimeFrameSelect_RelativeTimeFrame struct {
	RelativeTimeFrame *duration.Duration `protobuf:"bytes,2,opt,name=relative_time_frame,json=relativeTimeFrame,proto3,oneof"`
}
...
func (x *TimeFrame) GetFrom() *timestamp.Timestamp {
	if x != nil {
		return x.From
	}
	return nil
...
func (x *TimeFrame) GetTo() *timestamp.Timestamp {
	if x != nil {
		return x.To
	}
	return nil
