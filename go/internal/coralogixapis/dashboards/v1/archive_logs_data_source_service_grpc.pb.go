...
// UnimplementedArchiveLogsDataSourceServiceServer must be embedded to have
...
func (UnimplementedArchiveLogsDataSourceServiceServer) testEmbeddedByValue() {}
...
func RegisterArchiveLogsDataSourceServiceServer(s grpc.ServiceRegistrar, srv ArchiveLogsDataSourceServiceServer) {
	// If the following call pancis, it indicates UnimplementedArchiveLogsDataSourceServiceServer was
