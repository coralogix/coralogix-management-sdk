...
func (x *Dashboard) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *Dashboard) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *Dashboard) GetDescription() *wrappers.StringValue {
	if x != nil {
...
func (x *Dashboard) GetRelativeTimeFrame() *duration.Duration {
...
type Dashboard_RelativeTimeFrame struct {
	...
	RelativeTimeFrame *duration.Duration `protobuf:"bytes,8,opt,name=relative_time_frame,json=relativeTimeFrame,proto3,oneof"`
}
