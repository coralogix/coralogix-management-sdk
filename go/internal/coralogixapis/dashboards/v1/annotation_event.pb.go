...
func (x *AnnotationEvent_Instant) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *AnnotationEvent_Instant) GetPayload() *_struct.Struct {
	if x != nil {
		return x.Payload
	}
	return nil
...
func (x *AnnotationEvent_Range) GetStart() *timestamp.Timestamp {
	if x != nil {
		return x.Start
	}
	return nil
...
func (x *AnnotationEvent_Range) GetEnd() *timestamp.Timestamp {
	if x != nil {
		return x.End
	}
	return nil
...
func (x *AnnotationEvent_Range) GetPayload() *_struct.Struct {
	if x != nil {
		return x.Payload
	}
	return nil
