...
func (x *Hexagon) GetMin() *wrappers.DoubleValue {
	if x != nil {
		return x.Min
	}
	return nil
...
func (x *Hexagon) GetMax() *wrappers.DoubleValue {
	if x != nil {
		return x.Max
	}
	return nil
...
func (x *Hexagon) GetCustomUnit() *wrappers.StringValue {
	if x != nil {
		return x.CustomUnit
	}
	return nil
...
func (x *Hexagon) GetDecimal() *wrappers.Int32Value {
	if x != nil {
		return x.Decimal
	}
	return nil
