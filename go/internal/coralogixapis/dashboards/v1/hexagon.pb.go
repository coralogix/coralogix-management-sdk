...
const file_com_coralogixapis_dashboards_v1_ast_widgets_hexagon_proto_rawDesc = "" +
	...
	"\tlegend_by\x18\x0e \x01(\x0e2<.com.coralogixapis.dashboards.v1.ast.widgets.common.LegendByR\blegendBy\x1a\x83\x03\n" +
	"\x05Query\x12]\n" +
