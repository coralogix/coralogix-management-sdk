...
func (x *Widget) GetTitle() *wrappers.StringValue {
	if x != nil {
		return x.Title
	}
	return nil
...
func (x *Widget) GetDescription() *wrappers.StringValue {
	if x != nil {
...
func (x *Widget) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *Widget) GetUpdatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
type Widget_Appearance struct {
	...
	Width *wrappers.Int32Value `protobuf:"bytes,1,opt,name=width,proto3" json:"width,omitempty"`
}
...
func (x *Widget_Appearance) GetWidth() *wrappers.Int32Value {
	if x != nil {
		return x.Width
	}
	return nil
