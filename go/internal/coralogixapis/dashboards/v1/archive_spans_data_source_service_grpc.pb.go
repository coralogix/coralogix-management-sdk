...
// UnimplementedArchiveSpansDataSourceServiceServer must be embedded to have
...
func (UnimplementedArchiveSpansDataSourceServiceServer) testEmbeddedByValue() {}
...
func RegisterArchiveSpansDataSourceServiceServer(s grpc.ServiceRegistrar, srv ArchiveSpansDataSourceServiceServer) {
	// If the following call pancis, it indicates UnimplementedArchiveSpansDataSourceServiceServer was
