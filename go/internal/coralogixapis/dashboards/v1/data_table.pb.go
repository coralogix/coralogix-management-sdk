...
const file_com_coralogixapis_dashboards_v1_ast_widgets_data_table_proto_rawDesc = "" +
	"\n" +
	"<com/coralogixapis/dashboards/v1/ast/widgets/data_table.proto\x12+com.coralogixapis.dashboards.v1.ast.widgets\x1a0com/coralogixapis/dashboards/v1/ast/filter.proto\x1aGcom/coralogixapis/dashboards/v1/ast/widgets/common/data_mode_type.proto\x1aRcom/coralogixapis/dashboards/v1/ast/widgets/common/metrics_query_editor_mode.proto\x1a@com/coralogixapis/dashboards/v1/ast/widgets/common/queries.proto\x1a=com/coralogixapis/dashboards/v1/common/logs_aggregation.proto\x1a>com/coralogixapis/dashboards/v1/common/observation_field.proto\x1a;com/coralogixapis/dashboards/v1/common/ordering_field.proto\x1a2com/coralogixapis/dashboards/v1/common/query.proto\x1a7com/coralogixapis/dashboards/v1/common/span_field.proto\x1a>com/coralogixapis/dashboards/v1/common/spans_aggregation.proto\x1a7com/coralogixapis/dashboards/v1/common/time_frame.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xfb.\n" +
	...
	"\flucene_query\x18\x01 \x01(\v2?.com.coralogixapis.dashboards.v1.ast.widgets.common.LuceneQueryBb\x92A_2$A Lucene query string to search logsJ7{ \"value\": \"coralogix.metadata.subsystemName: cx_rum\" }R\vluceneQuery\x12\x85\x01\n" +
	"\afilters\x18\x02 \x03(\v26.com.coralogixapis.dashboards.v1.ast.Filter.LogsFilterB3\x92A02.List of filters that narrow down query resultsR\afilters\x12\x93\x01\n" +
	...
	"(*\tLogsQuery2\x1bA logs variant of the query\x1a\xb4\f\n" +
	"\n" +
	"SpansQuery\x12\x95\x01\n" +
	"\flucene_query\x18\x01 \x01(\v2?.com.coralogixapis.dashboards.v1.ast.widgets.common.LuceneQueryB1\x92A.2,A Lucene query string to search span recordsR\vluceneQuery\x12r\n" +
	"\afilters\x18\x02 \x03(\v27.com.coralogixapis.dashboards.v1.ast.Filter.SpansFilterB\x1f\x92A\x1c2\x1aList of span query filtersR\afilters\x12\x94\x01\n" +
	...
	"**\n" +
	"SpansQuery2\x1cA spans variant of the query\x1a\xf0\x06\n" +
	...
	".*\fMetricsQuery2\x1eA metrics variant of the query\x1a\xd1\x03\n" +
...
var file_com_coralogixapis_dashboards_v1_ast_widgets_data_table_proto_depIdxs = []int32{
	...
	24, // 24: com.coralogixapis.dashboards.v1.ast.widgets.DataTable.DataprimeQuery.filters:type_name -> com.coralogixapis.dashboards.v1.ast.Filter.Source
