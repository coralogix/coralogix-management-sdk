...
func (x *LogsAggregation_CountDistinct) GetField() *wrappers.StringValue {
	if x != nil {
		return x.Field
	}
	return nil
...
func (x *LogsAggregation_Sum) GetField() *wrappers.StringValue {
	if x != nil {
		return x.Field
	}
	return nil
...
func (x *LogsAggregation_Average) GetField() *wrappers.StringValue {
	if x != nil {
		return x.Field
	}
	return nil
...
func (x *LogsAggregation_Min) GetField() *wrappers.StringValue {
	if x != nil {
		return x.Field
	}
	return nil
...
func (x *LogsAggregation_Max) GetField() *wrappers.StringValue {
	if x != nil {
		return x.Field
	}
	return nil
...
type LogsAggregation_Percentile struct {
	...
	Percent          *wrappers.DoubleValue `protobuf:"bytes,2,opt,name=percent,proto3" json:"percent,omitempty"`
...
func (x *LogsAggregation_Percentile) GetField() *wrappers.StringValue {
	if x != nil {
		return x.Field
	}
	return nil
...
func (x *LogsAggregation_Percentile) GetPercent() *wrappers.DoubleValue {
	if x != nil {
		return x.Percent
	}
	return nil
