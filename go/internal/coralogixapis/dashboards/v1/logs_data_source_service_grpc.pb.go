...
// UnimplementedLogsDataSourceServiceServer must be embedded to have
...
func (UnimplementedLogsDataSourceServiceServer) testEmbeddedByValue()                               {}
...
func RegisterLogsDataSourceServiceServer(s grpc.ServiceRegistrar, srv LogsDataSourceServiceServer) {
	// If the following call pancis, it indicates UnimplementedLogsDataSourceServiceServer was
