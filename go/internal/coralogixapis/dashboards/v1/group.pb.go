...
func (x *Group) GetValue() *wrappers.DoubleValue {
	if x != nil {
		return x.Value
	}
	return nil
...
type MultiGroup struct {
	...
	Values []*wrappers.DoubleValue `protobuf:"bytes,2,rep,name=values,proto3" json:"values,omitempty"`
}
...
func (x *MultiGroup) GetValues() []*wrappers.DoubleValue {
	if x != nil {
		return x.Values
	}
	return nil
...
func (x *FieldGroup) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *FieldGroup) GetValue() *wrappers.StringValue {
	if x != nil {
		return x.Value
	}
	return nil
