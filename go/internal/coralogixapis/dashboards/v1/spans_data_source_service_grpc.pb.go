...
// UnimplementedSpansDataSourceServiceServer must be embedded to have
...
func (UnimplementedSpansDataSourceServiceServer) testEmbeddedByValue() {}
...
func RegisterSpansDataSourceServiceServer(s grpc.ServiceRegistrar, srv SpansDataSourceServiceServer) {
	// If the following call pancis, it indicates UnimplementedSpansDataSourceServiceServer was
