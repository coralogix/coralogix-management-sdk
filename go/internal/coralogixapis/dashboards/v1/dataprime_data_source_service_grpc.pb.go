...
// UnimplementedDataprimeDataSourceServiceServer must be embedded to have
...
func (UnimplementedDataprimeDataSourceServiceServer) testEmbeddedByValue() {}
...
func RegisterDataprimeDataSourceServiceServer(s grpc.ServiceRegistrar, srv DataprimeDataSourceServiceServer) {
	// If the following call pancis, it indicates UnimplementedDataprimeDataSourceServiceServer was
