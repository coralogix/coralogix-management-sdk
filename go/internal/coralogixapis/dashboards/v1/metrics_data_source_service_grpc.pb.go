...
// UnimplementedMetricsDataSourceServiceServer must be embedded to have
...
func (UnimplementedMetricsDataSourceServiceServer) testEmbeddedByValue() {}
...
func RegisterMetricsDataSourceServiceServer(s grpc.ServiceRegistrar, srv MetricsDataSourceServiceServer) {
	// If the following call pancis, it indicates UnimplementedMetricsDataSourceServiceServer was
