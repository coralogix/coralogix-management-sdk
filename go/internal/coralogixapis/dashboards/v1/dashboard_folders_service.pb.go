...
func (x *CreateDashboardFolderRequest) GetRequestId() *wrappers.StringValue {
	if x != nil {
		return x.RequestId
	}
	return nil
...
func (x *ReplaceDashboardFolderRequest) GetRequestId() *wrappers.StringValue {
	if x != nil {
		return x.RequestId
	}
	return nil
...
type DeleteDashboardFolderRequest struct {
	...
	RequestId *wrappers.StringValue `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	FolderId  *wrappers.StringValue `protobuf:"bytes,2,opt,name=folder_id,json=folderId,proto3" json:"folder_id,omitempty"`
}
...
func (x *DeleteDashboardFolderRequest) GetRequestId() *wrappers.StringValue {
	if x != nil {
		return x.RequestId
	}
	return nil
...
func (x *DeleteDashboardFolderRequest) GetFolderId() *wrappers.StringValue {
	if x != nil {
		return x.FolderId
	}
	return nil
...
func (x *GetDashboardFolderRequest) GetRequestId() *wrappers.StringValue {
	if x != nil {
		return x.RequestId
	}
	return nil
...
func (x *GetDashboardFolderRequest) GetFolderId() *wrappers.StringValue {
	if x != nil {
		return x.FolderId
	}
	return nil
