...
func file_com_coralogixapis_dashboards_v1_services_dashboard_folders_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_com_coralogixapis_dashboards_v1_services_dashboard_folders_service_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_dashboards_v1_services_dashboard_folders_service_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
