...
type Markdown struct {
	...
	MarkdownText *wrappers.StringValue `protobuf:"bytes,1,opt,name=markdown_text,json=markdownText,proto3" json:"markdown_text,omitempty"`
	TooltipText  *wrappers.StringValue `protobuf:"bytes,2,opt,name=tooltip_text,json=tooltipText,proto3" json:"tooltip_text,omitempty"`
}
...
func (x *Markdown) GetMarkdownText() *wrappers.StringValue {
	if x != nil {
...
func (x *Markdown) GetTooltipText() *wrappers.StringValue {
	if x != nil {
