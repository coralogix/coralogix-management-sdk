...
func (x *CustomSectionOptions) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *CustomSectionOptions) GetDescription() *wrappers.StringValue {
	if x != nil {
...
func (x *CustomSectionOptions) GetCollapsed() *wrappers.BoolValue {
	if x != nil {
		return x.Collapsed
	}
	return nil
...
type Row_Appearance struct {
	...
	Height *wrappers.Int32Value `protobuf:"bytes,1,opt,name=height,proto3" json:"height,omitempty"`
}
...
func (x *Row_Appearance) GetHeight() *wrappers.Int32Value {
	if x != nil {
		return x.Height
	}
	return nil
