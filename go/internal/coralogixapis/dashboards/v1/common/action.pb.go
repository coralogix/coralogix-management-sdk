...
type DashboardAction struct {
	...
	QueryId               *wrapperspb.StringValue `protobuf:"bytes,7,opt,name=query_id,json=queryId,proto3,oneof" json:"query_id,omitempty"`
...
func (x *DashboardAction) GetQueryId() *wrapperspb.StringValue {
	if x != nil {
		return x.QueryId
	}
	return nil
...
const file_com_coralogixapis_dashboards_v1_common_action_proto_rawDesc = "" +
	...
	"\twidget_id\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueBa\x9aA^2\\Reference to specific widget within a dashboard, can be null if the action is dashboard wideH\x00R\bwidgetId\x88\x01\x01\x12\xbd\x01\n" +
	"\bquery_id\x18\a \x01(\v2\x1c.google.protobuf.StringValueB\x7f\x9aA|2zReference to specific query within a widget, can be null if the action is dashboard wide or related to single query widgetH\x01R\aqueryId\x88\x01\x01\x12w\n" +
	"\n" +
	...
	"definition\x12\xa2\x01\n" +
	"\vdata_source\x18\x06 \x01(\x0e2<.com.coralogixapis.dashboards.v1.common.ActionDataSourceTypeB>\x9aA;29Defines the data source type of the action, if applicableH\x02R\n" +
...
var file_com_coralogixapis_dashboards_v1_common_action_proto_depIdxs = []int32{
	...
	6,  // 12: com.coralogixapis.dashboards.v1.common.DashboardAction.query_id:type_name -> google.protobuf.StringValue
	3,  // 13: com.coralogixapis.dashboards.v1.common.DashboardAction.definition:type_name -> com.coralogixapis.dashboards.v1.common.ActionDefinition
	0,  // 14: com.coralogixapis.dashboards.v1.common.DashboardAction.data_source:type_name -> com.coralogixapis.dashboards.v1.common.ActionDataSourceType
	4,  // 15: com.coralogixapis.dashboards.v1.common.ActionDefinition.custom_action:type_name -> com.coralogixapis.dashboards.v1.common.ActionDefinition.CustomAction
	5,  // 16: com.coralogixapis.dashboards.v1.common.ActionDefinition.go_to_dashboard_action:type_name -> com.coralogixapis.dashboards.v1.common.ActionDefinition.GoToDashboardTemplateAction
	6,  // 17: com.coralogixapis.dashboards.v1.common.ActionDefinition.CustomAction.url:type_name -> google.protobuf.StringValue
	6,  // 18: com.coralogixapis.dashboards.v1.common.ActionDefinition.GoToDashboardTemplateAction.dashboard_id:type_name -> google.protobuf.StringValue
