...
const (
	...
	OrderDirection_ORDER_DIRECTION_NONE        OrderDirection = 3
)
...
const file_com_coralogixapis_dashboards_v1_common_order_direction_proto_rawDesc = "" +
	"\n" +
	"<com/coralogixapis/dashboards/v1/common/order_direction.proto\x12&com.coralogixapis.dashboards.v1.common*~\n" +
	"\x0eOrderDirection\x12\x1f\n" +
	"\x1bORDER_DIRECTION_UNSPECIFIED\x10\x00\x12\x17\n" +
	"\x13ORDER_DIRECTION_ASC\x10\x01\x12\x18\n" +
	"\x14ORDER_DIRECTION_DESC\x10\x02\x12\x18\n" +
	"\x14ORDER_DIRECTION_NONE\x10\x03b\x06proto3"
