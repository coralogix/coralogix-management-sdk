...
const file_com_coralogixapis_dashboards_v1_services_dashboard_folders_service_proto_rawDesc = "" +
	...
	".Find out more Dashboards in our documentation.\x12Ihttps://coralogix.com/docs/user-guides/custom-dashboards/getting-started/2\x93\x15\n" +
	"\x17DashboardFoldersService\x12\x8b\x04\n" +
	"\x14ListDashboardFolders\x12E.com.coralogixapis.dashboards.v1.services.ListDashboardFoldersRequest\x1aF.com.coralogixapis.dashboards.v1.services.ListDashboardFoldersResponse\"\xe3\x02\x9aA\xe6\x01\n" +
	...
	"\x16List dashboard folders\x82\xd3\xe4\x93\x02WZ\x18\x12\x16/v1/dashboards/foldersZ#\x12!/dashboards/dashboards/v1/folders\x12\x16/dashboards/folders/v1\x12\xa1\x04\n" +
	"\x12GetDashboardFolder\x12C.com.coralogixapis.dashboards.v1.services.GetDashboardFolderRequest\x1aD.com.coralogixapis.dashboards.v1.services.GetDashboardFolderResponse\"\xff\x02\x9aA\xe0\x01\n" +
	...
	"\x14Get dashboard folder\x82\xd3\xe4\x93\x02{Z$\x12\"/v1/dashboards/folders/{folder_id}Z/\x12-/dashboards/dashboards/v1/folders/{folder_id}\x12\"/dashboards/folders/v1/{folder_id}\x12\xf5\x03\n" +
	"\x15CreateDashboardFolder\x12F.com.coralogixapis.dashboards.v1.services.CreateDashboardFolderRequest\x1aG.com.coralogixapis.dashboards.v1.services.CreateDashboardFolderResponse\"\xca\x02\x9aA\xc3\x01\n" +
	...
	"\x17Create dashboard folder\x82\xd3\xe4\x93\x02`:\x01*Z\x1b:\x01*\"\x16/v1/dashboards/foldersZ&:\x01*\"!/dashboards/dashboards/v1/folders\"\x16/dashboards/folders/v1\x12\xfa\x03\n" +
	"\x16ReplaceDashboardFolder\x12G.com.coralogixapis.dashboards.v1.services.ReplaceDashboardFolderRequest\x1aH.com.coralogixapis.dashboards.v1.services.ReplaceDashboardFolderResponse\"\xcc\x02\x9aA\xc4\x01\n" +
	...
	"\x18Replace dashboard folder\x82\xd3\xe4\x93\x02`:\x01*Z\x1b:\x01*\x1a\x16/v1/dashboards/foldersZ&:\x01*\x1a!/dashboards/dashboards/v1/folders\x1a\x16/dashboards/folders/v1\x12\x90\x04\n" +
	"\x15DeleteDashboardFolder\x12F.com.coralogixapis.dashboards.v1.services.DeleteDashboardFolderRequest\x1aG.com.coralogixapis.dashboards.v1.services.DeleteDashboardFolderResponse\"\xe5\x02\x9aA\xc3\x01\n" +
	...
	"\x16x-coralogixPermissions\x12\x1c2\x1a\n" +
	"\x18\x1a\x16team-dashboards:Updateʸ\x02\x19\n" +
	"\x17Delete dashboard folder\x82\xd3\xe4\x93\x02{Z$*\"/v1/dashboards/folders/{folder_id}Z/*-/dashboards/dashboards/v1/folders/{folder_id}*\"/dashboards/folders/v1/{folder_id}\x1a>\x9aA;\n" +
