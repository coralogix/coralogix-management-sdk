...
type SearchDataprimeRequest struct {
	...
	DataprimeQuery    *common.SerializedDataprimeQuery `protobuf:"bytes,1,opt,name=dataprime_query,json=dataprimeQuery,proto3" json:"dataprime_query,omitempty"`
	DataprimeQueryRaw *common.DataprimeQuery           `protobuf:"bytes,2,opt,name=dataprime_query_raw,json=dataprimeQueryRaw,proto3" json:"dataprime_query_raw,omitempty"`
	TimeFrame         *common.TimeFrame                `protobuf:"bytes,3,opt,name=time_frame,json=timeFrame,proto3" json:"time_frame,omitempty"`
...
func (x *SearchDataprimeRequest) GetDataprimeQuery() *common.SerializedDataprimeQuery {
	if x != nil {
...
func (x *SearchDataprimeRequest) GetDataprimeQueryRaw() *common.DataprimeQuery {
	if x != nil {
...
func (x *SearchDataprimeRequest) GetTimeFrame() *common.TimeFrame {
	if x != nil {
		return x.TimeFrame
	}
	return nil
...
type SearchDataprimeResponse struct {
	...
	Results []*common.DataprimeResult `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"`
}
...
func (x *SearchDataprimeResponse) GetResults() []*common.DataprimeResult {
	if x != nil {
		return x.Results
	}
	return nil
...
func (x *SearchDataprimeArchiveRequest) GetDataprimeQuery() *common.SerializedDataprimeQuery {
	if x != nil {
		return x.DataprimeQuery
	}
	return nil
...
func (x *SearchDataprimeArchiveRequest) GetDataprimeQueryRaw() *common.DataprimeQuery {
	if x != nil {
		return x.DataprimeQueryRaw
	}
	return nil
...
func (x *SearchDataprimeArchiveRequest) GetTimeFrame() *common.TimeFrame {
	if x != nil {
		return x.TimeFrame
	}
	return nil
...
func (x *SearchDataprimeArchiveResponse) GetResults() []*common.DataprimeResult {
	if x != nil {
		return x.Results
	}
	return nil
...
var file_com_coralogixapis_dashboards_v1_services_dataprime_data_source_service_proto_goTypes = []interface{}{
	...
	(*common.SerializedDataprimeQuery)(nil), // 4: com.coralogixapis.dashboards.v1.common.SerializedDataprimeQuery
	(*common.DataprimeQuery)(nil),           // 5: com.coralogixapis.dashboards.v1.common.DataprimeQuery
	(*common.TimeFrame)(nil),                // 6: com.coralogixapis.dashboards.v1.common.TimeFrame
	(*wrapperspb.Int32Value)(nil),           // 7: google.protobuf.Int32Value
	(*common.DataprimeResult)(nil),          // 8: com.coralogixapis.dashboards.v1.common.DataprimeResult
