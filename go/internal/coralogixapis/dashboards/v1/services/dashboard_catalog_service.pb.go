...
const file_com_coralogixapis_dashboards_v1_services_dashboard_catalog_service_proto_rawDesc = "" +
	...
	"'*%Dashboard catalog item data structure2\xd2\x04\n" +
	"\x17DashboardCatalogService\x12\xe6\x03\n" +
	"\x13GetDashboardCatalog\x12D.com.coralogixapis.dashboards.v1.services.GetDashboardCatalogRequest\x1aE.com.coralogixapis.dashboards.v1.services.GetDashboardCatalogResponse\"\xc1\x02\x9aA\xdf\x01\n" +
	...
	"\x15Get dashboard catalog\x82\xd3\xe4\x93\x02=Z\x18\x12\x16/v1/dashboards/catalog\x12!/dashboards/dashboards/v1/catalog\x1aN\x9aAK\n" +
