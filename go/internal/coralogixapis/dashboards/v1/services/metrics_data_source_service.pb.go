...
type SearchMetricsTimeSeriesRequest struct {
	...
	Filters     []*ast.Filter_MetricsFilter `protobuf:"bytes,5,rep,name=filters,proto3" json:"filters,omitempty"`
}
...
func (x *SearchMetricsTimeSeriesRequest) GetTimeFrame() *common.TimeFrame {
	if x != nil {
		return x.TimeFrame
	}
	return nil
...
func (x *SearchMetricsTimeSeriesRequest) GetFilters() []*ast.Filter_MetricsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *SearchMetricsTimeSeriesResponse) GetTimeSeries() []*common.TimeSeries {
	if x != nil {
		return x.TimeSeries
	}
	return nil
...
type SearchMetricsTimeValuesRequest struct {
	...
	Filters     []*ast.Filter_MetricsFilter `protobuf:"bytes,4,rep,name=filters,proto3" json:"filters,omitempty"`
}
...
func (x *SearchMetricsTimeValuesRequest) GetTimeFrame() *common.TimeFrame {
	if x != nil {
		return x.TimeFrame
	}
	return nil
...
func (x *SearchMetricsTimeValuesRequest) GetFilters() []*ast.Filter_MetricsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
type SearchMetricsTimeValuesResponse struct {
	...
	Values          []*common.LabelledValue `protobuf:"bytes,1,rep,name=values,proto3" json:"values,omitempty"`
	IsLimitExceeded bool                    `protobuf:"varint,2,opt,name=is_limit_exceeded,json=isLimitExceeded,proto3" json:"is_limit_exceeded,omitempty"`
	Total           *wrapperspb.Int64Value  `protobuf:"bytes,3,opt,name=total,proto3" json:"total,omitempty"`
}
...
func (x *SearchMetricsTimeValuesResponse) GetValues() []*common.LabelledValue {
	if x != nil {
		return x.Values
	}
	return nil
...
func (x *SearchMetricsGroupedSeriesRequest) GetTimeFrame() *common.TimeFrame {
	if x != nil {
		return x.TimeFrame
	}
	return nil
...
func (x *SearchMetricsGroupedSeriesRequest) GetFilters() []*ast.Filter_MetricsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *SearchMetricsGroupedSeriesResponse) GetSeries() []*common.GroupedSeries {
	if x != nil {
		return x.Series
	}
	return nil
...
func (x *SearchMetricsGroupedTimeSeriesRequest) GetTimeFrame() *common.TimeFrame {
	if x != nil {
		return x.TimeFrame
	}
	return nil
...
func (x *SearchMetricsGroupedTimeSeriesRequest) GetFilters() []*ast.Filter_MetricsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *SearchMetricsGroupedTimeSeriesResponse) GetSeries() []*common.GroupedSeries {
	if x != nil {
		return x.Series
	}
	return nil
...
func (x *SearchMetricsEventsRequest) GetTimeFrame() *common.TimeFrame {
	if x != nil {
		return x.TimeFrame
	}
	return nil
...
func (x *SearchMetricsEventsRequest) GetFilters() []*ast.Filter_MetricsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *MetricsEvent) GetTimeSeries() *common.TimeSeries {
	if x != nil {
		return x.TimeSeries
	}
	return nil
...
type SearchMetricsAnnotationEventsRequest struct {
	...
	Strategy    *ast.Annotation_MetricsSource_Strategy `protobuf:"bytes,5,opt,name=strategy,proto3" json:"strategy,omitempty"`
...
func (x *SearchMetricsAnnotationEventsRequest) GetTimeFrame() *common.TimeFrame {
	if x != nil {
		return x.TimeFrame
	}
	return nil
...
func (x *SearchMetricsAnnotationEventsRequest) GetFilters() []*ast.Filter_MetricsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *SearchMetricsAnnotationEventsRequest) GetStrategy() *ast.Annotation_MetricsSource_Strategy {
	if x != nil {
		return x.Strategy
	}
	return nil
...
func (x *SearchMetricsAnnotationEventsResponse) GetAnnotationEvents() []*common.AnnotationEvent {
	if x != nil {
...
type SearchMetricsEventsRequest_OrderBy struct {
	...
	Direction common.OrderDirection `protobuf:"varint,1,opt,name=direction,proto3,enum=com.coralogixapis.dashboards.v1.common.OrderDirection" json:"direction,omitempty"`
...
func (x *SearchMetricsEventsRequest_OrderBy) GetDirection() common.OrderDirection {
	if x != nil {
		return x.Direction
	}
...
var file_com_coralogixapis_dashboards_v1_services_metrics_data_source_service_proto_goTypes = []interface{}{
	...
	(*common.TimeFrame)(nil),                              // 19: com.coralogixapis.dashboards.v1.common.TimeFrame
	...
	(*common.TimeSeries)(nil),                             // 24: com.coralogixapis.dashboards.v1.common.TimeSeries
	(*wrapperspb.Int64Value)(nil),                         // 25: google.protobuf.Int64Value
	(*common.LabelledValue)(nil),                          // 26: com.coralogixapis.dashboards.v1.common.LabelledValue
	(*common.GroupedSeries)(nil),                          // 27: com.coralogixapis.dashboards.v1.common.GroupedSeries
	(*ast.Annotation_MetricsSource_Strategy)(nil),         // 28: com.coralogixapis.dashboards.v1.ast.Annotation.MetricsSource.Strategy
	(*common.AnnotationEvent)(nil),                        // 29: com.coralogixapis.dashboards.v1.common.AnnotationEvent
	(common.OrderDirection)(0),                            // 30: com.coralogixapis.dashboards.v1.common.OrderDirection
