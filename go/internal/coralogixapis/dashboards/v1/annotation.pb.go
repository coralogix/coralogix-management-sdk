...
func (x *Annotation) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *Annotation) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *Annotation) GetEnabled() *wrappers.BoolValue {
	if x != nil {
		return x.Enabled
	}
	return nil
...
type Annotation_MetricsSource struct {
	...
	MessageTemplate *wrappers.StringValue              `protobuf:"bytes,3,opt,name=message_template,json=messageTemplate,proto3" json:"message_template,omitempty"`
...
func (x *Annotation_MetricsSource) GetMessageTemplate() *wrappers.StringValue {
	if x != nil {
...
func (x *Annotation_MetricsSource) GetLabels() []*wrappers.StringValue {
	if x != nil {
		return x.Labels
	}
	return nil
...
func (x *Annotation_LogsSource) GetMessageTemplate() *wrappers.StringValue {
	if x != nil {
		return x.MessageTemplate
	}
	return nil
...
func (x *Annotation_SpansSource) GetMessageTemplate() *wrappers.StringValue {
	if x != nil {
		return x.MessageTemplate
	}
	return nil
