...
func (x *SearchMetricsEventsRequest_OrderBy) GetValue() isSearchMetricsEventsRequest_OrderBy_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *SearchMetricsEventsRequest_OrderBy) GetLabel() *wrapperspb.StringValue {
	if x != nil {
		if x, ok := x.Value.(*SearchMetricsEventsRequest_OrderBy_Label); ok {
			return x.Label
		}
	}
	return nil
...
func (x *SearchMetricsEventsRequest_OrderBy) GetAggType() MetricsEvent_AggregationType {
	if x != nil {
		if x, ok := x.Value.(*SearchMetricsEventsRequest_OrderBy_AggType); ok {
			return x.AggType
		}
	}
