...
func (x *Dashboard) GetOneMinute() *Dashboard_AutoRefreshOneMinute {
	if x != nil {
		if x, ok := x.AutoRefresh.(*Dashboard_OneMinute); ok {
			return x.OneMinute
		}
	}
	return nil
...
func (x *Dashboard) GetFifteenMinutes() *Dashboard_AutoRefreshFifteenMinutes {
	if x != nil {
		if x, ok := x.AutoRefresh.(*Dashboard_FifteenMinutes); ok {
...
type Dashboard_OneMinute struct {
	OneMinute *Dashboard_AutoRefreshOneMinute `protobuf:"bytes,18,opt,name=one_minute,json=oneMinute,proto3,oneof"`
}

type Dashboard_FifteenMinutes struct {
	FifteenMinutes *Dashboard_AutoRefreshFifteenMinutes `protobuf:"bytes,19,opt,name=fifteen_minutes,json=fifteenMinutes,proto3,oneof"`
}
...
func (*Dashboard_OneMinute) isDashboard_AutoRefresh() {}

func (*Dashboard_FifteenMinutes) isDashboard_AutoRefresh() {}
...
type Dashboard_AutoRefreshOneMinute struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *Dashboard_AutoRefreshOneMinute) Reset() {
	*x = Dashboard_AutoRefreshOneMinute{}
	mi := &file_com_coralogixapis_dashboards_v1_ast_dashboard_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Dashboard_AutoRefreshOneMinute) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Dashboard_AutoRefreshOneMinute) ProtoMessage() {}

func (x *Dashboard_AutoRefreshOneMinute) ProtoReflect() protoreflect.Message {
	mi := &file_com_coralogixapis_dashboards_v1_ast_dashboard_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Dashboard_AutoRefreshOneMinute.ProtoReflect.Descriptor instead.
func (*Dashboard_AutoRefreshOneMinute) Descriptor() ([]byte, []int) {
...
func (x *Dashboard_AutoRefreshFiveMinutes) Reset() {
	*x = Dashboard_AutoRefreshFiveMinutes{}
	mi := &file_com_coralogixapis_dashboards_v1_ast_dashboard_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Dashboard_AutoRefreshFiveMinutes) Descriptor() ([]byte, []int) {
	return file_com_coralogixapis_dashboards_v1_ast_dashboard_proto_rawDescGZIP(), []int{0, 3}
}

type Dashboard_AutoRefreshFifteenMinutes struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *Dashboard_AutoRefreshFifteenMinutes) Reset() {
	*x = Dashboard_AutoRefreshFifteenMinutes{}
	mi := &file_com_coralogixapis_dashboards_v1_ast_dashboard_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Dashboard_AutoRefreshFifteenMinutes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Dashboard_AutoRefreshFifteenMinutes) ProtoMessage() {}

func (x *Dashboard_AutoRefreshFifteenMinutes) ProtoReflect() protoreflect.Message {
	mi := &file_com_coralogixapis_dashboards_v1_ast_dashboard_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Dashboard_AutoRefreshFifteenMinutes.ProtoReflect.Descriptor instead.
func (*Dashboard_AutoRefreshFifteenMinutes) Descriptor() ([]byte, []int) {
	return file_com_coralogixapis_dashboards_v1_ast_dashboard_proto_rawDescGZIP(), []int{0, 4}
}
...
const file_com_coralogixapis_dashboards_v1_ast_dashboard_proto_rawDesc = "" +
	...
	"twoMinutes\x12j\n" +
	"\ffive_minutes\x18\x0e \x01(\v2E.com.coralogixapis.dashboards.v1.ast.Dashboard.AutoRefreshFiveMinutesH\x01R\vfiveMinutes\x12d\n" +
	"\n" +
	"one_minute\x18\x12 \x01(\v2C.com.coralogixapis.dashboards.v1.ast.Dashboard.AutoRefreshOneMinuteH\x01R\toneMinute\x12s\n" +
	"\x0ffifteen_minutes\x18\x13 \x01(\v2H.com.coralogixapis.dashboards.v1.ast.Dashboard.AutoRefreshFifteenMinutesH\x01R\x0efifteenMinutes\x12\x9e\x01\n" +
	...
	"\x0eAutoRefreshOff\x1a\x16\n" +
	"\x14AutoRefreshOneMinute\x1a\x17\n" +
	"\x15AutoRefreshTwoMinutes\x1a\x18\n" +
	"\x16AutoRefreshFiveMinutes\x1a\x1b\n" +
	"\x19AutoRefreshFifteenMinutes:\x80\x02\x9aA\xfc\x01\n" +
...
var file_com_coralogixapis_dashboards_v1_ast_dashboard_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_com_coralogixapis_dashboards_v1_ast_dashboard_proto_goTypes = []any{
	...
	(*Dashboard_AutoRefreshOneMinute)(nil),      // 2: com.coralogixapis.dashboards.v1.ast.Dashboard.AutoRefreshOneMinute
	(*Dashboard_AutoRefreshTwoMinutes)(nil),     // 3: com.coralogixapis.dashboards.v1.ast.Dashboard.AutoRefreshTwoMinutes
	(*Dashboard_AutoRefreshFiveMinutes)(nil),    // 4: com.coralogixapis.dashboards.v1.ast.Dashboard.AutoRefreshFiveMinutes
	(*Dashboard_AutoRefreshFifteenMinutes)(nil), // 5: com.coralogixapis.dashboards.v1.ast.Dashboard.AutoRefreshFifteenMinutes
	(*wrapperspb.StringValue)(nil),              // 6: google.protobuf.StringValue
	(*Layout)(nil),                              // 7: com.coralogixapis.dashboards.v1.ast.Layout
	(*variables.Variable)(nil),                  // 8: com.coralogixapis.dashboards.v1.ast.variables.Variable
	(*variables_v2.VariableV2)(nil),             // 9: com.coralogixapis.dashboards.v1.ast.variables_v2.VariableV2
	(*filters.Filter)(nil),                      // 10: com.coralogixapis.dashboards.v1.ast.filters.Filter
	(*common.TimeFrame)(nil),                    // 11: com.coralogixapis.dashboards.v1.common.TimeFrame
	(*durationpb.Duration)(nil),                 // 12: google.protobuf.Duration
	(*v1.UUID)(nil),                             // 13: com.coralogixapis.dashboards.v1.UUID
	(*FolderPath)(nil),                          // 14: com.coralogixapis.dashboards.v1.ast.FolderPath
	(*annotations.Annotation)(nil),              // 15: com.coralogixapis.dashboards.v1.ast.annotations.Annotation
	(*common.DashboardAction)(nil),              // 16: com.coralogixapis.dashboards.v1.common.DashboardAction
}
var file_com_coralogixapis_dashboards_v1_ast_dashboard_proto_depIdxs = []int32{
	6,  // 0: com.coralogixapis.dashboards.v1.ast.Dashboard.id:type_name -> google.protobuf.StringValue
	6,  // 1: com.coralogixapis.dashboards.v1.ast.Dashboard.name:type_name -> google.protobuf.StringValue
	6,  // 2: com.coralogixapis.dashboards.v1.ast.Dashboard.description:type_name -> google.protobuf.StringValue
	7,  // 3: com.coralogixapis.dashboards.v1.ast.Dashboard.layout:type_name -> com.coralogixapis.dashboards.v1.ast.Layout
	8,  // 4: com.coralogixapis.dashboards.v1.ast.Dashboard.variables:type_name -> com.coralogixapis.dashboards.v1.ast.variables.Variable
	9,  // 5: com.coralogixapis.dashboards.v1.ast.Dashboard.variables_v2:type_name -> com.coralogixapis.dashboards.v1.ast.variables_v2.VariableV2
	10, // 6: com.coralogixapis.dashboards.v1.ast.Dashboard.filters:type_name -> com.coralogixapis.dashboards.v1.ast.filters.Filter
	11, // 7: com.coralogixapis.dashboards.v1.ast.Dashboard.absolute_time_frame:type_name -> com.coralogixapis.dashboards.v1.common.TimeFrame
	12, // 8: com.coralogixapis.dashboards.v1.ast.Dashboard.relative_time_frame:type_name -> google.protobuf.Duration
	13, // 9: com.coralogixapis.dashboards.v1.ast.Dashboard.folder_id:type_name -> com.coralogixapis.dashboards.v1.UUID
	14, // 10: com.coralogixapis.dashboards.v1.ast.Dashboard.folder_path:type_name -> com.coralogixapis.dashboards.v1.ast.FolderPath
	15, // 11: com.coralogixapis.dashboards.v1.ast.Dashboard.annotations:type_name -> com.coralogixapis.dashboards.v1.ast.annotations.Annotation
	...
	3,  // 13: com.coralogixapis.dashboards.v1.ast.Dashboard.two_minutes:type_name -> com.coralogixapis.dashboards.v1.ast.Dashboard.AutoRefreshTwoMinutes
	4,  // 14: com.coralogixapis.dashboards.v1.ast.Dashboard.five_minutes:type_name -> com.coralogixapis.dashboards.v1.ast.Dashboard.AutoRefreshFiveMinutes
	2,  // 15: com.coralogixapis.dashboards.v1.ast.Dashboard.one_minute:type_name -> com.coralogixapis.dashboards.v1.ast.Dashboard.AutoRefreshOneMinute
	5,  // 16: com.coralogixapis.dashboards.v1.ast.Dashboard.fifteen_minutes:type_name -> com.coralogixapis.dashboards.v1.ast.Dashboard.AutoRefreshFifteenMinutes
	6,  // 17: com.coralogixapis.dashboards.v1.ast.Dashboard.slug_name:type_name -> google.protobuf.StringValue
	16, // 18: com.coralogixapis.dashboards.v1.ast.Dashboard.actions:type_name -> com.coralogixapis.dashboards.v1.common.DashboardAction
...
func file_com_coralogixapis_dashboards_v1_ast_dashboard_proto_init() {
	...
	file_com_coralogixapis_dashboards_v1_ast_dashboard_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*Dashboard_OneMinute)(nil),
		(*Dashboard_FifteenMinutes)(nil),
	}
	type x struct{}
