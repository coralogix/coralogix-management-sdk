...
const file_com_coralogixapis_dashboards_v1_ast_dashboard_proto_rawDesc = "" +
	...
	"\x06layout\x18\x04 \x01(\v2+.com.coralogixapis.dashboards.v1.ast.LayoutBB\x92A?2=The layout configuration for the dashboard's visual elements.R\x06layout\x12\xab\x01\n" +
	"\tvariables\x18\x05 \x03(\v27.com.coralogixapis.dashboards.v1.ast.variables.VariableBT\x92AO2MA list of variables that can be used within the dashboard for dynamic content\x18\x01R\tvariables\x12\xb3\x01\n" +
	"\fvariables_v2\x18\x10 \x03(\v2<.com.coralogixapis.dashboards.v1.ast.variables_v2.VariableV2BR\x92AO2MA list of variables that can be used within the dashboard for dynamic contentR\vvariablesV2\x12\x91\x01\n" +
	"\afilters\x18\x06 \x03(\v23.com.coralogixapis.dashboards.v1.ast.filters.FilterBB\x92A?2=A list of filters that can be applied to the dashboard's dataR\afilters\x12\xa3\x01\n" +
	...
	"\vannotations\x18\v \x03(\v2;.com.coralogixapis.dashboards.v1.ast.annotations.AnnotationBQ\x92AN2LA list of annotations that can be used within the dashboard's visualizationsR\vannotations\x12Q\n" +
