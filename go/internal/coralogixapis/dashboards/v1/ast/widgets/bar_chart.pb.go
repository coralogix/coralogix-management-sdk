...
func (x *BarChart_LogsQuery) GetFilters() []*ast.Filter_LogsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *BarChart_SpansQuery) GetFilters() []*ast.Filter_SpansFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *BarChart_MetricsQuery) GetFilters() []*ast.Filter_MetricsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *BarChart_DataprimeQuery) GetFilters() []*ast.Filter_Source {
	if x != nil {
		return x.Filters
	}
	return nil
...
var file_com_coralogixapis_dashboards_v1_ast_widgets_bar_chart_proto_goTypes = []interface{}{
	...
	(common.DataModeType)(0),            // 16: com.coralogixapis.dashboards.v1.ast.widgets.common.DataModeType
	(*common.LuceneQuery)(nil),          // 17: com.coralogixapis.dashboards.v1.ast.widgets.common.LuceneQuery
	(*common1.LogsAggregation)(nil),     // 18: com.coralogixapis.dashboards.v1.common.LogsAggregation
	(*ast.Filter_LogsFilter)(nil),       // 19: com.coralogixapis.dashboards.v1.ast.Filter.LogsFilter
	(*common1.ObservationField)(nil),    // 20: com.coralogixapis.dashboards.v1.common.ObservationField
	...
	(*common1.SpanField)(nil),           // 23: com.coralogixapis.dashboards.v1.common.SpanField
	(*common.PromQlQuery)(nil),          // 24: com.coralogixapis.dashboards.v1.ast.widgets.common.PromQlQuery
	(*ast.Filter_MetricsFilter)(nil),    // 25: com.coralogixapis.dashboards.v1.ast.Filter.MetricsFilter
	(*common1.DataprimeQuery)(nil),      // 26: com.coralogixapis.dashboards.v1.common.DataprimeQuery
	(*ast.Filter_Source)(nil),           // 27: com.coralogixapis.dashboards.v1.ast.Filter.Source
