...
func (x *PieChart_LogsQuery) GetFilters() []*ast.Filter_LogsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *PieChart_SpansQuery) GetFilters() []*ast.Filter_SpansFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *PieChart_MetricsQuery) GetFilters() []*ast.Filter_MetricsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *PieChart_DataprimeQuery) GetFilters() []*ast.Filter_Source {
	if x != nil {
		return x.Filters
	}
	return nil
...
var file_com_coralogixapis_dashboards_v1_ast_widgets_pie_chart_proto_goTypes = []interface{}{
	...
	(*common.LuceneQuery)(nil),       // 14: com.coralogixapis.dashboards.v1.ast.widgets.common.LuceneQuery
	(*common1.LogsAggregation)(nil),  // 15: com.coralogixapis.dashboards.v1.common.LogsAggregation
	(*ast.Filter_LogsFilter)(nil),    // 16: com.coralogixapis.dashboards.v1.ast.Filter.LogsFilter
	(*common1.ObservationField)(nil), // 17: com.coralogixapis.dashboards.v1.common.ObservationField
	...
	(*common1.DataprimeQuery)(nil),   // 23: com.coralogixapis.dashboards.v1.common.DataprimeQuery
	(*ast.Filter_Source)(nil),        // 24: com.coralogixapis.dashboards.v1.ast.Filter.Source
}
