...
type LineChart_QueryDefinition struct {
	...
	// Deprecated: Marked as deprecated in com/coralogixapis/dashboards/v1/ast/widgets/line_chart.proto.
	...
	IntervalResolution *common.IntervalResolution `protobuf:"bytes,18,opt,name=interval_resolution,json=intervalResolution,proto3" json:"interval_resolution,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *LineChart_QueryDefinition) GetIntervalResolution() *common.IntervalResolution {
	if x != nil {
		return x.IntervalResolution
	}
	return nil
}
...
type LineChart_MetricsQuery struct {
	...
	SeriesLimitType common1.MetricsSeriesLimitType  `protobuf:"varint,5,opt,name=series_limit_type,json=seriesLimitType,proto3,enum=com.coralogixapis.dashboards.v1.common.MetricsSeriesLimitType" json:"series_limit_type,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *LineChart_MetricsQuery) GetSeriesLimitType() common1.MetricsSeriesLimitType {
	if x != nil {
		return x.SeriesLimitType
	}
	return common1.MetricsSeriesLimitType(0)
}
...
// Deprecated: Use IntervalResolution instead. Resolution will be removed in a future version.
//
// Deprecated: Marked as deprecated in com/coralogixapis/dashboards/v1/ast/widgets/line_chart.proto.
...
const file_com_coralogixapis_dashboards_v1_ast_widgets_line_chart_proto_rawDesc = "" +
	"\n" +
	"<com/coralogixapis/dashboards/v1/ast/widgets/line_chart.proto\x12+com.coralogixapis.dashboards.v1.ast.widgets\x1a8com/coralogixapis/dashboards/v1/ast/filters/filter.proto\x1aGcom/coralogixapis/dashboards/v1/ast/widgets/common/data_mode_type.proto\x1aLcom/coralogixapis/dashboards/v1/ast/widgets/common/interval_resolution.proto\x1a?com/coralogixapis/dashboards/v1/ast/widgets/common/legend.proto\x1aRcom/coralogixapis/dashboards/v1/ast/widgets/common/metrics_query_editor_mode.proto\x1a>com/coralogixapis/dashboards/v1/ast/widgets/common/scale.proto\x1a>com/coralogixapis/dashboards/v1/ast/widgets/common/units.proto\x1a=com/coralogixapis/dashboards/v1/common/logs_aggregation.proto\x1aFcom/coralogixapis/dashboards/v1/common/metrics_series_limit_type.proto\x1a>com/coralogixapis/dashboards/v1/common/observation_field.proto\x1a2com/coralogixapis/dashboards/v1/common/query.proto\x1a7com/coralogixapis/dashboards/v1/common/span_field.proto\x1a>com/coralogixapis/dashboards/v1/common/spans_aggregation.proto\x1a7com/coralogixapis/dashboards/v1/common/time_frame.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\xa7>\n" +
	"\tLineChart\x12q\n" +
	...
	"\rconnect_nulls\x18\n" +
	" \x01(\v2\x1a.google.protobuf.BoolValueB\x82\x01\x9aA\x7f2vWhether the line should remain connected instead of producing scattered points when null values are present in betweenJ\x05falseR\fconnectNulls\x1a\xf6\x14\n" +
	...
	"\fcolor_scheme\x18\t \x01(\v2\x1c.google.protobuf.StringValueB^\x9aA[2AApplied color scheme for this query, one of the predefined valuesJ\x16{ \"value\": \"classic\" }R\vcolorScheme\x12\xbf\x01\n" +
	"\n" +
	"resolution\x18\n" +
	" \x01(\v2A.com.coralogixapis.dashboards.v1.ast.widgets.LineChart.ResolutionB\\\x9aAW2UResolution settings of the query values (deprecated, use interval_resolution instead)\x18\x01R\n" +
	...
	"\x11decimal_precision\x18\x11 \x01(\v2\x1a.google.protobuf.BoolValueB@\x9aA=24Whether to render numeric value without abbreviationJ\x05falseR\x10decimalPrecision\x12\xd8\x01\n" +
	"\x13interval_resolution\x18\x12 \x01(\v2F.com.coralogixapis.dashboards.v1.ast.widgets.common.IntervalResolutionB_\x9aA\\2ZInterval resolution settings for time bucket calculations, supporting auto or manual modesR\x12intervalResolution:]\x9aAZ\n" +
	...
	"\n" +
	"time_frame\x18\x03 \x01(\v27.com.coralogixapis.dashboards.v1.common.TimeFrameSelectBG\x9aAD2BSpecifies the time period for which the records should be returnedR\ttimeFrame\x1a\xa1\x03\n" +
	"\n" +
	"Resolution\x12\x93\x01\n" +
	...
	"\x11buckets_presented\x18\x02 \x01(\v2\x1b.google.protobuf.Int32ValueBG\x9aAD2BHow many buckets to present in the selected timeframe (deprecated)R\x10bucketsPresented:i\x9aAd\n" +
	"b*\n" +
	"Resolution2TResolution settings for query values. (deprecated, use interval_resolution instead).\x18\x01\"Z\n" +
...
var file_com_coralogixapis_dashboards_v1_ast_widgets_line_chart_proto_goTypes = []any{
	...
	(*common.IntervalResolution)(nil),    // 20: com.coralogixapis.dashboards.v1.ast.widgets.common.IntervalResolution
	...
	(*common1.PromQlQuery)(nil),          // 26: com.coralogixapis.dashboards.v1.common.PromQlQuery
	(*filters.Filter_MetricsFilter)(nil), // 27: com.coralogixapis.dashboards.v1.ast.filters.Filter.MetricsFilter
	(common.MetricsQueryEditorMode)(0),   // 28: com.coralogixapis.dashboards.v1.ast.widgets.common.MetricsQueryEditorMode
	(common1.MetricsSeriesLimitType)(0),  // 29: com.coralogixapis.dashboards.v1.common.MetricsSeriesLimitType
	(*common1.SpanField)(nil),            // 30: com.coralogixapis.dashboards.v1.common.SpanField
	(*common1.SpansAggregation)(nil),     // 31: com.coralogixapis.dashboards.v1.common.SpansAggregation
	(*filters.Filter_SpansFilter)(nil),   // 32: com.coralogixapis.dashboards.v1.ast.filters.Filter.SpansFilter
	(*common1.SpanObservationField)(nil), // 33: com.coralogixapis.dashboards.v1.common.SpanObservationField
...
var file_com_coralogixapis_dashboards_v1_ast_widgets_line_chart_proto_depIdxs = []int32{
	...
	20, // 22: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.QueryDefinition.interval_resolution:type_name -> com.coralogixapis.dashboards.v1.ast.widgets.common.IntervalResolution
	6,  // 23: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.Query.logs:type_name -> com.coralogixapis.dashboards.v1.ast.widgets.LineChart.LogsQuery
	7,  // 24: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.Query.metrics:type_name -> com.coralogixapis.dashboards.v1.ast.widgets.LineChart.MetricsQuery
	8,  // 25: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.Query.spans:type_name -> com.coralogixapis.dashboards.v1.ast.widgets.LineChart.SpansQuery
	9,  // 26: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.Query.dataprime:type_name -> com.coralogixapis.dashboards.v1.ast.widgets.LineChart.DataprimeQuery
	12, // 27: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.Tooltip.show_labels:type_name -> google.protobuf.BoolValue
	0,  // 28: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.Tooltip.type:type_name -> com.coralogixapis.dashboards.v1.ast.widgets.LineChart.TooltipType
	21, // 29: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.LogsQuery.lucene_query:type_name -> com.coralogixapis.dashboards.v1.common.LuceneQuery
	13, // 30: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.LogsQuery.group_by:type_name -> google.protobuf.StringValue
	22, // 31: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.LogsQuery.aggregations:type_name -> com.coralogixapis.dashboards.v1.common.LogsAggregation
	23, // 32: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.LogsQuery.filters:type_name -> com.coralogixapis.dashboards.v1.ast.filters.Filter.LogsFilter
	24, // 33: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.LogsQuery.group_bys:type_name -> com.coralogixapis.dashboards.v1.common.ObservationField
	25, // 34: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.LogsQuery.time_frame:type_name -> com.coralogixapis.dashboards.v1.common.TimeFrameSelect
	26, // 35: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.MetricsQuery.promql_query:type_name -> com.coralogixapis.dashboards.v1.common.PromQlQuery
	27, // 36: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.MetricsQuery.filters:type_name -> com.coralogixapis.dashboards.v1.ast.filters.Filter.MetricsFilter
	28, // 37: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.MetricsQuery.editor_mode:type_name -> com.coralogixapis.dashboards.v1.ast.widgets.common.MetricsQueryEditorMode
	25, // 38: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.MetricsQuery.time_frame:type_name -> com.coralogixapis.dashboards.v1.common.TimeFrameSelect
	29, // 39: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.MetricsQuery.series_limit_type:type_name -> com.coralogixapis.dashboards.v1.common.MetricsSeriesLimitType
	21, // 40: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.SpansQuery.lucene_query:type_name -> com.coralogixapis.dashboards.v1.common.LuceneQuery
	30, // 41: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.SpansQuery.group_by:type_name -> com.coralogixapis.dashboards.v1.common.SpanField
	31, // 42: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.SpansQuery.aggregations:type_name -> com.coralogixapis.dashboards.v1.common.SpansAggregation
	32, // 43: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.SpansQuery.filters:type_name -> com.coralogixapis.dashboards.v1.ast.filters.Filter.SpansFilter
	25, // 44: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.SpansQuery.time_frame:type_name -> com.coralogixapis.dashboards.v1.common.TimeFrameSelect
	33, // 45: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.SpansQuery.group_bys:type_name -> com.coralogixapis.dashboards.v1.common.SpanObservationField
	34, // 46: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.DataprimeQuery.dataprime_query:type_name -> com.coralogixapis.dashboards.v1.common.DataprimeQuery
	35, // 47: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.DataprimeQuery.filters:type_name -> com.coralogixapis.dashboards.v1.ast.filters.Filter.Source
	25, // 48: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.DataprimeQuery.time_frame:type_name -> com.coralogixapis.dashboards.v1.common.TimeFrameSelect
	36, // 49: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.Resolution.interval:type_name -> google.protobuf.Duration
	18, // 50: com.coralogixapis.dashboards.v1.ast.widgets.LineChart.Resolution.buckets_presented:type_name -> google.protobuf.Int32Value
