...
import (
	...
	common1 "coralogix-management-sdk/go/internal/coralogixapis/dashboards/v1/ast/widgets/common"
...
func (x *DataTable_LogsQuery) GetFilters() []*ast.Filter_LogsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *DataTable_SpansQuery) GetFilters() []*ast.Filter_SpansFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *DataTable_MetricsQuery) GetFilters() []*ast.Filter_MetricsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *DataTable_DataprimeQuery) GetFilters() []*ast.Filter_Source {
	if x != nil {
		return x.Filters
	}
	return nil
...
var file_com_coralogixapis_dashboards_v1_ast_widgets_data_table_proto_goTypes = []interface{}{
	...
	(*ast.Filter_LogsFilter)(nil),            // 16: com.coralogixapis.dashboards.v1.ast.Filter.LogsFilter
	(*ast.Filter_SpansFilter)(nil),           // 17: com.coralogixapis.dashboards.v1.ast.Filter.SpansFilter
	(*common1.PromQlQuery)(nil),              // 18: com.coralogixapis.dashboards.v1.ast.widgets.common.PromQlQuery
	(*ast.Filter_MetricsFilter)(nil),         // 19: com.coralogixapis.dashboards.v1.ast.Filter.MetricsFilter
	(*common.DataprimeQuery)(nil),            // 20: com.coralogixapis.dashboards.v1.common.DataprimeQuery
	(*ast.Filter_Source)(nil),                // 21: com.coralogixapis.dashboards.v1.ast.Filter.Source
	(*wrapperspb.StringValue)(nil),           // 22: google.protobuf.StringValue
	(*common.ObservationField)(nil),          // 23: com.coralogixapis.dashboards.v1.common.ObservationField
	(*wrapperspb.BoolValue)(nil),             // 24: google.protobuf.BoolValue
	(*common.LogsAggregation)(nil),           // 25: com.coralogixapis.dashboards.v1.common.LogsAggregation
