...
func (x *Gauge_MetricsQuery) GetFilters() []*ast.Filter_MetricsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *Gauge_LogsQuery) GetFilters() []*ast.Filter_LogsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *Gauge_SpansQuery) GetFilters() []*ast.Filter_SpansFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *Gauge_DataprimeQuery) GetFilters() []*ast.Filter_Source {
	if x != nil {
		return x.Filters
	}
	return nil
...
var file_com_coralogixapis_dashboards_v1_ast_widgets_gauge_proto_goTypes = []interface{}{
	...
	(*common.PromQlQuery)(nil),       // 13: com.coralogixapis.dashboards.v1.ast.widgets.common.PromQlQuery
	(*ast.Filter_MetricsFilter)(nil), // 14: com.coralogixapis.dashboards.v1.ast.Filter.MetricsFilter
	...
	(*common1.DataprimeQuery)(nil),   // 20: com.coralogixapis.dashboards.v1.common.DataprimeQuery
