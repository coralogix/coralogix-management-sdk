...
type Legend struct {
	...
	SeriesVisibility *SeriesVisibility      `protobuf:"bytes,5,opt,name=series_visibility,json=seriesVisibility,proto3" json:"series_visibility,omitempty"`
...
func (x *Legend) GetSeriesVisibility() *SeriesVisibility {
	if x != nil {
		return x.SeriesVisibility
	}
	return nil
}
...
const file_com_coralogixapis_dashboards_v1_ast_widgets_common_legend_proto_rawDesc = "" +
	"\n" +
	"?com/coralogixapis/dashboards/v1/ast/widgets/common/legend.proto\x122com.coralogixapis.dashboards.v1.ast.widgets.common\x1aJcom/coralogixapis/dashboards/v1/ast/widgets/common/series_visibility.proto\x1a\x1bgoogle/api/visibility.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\xec\t\n" +
	"\x06Legend\x12c\n" +
	"\n" +
	...
	"\tplacement\x18\x04 \x01(\x0e2J.com.coralogixapis.dashboards.v1.ast.widgets.common.Legend.LegendPlacementB)\x9aA&2$Location of the legend in the widgetR\tplacement\x12\xa1\x02\n" +
	"\x11series_visibility\x18\x05 \x01(\v2D.com.coralogixapis.dashboards.v1.ast.widgets.common.SeriesVisibilityB\xad\x01\x9aA\x99\x012\x96\x01Configuration for specifying which query or annotation series should be visible on the widget, by default all annotations and query series are visible\xfa\xd2\xe4\x93\x02\n" +
	"\x12\bINTERNALR\x10seriesVisibility\"\xd9\x01\n" +
...
var file_com_coralogixapis_dashboards_v1_ast_widgets_common_legend_proto_depIdxs = []int32{
	...
	5, // 4: com.coralogixapis.dashboards.v1.ast.widgets.common.Legend.series_visibility:type_name -> com.coralogixapis.dashboards.v1.ast.widgets.common.SeriesVisibility
...
func file_com_coralogixapis_dashboards_v1_ast_widgets_common_legend_proto_init() {
	...
	file_com_coralogixapis_dashboards_v1_ast_widgets_common_series_visibility_proto_init()
	type x struct{}
