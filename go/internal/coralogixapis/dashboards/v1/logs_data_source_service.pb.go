...
func file_com_coralogixapis_dashboards_v1_services_logs_data_source_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_com_coralogixapis_dashboards_v1_services_logs_data_source_service_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_dashboards_v1_services_logs_data_source_service_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_coralogixapis_dashboards_v1_services_logs_data_source_service_proto_msgTypes[19].OneofWrappers = []interface{}{
