...
var file_com_coralogixapis_aaa_organisations_v2_types_proto_rawDesc = []byte{
	...
	0x45, 0x5f, 0x54, 0x52, 0x49, 0x41, 0x4c, 0x10, 0x03, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
func file_com_coralogixapis_aaa_organisations_v2_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_aaa_organisations_v2_types_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Team); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogixapis_aaa_organisations_v2_types_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_aaa_organisations_v2_types_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*TeamId); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogixapis_aaa_organisations_v2_types_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_aaa_organisations_v2_types_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*UserId); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogixapis_aaa_organisations_v2_types_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_aaa_organisations_v2_types_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogixapis_aaa_organisations_v2_types_proto_msgTypes[7].Exporter = func(v any, i int) any {
