...
const file_com_coralogixapis_aaa_organisations_v2_types_proto_rawDesc = "" +
	"\n" +
	"2com/coralogixapis/aaa/organisations/v2/types.proto\x12&com.coralogixapis.aaa.organisations.v2\"\xdb\x02\n" +
	"\x04Team\x12>\n" +
	"\x02id\x18\x01 \x01(\v2..com.coralogixapis.aaa.organisations.v2.TeamIdR\x02id\x12\x1d\n" +
	"\n" +
	"cluster_id\x18\x02 \x01(\tR\tclusterId\x12\x19\n" +
	"\x05quota\x18\x03 \x01(\x02H\x00R\x05quota\x88\x01\x01\x12!\n" +
	"\tretention\x18\x04 \x01(\x05H\x01R\tretention\x88\x01\x01\x12R\n" +
	"\tplan_type\x18\x05 \x01(\x0e20.com.coralogixapis.aaa.organisations.v2.PlanTypeH\x02R\bplanType\x88\x01\x01\x12(\n" +
	"\x10is_auditing_team\x18\x06 \x01(\bR\x0eisAuditingTeam\x12\x12\n" +
	...
	"_plan_type\"\xd8\x01\n" +
	"\bTeamInfo\x12>\n" +
	"\x02id\x18\x01 \x01(\v2..com.coralogixapis.aaa.organisations.v2.TeamIdR\x02id\x12_\n" +
	"\x0forganisation_id\x18\x02 \x01(\v26.com.coralogixapis.aaa.organisations.v2.OrganisationIdR\x0eorganisationId\x12+\n" +
	"\x11organisation_name\x18\x03 \x01(\tR\x10organisationName\"\x18\n" +
	"\x06TeamId\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\" \n" +
	"\x0eOrganisationId\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"\x18\n" +
	"\x06UserId\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"\x1f\n" +
	"\rUserAccountId\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\"\xbd\x01\n" +
	"\x04User\x12\x1d\n" +
	"\n" +
	"first_name\x18\x01 \x01(\tR\tfirstName\x12\x1b\n" +
	"\tlast_name\x18\x02 \x01(\tR\blastName\x12\x1a\n" +
	"\busername\x18\x03 \x01(\tR\busername\x12]\n" +
	"\x0fuser_account_id\x18\x04 \x01(\v25.com.coralogixapis.aaa.organisations.v2.UserAccountIdR\ruserAccountId\"\x80\x01\n" +
	"\tTeamCount\x12G\n" +
	"\ateam_id\x18\x01 \x01(\v2..com.coralogixapis.aaa.organisations.v2.TeamIdR\x06teamId\x12*\n" +
	"\x11team_member_count\x18\x02 \x01(\rR\x0fteamMemberCount*h\n" +
	"\bPlanType\x12\x19\n" +
	"\x15PLAN_TYPE_UNSPECIFIED\x10\x00\x12\x18\n" +
	"\x14PLAN_TYPE_POST_TRIAL\x10\x01\x12\x12\n" +
	"\x0ePLAN_TYPE_PLAN\x10\x02\x12\x13\n" +
	"\x0fPLAN_TYPE_TRIAL\x10\x03b\x06proto3"
...
func file_com_coralogixapis_aaa_organisations_v2_types_proto_init() {
	...
	file_com_coralogixapis_aaa_organisations_v2_types_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
