...
func file_com_coralogixapis_aaa_organisations_v2_team_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_com_coralogixapis_aaa_organisations_v2_team_service_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_aaa_organisations_v2_team_service_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_aaa_organisations_v2_team_service_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_coralogixapis_aaa_organisations_v2_team_service_proto_msgTypes[8].OneofWrappers = []interface{}{}
	type x struct{}
