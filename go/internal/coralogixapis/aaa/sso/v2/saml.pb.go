...
const file_com_coralogixapis_aaa_sso_v2_saml_proto_rawDesc = "" +
	"\n" +
	"'com/coralogixapis/aaa/sso/v2/saml.proto\x12\x1ccom.coralogixapis.aaa.sso.v2\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\xb4\x02\n" +
	"\x16GetSPParametersRequest\x12%\n" +
	"\ateam_id\x18\x01 \x01(\rB\f\x9aA\tJ\a1234567R\x06teamId:\xf2\x01\x9aA\xee\x01\n" +
	"n*\x19Get SP Parameters Request2QThis data structure is used to retrieve the parameters of a SAML service provider*|\n" +
	"\x1fFind out more about enrichments\x12Yhttps://coralogix.com/docs/user-guides/data-transformation/enrichments/custom-enrichment/\"\xcf\x04\n" +
	"\fSPParameters\x12\\\n" +
	...
	"\abinding\x18\x05 \x01(\tB\x0e\x9aA\vJ\t\"binding\"R\abinding:\xeb\x01\x9aA\xe7\x01\n" +
	"g*\x1bService Provider Parameters2HThis data structure represents the parameters of a SAML service provider*|\n" +
	"\x1fFind out more about enrichments\x12Yhttps://coralogix.com/docs/user-guides/data-transformation/enrichments/custom-enrichment/\"\xf3\x02\n" +
	"\x17GetSPParametersResponse\x12B\n" +
	"\x06params\x18\x01 \x01(\v2*.com.coralogixapis.aaa.sso.v2.SPParametersR\x06params:\x93\x02\x9aA\x8f\x02\n" +
	"\x8e\x01*\x1aGet SP Parameters Response2pThis data structure is obtained as a response to a request to retrieve the parameters of a SAML service provider*|\n" +
	"\x1fFind out more about enrichments\x12Yhttps://coralogix.com/docs/user-guides/data-transformation/enrichments/custom-enrichment/\"\xc4\x04\n" +
	"\rIDPParameters\x12!\n" +
	...
	"\x0eteam_entity_id\x18\x05 \x01(\rB\f\x9aA\tJ\a1234567H\x01R\fteamEntityId\x88\x01\x01\x12.\n" +
	"\vgroup_names\x18\x06 \x03(\tB\r\x9aA\n" +
	"J\b\"group1\"R\n" +
	"groupNames:\xdf\x01\x9aA\xdb\x01\n" +
	"[*\x0eIDP Parameters2IThis data structure represents a set of SAML identity provider parameters*|\n" +
	...
	"\n" +
	"\bmetadataB\x11\n" +
	"\x0f_team_entity_id\"\xe9\x02\n" +
	"\x17SetIDPParametersRequest\x12\x17\n" +
	"\ateam_id\x18\x01 \x01(\rR\x06teamId\x12C\n" +
	"\x06params\x18\x02 \x01(\v2+.com.coralogixapis.aaa.sso.v2.IDPParametersR\x06params:\xef\x01\x9aA\xeb\x01\n" +
	"k*\x1aSet IDP Parameters Request2MThis data structure is used to set the parameters of a SAML identity provider*|\n" +
	...
	"\x18SetIDPParametersResponse\"\xb3\x02\n" +
	"\x10SetActiveRequest\x12\x17\n" +
	"\ateam_id\x18\x01 \x01(\rR\x06teamId\x12\x1b\n" +
	"\tis_active\x18\x02 \x01(\bR\bisActive:\xe8\x01\x9aA\xe4\x01\n" +
	"d*\x12Set Active Request2NThis data structure is used to activate or deactivate a SAML identity provider*|\n" +
	...
	"\x11SetActiveResponse\"\xc1\x02\n" +
	"\x17GetConfigurationRequest\x12\x17\n" +
	"\ateam_id\x18\x01 \x01(\rR\x06teamId:\x8c\x02\x9aA\x88\x02\n" +
	"\x87\x01*\x19Get Configuration Request2jThis data structure is used to retrieve the configuration of a SAML service provider and identity provider*|\n" +
	"\x1fFind out more about enrichments\x12Yhttps://coralogix.com/docs/user-guides/data-transformation/enrichments/custom-enrichment/\"\xb7\x05\n" +
	...
	"\x04icon\x18\x02 \x01(\tR\x04icon:\xad\x02\x9aA\xa9\x02\n" +
	"\xa8\x01*\x1aGet Configuration Response2\x89\x01This data structure is obtained as a response to a request to retrieve the configuration of a SAML service provider and identity provider*|\n" +
