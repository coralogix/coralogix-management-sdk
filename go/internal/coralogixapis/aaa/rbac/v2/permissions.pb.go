...
type Permission struct {
	...
	DeprecatedExpressions []string               `protobuf:"bytes,5,rep,name=deprecated_expressions,json=deprecatedExpressions,proto3" json:"deprecated_expressions,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *Permission) GetDeprecatedExpressions() []string {
	if x != nil {
		return x.DeprecatedExpressions
	}
	return nil
}
...
const file_com_coralogixapis_aaa_rbac_v2_permissions_proto_rawDesc = "" +
	...
	"\x19ListAllPermissionsRequest\"\x92\x02\n" +
	"\n" +
	"Permission\x12#\n" +
	"\n" +
	...
	"\vexplanation\x18\x04 \x01(\tH\x03R\vexplanation\x88\x01\x01\x125\n" +
	"\x16deprecated_expressions\x18\x05 \x03(\tR\x15deprecatedExpressionsB\r\n" +
	"\v_expressionB\x0e\n" +
	"\f_descriptionB\v\n" +
	"\t_doc_linkB\x0e\n" +
	"\f_explanation\"i\n" +
...
func file_com_coralogixapis_aaa_rbac_v2_permissions_proto_init() {
	...
	// Optional fields for Permission generate synthetic oneofs.
