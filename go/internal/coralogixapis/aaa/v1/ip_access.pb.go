...
const file_com_coralogixapis_aaa_v1_ip_access_proto_rawDesc = "" +
	"\n" +
	"(com/coralogixapis/aaa/v1/ip_access.proto\x12\x18com.coralogixapis.aaa.v1\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\xd0\x03\n" +
	"\bIpAccess\x12K\n" +
	...
	"\aenabled\x18\x03 \x01(\bB3\x9aA02(Whether this IP access entry is enabled.J\x04trueR\aenabled:\xd5\x01\x9aA\xd1\x01\n" +
	"1*\tIP Access2$Represents a single IP access entry.*\x9b\x01\n" +
