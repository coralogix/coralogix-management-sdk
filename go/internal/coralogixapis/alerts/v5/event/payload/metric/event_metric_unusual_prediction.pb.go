...
func file_com_coralogixapis_alerts_v5_event_payload_metric_event_metric_unusual_prediction_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v5_event_payload_metric_event_metric_unusual_prediction_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_alerts_v5_event_payload_metric_event_metric_unusual_prediction_proto_msgTypes[1].Exporter = func(v any, i int) any {
