...
type EventMetricUnusualPayload struct {
	...
	RatioUnusualSamples *wrappers.DoubleValue  `protobuf:"bytes,7,opt,name=ratio_unusual_samples,json=ratioUnusualSamples,proto3" json:"ratio_unusual_samples,omitempty"`
}
...
func (x *EventMetricUnusualPayload) GetFromTimestamp() *timestamp.Timestamp {
	if x != nil {
...
func (x *EventMetricUnusualPayload) GetToTimestamp() *timestamp.Timestamp {
	if x != nil {
...
func (x *EventMetricUnusualPayload) GetForecastTimestamp() *wrappers.UInt64Value {
	if x != nil {
...
func (x *EventMetricUnusualPayload) GetDistance() *wrappers.DoubleValue {
	if x != nil {
		return x.Distance
	}
	return nil
...
func (x *EventMetricUnusualPayload) GetRatioUnusualSamples() *wrappers.DoubleValue {
	if x != nil {
...
func (x *TimeRangeWithInterval) GetFromTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.FromTimestamp
	}
	return nil
...
func (x *TimeRangeWithInterval) GetToTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.ToTimestamp
	}
	return nil
...
type NamedInterval struct {
	...
	DurationMs *wrappers.Int64Value  `protobuf:"bytes,2,opt,name=duration_ms,json=durationMs,proto3" json:"duration_ms,omitempty"`
}
...
func (x *NamedInterval) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *NamedInterval) GetDurationMs() *wrappers.Int64Value {
	if x != nil {
		return x.DurationMs
	}
	return nil
...
type ExtremeSample struct {
	...
	LowerLimit *wrappers.DoubleValue `protobuf:"bytes,2,opt,name=lower_limit,json=lowerLimit,proto3" json:"lower_limit,omitempty"`
	UpperLimit *wrappers.DoubleValue `protobuf:"bytes,3,opt,name=upper_limit,json=upperLimit,proto3" json:"upper_limit,omitempty"`
...
func (x *ExtremeSample) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *ExtremeSample) GetLowerLimit() *wrappers.DoubleValue {
	if x != nil {
		return x.LowerLimit
	}
	return nil
...
func (x *ExtremeSample) GetUpperLimit() *wrappers.DoubleValue {
	if x != nil {
		return x.UpperLimit
	}
	return nil
...
func (x *ExtremeSample) GetValue() *wrappers.DoubleValue {
	if x != nil {
		return x.Value
	}
	return nil
