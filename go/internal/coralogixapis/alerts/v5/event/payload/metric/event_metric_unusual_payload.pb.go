...
var file_com_coralogixapis_alerts_v5_event_payload_metric_event_metric_unusual_payload_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_alerts_v5_event_payload_metric_event_metric_unusual_payload_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v5_event_payload_metric_event_metric_unusual_payload_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EventMetricUnusualPayload); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_alerts_v5_event_payload_metric_event_metric_unusual_payload_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TimeRangeWithInterval); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_alerts_v5_event_payload_metric_event_metric_unusual_payload_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NamedInterval); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_alerts_v5_event_payload_metric_event_metric_unusual_payload_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExtremeSample); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
