...
var file_com_coralogixapis_alerts_v5_event_payload_standard_event_standard_unusual_payload_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_alerts_v5_event_payload_standard_event_standard_unusual_payload_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v5_event_payload_standard_event_standard_unusual_payload_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
