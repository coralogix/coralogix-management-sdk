...
const file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_more_than_usual_enriched_proto_rawDesc = "" +
	"\n" +
	"\\com/coralogixapis/alerts/v4/event/payload/metric/event_metric_more_than_usual_enriched.proto\x12\x1bcom.coralogixapis.alerts.v4\x1aScom/coralogixapis/alerts/v4/event/payload/metric/event_metric_more_than_usual.proto\x1aVcom/coralogixapis/alerts/v4/event/payload/metric/event_metric_unusual_prediction.proto\"\xe2\x01\n" +
	" EventMetricMoreThanUsualEnriched\x12u\n" +
	"\x1cevent_metric_more_than_usual\x18\x01 \x01(\v25.com.coralogixapis.alerts.v4.EventMetricMoreThanUsualR\x18eventMetricMoreThanUsual\x12G\n" +
	"\n" +
...
var (
	...
	file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_more_than_usual_enriched_proto_rawDescData []byte
)
...
func file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_more_than_usual_enriched_proto_rawDescGZIP() []byte {
	file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_more_than_usual_enriched_proto_rawDescOnce.Do(func() {
		file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_more_than_usual_enriched_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_more_than_usual_enriched_proto_rawDesc), len(file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_more_than_usual_enriched_proto_rawDesc)))
	})
...
var file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_more_than_usual_enriched_proto_goTypes = []any{
...
func file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_more_than_usual_enriched_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_more_than_usual_enriched_proto_rawDesc), len(file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_more_than_usual_enriched_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
