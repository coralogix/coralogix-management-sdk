...
var file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_enriched_proto_rawDesc = []byte{
	...
	0x34, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x4c, 0x65, 0x73,
...
var (
	...
	file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_enriched_proto_rawDescData = file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_enriched_proto_rawDesc
)
...
func file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_enriched_proto_rawDescGZIP() []byte {
	file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_enriched_proto_rawDescOnce.Do(func() {
		file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_enriched_proto_rawDescData = protoimpl.X.CompressGZIP(file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_enriched_proto_rawDescData)
	})
...
var file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_enriched_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_enriched_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_enriched_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_enriched_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_enriched_proto_rawDesc = nil
