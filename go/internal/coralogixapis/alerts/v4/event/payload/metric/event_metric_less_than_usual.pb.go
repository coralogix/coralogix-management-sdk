...
const file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_proto_rawDesc = "" +
	"\n" +
	"Scom/coralogixapis/alerts/v4/event/payload/metric/event_metric_less_than_usual.proto\x12\x1bcom.coralogixapis.alerts.v4\x1aLcom/coralogixapis/alerts/v4/event/payload/metric/event_unusual_payload.proto\"t\n" +
	"\x18EventMetricLessThanUsual\x12X\n" +
	"\x0fless_than_usual\x18\x01 \x01(\v20.com.coralogixapis.alerts.v4.EventUnusualPayloadR\rlessThanUsualb\x06proto3"

var (
	file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_proto_rawDescOnce sync.Once
	file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_proto_rawDescData []byte
)
...
func file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_proto_rawDescGZIP() []byte {
	file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_proto_rawDescOnce.Do(func() {
		file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_proto_rawDesc), len(file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_proto_rawDesc)))
	})
...
func file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_proto_rawDesc), len(file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
