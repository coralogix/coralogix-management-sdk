...
var file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v4_event_payload_metric_event_metric_less_than_usual_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
