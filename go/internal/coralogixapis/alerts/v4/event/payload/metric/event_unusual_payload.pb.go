...
func file_com_coralogixapis_alerts_v4_event_payload_metric_event_unusual_payload_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v4_event_payload_metric_event_unusual_payload_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_alerts_v4_event_payload_metric_event_unusual_payload_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_alerts_v4_event_payload_metric_event_unusual_payload_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_alerts_v4_event_payload_metric_event_unusual_payload_proto_msgTypes[3].Exporter = func(v any, i int) any {
