...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_metric_common_metrics_filter_proto_rawDesc = "" +
	"\n" +
	"Xcom/coralogixapis/alerts/v3/alert_def_type_definition/metric/common/metrics_filter.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a\x1egoogle/protobuf/wrappers.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\xcf\x01\n" +
	"\fMetricFilter\x12\x88\x01\n" +
	"\x06promql\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueBP\x9aAM2\x1bA PromQL filter for metricsJ%\"avg_over_time(metric_name[5m]) > 10\"\xa2\x02\x06promqlH\x00R\x06promql:,\x9aA)\n" +
	"'*%Metric filter configuration in alertsB\x06\n" +
	"\x04typeb\x06proto3"
