...
const file_com_coralogixapis_alerts_v3_commons_proto_rawDesc = "" +
	"\n" +
	")com/coralogixapis/alerts/v3/commons.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a google/protobuf/descriptor.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\x91\x02\n" +
	"\fTimeDuration\x12U\n" +
	"\bduration\x18\x01 \x01(\v2\x1c.google.protobuf.UInt64ValueB\x1b\x9aA\x182\x12The duration valueJ\x0260R\bduration\x12s\n" +
	"\x04unit\x18\x02 \x01(\x0e2).com.coralogixapis.alerts.v3.DurationUnitB4\x9aA12\x18The unit of the durationJ\x15\"DURATION_UNIT_HOURS\"R\x04unit:5\x9aA2\n" +
	"0*\rTime duration2\x1fConfiguration for time duration\"\x98\x01\n" +
	"\vOrderByList\x12W\n" +
	"\torder_bys\x18\x01 \x03(\v2$.com.coralogixapis.alerts.v3.OrderByB\x14\x9aA\x112\x0fOrder by fieldsR\borderBys:0\x9aA-\n" +
	"+*\rOrder by list2\x1aList of fields to order by\"\x8b\x03\n" +
	...
	"\tdirection\x18\x02 \x01(\x0e2-.com.coralogixapis.alerts.v3.OrderByDirectionBD\x9aAA2\x16Direction for orderingJ'\"ORDER_BY_DIRECTION_ASC_OR_UNSPECIFIED\"R\tdirection:c\x9aA`\n" +
	"^*\bOrder by2RA data structure that specifies the field and direction for ordering query results*Z\n" +
	"\bNotifyOn\x12(\n" +
