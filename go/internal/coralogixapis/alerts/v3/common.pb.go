...
type CoralogixLogMetadata struct {
	...
	Severity        *wrappers.StringValue `protobuf:"bytes,3,opt,name=severity,proto3" json:"severity,omitempty"`
}
...
func (x *CoralogixLogMetadata) GetApplicationName() *wrappers.StringValue {
	if x != nil {
...
func (x *CoralogixLogMetadata) GetSubsystemName() *wrappers.StringValue {
	if x != nil {
...
func (x *CoralogixLogMetadata) GetSeverity() *wrappers.StringValue {
	if x != nil {
		return x.Severity
	}
	return nil
