...
const file_com_coralogixapis_alerts_v3_alert_def_priority_proto_rawDesc = "" +
	"\n" +
	"4com/coralogixapis/alerts/v3/alert_def_priority.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a google/protobuf/descriptor.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\xc1\x02\n" +
	...
	"\x04name\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueB*\x9aA'2%String representation of the priorityR\x04name:M\x9aAJ\n" +
	"H*\x19Alert definition priority2+Defines the priority of an alert definition*\xa8\x01\n" +
