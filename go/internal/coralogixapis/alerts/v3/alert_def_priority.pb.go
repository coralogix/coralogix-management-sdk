...
const file_com_coralogixapis_alerts_v3_alert_def_priority_proto_rawDesc = "" +
	"\n" +
	"4com/coralogixapis/alerts/v3/alert_def_priority.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a google/protobuf/descriptor.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\x81\x01\n" +
	"\bPriority\x12C\n" +
	"\x05value\x18\x01 \x01(\x0e2-.com.coralogixapis.alerts.v3.AlertDefPriorityR\x05value\x120\n" +
	"\x04name\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x04name*\xa8\x01\n" +
