...
var file_com_coralogixapis_alerts_v3_event_payload_flow_event_flow_match_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_alerts_v3_event_payload_flow_event_flow_match_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v3_event_payload_flow_event_flow_match_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EventFlowMatch); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_alerts_v3_event_payload_flow_event_flow_match_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FlowGroupEvents); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_alerts_v3_event_payload_flow_event_flow_match_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AlertEventOut); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
