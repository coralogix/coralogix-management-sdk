...
func (x *EventFlowMatch) GetFrom() *timestamp.Timestamp {
	if x != nil {
		return x.From
	}
	return nil
...
func (x *EventFlowMatch) GetTo() *timestamp.Timestamp {
	if x != nil {
		return x.To
	}
	return nil
...
type FlowGroupEvents struct {
	...
	ResolvedAlerts []*wrappers.StringValue `protobuf:"bytes,2,rep,name=resolved_alerts,json=resolvedAlerts,proto3" json:"resolved_alerts,omitempty"`
}
...
func (x *FlowGroupEvents) GetResolvedAlerts() []*wrappers.StringValue {
	if x != nil {
...
type AlertEventOut struct {
	...
	AlertId   *wrappers.StringValue `protobuf:"bytes,2,opt,name=alert_id,json=alertId,proto3" json:"alert_id,omitempty"`
	EventId   *wrappers.StringValue `protobuf:"bytes,3,opt,name=event_id,json=eventId,proto3" json:"event_id,omitempty"`
}
...
func (x *AlertEventOut) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *AlertEventOut) GetAlertId() *wrappers.StringValue {
	if x != nil {
		return x.AlertId
	}
	return nil
...
func (x *AlertEventOut) GetEventId() *wrappers.StringValue {
	if x != nil {
		return x.EventId
	}
	return nil
