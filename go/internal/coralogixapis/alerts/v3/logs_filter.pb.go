...
type LogsSimpleFilter struct {
	...
	LuceneQuery  *wrappers.StringValue `protobuf:"bytes,1,opt,name=lucene_query,json=luceneQuery,proto3" json:"lucene_query,omitempty"`
...
func (x *LogsSimpleFilter) GetLuceneQuery() *wrappers.StringValue {
	if x != nil {
...
func (x *LabelFilterType) GetValue() *wrappers.StringValue {
	if x != nil {
		return x.Value
	}
	return nil
