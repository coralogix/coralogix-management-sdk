...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_common_logs_filter_proto_rawDesc = "" +
	"\n" +
	"Scom/coralogixapis/alerts/v3/alert_def_type_definition/logs/common/logs_filter.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a\x1egoogle/protobuf/wrappers.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xbd\x01\n" +
	"\n" +
	"LogsFilter\x12T\n" +
	"\rsimple_filter\x18\x01 \x01(\v2-.com.coralogixapis.alerts.v3.LogsSimpleFilterH\x00R\fsimpleFilter:J\x92AG\n" +
	"E*\n" +
