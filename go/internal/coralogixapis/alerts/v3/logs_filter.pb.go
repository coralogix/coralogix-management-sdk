...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_common_logs_filter_proto_rawDesc = "" +
	...
	"severities:V\x9aAS\n" +
	"Q*\rLabel filters2@Filters for application name, subsystem name, and log severities\"\xe2\x02\n" +
	...
	"\toperation\x18\x02 \x01(\x0e23.com.coralogixapis.alerts.v3.LogFilterOperationTypeBV\x9aAS2+The operation to perform on the label valueJ$\"LOG_FILTER_OPERATION_TYPE_INCLUDES\"R\toperation:;\x9aA8\n" +
	"6*\x11Label filter type2!Label filter type for log entries*\xc5\x01\n" +
