...
func (x *EventRatioMoreThan) GetSpecial() payload.SpecialRatioValues {
...
var file_com_coralogixapis_alerts_v3_event_payload_ratio_event_ratio_more_than_proto_rawDesc = []byte{
	...
	0x4d, 0x6f, 0x72, 0x65, 0x54, 0x68, 0x61, 0x6e, 0x12, 0x4b, 0x0a, 0x13, 0x6e, 0x75, 0x6d, 0x65,
...
var file_com_coralogixapis_alerts_v3_event_payload_ratio_event_ratio_more_than_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_alerts_v3_event_payload_ratio_event_ratio_more_than_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v3_event_payload_ratio_event_ratio_more_than_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EventRatioMoreThan); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_com_coralogixapis_alerts_v3_event_payload_ratio_event_ratio_more_than_proto_msgTypes[0].OneofWrappers = []interface{}{
