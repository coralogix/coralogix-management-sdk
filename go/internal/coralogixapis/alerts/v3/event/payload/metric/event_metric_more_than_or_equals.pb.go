...
var file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_or_equals_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_or_equals_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_or_equals_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_or_equals_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
