...
var file_com_coralogixapis_alerts_v3_event_alert_event_payload_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_alerts_v3_event_alert_event_payload_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v3_event_alert_event_payload_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AlertEventPayload); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
