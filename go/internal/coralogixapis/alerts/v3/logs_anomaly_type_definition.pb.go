...
func (x *LogsAnomalyType) GetNotificationPayloadFilter() []*wrappers.StringValue {
	if x != nil {
...
type LogsAnomalyCondition struct {
	...
	MinimumThreshold *wrappers.DoubleValue    `protobuf:"bytes,1,opt,name=minimum_threshold,json=minimumThreshold,proto3" json:"minimum_threshold,omitempty"`
...
func (x *LogsAnomalyCondition) GetMinimumThreshold() *wrappers.DoubleValue {
	if x != nil {
