...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_logs_anomaly_type_definition_proto_rawDesc = "" +
	"\n" +
	"]com/coralogixapis/alerts/v3/alert_def_type_definition/logs/logs_anomaly_type_definition.proto\x12\x1bcom.coralogixapis.alerts.v3\x1aYcom/coralogixapis/alerts/v3/alert_def_type_definition/common/anomaly_alert_settings.proto\x1adcom/coralogixapis/alerts/v3/alert_def_type_definition/logs/anomaly/logs_anomaly_condition_type.proto\x1aScom/coralogixapis/alerts/v3/alert_def_type_definition/logs/common/logs_filter.proto\x1aWcom/coralogixapis/alerts/v3/alert_def_type_definition/logs/common/logs_timewindow.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\xcf\a\n" +
	"\x0fLogsAnomalyType\x12H\n" +
	"\vlogs_filter\x18\x01 \x01(\v2'.com.coralogixapis.alerts.v3.LogsFilterR\n" +
	"logsFilter\x12r\n" +
	"\x05rules\x18\x02 \x03(\v2,.com.coralogixapis.alerts.v3.LogsAnomalyRuleB.\x9aA+2#The rules for the log anomaly alert\xa0\x01\x01\xa8\x01\x01R\x05rules\x12\xbb\x01\n" +
	"\x1bnotification_payload_filter\x18\x03 \x03(\v2\x1c.google.protobuf.StringValueB]\x9aAZ2IThe filter to specify which fields to include in the notification payloadJ\r[\"obj.field\"]R\x19notificationPayloadFilter\x12\xa7\x01\n" +
	...
	"\x16anomaly_alert_settings\x18\x05 \x01(\v21.com.coralogixapis.alerts.v3.AnomalyAlertSettingsB)\x9aA&2$Anomaly alert settings configurationR\x14anomalyAlertSettings:\x80\x02\x9aA\xfc\x01\n" +
	"\\*\x1cLog-based anomaly alert type2<Configuration for alerts triggered by anomalous log patterns*\x9b\x01\n" +
	"9Learn more about logs anomaly alerts in our documentation\x12^https://coralogix.com/docs/user-guides/alerting/create-an-alert/logs/anomaly-detection-alerts/\"\xd9\x01\n" +
	"\x0fLogsAnomalyRule\x12{\n" +
	"\tcondition\x18\x01 \x01(\v21.com.coralogixapis.alerts.v3.LogsAnomalyConditionB*\x9aA'2%The condition for the threshold alertR\tcondition:I\x9aAF\n" +
	"D*\x16Log-based anomaly rule2*Defines a rule for detecting log anomalies\"\xab\x04\n" +
	...
	"\x0econdition_type\x18\x03 \x01(\x0e25.com.coralogixapis.alerts.v3.LogsAnomalyConditionTypeB`\x9aA]2#The type of condition for the alertJ6\"LOGS_ANOMALY_CONDITION_TYPE_MORE_THAN_OR_UNSPECIFIED\"R\rconditionType:R\x9aAO\n" +
	"M*\x1bLog-based anomaly condition2.Defines conditions for detecting log anomaliesb\x06proto3"
