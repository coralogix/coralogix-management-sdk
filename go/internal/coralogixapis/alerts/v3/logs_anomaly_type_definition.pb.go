...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_logs_anomaly_type_definition_proto_rawDesc = "" +
	...
	"\x16anomaly_alert_settings\x18\x05 \x01(\v21.com.coralogixapis.alerts.v3.AnomalyAlertSettingsR\x14anomalyAlertSettings:r\x92Ao\n" +
	"m*\x17Logs Anomaly Alert Type2<Configuration for alerts triggered by anomalous log patterns\xd2\x01\vlogs_filter\xd2\x01\x05rules\"\xb4\x01\n" +
	"\x0fLogsAnomalyRule\x12O\n" +
	"\tcondition\x18\x01 \x01(\v21.com.coralogixapis.alerts.v3.LogsAnomalyConditionR\tcondition:P\x92AM\n" +
	"K*\x11Logs Anomaly Rule2*Defines a rule for detecting log anomalies\xd2\x01\tcondition\"\x89\x03\n" +
	...
	"timeWindow\x12\\\n" +
	"\x0econdition_type\x18\x03 \x01(\x0e25.com.coralogixapis.alerts.v3.LogsAnomalyConditionTypeR\rconditionType:o\x92Al\n" +
	"j*\x16Logs Anomaly Condition2.Defines conditions for detecting log anomalies\xd2\x01\x11minimum_threshold\xd2\x01\vtime_windowb\x06proto3"
