...
type AlertEventPayload struct {
	...
	PayloadType *wrappers.StringValue `protobuf:"bytes,2,opt,name=payload_type,json=payloadType,proto3" json:"payload_type,omitempty"`
}
...
func (x *AlertEventPayload) GetPayload() *_struct.Struct {
	if x != nil {
		return x.Payload
	}
	return nil
...
func (x *AlertEventPayload) GetPayloadType() *wrappers.StringValue {
	if x != nil {
