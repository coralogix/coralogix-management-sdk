...
const file_com_coralogixapis_alerts_v3_alert_def_scheduling_proto_rawDesc = "" +
	"\n" +
	"6com/coralogixapis/alerts/v3/alert_def_scheduling.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a.protoc-gen-openapiv3/options/annotations.proto\"\xe7\x03\n" +
	"\x10ActivitySchedule\x12\x89\x01\n" +
	"\vday_of_week\x18\x01 \x03(\x0e2&.com.coralogixapis.alerts.v3.DayOfWeekBA\x9aA>J<[\"DAY_OF_WEEK_MONDAY_OR_UNSPECIFIED\", \"DAY_OF_WEEK_TUESDAY\"]R\tdayOfWeek\x12l\n" +
	"\n" +
	"start_time\x18\x02 \x01(\v2&.com.coralogixapis.alerts.v3.TimeOfDayB%\x9aA\"2 Start time of the alert activityR\tstartTime\x12f\n" +
	"\bend_time\x18\x03 \x01(\v2&.com.coralogixapis.alerts.v3.TimeOfDayB#\x9aA 2\x1eEnd time of the alert activityR\aendTime:q\x9aAn\n" +
	"l*\x17Alert activity schedule2QDefines when an alert should be active based on days of the week and time windows\"\x91\x01\n" +
	"\tTimeOfDay\x12\x1d\n" +
	"\x05hours\x18\x01 \x01(\x05B\a\x9aA\x04J\x0214R\x05hours\x12!\n" +
	"\aminutes\x18\x02 \x01(\x05B\a\x9aA\x04J\x0230R\aminutes:B\x9aA?\n" +
	"=*\vTime of day2.Represents a specific time in a 24-hour format*\xca\x01\n" +
	"\tDayOfWeek\x12%\n" +
