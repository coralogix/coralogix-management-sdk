...
const file_com_coralogixapis_alerts_v3_alert_def_scheduling_proto_rawDesc = "" +
	"\n" +
	"6com/coralogixapis/alerts/v3/alert_def_scheduling.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a.protoc-gen-openapiv3/options/annotations.proto\"\x90\x04\n" +
	...
	"\bend_time\x18\x03 \x01(\v2&.com.coralogixapis.alerts.v3.TimeOfDayB#\x9aA 2\x1eEnd time of the alert activityR\aendTime:\x99\x01\x9aA\x95\x01\n" +
	...
	"\tTimeOfDay\x12:\n" +
	"\x05hours\x18\x01 \x01(\x05B$\x9aA!J\x0214\x8a\x01\x1a^([01][0-9]|2[0-3]|[0-9])$R\x05hours\x128\n" +
	"\aminutes\x18\x02 \x01(\x05B\x1e\x9aA\x1bJ\x0230\x8a\x01\x14^([0-5][0-9]|[0-9])$R\aminutes:T\x9aAQ\n" +
