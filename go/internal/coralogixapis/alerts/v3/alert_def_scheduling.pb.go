...
const file_com_coralogixapis_alerts_v3_alert_def_scheduling_proto_rawDesc = "" +
	"\n" +
	"6com/coralogixapis/alerts/v3/alert_def_scheduling.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xfa\x02\n" +
	...
	"\bend_time\x18\x03 \x01(\v2&.com.coralogixapis.alerts.v3.TimeOfDayR\aendTime:\x93\x01\x92A\x8f\x01\n" +
	"\x8c\x01*\x11Activity Schedule2QDefines when an alert should be active based on days of the week and time windows\xd2\x01\vday_of_week\xd2\x01\n" +
