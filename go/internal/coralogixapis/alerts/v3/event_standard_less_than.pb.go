...
type EventStandardLessThan struct {
	...
	IsDeadman     *wrappers.BoolValue  `protobuf:"bytes,4,opt,name=is_deadman,json=isDeadman,proto3" json:"is_deadman,omitempty"`
...
func (x *EventStandardLessThan) GetHitValue() *wrappers.Int64Value {
	if x != nil {
		return x.HitValue
	}
	return nil
...
func (x *EventStandardLessThan) GetFromTimestamp() *timestamp.Timestamp {
	if x != nil {
...
func (x *EventStandardLessThan) GetToTimestamp() *timestamp.Timestamp {
	if x != nil {
...
func (x *EventStandardLessThan) GetIsDeadman() *wrappers.BoolValue {
	if x != nil {
		return x.IsDeadman
	}
	return nil
