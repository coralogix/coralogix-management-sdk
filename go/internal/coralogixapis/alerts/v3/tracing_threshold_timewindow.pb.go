...
func file_com_coralogixapis_alerts_v3_alert_def_type_definition_tracing_threshold_tracing_threshold_timewindow_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v3_alert_def_type_definition_tracing_threshold_tracing_threshold_timewindow_proto_msgTypes[0].Exporter = func(v any, i int) any {
