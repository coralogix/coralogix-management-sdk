...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_new_value_logs_new_value_timewindow_proto_rawDesc = "" +
	"\n" +
	"dcom/coralogixapis/alerts/v3/alert_def_type_definition/logs/new_value/logs_new_value_timewindow.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a.protoc-gen-openapiv2/options/annotations.proto\"\x8f\x02\n" +
	"\x16LogsNewValueTimeWindow\x12\x92\x01\n" +
	")logs_new_value_time_window_specific_value\x18\x01 \x01(\x0e28.com.coralogixapis.alerts.v3.LogsNewValueTimeWindowValueH\x00R#logsNewValueTimeWindowSpecificValue:X\x92AU\n" +
	"S*\x1aLogs New Value Time Window2.Time window configuration for new value alerts\xd2\x01\x04typeB\x06\n" +
	"\x04type*\xa1\x03\n" +
