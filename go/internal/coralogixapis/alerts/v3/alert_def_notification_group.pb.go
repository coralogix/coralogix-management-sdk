...
const file_com_coralogixapis_alerts_v3_alert_def_notification_group_proto_rawDesc = "" +
	...
	"\x13retriggering_period\"\xc2\x03\n" +
	...
	"\x06router\x18\x04 \x01(\v2/.com.coralogixapis.alerts.v3.NotificationRouterH\x00R\x06router\x88\x01\x01:]\x92AZ\n" +
	"X*#Alert definition notification group\xd2\x01\rgroup_by_keys\xd2\x01\bwebhooks\xd2\x01\fdestinations\xd2\x01\x06routerB\t\n" +
	"\a_router\"\xae\x03\n" +
