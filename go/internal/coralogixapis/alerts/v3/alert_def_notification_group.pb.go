...
const file_com_coralogixapis_alerts_v3_alert_def_notification_group_proto_rawDesc = "" +
	...
	"\tnotify_on\x18\x02 \x01(\x0e2%.com.coralogixapis.alerts.v3.NotifyOnR\bnotifyOnB\x15\n" +
	"\x13retriggering_period\"\xe3\x02\n" +
	...
	"\x06router\x18\x04 \x01(\v2/.com.coralogixapis.alerts.v3.NotificationRouterH\x00R\x06router\x88\x01\x01B\t\n" +
	"\a_router\"\x9b\x02\n" +
	...
	"\vintegration\x18\x02 \x01(\v2,.com.coralogixapis.alerts.v3.IntegrationTypeR\vintegrationB\x15\n" +
	...
	"recipientsB\x12\n" +
	"\x10integration_type\"B\n" +
	"\n" +
	"Recipients\x124\n" +
	"\x06emails\x18\x01 \x03(\v2\x1c.google.protobuf.StringValueR\x06emailsb\x06proto3"
