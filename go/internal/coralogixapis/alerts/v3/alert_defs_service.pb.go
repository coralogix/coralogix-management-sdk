...
const file_com_coralogixapis_alerts_v3_alert_defs_service_proto_rawDesc = "" +
	...
	"\tdirection\x18\x02 \x01(\x0e2-.com.coralogixapis.alerts.v3.OrderByDirectionR\tdirection:`\x92A]\n" +
	"[*\bOrder By26Specifies the field and direction for ordering results\xd2\x01\n" +
	"field_name\xd2\x01\tdirection\"\xad\x01\n" +
	"\x12GetAlertDefRequest\x12>\n" +
	"\x02id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueB\x10\x92A\rJ\v\"alert-123\"R\x02id:W\x92AT\n" +
	"R*\x1cGet Alert Definition Request2-Request to retrieve an alert definition by ID\xd2\x01\x02id\"\xf3\x01\n" +
	"\x1dGetAlertDefByVersionIdRequest\x12U\n" +
	"\x10alert_version_id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueB\r\x92A\n" +
	"J\b\"v1-123\"R\x0ealertVersionId:{\x92Ax\n" +
	"v**Get Alert Definition By Version ID Request25Request to retrieve an alert definition by version ID\xd2\x01\x10alert_version_id\"\xbf\x01\n" +
	"\x13GetAlertDefResponse\x12B\n" +
	"\talert_def\x18\x01 \x01(\v2%.com.coralogixapis.alerts.v3.AlertDefR\balertDef:d\x92Aa\n" +
	"_*\x1dGet Alert Definition Response22Response containing the requested alert definition\xd2\x01\talert_def\"\xe9\x01\n" +
	"\x1eGetAlertDefByVersionIdResponse\x12B\n" +
	"\talert_def\x18\x01 \x01(\v2%.com.coralogixapis.alerts.v3.AlertDefR\balertDef:\x82\x01\x92A\x7f\n" +
	"}*+Get Alert Definition By Version ID Response2BResponse containing the alert definition for the requested version\xd2\x01\talert_def\"\xc3\x01\n" +
	"\x15ListAlertDefsResponse\x12D\n" +
	"\n" +
	"alert_defs\x18\x01 \x03(\v2%.com.coralogixapis.alerts.v3.AlertDefR\talertDefs:d\x92Aa\n" +
	"_*\x1fList Alert Definitions Response2/Response containing a list of alert definitions\xd2\x01\n" +
	"alert_defs\"n\n" +
	"\x14ListAlertDefsRequest:V\x92AS\n" +
	"Q*\x1eList Alert Definitions Request2/Request to retrieve a list of alert definitions\"X\n" +
	"\x15DownloadAlertsRequest:?\x92A<\n" +
	":*\x17Download Alerts Request2\x1fRequest to download alerts data\"\x8d\x01\n" +
	"\x16DownloadAlertsResponse\x12\x18\n" +
	"\acontent\x18\x01 \x01(\fR\acontent:Y\x92AV\n" +
	"T*\x18Download Alerts Response2.Response containing the downloaded alerts data\xd2\x01\acontent\"\xd9\x01\n" +
	"\x17BatchGetAlertDefRequest\x12O\n" +
	"\x03ids\x18\x01 \x03(\v2\x1c.google.protobuf.StringValueB\x1f\x92A\x1cJ\x1a[\"alert-123\", \"alert-456\"]R\x03ids:m\x92Aj\n" +
	"h*#Batch Get Alert Definitions Request2;Request to retrieve multiple alert definitions by their IDs\xd2\x01\x03ids\"\xdb\x03\n" +
	...
	"\x05value\x18\x02 \x01(\v2%.com.coralogixapis.alerts.v3.AlertDefR\x05value:\x028\x01:\x9e\x01\x92A\x9a\x01\n" +
	"\x97\x01*$Batch Get Alert Definitions Response2RResponse containing the requested alert definitions and any IDs that weren't found\xd2\x01\n" +
	"alert_defs\xd2\x01\rnot_found_ids\"\xb1\x01\n" +
	"\x15DeleteAlertDefRequest\x12>\n" +
	"\x02id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueB\x10\x92A\rJ\v\"alert-123\"R\x02id:X\x92AU\n" +
	"S*\x1fDelete Alert Definition Request2+Request to delete an alert definition by ID\xd2\x01\x02id\"n\n" +
	"\x16DeleteAlertDefResponse:T\x92AQ\n" +
	"O* Delete Alert Definition Response2+Response after deleting an alert definition\"\xb1\x02\n" +
	...
	"\x02id\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueB\x10\x92A\rJ\v\"alert-123\"R\x02id:t\x92Aq\n" +
	"o* Replace Alert Definition Request2/Request to replace an existing alert definition\xd2\x01\x14alert_def_properties\xd2\x01\x02id\"\xc6\x01\n" +
	"\x17ReplaceAlertDefResponse\x12B\n" +
	"\talert_def\x18\x01 \x01(\v2%.com.coralogixapis.alerts.v3.AlertDefR\balertDef:g\x92Ad\n" +
	"b*!Replace Alert Definition Response21Response containing the replaced alert definition\xd2\x01\talert_def\"\xe3\x01\n" +
	"\x15CreateAlertDefRequest\x12a\n" +
	"\x14alert_def_properties\x18\x01 \x01(\v2/.com.coralogixapis.alerts.v3.AlertDefPropertiesR\x12alertDefProperties:g\x92Ad\n" +
	"b*\x1fCreate Alert Definition Request2(Request to create a new alert definition\xd2\x01\x14alert_def_properties\"\xc9\x01\n" +
	"\x16CreateAlertDefResponse\x12B\n" +
	"\talert_def\x18\x01 \x01(\v2%.com.coralogixapis.alerts.v3.AlertDefR\balertDef:k\x92Ah\n" +
	"f* Create Alert Definition Response26Response containing the newly created alert definition\xd2\x01\talert_def\"\xec\x01\n" +
	"\x10SetActiveRequest\x12>\n" +
	"\x02id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueB\x10\x92A\rJ\v\"alert-123\"R\x02id\x12=\n" +
	"\x06active\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueB\t\x92A\x06J\x04trueR\x06active:Y\x92AV\n" +
	"T*\x12Set Active Request20Request to enable or disable an alert definition\xd2\x01\x02id\xd2\x01\x06active\"i\n" +
	...
	"\x1cORDER_BY_FIELDS_UPDATED_TIME\x10\x042\x90\f\n" +
	"\x10AlertDefsService\x12\xa7\x01\n" +
	"\vGetAlertDef\x12/.com.coralogixapis.alerts.v3.GetAlertDefRequest\x1a0.com.coralogixapis.alerts.v3.GetAlertDefResponse\"5¸\x02\x16\n" +
	"\x14get alert definition\x82\xd3\xe4\x93\x02\x15\x12\x13/v3/alert-defs/{id}\x12\xf9\x01\n" +
	"\x16GetAlertDefByVersionId\x12:.com.coralogixapis.alerts.v3.GetAlertDefByVersionIdRequest\x1a;.com.coralogixapis.alerts.v3.GetAlertDefByVersionIdResponse\"f¸\x02*\n" +
	"(get alert definition by alert version id\x82\xd3\xe4\x93\x022\x120/v3/alert-defs/alertVersionId/{alert_version_id}\x12\xc4\x01\n" +
	"\x0eCreateAlertDef\x122.com.coralogixapis.alerts.v3.CreateAlertDefRequest\x1a3.com.coralogixapis.alerts.v3.CreateAlertDefResponse\"I¸\x02\x19\n" +
	"\x17create alert definition\x82\xd3\xe4\x93\x02&:\x14alert_def_properties\"\x0e/v3/alert-defs\x12\xb5\x01\n" +
	"\x0fReplaceAlertDef\x123.com.coralogixapis.alerts.v3.ReplaceAlertDefRequest\x1a4.com.coralogixapis.alerts.v3.ReplaceAlertDefResponse\"7¸\x02\x1a\n" +
	"\x18replace alert definition\x82\xd3\xe4\x93\x02\x13:\x01*\x1a\x0e/v3/alert-defs\x12\xae\x01\n" +
	"\rListAlertDefs\x121.com.coralogixapis.alerts.v3.ListAlertDefsRequest\x1a2.com.coralogixapis.alerts.v3.ListAlertDefsResponse\"6¸\x02\x1c\n" +
	"\x1aget alert definitions list\x82\xd3\xe4\x93\x02\x10\x12\x0e/v3/alert-defs\x12\xad\x01\n" +
	"\x0eDownloadAlerts\x122.com.coralogixapis.alerts.v3.DownloadAlertsRequest\x1a3.com.coralogixapis.alerts.v3.DownloadAlertsResponse\"0¸\x02\x11\n" +
	"\x0fDownload alerts\x82\xd3\xe4\x93\x02\x15\x12\x13/v3/alerts/download0\x01\x12\xb4\x01\n" +
	"\x0eDeleteAlertDef\x122.com.coralogixapis.alerts.v3.DeleteAlertDefRequest\x1a3.com.coralogixapis.alerts.v3.DeleteAlertDefResponse\"9¸\x02\x1a\n" +
	"\x18delete alert definitions\x82\xd3\xe4\x93\x02\x15*\x13/v3/alert-defs/{id}\x12\xbe\x01\n" +
	"\tSetActive\x12-.com.coralogixapis.alerts.v3.SetActiveRequest\x1a..com.coralogixapis.alerts.v3.SetActiveResponse\"R¸\x02)\n" +
	"'disable or enable the alert definitions\x82\xd3\xe4\x93\x02\x1f\"\x1d/v3/alert-defs/{id}:setActiveb\x06proto3"
