...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_tracing_common_tracing_filter_proto_rawDesc = "" +
	"\n" +
	"Ycom/coralogixapis/alerts/v3/alert_def_type_definition/tracing/common/tracing_filter.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a\x1egoogle/protobuf/wrappers.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\xfc\x01\n" +
	"\rTracingFilter\x12\x95\x01\n" +
	"\rsimple_filter\x18\x01 \x01(\v20.com.coralogixapis.alerts.v3.TracingSimpleFilterB<\x9aA927Simple filter using latency threshold and label filtersH\x00R\fsimpleFilter:D\x9aAA\n" +
	"?*\x0eTracing filter2-Filter configuration for tracing-based alertsB\r\n" +
	"\vfilter_type\"\x8f\x03\n" +
	"\x13TracingSimpleFilter\x12~\n" +
	"\x15tracing_label_filters\x18\x01 \x01(\v20.com.coralogixapis.alerts.v3.TracingLabelFiltersB\x18\x9aA\x152\x13Trace label filtersR\x13tracingLabelFilters\x12\x91\x01\n" +
	"\x14latency_threshold_ms\x18\x02 \x01(\v2\x1c.google.protobuf.UInt64ValueBA\x9aA>26The latency threshold to filter traces in millisecondsJ\x041000R\x12latencyThresholdMs:d\x9aAa\n" +
	"_*\x15Simple tracing filter2FBasic filter configuration using a latency threshold and label filters\"\xe2\x05\n" +
	...
	"spanFields:x\x9aAu\n" +
	"s*\x15Tracing label filters2ZFilters for application name, subsystem name, service name, operation name and span fields\"\xd3\x02\n" +
	"\x1bTracingSpanFieldsFilterType\x12m\n" +
	"\x03key\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueB=\x9aA:2&The key of the span field to filter byJ\x10\"span.field.key\"R\x03key\x12r\n" +
	"\vfilter_type\x18\x02 \x01(\v2..com.coralogixapis.alerts.v3.TracingFilterTypeB!\x9aA\x1e2\x1cThe FilterType to filter by.R\n" +
	"filterType:Q\x9aAN\n" +
	"L*\x1fTracing span fields filter type2)A filter for span fields in trace entries\"\xff\x02\n" +
	...
	"\toperation\x18\x02 \x01(\x0e27.com.coralogixapis.alerts.v3.TracingFilterOperationTypeB]\x9aAZ2+The operation to perform on the label valueJ+\"TRACING_FILTER_OPERATION_TYPE_STARTS_WITH\"R\toperation:9\x9aA6\n" +
	"4*\x13Tracing filter type2\x1dFilter type for trace entries*\x83\x02\n" +
