...
type TracingSimpleFilter struct {
	...
	LatencyThresholdMs  *wrappers.UInt64Value `protobuf:"bytes,2,opt,name=latency_threshold_ms,json=latencyThresholdMs,proto3" json:"latency_threshold_ms,omitempty"`
}
...
func (x *TracingSimpleFilter) GetLatencyThresholdMs() *wrappers.UInt64Value {
	if x != nil {
...
func (x *TracingSpanFieldsFilterType) GetKey() *wrappers.StringValue {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *TracingFilterType) GetValues() []*wrappers.StringValue {
	if x != nil {
		return x.Values
	}
	return nil
