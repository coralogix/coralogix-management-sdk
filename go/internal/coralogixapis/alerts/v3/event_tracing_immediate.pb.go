...
type EventTracingImmediate struct {
	...
	TraceIds  []*wrappers.StringValue `protobuf:"bytes,2,rep,name=trace_ids,json=traceIds,proto3" json:"trace_ids,omitempty"`
...
func (x *EventTracingImmediate) GetTraceIds() []*wrappers.StringValue {
	if x != nil {
		return x.TraceIds
	}
	return nil
...
func (x *Span) GetTraceId() *wrappers.StringValue {
	if x != nil {
		return x.TraceId
	}
	return nil
