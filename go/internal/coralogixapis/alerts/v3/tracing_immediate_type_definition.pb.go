...
func file_com_coralogixapis_alerts_v3_alert_def_type_definition_tracing_tracing_immediate_type_definition_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v3_alert_def_type_definition_tracing_tracing_immediate_type_definition_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*TracingImmediateType); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
