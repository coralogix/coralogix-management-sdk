...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_tracing_tracing_immediate_type_definition_proto_rawDesc = "" +
	"\n" +
	"ecom/coralogixapis/alerts/v3/alert_def_type_definition/tracing/tracing_immediate_type_definition.proto\x12\x1bcom.coralogixapis.alerts.v3\x1aYcom/coralogixapis/alerts/v3/alert_def_type_definition/tracing/common/tracing_filter.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\xbb\x04\n" +
	"\x14TracingImmediateType\x12\x8c\x01\n" +
	"\x0etracing_filter\x18\x01 \x01(\v2*.com.coralogixapis.alerts.v3.TracingFilterB9\x9aA624A filter to match trace entries for immediate alertsR\rtracingFilter\x12\x93\x01\n" +
	"\x1bnotification_payload_filter\x18\x02 \x03(\v2\x1c.google.protobuf.StringValueB5\x9aA22!Notification payload field filterJ\r[\"obj.field\"]R\x19notificationPayloadFilter:\xfd\x01\x9aA\xf9\x01\n" +
	"a* Trace-based immediate alert type2=Configuration for immediate alerts triggered on trace entries*\x93\x01\n" +
