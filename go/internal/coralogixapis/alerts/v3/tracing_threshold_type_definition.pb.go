...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_tracing_tracing_threshold_type_definition_proto_rawDesc = "" +
	...
	"\x1bnotification_payload_filter\x18\x03 \x03(\v2\x1c.google.protobuf.StringValueR\x19notificationPayloadFilter:\x90\x02\x92A\x8c\x02\n" +
	...
	"8Learn more about trace-based alerts in our documentation\x12Vhttps://coralogix.com/docs/user-guides/alerting/create-an-alert/traces/tracing-alerts/\"l\n" +
	"\x14TracingThresholdRule\x12T\n" +
	"\tcondition\x18\x01 \x01(\v26.com.coralogixapis.alerts.v3.TracingThresholdConditionR\tcondition\"\xd6\x02\n" +
	...
	"timeWindow\x12a\n" +
	"\x0econdition_type\x18\x03 \x01(\x0e2:.com.coralogixapis.alerts.v3.TracingThresholdConditionTypeR\rconditionType:F\x92AC\n" +
	"A*%Trace-based alert threshold condition\xd2\x01\tthreshold\xd2\x01\vtime_windowb\x06proto3"
