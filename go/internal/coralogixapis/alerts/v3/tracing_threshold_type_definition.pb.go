...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_tracing_tracing_threshold_type_definition_proto_rawDesc = "" +
	"\n" +
	"ecom/coralogixapis/alerts/v3/alert_def_type_definition/tracing/tracing_threshold_type_definition.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a\x1egoogle/protobuf/wrappers.proto\x1ajcom/coralogixapis/alerts/v3/alert_def_type_definition/tracing/threshold/tracing_threshold_timewindow.proto\x1aYcom/coralogixapis/alerts/v3/alert_def_type_definition/tracing/common/tracing_filter.proto\x1ancom/coralogixapis/alerts/v3/alert_def_type_definition/tracing/threshold/tracing_threshold_condition_type.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\x88\x03\n" +
	"\x14TracingThresholdType\x12Q\n" +
	"\x0etracing_filter\x18\x01 \x01(\v2*.com.coralogixapis.alerts.v3.TracingFilterR\rtracingFilter\x12G\n" +
	"\x05rules\x18\x02 \x03(\v21.com.coralogixapis.alerts.v3.TracingThresholdRuleR\x05rules\x12\\\n" +
	"\x1bnotification_payload_filter\x18\x03 \x03(\v2\x1c.google.protobuf.StringValueR\x19notificationPayloadFilter:v\x92As\n" +
	"q*\x1cTracing Threshold Alert Type28Configuration for alerts based on trace count thresholds\xd2\x01\x0etracing_filter\xd2\x01\x05rules\"l\n" +
	"\x14TracingThresholdRule\x12T\n" +
	"\tcondition\x18\x01 \x01(\v26.com.coralogixapis.alerts.v3.TracingThresholdConditionR\tcondition\"\xfb\x02\n" +
	"\x19TracingThresholdCondition\x12=\n" +
	"\vspan_amount\x18\x01 \x01(\v2\x1c.google.protobuf.DoubleValueR\n" +
	"spanAmount\x12O\n" +
	"\vtime_window\x18\x02 \x01(\v2..com.coralogixapis.alerts.v3.TracingTimeWindowR\n" +
	"timeWindow\x12a\n" +
	"\x0econdition_type\x18\x03 \x01(\x0e2:.com.coralogixapis.alerts.v3.TracingThresholdConditionTypeR\rconditionType:k\x92Ah\n" +
	"f*\x1bTracing Threshold Condition2-Defines conditions for trace threshold alerts\xd2\x01\tthreshold\xd2\x01\vtime_windowb\x06proto3"
