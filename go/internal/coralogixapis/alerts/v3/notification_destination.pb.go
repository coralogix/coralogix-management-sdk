...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_notification_destination_proto_rawDesc = "" +
	"\n" +
	"Tcom/coralogixapis/alerts/v3/alert_def_type_definition/notification_destination.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a)com/coralogixapis/alerts/v3/commons.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\x95\x04\n" +
	...
	"\x16resolvedRouteOverrides\x18\x05 \x01(\v20.com.coralogixapis.alerts.v3.NotificationRoutingH\x01R\x16resolvedRouteOverrides\x88\x01\x01:i\x92Af\n" +
	"d*\x18Notification Destination2:Configuration for where alert notifications should be sent\xd2\x01\vdestinationB\f\n" +
	"\n" +
	"_preset_idB\x19\n" +
	"\x17_resolvedRouteOverrides\"\x88\x01\n" +
	"\x13NotificationRouting\x12\\\n" +
	"\x10config_overrides\x18\x01 \x01(\v2,.com.coralogixapis.alerts.v3.SourceOverridesH\x00R\x0fconfigOverrides\x88\x01\x01B\x13\n" +
	"\x11_config_overrides\"\x8b\x02\n" +
	...
	"\x17connector_config_fields\x18\x03 \x03(\v21.com.coralogixapis.alerts.v3.ConnectorConfigFieldR\x15connectorConfigFields\"Q\n" +
	"\x14ConnectorConfigField\x12\x1d\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tR\tfieldName\x12\x1a\n" +
	"\btemplate\x18\x02 \x01(\tR\btemplate\"O\n" +
	...
	"\tnotify_on\x18\x02 \x01(\x0e2%.com.coralogixapis.alerts.v3.NotifyOnH\x00R\bnotifyOn\x88\x01\x01B\f\n" +
	"\n" +
