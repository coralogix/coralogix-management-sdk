...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_notification_destination_proto_rawDesc = "" +
	"\n" +
	"Tcom/coralogixapis/alerts/v3/alert_def_type_definition/notification_destination.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a)com/coralogixapis/alerts/v3/commons.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\x9d\x06\n" +
	"\x17NotificationDestination\x12!\n" +
	"\fconnector_id\x18\x01 \x01(\tR\vconnectorId\x12 \n" +
	"\tpreset_id\x18\x02 \x01(\tH\x00R\bpresetId\x88\x01\x01\x12B\n" +
	"\tnotify_on\x18\x03 \x01(\x0e2%.com.coralogixapis.alerts.v3.NotifyOnR\bnotifyOn\x12n\n" +
	"\x19triggeredRoutingOverrides\x18\x04 \x01(\v20.com.coralogixapis.alerts.v3.NotificationRoutingR\x19triggeredRoutingOverrides\x12m\n" +
	"\x16resolvedRouteOverrides\x18\x05 \x01(\v20.com.coralogixapis.alerts.v3.NotificationRoutingH\x01R\x16resolvedRouteOverrides\x88\x01\x01:\xf0\x02\x92A\xec\x02\n" +
	"\xc8\x01*&Notification destination configuration2BConfiguration for where and how alert notifications should be sent\xd2\x01\fconnector_id\xd2\x01\tpreset_id\xd2\x01\tnotify_on\xd2\x01\x19triggeredRoutingOverrides\xd2\x01\x16resolvedRouteOverrides*\x9e\x01\n" +
	...
	"\n" +
	"_preset_idB\x19\n" +
	"\x17_resolvedRouteOverrides\"\xb8\x01\n" +
	"\x13NotificationRouting\x12\\\n" +
	"\x10config_overrides\x18\x01 \x01(\v2,.com.coralogixapis.alerts.v3.SourceOverridesH\x00R\x0fconfigOverrides\x88\x01\x01:.\x92A+\n" +
	")*\x14Notification routing\xd2\x01\x10config_overridesB\x13\n" +
	"\x11_config_overrides\"\xe9\x02\n" +
	"\x0fSourceOverrides\x12(\n" +
	"\x10output_schema_id\x18\x01 \x01(\tR\x0eoutputSchemaId\x12c\n" +
	"\x15message_config_fields\x18\x02 \x03(\v2/.com.coralogixapis.alerts.v3.MessageConfigFieldR\x13messageConfigFields\x12i\n" +
	"\x17connector_config_fields\x18\x03 \x03(\v21.com.coralogixapis.alerts.v3.ConnectorConfigFieldR\x15connectorConfigFields:\\\x92AY\n" +
	"W*\x10Source overrides\xd2\x01\x10output_schema_id\xd2\x01\x15message_config_fields\xd2\x01\x17connector_config_fields\"\x88\x01\n" +
	"\x14ConnectorConfigField\x12\x1d\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tR\tfieldName\x12\x1a\n" +
	"\btemplate\x18\x02 \x01(\tR\btemplate:5\x92A2\n" +
	"0*\x16Connector config field\xd2\x01\n" +
	"field_name\xd2\x01\btemplate\"\xb4\x01\n" +
	"\x12MessageConfigField\x12\x1d\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tR\tfieldName\x12\x1a\n" +
	"\btemplate\x18\x02 \x01(\tR\btemplate:c\x92A`\n" +
	"^*\x14Message config field2.Configuration field for a notification message\xd2\x01\n" +
	"field_name\xd2\x01\btemplate\"\xd1\x01\n" +
	"\x12NotificationRouter\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12G\n" +
	"\tnotify_on\x18\x02 \x01(\x0e2%.com.coralogixapis.alerts.v3.NotifyOnH\x00R\bnotifyOn\x88\x01\x01:T\x92AQ\n" +
	"O*\x13Notification router2'Configuration for routing notifications\xd2\x01\x02id\xd2\x01\tnotify_onB\f\n" +
	"\n" +
