...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_notification_destination_proto_rawDesc = "" +
	"\n" +
	"Tcom/coralogixapis/alerts/v3/alert_def_type_definition/notification_destination.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a)com/coralogixapis/alerts/v3/commons.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\x8a\t\n" +
	...
	"\x16resolvedRouteOverrides\x18\x05 \x01(\v20.com.coralogixapis.alerts.v3.NotificationRoutingBe\x9aAb2`Optional routing configuration to override from the connector/preset for resolved notifications.H\x01R\x16resolvedRouteOverrides\x88\x01\x01:\x93\x02\x9aA\x8f\x02\n" +
	"l*&Notification destination configuration2BConfiguration for where and how alert notifications should be sent*\x9e\x01\n" +
	...
	"\x17connector_config_fields\x18\x03 \x03(\v21.com.coralogixapis.alerts.v3.ConnectorConfigFieldB#\x9aA 2\x1eConnector configuration fieldsR\x15connectorConfigFields:\x17\x9aA\x14\n" +
	"\x12*\x10Source overrides\"\xf3\x01\n" +
	...
	"\btemplate\x18\x02 \x01(\tBH\x9aAE2(The template for the configuration fieldJ\x12\"template_example\"\xa2\x02\x04teraR\btemplate:\x1d\x9aA\x1a\n" +
	"\x18*\x16Connector config field\"\x9f\x02\n" +
	"\x12MessageConfigField\x12V\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tB7\x9aA42#The name of the configuration fieldJ\r\"description\"R\tfieldName\x12d\n" +
	"\btemplate\x18\x02 \x01(\tBH\x9aAE2(The template for the configuration fieldJ\x12\"template_example\"\xa2\x02\x04teraR\btemplate:K\x9aAH\n" +
	"F*\x14Message config field2.Configuration field for a notification message\"\x8e\x03\n" +
