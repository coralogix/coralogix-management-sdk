...
const file_com_coralogixapis_alerts_v3_event_alert_event_service_proto_rawDesc = "" +
	"\n" +
	";com/coralogixapis/alerts/v3/event/alert_event_service.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a google/protobuf/descriptor.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a3com/coralogixapis/alerts/v3/event/alert_event.proto\x1a'com/coralogix/common/v1/audit_log.proto\"\x98\x01\n" +
	"\x19GetAlertEventStatsRequest\x12.\n" +
	"\x03ids\x18\x01 \x03(\v2\x1c.google.protobuf.StringValueR\x03ids\x12K\n" +
	"\torder_bys\x18\x02 \x03(\v2..com.coralogixapis.alerts.v3.AlertEventOrderByR\borderBys\"\xf2\x01\n" +
	...
	"\x05value\x18\x02 \x01(\v2'.com.coralogixapis.alerts.v3.EventStatsR\x05value:\x028\x01\"\xc3\x01\n" +
	"\vPermutation\x12n\n" +
	...
	"\x17activity_analysis_stats\x18\x06 \x01(\v22.com.coralogixapis.alerts.v3.ActivityAnalysisStatsR\x15activityAnalysisStats\"\x8f\x01\n" +
	"\x15ActivityAnalysisStats\x12B\n" +
	"\x0eis_muted_count\x18\x01 \x01(\v2\x1c.google.protobuf.UInt32ValueR\fisMutedCount\x122\n" +
	"\x05rules\x18\x02 \x03(\v2\x1c.google.protobuf.StringValueR\x05rules\"\xe1\x01\n" +
	...
	"#ORDER_BY_ALERT_EVENT_DIRECTION_DESC\x10\x022\x83\x03\n" +
	"\x11AlertEventService\x12\xa9\x01\n" +
	"\rGetAlertEvent\x121.com.coralogixapis.alerts.v3.GetAlertEventRequest\x1a2.com.coralogixapis.alerts.v3.GetAlertEventResponse\"1¸\x02\x11\n" +
	"\x0fget alert event\x82\xd3\xe4\x93\x02\x16\x12\x14/v3/alert_event/{id}\x12\xc1\x01\n" +
	"\x13GetAlertEventsStats\x126.com.coralogixapis.alerts.v3.GetAlertEventStatsRequest\x1a7.com.coralogixapis.alerts.v3.GetAlertEventStatsResponse\"9¸\x02\x18\n" +
	"\x16get alert events stats\x82\xd3\xe4\x93\x02\x17\x12\x15/v3/alert_event_statsb\x06proto3"
