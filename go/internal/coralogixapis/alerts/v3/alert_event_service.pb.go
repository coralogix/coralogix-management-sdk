...
func (x *GetAlertEventStatsRequest) GetIds() []*wrappers.StringValue {
	if x != nil {
		return x.Ids
	}
	return nil
...
type EventStats struct {
	...
	ResolvedCount                *wrappers.UInt32Value  `protobuf:"bytes,2,opt,name=resolved_count,json=resolvedCount,proto3" json:"resolved_count,omitempty"`
	TriggeredCount               *wrappers.UInt32Value  `protobuf:"bytes,3,opt,name=triggered_count,json=triggeredCount,proto3" json:"triggered_count,omitempty"`
...
func (x *EventStats) GetCount() *wrappers.UInt32Value {
	if x != nil {
		return x.Count
	}
	return nil
...
func (x *EventStats) GetResolvedCount() *wrappers.UInt32Value {
	if x != nil {
...
func (x *EventStats) GetTriggeredCount() *wrappers.UInt32Value {
	if x != nil {
...
type ActivityAnalysisStats struct {
	...
	IsMutedCount *wrappers.UInt32Value   `protobuf:"bytes,1,opt,name=is_muted_count,json=isMutedCount,proto3" json:"is_muted_count,omitempty"`
	Rules        []*wrappers.StringValue `protobuf:"bytes,2,rep,name=rules,proto3" json:"rules,omitempty"`
}
...
func (x *ActivityAnalysisStats) GetIsMutedCount() *wrappers.UInt32Value {
	if x != nil {
...
func (x *ActivityAnalysisStats) GetRules() []*wrappers.StringValue {
	if x != nil {
		return x.Rules
	}
	return nil
...
func (x *GetAlertEventRequest) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *GetAlertEventResponse) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
type PaginationRequest struct {
	...
	PageSize  *wrappers.UInt32Value `protobuf:"bytes,1,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`
...
func (x *PaginationRequest) GetPageSize() *wrappers.UInt32Value {
	if x != nil {
		return x.PageSize
	}
	return nil
...
func (x *PaginationRequest) GetPageToken() *wrappers.StringValue {
	if x != nil {
		return x.PageToken
	}
	return nil
...
type PaginationResponse struct {
	...
	TotalSize     *wrappers.UInt32Value `protobuf:"bytes,1,opt,name=total_size,json=totalSize,proto3" json:"total_size,omitempty"`
	NextPageToken *wrappers.StringValue `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
}
...
func (x *PaginationResponse) GetTotalSize() *wrappers.UInt32Value {
	if x != nil {
		return x.TotalSize
	}
	return nil
...
func (x *PaginationResponse) GetNextPageToken() *wrappers.StringValue {
	if x != nil {
