...
type MetricAnomalyCondition struct {
	...
	MinNonNullValuesPct *wrappers.UInt32Value      `protobuf:"bytes,4,opt,name=min_non_null_values_pct,json=minNonNullValuesPct,proto3" json:"min_non_null_values_pct,omitempty"`
...
func (x *MetricAnomalyCondition) GetThreshold() *wrappers.DoubleValue {
	if x != nil {
		return x.Threshold
	}
	return nil
...
func (x *MetricAnomalyCondition) GetForOverPct() *wrappers.UInt32Value {
	if x != nil {
		return x.ForOverPct
	}
	return nil
...
func (x *MetricAnomalyCondition) GetMinNonNullValuesPct() *wrappers.UInt32Value {
	if x != nil {
