...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_metric_metric_anomaly_type_definition_proto_rawDesc = "" +
	...
	"\x16anomaly_alert_settings\x18\x04 \x01(\v21.com.coralogixapis.alerts.v3.AnomalyAlertSettingsB.\x9aA+2)Configuration for anomaly alert settings.R\x14anomalyAlertSettings:\x91\x02\x9aA\x8d\x02\n" +
	"b*\x1fMetric-based anomaly alert type2?Configuration for alerts triggered by anomalous metric patterns*\xa6\x01\n" +
	"ALearn more about metric-based anomaly alerts in our documentation\x12ahttps://coralogix.com/docs/user-guides/alerting/create-an-alert/metrics/anomaly-detection-alerts/\"\xed\x01\n" +
	"\x11MetricAnomalyRule\x12\x83\x01\n" +
	"\tcondition\x18\x01 \x01(\v23.com.coralogixapis.alerts.v3.MetricAnomalyConditionB0\x9aA-2+The condition for the metric anomaly alert.R\tcondition:R\x9aAO\n" +
	"M*\x19Metric-based anomaly rule20A rule for metric-based anomaly detection alerts\"\xa9\x06\n" +
	...
	"\x0econdition_type\x18\x05 \x01(\x0e27.com.coralogixapis.alerts.v3.MetricAnomalyConditionTypeBZ\x9aAW2$The type of condition for the alert.J/\"METRIC_ANOMALY_CONDITION_TYPE_LESS_THAN_USUAL\"R\rconditionType:%\x9aA\"\n" +
	" *\x1eMetric-based anomaly conditionb\x06proto3"
