...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_metric_metric_anomaly_type_definition_proto_rawDesc = "" +
	...
	"\x16anomaly_alert_settings\x18\x04 \x01(\v21.com.coralogixapis.alerts.v3.AnomalyAlertSettingsR\x14anomalyAlertSettings:y\x92Av\n" +
	"t*\x19Metric Anomaly Alert Type2?Configuration for alerts triggered by anomalous metric patterns\xd2\x01\rmetric_source\xd2\x01\x05rules\"f\n" +
	"\x11MetricAnomalyRule\x12Q\n" +
	"\tcondition\x18\x01 \x01(\v23.com.coralogixapis.alerts.v3.MetricAnomalyConditionR\tcondition\"\xc8\x04\n" +
	...
	"\x0econdition_type\x18\x05 \x01(\x0e27.com.coralogixapis.alerts.v3.MetricAnomalyConditionTypeB\x13\x92A\x10J\x0e\"GREATER_THAN\"R\rconditionType:t\x92Aq\n" +
	"o*\x18Metric Anomaly Condition21Defines conditions for detecting metric anomalies\xd2\x01\x11minimum_threshold\xd2\x01\vtime_windowb\x06proto3"
