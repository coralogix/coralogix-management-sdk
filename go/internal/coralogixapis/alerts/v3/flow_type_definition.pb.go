...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_flow_flow_type_definition_proto_rawDesc = "" +
	"\n" +
	"Ucom/coralogixapis/alerts/v3/alert_def_type_definition/flow/flow_type_definition.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a\x1egoogle/protobuf/wrappers.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xfe\x01\n" +
	"\bFlowType\x12?\n" +
	"\x06stages\x18\x01 \x03(\v2'.com.coralogixapis.alerts.v3.FlowStagesR\x06stages\x12V\n" +
	"\x13enforce_suppression\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueB\t\x92A\x06J\x04trueR\x12enforceSuppression:Y\x92AV\n" +
	"T*\x0fFlow Alert Type28Configuration for flow-based alerts with multiple stages\xd2\x01\x06stages\"\xea\x02\n" +
	"\n" +
	"FlowStages\x12]\n" +
	"\x12flow_stages_groups\x18\n" +
	" \x01(\v2-.com.coralogixapis.alerts.v3.FlowStagesGroupsH\x00R\x10flowStagesGroups\x12J\n" +
	"\ftimeframe_ms\x18\x03 \x01(\v2\x1b.google.protobuf.Int64ValueB\n" +
	"\x92A\aJ\x0560000R\vtimeframeMs\x12Q\n" +
	"\x0etimeframe_type\x18\x04 \x01(\x0e2*.com.coralogixapis.alerts.v3.TimeframeTypeR\rtimeframeType:O\x92AL\n" +
	"J*\vFlow Stages2\x1eDefines stages in a flow alert\xd2\x01\vflow_stages\xd2\x01\ftimeframe_msB\r\n" +
	"\vflow_stages\"\x9e\x01\n" +
	"\x10FlowStagesGroups\x12D\n" +
	"\x06groups\x18\x01 \x03(\v2,.com.coralogixapis.alerts.v3.FlowStagesGroupR\x06groups:D\x92AA\n" +
	"?*\x12Flow Stages Groups2 Groups of stages in a flow alert\xd2\x01\x06groups\"\xea\x01\n" +
	"\x0fFlowStagesGroup\x12U\n" +
	"\n" +
	"alert_defs\x18\x01 \x03(\v26.com.coralogixapis.alerts.v3.FlowStagesGroupsAlertDefsR\talertDefs\x12<\n" +
	"\anext_op\x18\x02 \x01(\x0e2#.com.coralogixapis.alerts.v3.NextOpR\x06nextOp\x12B\n" +
	"\talerts_op\x18\x03 \x01(\x0e2%.com.coralogixapis.alerts.v3.AlertsOpR\balertsOp\"\xe5\x01\n" +
	"\x19FlowStagesGroupsAlertDefs\x124\n" +
	"\x02id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueB\x06\x92A\x03J\x011R\x02id\x127\n" +
	"\x03not\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueB\t\x92A\x06J\x04trueR\x03not:Y\x92AV\n" +
	"T*\x1dFlow Stages Groups Alert Defs2(Alert definitions for a flow stage group\xd2\x01\x02id\xd2\x01\x03not*8\n" +
	"\x06NextOp\x12\x1e\n" +
