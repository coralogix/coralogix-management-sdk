...
type FlowType struct {
	...
	EnforceSuppression *wrappers.BoolValue `protobuf:"bytes,2,opt,name=enforce_suppression,json=enforceSuppression,proto3" json:"enforce_suppression,omitempty"`
}
...
func (x *FlowType) GetEnforceSuppression() *wrappers.BoolValue {
	if x != nil {
...
type FlowStages struct {
	...
	TimeframeMs   *wrappers.Int64Value    `protobuf:"bytes,3,opt,name=timeframe_ms,json=timeframeMs,proto3" json:"timeframe_ms,omitempty"`
...
func (x *FlowStages) GetTimeframeMs() *wrappers.Int64Value {
	if x != nil {
...
type FlowStagesGroupsAlertDefs struct {
	...
	Not *wrappers.BoolValue   `protobuf:"bytes,2,opt,name=not,proto3" json:"not,omitempty"`
}
...
func (x *FlowStagesGroupsAlertDefs) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *FlowStagesGroupsAlertDefs) GetNot() *wrappers.BoolValue {
	if x != nil {
		return x.Not
	}
	return nil
