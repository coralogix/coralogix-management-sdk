...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_flow_flow_type_definition_proto_rawDesc = "" +
	"\n" +
	"Ucom/coralogixapis/alerts/v3/alert_def_type_definition/flow/flow_type_definition.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a\x1egoogle/protobuf/wrappers.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\x84\x03\n" +
	"\bFlowType\x12?\n" +
	"\x06stages\x18\x01 \x03(\v2'.com.coralogixapis.alerts.v3.FlowStagesR\x06stages\x12V\n" +
	"\x13enforce_suppression\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueB\t\x92A\x06J\x04trueR\x12enforceSuppression:\xde\x01\x92A\xda\x01\n" +
	"T*\x0fFlow alert type28Configuration for flow-based alerts with multiple stages\xd2\x01\x06stages*\x81\x01\n" +
	"1Learn more about flow alerts in our documentation\x12Lhttps://coralogix.com/docs/user-guides/alerting/create-an-alert/flow-alerts/\"\xea\x02\n" +
	"\n" +
	"FlowStages\x12]\n" +
	...
	">*\x11Flow stage groups2 Groups of stages in a flow alert\xd2\x01\x06groups\"\xea\x01\n" +
	...
	"\talerts_op\x18\x03 \x01(\x0e2%.com.coralogixapis.alerts.v3.AlertsOpR\balertsOp\"\xea\x01\n" +
	"\x19FlowStagesGroupsAlertDefs\x124\n" +
	"\x02id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueB\x06\x92A\x03J\x011R\x02id\x127\n" +
	"\x03not\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueB\t\x92A\x06J\x04trueR\x03not:^\x92A[\n" +
	"Y*\"Flow stage group alert definitions2(Alert definitions for a flow stage group\xd2\x01\x02id\xd2\x01\x03not*8\n" +
	"\x06NextOp\x12\x1e\n" +
