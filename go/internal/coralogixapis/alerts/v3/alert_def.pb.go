...
const file_com_coralogixapis_alerts_v3_alert_def_proto_rawDesc = "" +
	...
	"/Find out more about alerts in our documentation\x12Ghttps://coralogix.com/docs/user-guides/alerting/introduction-to-alerts/\"\xbc\x1e\n" +
	...
	"\aenabled\x18\x03 \x01(\v2\x1a.google.protobuf.BoolValueBE\x92AB24Whether the alert is currently active and monitoring:\x04trueJ\x04trueR\aenabled\x12\x86\x01\n" +
	"\bpriority\x18\x04 \x01(\x0e2-.com.coralogixapis.alerts.v3.AlertDefPriorityB;\x92A82\x1fThe priority level of the alertJ\x15ALERT_DEF_PRIORITY_P4R\bpriority\x12\x88\x01\n" +
	"\tactive_on\x18\x05 \x01(\v2-.com.coralogixapis.alerts.v3.ActivityScheduleB:\x92A725The schedule defining when the alert should be activeH\x00R\bactiveOn\x12o\n" +
	"\x04type\x18\x06 \x01(\x0e2).com.coralogixapis.alerts.v3.AlertDefTypeB0\x92A-2\n" +
	"Alert typeJ\x1fALERT_DEF_TYPE_METRIC_THRESHOLDR\x04type\x12\x8a\x01\n" +
