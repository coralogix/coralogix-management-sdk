...
const file_com_coralogixapis_alerts_v3_alert_def_proto_rawDesc = "" +
	...
	"\fupdated_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\vupdatedTime:\x98\x02\x92A\x94\x02\n" +
	"\x93\x01*\x10Alert Definition22This data structure represents an alert definition\xd2\x01\x14alert_def_properties\xd2\x01\x02id\xd2\x01\x10alert_version_id\xd2\x01\fcreated_time\xd2\x01\fupdated_time*|\n" +
	"\x1fFind out more about enrichments\x12Yhttps://coralogix.com/docs/user-guides/data-transformation/enrichments/custom-enrichment/\"\xf0\x12\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:\x81\x01\x92A~\n" +
	"|*\x1bAlert Definition Properties23User-configurable properties of an alert definition\xd2\x01\x04name\xd2\x01\aenabled\xd2\x01\x04type\xd2\x01\x0ftype_definitionB\n" +
	"\n" +
	"\bscheduleB\x11\n" +
