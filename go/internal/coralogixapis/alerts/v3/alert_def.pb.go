...
const file_com_coralogixapis_alerts_v3_alert_def_proto_rawDesc = "" +
	...
	"\x06status\x18\x06 \x01(\x0e2+.com.coralogixapis.alerts.v3.AlertDefStatusB;\x9aA82\x1fThe current status of the alertJ\x15\"ALERT_DEF_STATUS_OK\"H\x00R\x06status\x88\x01\x01:\xc8\x01\x9aA\xc4\x01\n" +
	"F*\x10Alert definition22This data structure represents an alert definition*z\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:W\x9aAT\n" +
	"R*\x1bAlert definition properties23User-configurable properties of an alert definitionB\n" +
	"\n" +
	"\bscheduleB\x11\n" +
