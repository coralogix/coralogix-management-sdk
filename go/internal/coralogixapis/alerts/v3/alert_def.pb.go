...
type AlertDef struct {
	...
	Id                 *wrappers.StringValue `protobuf:"bytes,2,opt,name=id,proto3" json:"id,omitempty"`                                                  // This is the Alert Definition's Persistent ID (does not change on replace) , AKA UniqueIdentifier
	AlertVersionId     *wrappers.StringValue `protobuf:"bytes,20,opt,name=alert_version_id,json=alertVersionId,proto3" json:"alert_version_id,omitempty"` // the old alertId
...
func (x *AlertDef) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *AlertDef) GetAlertVersionId() *wrappers.StringValue {
	if x != nil {
...
func (x *AlertDef) GetCreatedTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *AlertDef) GetUpdatedTime() *timestamp.Timestamp {
	if x != nil {
...
type AlertDefProperties struct {
	...
	GroupByKeys       []*wrappers.StringValue             `protobuf:"bytes,7,rep,name=group_by_keys,json=groupByKeys,proto3" json:"group_by_keys,omitempty"`
	...
	PhantomMode             *wrappers.BoolValue          `protobuf:"bytes,11,opt,name=phantom_mode,json=phantomMode,proto3" json:"phantom_mode,omitempty"`
	Deleted                 *wrappers.BoolValue          `protobuf:"bytes,12,opt,name=deleted,proto3" json:"deleted,omitempty"`
}
...
func (x *AlertDefProperties) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *AlertDefProperties) GetDescription() *wrappers.StringValue {
	if x != nil {
...
func (x *AlertDefProperties) GetEnabled() *wrappers.BoolValue {
	if x != nil {
		return x.Enabled
	}
	return nil
...
func (x *AlertDefProperties) GetGroupByKeys() []*wrappers.StringValue {
	if x != nil {
...
func (x *AlertDefProperties) GetPhantomMode() *wrappers.BoolValue {
	if x != nil {
...
func (x *AlertDefProperties) GetDeleted() *wrappers.BoolValue {
	if x != nil {
		return x.Deleted
	}
	return nil
