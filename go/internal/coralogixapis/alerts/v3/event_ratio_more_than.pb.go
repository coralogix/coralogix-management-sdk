...
const file_com_coralogixapis_alerts_v3_event_payload_ratio_event_ratio_more_than_proto_rawDesc = "" +
	"\n" +
	"Kcom/coralogixapis/alerts/v3/event/payload/ratio/event_ratio_more_than.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a4com/coralogixapis/alerts/v3/alert_def_severity.proto\x1aDcom/coralogixapis/alerts/v3/event/payload/ratio_special_values.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\x99\x04\n" +
	"\x12EventRatioMoreThan\x12K\n" +
...
var (
	...
	file_com_coralogixapis_alerts_v3_event_payload_ratio_event_ratio_more_than_proto_rawDescData []byte
)
...
func file_com_coralogixapis_alerts_v3_event_payload_ratio_event_ratio_more_than_proto_rawDescGZIP() []byte {
	file_com_coralogixapis_alerts_v3_event_payload_ratio_event_ratio_more_than_proto_rawDescOnce.Do(func() {
		file_com_coralogixapis_alerts_v3_event_payload_ratio_event_ratio_more_than_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogixapis_alerts_v3_event_payload_ratio_event_ratio_more_than_proto_rawDesc), len(file_com_coralogixapis_alerts_v3_event_payload_ratio_event_ratio_more_than_proto_rawDesc)))
	})
...
func file_com_coralogixapis_alerts_v3_event_payload_ratio_event_ratio_more_than_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogixapis_alerts_v3_event_payload_ratio_event_ratio_more_than_proto_rawDesc), len(file_com_coralogixapis_alerts_v3_event_payload_ratio_event_ratio_more_than_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
