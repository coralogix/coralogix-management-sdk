...
func (x *EventRatioMoreThan) GetNumeratorHitValue() *wrappers.Int64Value {
	if x != nil {
...
func (x *EventRatioMoreThan) GetDenominatorHitValue() *wrappers.Int64Value {
	if x != nil {
...
func (x *EventRatioMoreThan) GetNumeric() *wrappers.FloatValue {
...
func (x *EventRatioMoreThan) GetFromTimestamp() *timestamp.Timestamp {
	if x != nil {
...
func (x *EventRatioMoreThan) GetToTimestamp() *timestamp.Timestamp {
	if x != nil {
