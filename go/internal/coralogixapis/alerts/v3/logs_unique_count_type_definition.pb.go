...
type LogsUniqueCountType struct {
	...
	MaxUniqueCountPerGroupByKey *wrappers.Int64Value    `protobuf:"bytes,4,opt,name=max_unique_count_per_group_by_key,json=maxUniqueCountPerGroupByKey,proto3" json:"max_unique_count_per_group_by_key,omitempty"`
	UniqueCountKeypath          *wrappers.StringValue   `protobuf:"bytes,5,opt,name=unique_count_keypath,json=uniqueCountKeypath,proto3" json:"unique_count_keypath,omitempty"`
}
...
func (x *LogsUniqueCountType) GetNotificationPayloadFilter() []*wrappers.StringValue {
	if x != nil {
...
func (x *LogsUniqueCountType) GetMaxUniqueCountPerGroupByKey() *wrappers.Int64Value {
	if x != nil {
...
func (x *LogsUniqueCountType) GetUniqueCountKeypath() *wrappers.StringValue {
	if x != nil {
...
type LogsUniqueCountCondition struct {
	...
	MaxUniqueCount *wrappers.Int64Value       `protobuf:"bytes,2,opt,name=max_unique_count,json=maxUniqueCount,proto3" json:"max_unique_count,omitempty"`
...
func (x *LogsUniqueCountCondition) GetMaxUniqueCount() *wrappers.Int64Value {
	if x != nil {
