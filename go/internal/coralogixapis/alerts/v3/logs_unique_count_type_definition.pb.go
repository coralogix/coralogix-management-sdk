...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_logs_unique_count_type_definition_proto_rawDesc = "" +
	...
	"logsFilter\x12{\n" +
	"\x05rules\x18\x02 \x03(\v20.com.coralogixapis.alerts.v3.LogsUniqueCountRuleB3\x9aA02(The rules for the log unique count alert\xa0\x01\x01\xa8\x01\x01R\x05rules\x12\xbb\x01\n" +
	"\x1bnotification_payload_filter\x18\x03 \x03(\v2\x1c.google.protobuf.StringValueB]\x9aAZ2IThe filter to specify which fields to include in the notification payloadJ\r[\"obj.field\"]R\x19notificationPayloadFilter\x12\x98\x01\n" +
	...
	"\x14unique_count_keypath\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueBE\x9aAB23The keypath in the logs to be used for unique countJ\v\"obj.field\"R\x12uniqueCountKeypath:\x8c\x02\x9aA\x88\x02\n" +
	"b*!Log-based unique count alert type2=Configuration for alerts based on unique value counts in logs*\xa1\x01\n" +
	"DLearn more about log-based, unique count alerts in our documentation\x12Yhttps://coralogix.com/docs/user-guides/alerting/create-an-alert/logs/unique-count-alerts/\"\xfe\x01\n" +
	"\x13LogsUniqueCountRule\x12\x8c\x01\n" +
	"\tcondition\x18\x01 \x01(\v25.com.coralogixapis.alerts.v3.LogsUniqueCountConditionB7\x9aA422The condition for detecting unique counts in logs.R\tcondition:X\x9aAU\n" +
	"S*\x1bLog-based unique count rule24Defines the rule for detecting unique counts in logs\"\xe1\x02\n" +
	...
	"timeWindow:N\x9aAK\n" +
	"I*\x1bLogs unique count condition2*Defines conditions for unique count alertsb\x06proto3"
