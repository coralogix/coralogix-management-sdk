...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_ratio_logs_ratio_timewindow_proto_rawDesc = "" +
	"\n" +
	"\\com/coralogixapis/alerts/v3/alert_def_type_definition/logs/ratio/logs_ratio_timewindow.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a.protoc-gen-openapiv2/options/annotations.proto\"\x91\x03\n" +
	"\x13LogsRatioTimeWindow\x12\x88\x01\n" +
	"%logs_ratio_time_window_specific_value\x18\x01 \x01(\x0e25.com.coralogixapis.alerts.v3.LogsRatioTimeWindowValueH\x00R logsRatioTimeWindowSpecificValue:\xe6\x01\x92A\xe2\x01\n" +
