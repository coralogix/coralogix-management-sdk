...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_ratio_logs_ratio_timewindow_proto_rawDesc = "" +
	"\n" +
	"\\com/coralogixapis/alerts/v3/alert_def_type_definition/logs/ratio/logs_ratio_timewindow.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a.protoc-gen-openapiv3/options/annotations.proto\"\xf7\x03\n" +
	"\x13LogsRatioTimeWindow\x12\xf5\x01\n" +
	"%logs_ratio_time_window_specific_value\x18\x01 \x01(\x0e25.com.coralogixapis.alerts.v3.LogsRatioTimeWindowValueBk\x9aAh2-Specifies the time window for the ratio alertJ7\"LOGS_RATIO_TIME_WINDOW_VALUE_MINUTES_5_OR_UNSPECIFIED\"H\x00R logsRatioTimeWindowSpecificValue:\xdf\x01\x9aA\xdb\x01\n" +
	"D*\x16Logs ratio time window2*Time window configuration for ratio alerts*\x92\x01\n" +
	...
	"\x04type*\x84\x04\n" +
	"\x18LogsRatioTimeWindowValue\x129\n" +
	"5LOGS_RATIO_TIME_WINDOW_VALUE_MINUTES_5_OR_UNSPECIFIED\x10\x00\x12+\n" +
	"'LOGS_RATIO_TIME_WINDOW_VALUE_MINUTES_10\x10\x01\x12+\n" +
	"'LOGS_RATIO_TIME_WINDOW_VALUE_MINUTES_15\x10\x02\x12+\n" +
	"'LOGS_RATIO_TIME_WINDOW_VALUE_MINUTES_30\x10\x03\x12'\n" +
	"#LOGS_RATIO_TIME_WINDOW_VALUE_HOUR_1\x10\x04\x12(\n" +
	"$LOGS_RATIO_TIME_WINDOW_VALUE_HOURS_2\x10\x05\x12(\n" +
	"$LOGS_RATIO_TIME_WINDOW_VALUE_HOURS_4\x10\x06\x12(\n" +
	"$LOGS_RATIO_TIME_WINDOW_VALUE_HOURS_6\x10\a\x12)\n" +
	"%LOGS_RATIO_TIME_WINDOW_VALUE_HOURS_12\x10\b\x12)\n" +
	"%LOGS_RATIO_TIME_WINDOW_VALUE_HOURS_24\x10\t\x12)\n" +
	"%LOGS_RATIO_TIME_WINDOW_VALUE_HOURS_36\x10\n" +
	"b\x06proto3"

var (
	file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_ratio_logs_ratio_timewindow_proto_rawDescOnce sync.Once
	file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_ratio_logs_ratio_timewindow_proto_rawDescData []byte
)
...
func file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_ratio_logs_ratio_timewindow_proto_rawDescGZIP() []byte {
	file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_ratio_logs_ratio_timewindow_proto_rawDescOnce.Do(func() {
		file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_ratio_logs_ratio_timewindow_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_ratio_logs_ratio_timewindow_proto_rawDesc), len(file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_ratio_logs_ratio_timewindow_proto_rawDesc)))
	})
...
func file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_ratio_logs_ratio_timewindow_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_ratio_logs_ratio_timewindow_proto_rawDesc), len(file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_ratio_logs_ratio_timewindow_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
