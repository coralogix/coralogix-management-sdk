...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_ratio_logs_ratio_timewindow_proto_rawDesc = "" +
	"\n" +
	"\\com/coralogixapis/alerts/v3/alert_def_type_definition/logs/ratio/logs_ratio_timewindow.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xfa\x01\n" +
	"\x13LogsRatioTimeWindow\x12\x88\x01\n" +
	"%logs_ratio_time_window_specific_value\x18\x01 \x01(\x0e25.com.coralogixapis.alerts.v3.LogsRatioTimeWindowValueH\x00R logsRatioTimeWindowSpecificValue:P\x92AM\n" +
	"K*\x16Logs Ratio Time Window2*Time window configuration for ratio alerts\xd2\x01\x04typeB\x06\n" +
	"\x04type*\x84\x04\n" +
