...
const file_com_coralogixapis_alerts_v3_alert_def_severity_proto_rawDesc = "" +
	"\n" +
	"4com/coralogixapis/alerts/v3/alert_def_severity.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a4com/coralogixapis/alerts/v3/alert_def_priority.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\xba\x02\n" +
	...
	"\bpriority\x18\x02 \x01(\x0e2-.com.coralogixapis.alerts.v3.AlertDefPriorityBB\x9aA?2$The priority of the alert definitionJ\x17\"ALERT_DEF_PRIORITY_P3\"R\bpriority:U\x9aAR\n" +
	"P*\x19Alert definition severity23Defines the severity level and priority of an alertb\x06proto3"
