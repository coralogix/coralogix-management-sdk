...
type LogsThresholdType struct {
	...
	NotificationPayloadFilter  []*wrappers.StringValue     `protobuf:"bytes,4,rep,name=notification_payload_filter,json=notificationPayloadFilter,proto3" json:"notification_payload_filter,omitempty"`
}
...
func (x *LogsThresholdType) GetNotificationPayloadFilter() []*wrappers.StringValue {
	if x != nil {
...
func (x *LogsThresholdCondition) GetThreshold() *wrappers.DoubleValue {
	if x != nil {
		return x.Threshold
	}
	return nil
