...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_logs_threshold_type_definition_proto_rawDesc = "" +
	...
	"\x05rules\x18\x03 \x03(\v2..com.coralogixapis.alerts.v3.LogsThresholdRuleB,\x9aA)2!The rules for the threshold alert\xa0\x01\x05\xa8\x01\x01R\x05rules\x12\xbb\x01\n" +
	"\x1bnotification_payload_filter\x18\x04 \x03(\v2\x1c.google.protobuf.StringValueB]\x9aAZ2IThe filter to specify which fields to include in the notification payloadJ\r[\"obj.field\"]R\x19notificationPayloadFilter\x12\x98\x01\n" +
	"\x13evaluation_delay_ms\x18\x05 \x01(\v2\x1b.google.protobuf.Int32ValueBK\x9aAH2?The delay in milliseconds before evaluating the alert conditionJ\x0560000R\x11evaluationDelayMs:\xa1\x02\x9aA\x9d\x02\n" +
	"~*\x1eLog-based threshold alert type2\\Configuration for alerts triggered when log counts exceed or fall below specified thresholds*\x9a\x01\n" +
	"@Learn more about log-based threshold alerts in our documentation\x12Vhttps://coralogix.com/docs/user-guides/alerting/create-an-alert/logs/threshold-alerts/\"\xf7\x02\n" +
	...
	"\boverride\x18\x02 \x01(\v2-.com.coralogixapis.alerts.v3.AlertDefOverrideB(\x9aA%2#The override settings for the alertR\boverride:n\x9aAk\n" +
	"i*\x13Logs Threshold Rule2RLogsThresholdRule is a message that defines a rule for log-based threshold alerts.\"\xcf\x04\n" +
	"\x16LogsThresholdCondition\x12s\n" +
	"\tthreshold\x18\x01 \x01(\v2\x1c.google.protobuf.DoubleValueB7\x9aA42+The threshold value for the alert conditionJ\x05100.0R\tthreshold\x12z\n" +
	...
	"\x0econdition_type\x18\x03 \x01(\x0e27.com.coralogixapis.alerts.v3.LogsThresholdConditionTypeBb\x9aA_2#The type of condition for the alertJ8\"LOGS_THRESHOLD_CONDITION_TYPE_MORE_THAN_OR_UNSPECIFIED\"R\rconditionType:\x7f\x9aA|\n" +
	"z*\x18Logs Threshold Condition2^LogsThresholdCondition is a message that defines the condition for log-based threshold alerts.b\x06proto3"
