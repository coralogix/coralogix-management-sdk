...
var file_com_coralogixapis_alerts_v3_event_payload_flow_event_flow_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_alerts_v3_event_payload_flow_event_flow_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v3_event_payload_flow_event_flow_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
