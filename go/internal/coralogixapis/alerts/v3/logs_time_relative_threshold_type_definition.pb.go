...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_logs_time_relative_threshold_type_definition_proto_rawDesc = "" +
	...
	"\x92A\aJ\x0560000R\x11evaluationDelayMs:\x94\x01\x92A\x90\x01\n" +
	"\x8d\x01*'Logs Time Relative Threshold Alert Type2LConfiguration for alerts comparing log counts between different time periods\xd2\x01\vlogs_filter\xd2\x01\x05rules\"\xb7\x01\n" +
	...
	"\boverride\x18\x02 \x01(\v2-.com.coralogixapis.alerts.v3.AlertDefOverrideR\boverride\"\x96\x03\n" +
	...
	"comparedTo\x12a\n" +
	"\x0econdition_type\x18\x04 \x01(\x0e2:.com.coralogixapis.alerts.v3.LogsTimeRelativeConditionTypeR\rconditionType:u\x92Ar\n" +
	"p*\x1cLogs Time Relative Condition26Defines conditions for time-relative comparison alerts\xd2\x01\tthreshold\xd2\x01\vcompared_tob\x06proto3"
