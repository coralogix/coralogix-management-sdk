...
type LogsTimeRelativeThresholdType struct {
	...
	IgnoreInfinity             *wrappers.BoolValue         `protobuf:"bytes,3,opt,name=ignore_infinity,json=ignoreInfinity,proto3" json:"ignore_infinity,omitempty"`
...
func (x *LogsTimeRelativeThresholdType) GetIgnoreInfinity() *wrappers.BoolValue {
	if x != nil {
...
func (x *LogsTimeRelativeThresholdType) GetNotificationPayloadFilter() []*wrappers.StringValue {
	if x != nil {
...
func (x *LogsTimeRelativeCondition) GetThreshold() *wrappers.DoubleValue {
	if x != nil {
		return x.Threshold
	}
	return nil
