...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_logs_time_relative_threshold_type_definition_proto_rawDesc = "" +
	"\n" +
	"mcom/coralogixapis/alerts/v3/alert_def_type_definition/logs/logs_time_relative_threshold_type_definition.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a\x1egoogle/protobuf/wrappers.proto\x1aScom/coralogixapis/alerts/v3/alert_def_type_definition/logs/common/logs_filter.proto\x1amcom/coralogixapis/alerts/v3/alert_def_type_definition/logs/time_relative/logs_time_relative_compared_to.proto\x1aXcom/coralogixapis/alerts/v3/alert_def_type_definition/undetected_values_management.proto\x1apcom/coralogixapis/alerts/v3/alert_def_type_definition/logs/time_relative/logs_time_relative_condition_type.proto\x1aEcom/coralogixapis/alerts/v3/alert_def_type_definition/overrides.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xac\a\n" +
	"\x1dLogsTimeRelativeThresholdType\x12H\n" +
	"\vlogs_filter\x18\x01 \x01(\v2'.com.coralogixapis.alerts.v3.LogsFilterR\n" +
	"logsFilter\x12G\n" +
	"\x05rules\x18\x02 \x03(\v21.com.coralogixapis.alerts.v3.LogsTimeRelativeRuleR\x05rules\x12N\n" +
	"\x0fignore_infinity\x18\x03 \x01(\v2\x1a.google.protobuf.BoolValueB\t\x92A\x06J\x04trueR\x0eignoreInfinity\x12i\n" +
	"\x1bnotification_payload_filter\x18\x04 \x03(\v2\x1c.google.protobuf.StringValueB\v\x92A\bJ\x06\"text\"R\x19notificationPayloadFilter\x12y\n" +
	"\x1cundetected_values_management\x18\x05 \x01(\v27.com.coralogixapis.alerts.v3.UndetectedValuesManagementR\x1aundetectedValuesManagement\x12W\n" +
	"\x13evaluation_delay_ms\x18\x06 \x01(\v2\x1b.google.protobuf.Int32ValueB\n" +
	"\x92A\aJ\x0560000R\x11evaluationDelayMs:\xe8\x02\x92A\xe4\x02\n" +
	"\xbb\x01*,Log-based time-relative threshold alert type2uConfiguration for alerts that are triggered when a fixed ratio reaches a set threshold compared to a past time frame.\xd2\x01\vlogs_filter\xd2\x01\x05rules*\xa3\x01\n" +
	"ELearn more about log-based, time-relative alerts in our documentation\x12Zhttps://coralogix.com/docs/user-guides/alerting/create-an-alert/logs/time-relative-alerts/\"\xb7\x01\n" +
	"\x14LogsTimeRelativeRule\x12T\n" +
	"\tcondition\x18\x01 \x01(\v26.com.coralogixapis.alerts.v3.LogsTimeRelativeConditionR\tcondition\x12I\n" +
	"\boverride\x18\x02 \x01(\v2-.com.coralogixapis.alerts.v3.AlertDefOverrideR\boverride\"\x9b\x03\n" +
	"\x19LogsTimeRelativeCondition\x12E\n" +
	"\tthreshold\x18\x01 \x01(\v2\x1c.google.protobuf.DoubleValueB\t\x92A\x06J\x0410.0R\tthreshold\x12X\n" +
	"\vcompared_to\x18\x02 \x01(\x0e27.com.coralogixapis.alerts.v3.LogsTimeRelativeComparedToR\n" +
	"comparedTo\x12a\n" +
	"\x0econdition_type\x18\x04 \x01(\x0e2:.com.coralogixapis.alerts.v3.LogsTimeRelativeConditionTypeR\rconditionType:z\x92Aw\n" +
