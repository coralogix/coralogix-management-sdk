...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_logs_time_relative_threshold_type_definition_proto_rawDesc = "" +
	...
	"\x8a\x01*\x17Logs Time Relative Rule2XLogsTimeRelativeRule is a message that defines a rule for log-based time-relative alerts\xd2\x01\tcondition\xd2\x01\boverride\"\x93\x05\n" +
	...
	"\x0econdition_type\x18\x04 \x01(\x0e2:.com.coralogixapis.alerts.v3.LogsTimeRelativeConditionTypeBf\x9aAc2#The type of condition for the alertJ<\"LOGS_TIME_RELATIVE_CONDITION_TYPE_MORE_THAN_OR_UNSPECIFIED\"R\rconditionType:z\x9aAw\n" +
	"u*!Log-based time-relative condition26Defines conditions for time-relative comparison alerts\xd2\x01\tthreshold\xd2\x01\vcompared_tob\x06proto3"
