...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_logs_time_relative_threshold_type_definition_proto_rawDesc = "" +
	...
	"\x0fignore_infinity\x18\x03 \x01(\v2\x1a.google.protobuf.BoolValueB.\x9aA+2#Ignore infinity values in the alertJ\x04trueR\x0eignoreInfinity\x12p\n" +
	"\x1bnotification_payload_filter\x18\x04 \x03(\v2\x1c.google.protobuf.StringValueB\x12\x9aA\x0fJ\r[\"obj.field\"]R\x19notificationPayloadFilter\x12\xbe\x01\n" +
	...
	"\x13evaluation_delay_ms\x18\x06 \x01(\v2\x1b.google.protobuf.Int32ValueBK\x9aAH2?The delay in milliseconds before evaluating the alert conditionJ\x0560000R\x11evaluationDelayMs:\xd2\x02\x9aA\xce\x02\n" +
	"\xa5\x01*,Log-based time-relative threshold alert type2uConfiguration for alerts that are triggered when a fixed ratio reaches a set threshold compared to a past time frame.*\xa3\x01\n" +
	"ELearn more about log-based, time-relative alerts in our documentation\x12Zhttps://coralogix.com/docs/user-guides/alerting/create-an-alert/logs/time-relative-alerts/\"\x8e\x03\n" +
	...
	"\boverride\x18\x02 \x01(\v2-.com.coralogixapis.alerts.v3.AlertDefOverrideB)\x9aA&2$The override settings for the alert.R\boverride:x\x9aAu\n" +
	"s*\x17Logs Time Relative Rule2XLogsTimeRelativeRule is a message that defines a rule for log-based time-relative alerts\"\xf9\x04\n" +
	...
	"\x0econdition_type\x18\x04 \x01(\x0e2:.com.coralogixapis.alerts.v3.LogsTimeRelativeConditionTypeBf\x9aAc2#The type of condition for the alertJ<\"LOGS_TIME_RELATIVE_CONDITION_TYPE_MORE_THAN_OR_UNSPECIFIED\"R\rconditionType:`\x9aA]\n" +
	"[*!Log-based time-relative condition26Defines conditions for time-relative comparison alertsb\x06proto3"
