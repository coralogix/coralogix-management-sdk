...
type DynamicAlertMatch struct {
	...
	ForecastTimestamp *wrappers.UInt64Value `protobuf:"bytes,4,opt,name=forecast_timestamp,json=forecastTimestamp,proto3" json:"forecast_timestamp,omitempty"`
}
...
func (x *DynamicAlertMatch) GetForecastTimestamp() *wrappers.UInt64Value {
	if x != nil {
...
type ObservedDetails struct {
	...
	Ratio         *wrappers.DoubleValue `protobuf:"bytes,3,opt,name=ratio,proto3" json:"ratio,omitempty"`
}
...
func (x *ObservedDetails) GetFromTimestamp() *timestamp.Timestamp {
	if x != nil {
...
func (x *ObservedDetails) GetToTimestamp() *timestamp.Timestamp {
	if x != nil {
...
func (x *ObservedDetails) GetRatio() *wrappers.DoubleValue {
	if x != nil {
		return x.Ratio
	}
	return nil
...
type TopBucket struct {
	...
	Limits    []*wrappers.DoubleValue `protobuf:"bytes,1,rep,name=limits,proto3" json:"limits,omitempty"`
	Timestamp *timestamp.Timestamp    `protobuf:"bytes,2,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	Value     *wrappers.DoubleValue   `protobuf:"bytes,3,opt,name=value,proto3" json:"value,omitempty"`
}
...
func (x *TopBucket) GetLimits() []*wrappers.DoubleValue {
	if x != nil {
		return x.Limits
	}
	return nil
...
func (x *TopBucket) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *TopBucket) GetValue() *wrappers.DoubleValue {
	if x != nil {
		return x.Value
	}
	return nil
