...
var file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_usual_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_usual_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_usual_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_usual_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DynamicAlertMatch); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_usual_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ObservedDetails); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_usual_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_usual_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SearchDetailsInterval); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_usual_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TopBucket); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
