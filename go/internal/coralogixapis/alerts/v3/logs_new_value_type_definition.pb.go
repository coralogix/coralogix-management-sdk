...
func (x *LogsNewValueType) GetNotificationPayloadFilter() []*wrappers.StringValue {
	if x != nil {
...
type LogsNewValueCondition struct {
	...
	KeypathToTrack *wrappers.StringValue   `protobuf:"bytes,1,opt,name=keypath_to_track,json=keypathToTrack,proto3" json:"keypath_to_track,omitempty"`
...
func (x *LogsNewValueCondition) GetKeypathToTrack() *wrappers.StringValue {
	if x != nil {
