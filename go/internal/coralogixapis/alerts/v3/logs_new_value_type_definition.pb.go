...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_logs_logs_new_value_type_definition_proto_rawDesc = "" +
	...
	"logsFilter\x12v\n" +
	"\x05rules\x18\x02 \x03(\v2-.com.coralogixapis.alerts.v3.LogsNewValueRuleB1\x9aA.2&The rules for the log new value alert.\xa0\x01\x01\xa8\x01\x01R\x05rules\x12\xbc\x01\n" +
	"\x1bnotification_payload_filter\x18\x03 \x03(\v2\x1c.google.protobuf.StringValueB^\x9aA[2JThe filter to specify which fields to include in the notification payload.J\r[\"obj.field\"]R\x19notificationPayloadFilter:i\x9aAf\n" +
	"d*\x1eLog-based new value alert type2BConfiguration for alerts triggered by new values appearing in logs\"\xf4\x01\n" +
	"\x10LogsNewValueRule\x12\x86\x01\n" +
	"\tcondition\x18\x01 \x01(\v22.com.coralogixapis.alerts.v3.LogsNewValueConditionB4\x9aA12/The condition for detecting new values in logs.R\tcondition:W\x9aAT\n" +
	"R*\x18Log-based new value rule26Defines the condition for detecting new values in logs\"\xfd\x02\n" +
	...
	"timeWindow:Y\x9aAV\n" +
	"T*\x1dLog-based new value condition23Defines conditions for detecting new values in logsb\x06proto3"
