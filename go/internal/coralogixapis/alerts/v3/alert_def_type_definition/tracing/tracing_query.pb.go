...
var file_com_coralogixapis_alerts_v3_alert_def_type_definition_tracing_tracing_query_proto_rawDesc = []byte{
	...
	0x54, 0x59, 0x50, 0x45, 0x5f, 0x49, 0x53, 0x5f, 0x4e, 0x4f, 0x54, 0x10, 0x04, 0x62, 0x06, 0x70,
...
var file_com_coralogixapis_alerts_v3_alert_def_type_definition_tracing_tracing_query_proto_goTypes = []any{
...
func file_com_coralogixapis_alerts_v3_alert_def_type_definition_tracing_tracing_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v3_alert_def_type_definition_tracing_tracing_query_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_alerts_v3_alert_def_type_definition_tracing_tracing_query_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_alerts_v3_alert_def_type_definition_tracing_tracing_query_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_alerts_v3_alert_def_type_definition_tracing_tracing_query_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_com_coralogixapis_alerts_v3_alert_def_type_definition_tracing_tracing_query_proto_msgTypes[0].OneofWrappers = []any{
