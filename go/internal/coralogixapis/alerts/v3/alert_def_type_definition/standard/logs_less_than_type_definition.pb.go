...
type LogsLessThanTypeDefinition struct {
	...
	UndetectedValuesManagement *alert_def_type_definition.UndetectedValuesManagement `protobuf:"bytes,4,opt,name=undetected_values_management,json=undetectedValuesManagement,proto3" json:"undetected_values_management,omitempty"`
...
func (x *LogsLessThanTypeDefinition) GetLogsFilter() *alert_def_type_definition.LogsFilter {
	if x != nil {
		return x.LogsFilter
	}
	return nil
...
func (x *LogsLessThanTypeDefinition) GetUndetectedValuesManagement() *alert_def_type_definition.UndetectedValuesManagement {
	if x != nil {
...
var file_com_coralogixapis_alerts_v3_alert_def_type_definition_standard_logs_less_than_type_definition_proto_rawDesc = []byte{
	...
	0x64, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_com_coralogixapis_alerts_v3_alert_def_type_definition_standard_logs_less_than_type_definition_proto_goTypes = []any{
	...
	(*alert_def_type_definition.UndetectedValuesManagement)(nil), // 4: com.coralogixapis.alerts.v3.UndetectedValuesManagement
...
func file_com_coralogixapis_alerts_v3_alert_def_type_definition_standard_logs_less_than_type_definition_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v3_alert_def_type_definition_standard_logs_less_than_type_definition_proto_msgTypes[0].Exporter = func(v any, i int) any {
