...
var file_com_coralogixapis_alerts_v3_alert_def_type_definition_unique_count_unique_value_timewindow_proto_goTypes = []any{
...
func file_com_coralogixapis_alerts_v3_alert_def_type_definition_unique_count_unique_value_timewindow_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v3_alert_def_type_definition_unique_count_unique_value_timewindow_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_com_coralogixapis_alerts_v3_alert_def_type_definition_unique_count_unique_value_timewindow_proto_msgTypes[0].OneofWrappers = []any{
