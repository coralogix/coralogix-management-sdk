...
func (x *EventTimeRelativeMoreThan) GetResultHitValue() isEventTimeRelativeMoreThan_ResultHitValue {
	if x != nil {
...
func (x *EventTimeRelativeMoreThan) GetNumeric() *wrapperspb.FloatValue {
	if x != nil {
		if x, ok := x.ResultHitValue.(*EventTimeRelativeMoreThan_Numeric); ok {
			return x.Numeric
		}
	}
	return nil
...
func (x *EventTimeRelativeMoreThan) GetSpecial() SpecialRatioValues {
	if x != nil {
		if x, ok := x.ResultHitValue.(*EventTimeRelativeMoreThan_Special); ok {
			return x.Special
		}
	}
...
func (x *EventTimeRelativeMoreThan) GetSeverity() *AlertDefSeverity {
	if x != nil {
		return x.Severity
	}
	return nil
...
var file_com_coralogixapis_alerts_v3_event_payload_time_relative_event_time_relative_more_than_proto_rawDesc = string([]byte{
	...
	0x74, 0x54, 0x69, 0x6d, 0x65, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x76, 0x65, 0x4d, 0x6f, 0x72,
	0x65, 0x54, 0x68, 0x61, 0x6e, 0x12, 0x4b, 0x0a, 0x13, 0x6e, 0x75, 0x6d, 0x65, 0x72, 0x61, 0x74,
...
var (
	...
	file_com_coralogixapis_alerts_v3_event_payload_time_relative_event_time_relative_more_than_proto_rawDescData []byte
)
...
func file_com_coralogixapis_alerts_v3_event_payload_time_relative_event_time_relative_more_than_proto_rawDescGZIP() []byte {
	file_com_coralogixapis_alerts_v3_event_payload_time_relative_event_time_relative_more_than_proto_rawDescOnce.Do(func() {
		file_com_coralogixapis_alerts_v3_event_payload_time_relative_event_time_relative_more_than_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogixapis_alerts_v3_event_payload_time_relative_event_time_relative_more_than_proto_rawDesc), len(file_com_coralogixapis_alerts_v3_event_payload_time_relative_event_time_relative_more_than_proto_rawDesc)))
	})
...
var file_com_coralogixapis_alerts_v3_event_payload_time_relative_event_time_relative_more_than_proto_depIdxs = []int32{
	...
	5, // 6: com.coralogixapis.alerts.v3.EventTimeRelativeMoreThan.severity:type_name -> com.coralogixapis.alerts.v3.AlertDefSeverity
...
func file_com_coralogixapis_alerts_v3_event_payload_time_relative_event_time_relative_more_than_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogixapis_alerts_v3_event_payload_time_relative_event_time_relative_more_than_proto_rawDesc), len(file_com_coralogixapis_alerts_v3_event_payload_time_relative_event_time_relative_more_than_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
