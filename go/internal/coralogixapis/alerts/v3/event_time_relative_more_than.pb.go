...
func (x *EventTimeRelativeMoreThan) GetNumeratorHitValue() *wrappers.Int64Value {
	if x != nil {
...
func (x *EventTimeRelativeMoreThan) GetDenominatorHitValue() *wrappers.Int64Value {
	if x != nil {
...
func (x *EventTimeRelativeMoreThan) GetNumeric() *wrappers.FloatValue {
...
func (x *EventTimeRelativeMoreThan) GetFromTimestamp() *timestamp.Timestamp {
	if x != nil {
...
func (x *EventTimeRelativeMoreThan) GetToTimestamp() *timestamp.Timestamp {
	if x != nil {
