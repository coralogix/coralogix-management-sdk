...
const file_com_coralogixapis_alerts_v3_event_payload_time_relative_event_time_relative_more_than_proto_rawDesc = "" +
	"\n" +
	"[com/coralogixapis/alerts/v3/event/payload/time_relative/event_time_relative_more_than.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1aDcom/coralogixapis/alerts/v3/event/payload/ratio_special_values.proto\x1a4com/coralogixapis/alerts/v3/alert_def_severity.proto\"\xa0\x04\n" +
	"\x19EventTimeRelativeMoreThan\x12K\n" +
