...
func (x *EventMetricMoreThan) GetPercentageOverThreshold() *wrappers.FloatValue {
	if x != nil {
...
func (x *EventMetricMoreThan) GetAvgValueAcrossThreshold() *wrappers.FloatValue {
	if x != nil {
...
func (x *EventMetricMoreThan) GetMinValueAcrossThreshold() *wrappers.FloatValue {
	if x != nil {
...
func (x *EventMetricMoreThan) GetMaxValueAcrossThreshold() *wrappers.FloatValue {
	if x != nil {
...
func (x *EventMetricMoreThan) GetFromTimestamp() *timestamp.Timestamp {
	if x != nil {
...
func (x *EventMetricMoreThan) GetToTimestamp() *timestamp.Timestamp {
	if x != nil {
