...
const file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_proto_rawDesc = "" +
	"\n" +
	"Mcom/coralogixapis/alerts/v3/event/payload/metric/event_metric_more_than.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a4com/coralogixapis/alerts/v3/alert_def_severity.proto\"\xb5\x05\n" +
	"\x13EventMetricMoreThan\x12W\n" +
...
var (
	...
	file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_proto_rawDescData []byte
)
...
func file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_proto_rawDescGZIP() []byte {
	file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_proto_rawDescOnce.Do(func() {
		file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_proto_rawDesc), len(file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_proto_rawDesc)))
	})
...
func file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_proto_rawDesc), len(file_com_coralogixapis_alerts_v3_event_payload_metric_event_metric_more_than_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
