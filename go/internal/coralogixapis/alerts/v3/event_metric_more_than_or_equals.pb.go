...
func (x *EventMetricMoreThanOrEquals) GetPercentageOverThreshold() *wrappers.FloatValue {
	if x != nil {
...
func (x *EventMetricMoreThanOrEquals) GetAvgValueAcrossThreshold() *wrappers.FloatValue {
	if x != nil {
...
func (x *EventMetricMoreThanOrEquals) GetMinValueAcrossThreshold() *wrappers.FloatValue {
	if x != nil {
...
func (x *EventMetricMoreThanOrEquals) GetMaxValueAcrossThreshold() *wrappers.FloatValue {
	if x != nil {
...
func (x *EventMetricMoreThanOrEquals) GetFromTimestamp() *timestamp.Timestamp {
	if x != nil {
...
func (x *EventMetricMoreThanOrEquals) GetToTimestamp() *timestamp.Timestamp {
	if x != nil {
