...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_metric_metric_threshold_type_definition_proto_rawDesc = "" +
	...
	"\x13evaluation_delay_ms\x18\x05 \x01(\v2\x1b.google.protobuf.Int32ValueR\x11evaluationDelayMs:y\x92Av\n" +
	"t*\x1bMetric Threshold Alert Type2=Configuration for alerts based on metric threshold violations\xd2\x01\rmetric_source\xd2\x01\x05rules\"\xb5\x01\n" +
