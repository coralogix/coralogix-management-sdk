...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_metric_metric_threshold_type_definition_proto_rawDesc = "" +
	...
	"\x13evaluation_delay_ms\x18\x05 \x01(\v2\x1b.google.protobuf.Int32ValueBK\x9aAH2?The delay in milliseconds before evaluating the alert conditionJ\x0560000R\x11evaluationDelayMs:\xb5\x02\x9aA\xb1\x02\n" +
	...
	"\boverride\x18\x02 \x01(\v2-.com.coralogixapis.alerts.v3.AlertDefOverrideB\x1c\x9aA\x192\x17Alert override settingsR\boverride:e\x9aAb\n" +
	"`*\x15Metric Threshold Rule20Defines a rule for metric-based threshold alerts\xd2\x01\tcondition\xd2\x01\boverride\"\x84\x06\n" +
	"\x18MetricThresholdCondition\x12\x83\x01\n" +
	"\tthreshold\x18\x01 \x01(\v2\x1c.google.protobuf.DoubleValueBG\x9aAD2+The threshold value for the alert conditionJ\x05100.0\x8a\x01\r^\\d+(\\.\\d+)?$R\tthreshold\x12\xa8\x01\n" +
	"\ffor_over_pct\x18\x02 \x01(\v2\x1c.google.protobuf.UInt32ValueBh\x9aAe2LThe percentage of values that must exceed the threshold to trigger the alertJ\x0280\x8a\x01\x10^(100|[1-9]?\\d)$R\n" +
	"forOverPct\x12{\n" +
	...
	"\x0econdition_type\x18\x05 \x01(\x0e29.com.coralogixapis.alerts.v3.MetricThresholdConditionTypeB[\x9aAX2\x1fThe type of the alert conditionJ5\"METRIC_THRESHOLD_CONDITION_TYPE_MORE_THAN_OR_EQUALS\"R\rconditionType:z\x9aAw\n" +
	"u*\x1aMetric Threshold Condition2.Defines conditions for metric threshold alerts\xd2\x01\tthreshold\xd2\x01\ffor_over_pct\xd2\x01\vof_the_lastb\x06proto3"
