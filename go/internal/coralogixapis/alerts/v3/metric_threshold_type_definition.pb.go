...
const file_com_coralogixapis_alerts_v3_alert_def_type_definition_metric_metric_threshold_type_definition_proto_rawDesc = "" +
	"\n" +
	"ccom/coralogixapis/alerts/v3/alert_def_type_definition/metric/metric_threshold_type_definition.proto\x12\x1bcom.coralogixapis.alerts.v3\x1a[com/coralogixapis/alerts/v3/alert_def_type_definition/metric/common/metric_timewindow.proto\x1aXcom/coralogixapis/alerts/v3/alert_def_type_definition/metric/common/metrics_filter.proto\x1alcom/coralogixapis/alerts/v3/alert_def_type_definition/metric/threshold/metric_threshold_condition_type.proto\x1alcom/coralogixapis/alerts/v3/alert_def_type_definition/metric/threshold/metric_threshold_missing_values.proto\x1aEcom/coralogixapis/alerts/v3/alert_def_type_definition/overrides.proto\x1aXcom/coralogixapis/alerts/v3/alert_def_type_definition/undetected_values_management.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\x99\b\n" +
	"\x13MetricThresholdType\x12\x86\x01\n" +
	"\rmetric_filter\x18\x01 \x01(\v2).com.coralogixapis.alerts.v3.MetricFilterB6\x9aA321The filter to match metric entries for the alert.R\fmetricFilter\x12{\n" +
	"\x05rules\x18\x02 \x03(\v20.com.coralogixapis.alerts.v3.MetricThresholdRuleB3\x9aA02(The rules for the metric threshold alert\xa0\x01\x05\xa8\x01\x01R\x05rules\x12\xba\x01\n" +
	"\x1cundetected_values_management\x18\x03 \x01(\v27.com.coralogixapis.alerts.v3.UndetectedValuesManagementB?\x9aA<2:Configuration for handling undetected values in the alert.R\x1aundetectedValuesManagement\x12\x95\x01\n" +
	"\x0emissing_values\x18\x04 \x01(\v20.com.coralogixapis.alerts.v3.MetricMissingValuesB<\x9aA927Configuration for handling missing values in the alert.R\rmissingValues\x12\x98\x01\n" +
	"\x13evaluation_delay_ms\x18\x05 \x01(\v2\x1b.google.protobuf.Int32ValueBK\x9aAH2?The delay in milliseconds before evaluating the alert conditionJ\x0560000R\x11evaluationDelayMs:\x8b\x02\x9aA\x87\x02\n" +
	"b*!Metric-based threshold alert type2=Configuration for alerts based on metric threshold violations*\xa0\x01\n" +
	"CLearn more about metric-based threshold alerts in our documentation\x12Yhttps://coralogix.com/docs/user-guides/alerting/create-an-alert/metrics/threshold-alerts/\"\xd7\x02\n" +
	"\x13MetricThresholdRule\x12\x86\x01\n" +
	"\tcondition\x18\x01 \x01(\v25.com.coralogixapis.alerts.v3.MetricThresholdConditionB1\x9aA.2,The condition for the metric threshold alertR\tcondition\x12g\n" +
	"\boverride\x18\x02 \x01(\v2-.com.coralogixapis.alerts.v3.AlertDefOverrideB\x1c\x9aA\x192\x17Alert override settingsR\boverride:N\x9aAK\n" +
	"I*\x15Metric Threshold Rule20Defines a rule for metric-based threshold alerts\"\xb7\x05\n" +
	"\x18MetricThresholdCondition\x12s\n" +
	"\tthreshold\x18\x01 \x01(\v2\x1c.google.protobuf.DoubleValueB7\x9aA42+The threshold value for the alert conditionJ\x05100.0R\tthreshold\x12\x95\x01\n" +
	"\ffor_over_pct\x18\x02 \x01(\v2\x1c.google.protobuf.UInt32ValueBU\x9aAR2LThe percentage of values that must exceed the threshold to trigger the alertJ\x0280R\n" +
	"forOverPct\x12{\n" +
	"\vof_the_last\x18\x03 \x01(\v2-.com.coralogixapis.alerts.v3.MetricTimeWindowB,\x9aA)2'The time window for the alert conditionR\tofTheLast\x12\xbd\x01\n" +
	"\x0econdition_type\x18\x05 \x01(\x0e29.com.coralogixapis.alerts.v3.MetricThresholdConditionTypeB[\x9aAX2\x1fThe type of the alert conditionJ5\"METRIC_THRESHOLD_CONDITION_TYPE_MORE_THAN_OR_EQUALS\"R\rconditionType:Q\x9aAN\n" +
	"L*\x1aMetric Threshold Condition2.Defines conditions for metric threshold alertsb\x06proto3"
