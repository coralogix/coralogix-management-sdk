...
type MetricThresholdCondition struct {
	...
	Threshold     *wrappers.DoubleValue        `protobuf:"bytes,1,opt,name=threshold,proto3" json:"threshold,omitempty"`
	ForOverPct    *wrappers.UInt32Value        `protobuf:"bytes,2,opt,name=for_over_pct,json=forOverPct,proto3" json:"for_over_pct,omitempty"`
...
func (x *MetricThresholdCondition) GetThreshold() *wrappers.DoubleValue {
	if x != nil {
		return x.Threshold
	}
	return nil
...
func (x *MetricThresholdCondition) GetForOverPct() *wrappers.UInt32Value {
	if x != nil {
		return x.ForOverPct
	}
	return nil
