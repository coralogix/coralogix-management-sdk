...
type LogsRatioThresholdType struct {
	...
	NumeratorAlias             *wrappers.StringValue       `protobuf:"bytes,2,opt,name=numerator_alias,json=numeratorAlias,proto3" json:"numerator_alias,omitempty"`
	Denominator                *LogsFilter                 `protobuf:"bytes,3,opt,name=denominator,proto3" json:"denominator,omitempty"`
	DenominatorAlias           *wrappers.StringValue       `protobuf:"bytes,4,opt,name=denominator_alias,json=denominatorAlias,proto3" json:"denominator_alias,omitempty"`
	Rules                      []*LogsRatioRules           `protobuf:"bytes,5,rep,name=rules,proto3" json:"rules,omitempty"`
	IgnoreInfinity             *wrappers.BoolValue         `protobuf:"bytes,9,opt,name=ignore_infinity,json=ignoreInfinity,proto3" json:"ignore_infinity,omitempty"`
	NotificationPayloadFilter  []*wrappers.StringValue     `protobuf:"bytes,6,rep,name=notification_payload_filter,json=notificationPayloadFilter,proto3" json:"notification_payload_filter,omitempty"`
...
func (x *LogsRatioThresholdType) GetNumeratorAlias() *wrappers.StringValue {
	if x != nil {
...
func (x *LogsRatioThresholdType) GetDenominatorAlias() *wrappers.StringValue {
	if x != nil {
...
func (x *LogsRatioThresholdType) GetIgnoreInfinity() *wrappers.BoolValue {
	if x != nil {
...
func (x *LogsRatioThresholdType) GetNotificationPayloadFilter() []*wrappers.StringValue {
	if x != nil {
...
func (x *LogsRatioCondition) GetThreshold() *wrappers.DoubleValue {
	if x != nil {
		return x.Threshold
	}
	return nil
