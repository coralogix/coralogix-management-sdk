...
// UnimplementedEvents2MetricServiceServer must be embedded to have
...
func (UnimplementedEvents2MetricServiceServer) AtomicBatchExecuteE2M(context.Context, *AtomicBatchExecuteE2MRequest) (*AtomicBatchExecuteE2MResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AtomicBatchExecuteE2M not implemented")
}
func (UnimplementedEvents2MetricServiceServer) ListLabelsCardinality(context.Context, *ListLabelsCardinalityRequest) (*ListLabelsCardinalityResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListLabelsCardinality not implemented")
}
...
func (UnimplementedEvents2MetricServiceServer) testEmbeddedByValue()                              {}
...
func RegisterEvents2MetricServiceServer(s grpc.ServiceRegistrar, srv Events2MetricServiceServer) {
	// If the following call panics, it indicates UnimplementedEvents2MetricServiceServer was
