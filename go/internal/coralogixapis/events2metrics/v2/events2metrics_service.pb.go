...
const file_com_coralogixapis_events2metrics_v2_events2metrics_service_proto_rawDesc = "" +
	"\n" +
	"@com/coralogixapis/events2metrics/v2/events2metrics_service.proto\x12#com.coralogixapis.events2metrics.v2\x1aCcom/coralogixapis/events2metrics/v2/events2metrics_definition.proto\x1a'com/coralogix/common/v1/audit_log.proto\x1a2com/coralogixapis/logs2metrics/v2/logs_query.proto\x1a4com/coralogixapis/spans2metrics/v2/spans_query.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xac\x02\n" +
	"\x10CreateE2MRequest\x12F\n" +
	"\x03e2m\x18\x01 \x01(\v24.com.coralogixapis.events2metrics.v2.E2MCreateParamsR\x03e2m:\xcf\x01\x92A\xcb\x01\n" +
	"S*\x12Create E2M Request27This is used to create a new event to metric definition\xd2\x01\x03e2m*t\n" +
	"\"Find out more about events2metrics\x12Nhttps://coralogix.com/docs/user-guides/monitoring-and-insights/events2metrics/\"O\n" +
	"\x11CreateE2MResponse\x12:\n" +
	"\x03e2m\x18\x01 \x01(\v2(.com.coralogixapis.events2metrics.v2.E2MR\x03e2m\"\x10\n" +
	"\x0eListE2MRequest\"\xb1\x02\n" +
	"\x0fListE2MResponse\x12:\n" +
	"\x03e2m\x18\x01 \x03(\v2(.com.coralogixapis.events2metrics.v2.E2MR\x03e2m:\xe1\x01\x92A\xdd\x01\n" +
	"e*\x11List E2M Response2JThis is the response obtained when listing all event to metric definitions\xd2\x01\x03e2m*t\n" +
	"\"Find out more about events2metrics\x12Nhttps://coralogix.com/docs/user-guides/monitoring-and-insights/events2metrics/\"\xb8\x02\n" +
	"\x11ReplaceE2MRequest\x12:\n" +
	"\x03e2m\x18\x01 \x01(\v2(.com.coralogixapis.events2metrics.v2.E2MR\x03e2m:\xe6\x01\x92A\xe2\x01\n" +
	"j*\x13Replace E2M Request2MThis data structure is used to replace an existing event to metric definition\xd2\x01\x03e2m*t\n" +
	"\"Find out more about events2metrics\x12Nhttps://coralogix.com/docs/user-guides/monitoring-and-insights/events2metrics/\"\xc2\x02\n" +
	"\x12ReplaceE2MResponse\x12:\n" +
	"\x03e2m\x18\x01 \x01(\v2(.com.coralogixapis.events2metrics.v2.E2MR\x03e2m:\xef\x01\x92A\xeb\x01\n" +
	...
	"\"Find out more about events2metrics\x12Nhttps://coralogix.com/docs/user-guides/monitoring-and-insights/events2metrics/\"\xd0\x02\n" +
	"\rGetE2MRequest\x12Y\n" +
	"\x02id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueB+\x92A(J&\"d6a3658e-78d2-47d0-9b81-b2c551f01b09\"R\x02id:\xe3\x01\x92A\xdf\x01\n" +
	"g*\x10Get E2M Response2NThis data structure is used to retrieve an existing event to metric definition\xd2\x01\x02id*t\n" +
	"\"Find out more about events2metrics\x12Nhttps://coralogix.com/docs/user-guides/monitoring-and-insights/events2metrics/\"\xbb\x02\n" +
	"\x0eGetE2MResponse\x12:\n" +
	"\x03e2m\x18\x01 \x01(\v2(.com.coralogixapis.events2metrics.v2.E2MR\x03e2m:\xec\x01\x92A\xe8\x01\n" +
	...
	"\"Find out more about events2metrics\x12Nhttps://coralogix.com/docs/user-guides/monitoring-and-insights/events2metrics/\"\xd3\x02\n" +
	"\x10DeleteE2MRequest\x12Y\n" +
	"\x02id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueB+\x92A(J&\"d6a3658e-78d2-47d0-9b81-b2c551f01b09\"R\x02id:\xe3\x01\x92A\xdf\x01\n" +
	"g*\x12Delete E2M Request2LThis data structure is used to delete an existing event to metric definition\xd2\x01\x02id*t\n" +
	"\"Find out more about events2metrics\x12Nhttps://coralogix.com/docs/user-guides/monitoring-and-insights/events2metrics/\"\xaf\x02\n" +
	"\x11DeleteE2MResponse\x12,\n" +
	"\x02id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x02id:\xeb\x01\x92A\xe7\x01\n" +
	...
	"\arequest\"t\n" +
	"\x1cAtomicBatchExecuteE2MRequest\x12T\n" +
	"\brequests\x18\x01 \x03(\v28.com.coralogixapis.events2metrics.v2.E2MExecutionRequestR\brequests\"\xa1\x02\n" +
	...
	"\n" +
	"\bresponse\"\x89\x01\n" +
	"\x1dAtomicBatchExecuteE2MResponse\x12h\n" +
	"\x12matching_responses\x18\x01 \x03(\v29.com.coralogixapis.events2metrics.v2.E2MExecutionResponseR\x11matchingResponses\"\xa0\x02\n" +
	"\x1cListLabelsCardinalityRequest\x12Q\n" +
	"\vspans_query\x18\x01 \x01(\v2..com.coralogixapis.spans2metrics.v2.SpansQueryH\x00R\n" +
	"spansQuery\x12M\n" +
	"\n" +
	"logs_query\x18\x02 \x01(\v2,.com.coralogixapis.logs2metrics.v2.LogsQueryH\x00R\tlogsQuery\x12U\n" +
	"\rmetric_labels\x18\x03 \x03(\v20.com.coralogixapis.events2metrics.v2.MetricLabelR\fmetricLabelsB\a\n" +
	"\x05query\"X\n" +
	" LabelsPermutationsCardinalityDay\x12\x10\n" +
	"\x03day\x18\x01 \x01(\tR\x03day\x12\"\n" +
	"\fpermutations\x18\x02 \x01(\x05R\fpermutations\"\x8a\x01\n" +
	"\x1dListLabelsCardinalityResponse\x12i\n" +
	"\fpermutations\x18\x01 \x03(\v2E.com.coralogixapis.events2metrics.v2.LabelsPermutationsCardinalityDayR\fpermutations\"\x12\n" +
	"\x10GetLimitsRequest\"\xbf\x03\n" +
	"\x11GetLimitsResponse\x12;\n" +
	"\n" +
	"company_id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\tcompanyId\x12!\n" +
	"\flabels_limit\x18\x02 \x01(\x05R\vlabelsLimit\x12p\n" +
	...
	"\rmetrics_limit\x18\x04 \x01(\v2A.com.coralogixapis.events2metrics.v2.GetLimitsResponse.LimitUsageR\fmetricsLimit\x1ap\n" +
	"\n" +
	"LimitUsage\x121\n" +
	"\x05limit\x18\x01 \x01(\v2\x1b.google.protobuf.Int32ValueR\x05limit\x12/\n" +
	"\x04used\x18\x02 \x01(\v2\x1b.google.protobuf.Int32ValueR\x04used2\x9f\f\n" +
	"\x14Events2MetricService\x12\xb3\x01\n" +
	"\tCreateE2M\x125.com.coralogixapis.events2metrics.v2.CreateE2MRequest\x1a6.com.coralogixapis.events2metrics.v2.CreateE2MResponse\"7¸\x02\x10\n" +
	"\x0eCreate new E2M\x82\xd3\xe4\x93\x02\x1d:\x03e2m\"\x16/api/v2/events2metrics\x12\xa6\x01\n" +
	"\aListE2M\x123.com.coralogixapis.events2metrics.v2.ListE2MRequest\x1a4.com.coralogixapis.events2metrics.v2.ListE2MResponse\"0¸\x02\x0e\n" +
	"\fList all E2M\x82\xd3\xe4\x93\x02\x18\x12\x16/api/v2/events2metrics\x12\xb3\x01\n" +
	"\n" +
	"ReplaceE2M\x126.com.coralogixapis.events2metrics.v2.ReplaceE2MRequest\x1a7.com.coralogixapis.events2metrics.v2.ReplaceE2MResponse\"4¸\x02\r\n" +
	"\vReplace E2M\x82\xd3\xe4\x93\x02\x1d:\x03e2m\x1a\x16/api/v2/events2metrics\x12\xa3\x01\n" +
	"\x06GetE2M\x122.com.coralogixapis.events2metrics.v2.GetE2MRequest\x1a3.com.coralogixapis.events2metrics.v2.GetE2MResponse\"0¸\x02\t\n" +
	"\aGet E2M\x82\xd3\xe4\x93\x02\x1d\x12\x1b/api/v2/events2metrics/{id}\x12\xaf\x01\n" +
	"\tDeleteE2M\x125.com.coralogixapis.events2metrics.v2.DeleteE2MRequest\x1a6.com.coralogixapis.events2metrics.v2.DeleteE2MResponse\"3¸\x02\f\n" +
	"\n" +
	"Delete E2M\x82\xd3\xe4\x93\x02\x1d*\x1b/api/v2/events2metrics/{id}\x12\xf4\x01\n" +
	"\x15AtomicBatchExecuteE2M\x12A.com.coralogixapis.events2metrics.v2.AtomicBatchExecuteE2MRequest\x1aB.com.coralogixapis.events2metrics.v2.AtomicBatchExecuteE2MResponse\"T¸\x02\x1a\n" +
	"\x18Atomic Batch Execute E2M\x82\xd3\xe4\x93\x020:\x01*\"+/api/v2/events2metrics/atomic_batch_execute\x12\xee\x01\n" +
	"\x15ListLabelsCardinality\x12A.com.coralogixapis.events2metrics.v2.ListLabelsCardinalityRequest\x1aB.com.coralogixapis.events2metrics.v2.ListLabelsCardinalityResponse\"N¸\x02\x19\n" +
	"\x17List Labels Cardinality\x82\xd3\xe4\x93\x02+\x12)/api/v2/events2metrics/labels_cardinality\x12\xb1\x01\n" +
	"\tGetLimits\x125.com.coralogixapis.events2metrics.v2.GetLimitsRequest\x1a6.com.coralogixapis.events2metrics.v2.GetLimitsResponse\"5¸\x02\f\n" +
	"\n" +
	"get limits\x82\xd3\xe4\x93\x02\x1f\x12\x1d/api/v2/events2metrics/limitsb\x06proto3"
