...
func (x *GetE2MRequest) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *DeleteE2MRequest) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *DeleteE2MResponse) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
type GetLimitsResponse struct {
	...
	// company id
	CompanyId *wrappers.StringValue `protobuf:"bytes,1,opt,name=company_id,json=companyId,proto3" json:"company_id,omitempty"`
	// labels limit
...
func (x *GetLimitsResponse) GetCompanyId() *wrappers.StringValue {
	if x != nil {
		return x.CompanyId
	}
	return nil
...
type GetLimitsResponse_LimitUsage struct {
	...
	Used *wrappers.Int32Value `protobuf:"bytes,2,opt,name=used,proto3" json:"used,omitempty"`
}
...
func (x *GetLimitsResponse_LimitUsage) GetLimit() *wrappers.Int32Value {
	if x != nil {
		return x.Limit
	}
	return nil
...
func (x *GetLimitsResponse_LimitUsage) GetUsed() *wrappers.Int32Value {
	if x != nil {
		return x.Used
	}
	return nil
