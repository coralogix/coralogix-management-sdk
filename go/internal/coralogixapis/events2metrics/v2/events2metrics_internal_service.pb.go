...
type CreateE2MRequestInternal struct {
	...
	IsInternal *wrappers.BoolValue `protobuf:"bytes,2,opt,name=is_internal,json=isInternal,proto3" json:"is_internal,omitempty"`
}
...
func (x *CreateE2MRequestInternal) GetIsInternal() *wrappers.BoolValue {
	if x != nil {
		return x.IsInternal
	}
	return nil
...
func (x *DeleteE2MRequestInternal) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *DeleteE2MResponseInternal) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
