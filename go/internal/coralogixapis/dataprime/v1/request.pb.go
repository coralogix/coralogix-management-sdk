...
func (x *QueryRequest) GetQuery() *wrappers.StringValue {
	if x != nil {
		return x.Query
	}
	return nil
...
type Metadata struct {
	...
	StartDate *timestamp.Timestamp `protobuf:"bytes,1,opt,name=start_date,json=startDate,proto3,oneof" json:"start_date,omitempty"`
	// end of the time range for the query, default: start + 15 min or current time if start is not defined
	EndDate *timestamp.Timestamp `protobuf:"bytes,2,opt,name=end_date,json=endDate,proto3,oneof" json:"end_date,omitempty"`
	// default value for source to be used when source is omitted in a query
	DefaultSource *wrappers.StringValue `protobuf:"bytes,3,opt,name=default_source,json=defaultSource,proto3,oneof" json:"default_source,omitempty"`
	...
	NowDate *timestamp.Timestamp `protobuf:"bytes,8,opt,name=now_date,json=nowDate,proto3,oneof" json:"now_date,omitempty"`
}
...
func (x *Metadata) GetStartDate() *timestamp.Timestamp {
	if x != nil {
		return x.StartDate
	}
	return nil
...
func (x *Metadata) GetEndDate() *timestamp.Timestamp {
	if x != nil {
		return x.EndDate
	}
	return nil
...
func (x *Metadata) GetDefaultSource() *wrappers.StringValue {
	if x != nil {
...
func (x *Metadata) GetNowDate() *timestamp.Timestamp {
	if x != nil {
		return x.NowDate
	}
	return nil
