...
func file_com_coralogixapis_dataprime_v1_response_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_com_coralogixapis_dataprime_v1_response_proto_msgTypes[23].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_dataprime_v1_response_proto_msgTypes[24].Exporter = func(v any, i int) any {
