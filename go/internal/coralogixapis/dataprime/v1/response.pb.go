...
func file_com_coralogixapis_dataprime_v1_response_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_com_coralogixapis_dataprime_v1_response_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_coralogixapis_dataprime_v1_response_proto_msgTypes[20].OneofWrappers = []interface{}{
