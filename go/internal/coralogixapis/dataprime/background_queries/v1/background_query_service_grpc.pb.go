...
func (c *backgroundQueryServiceClient) GetResults(ctx context.Context, in *GetResultsRequest, opts ...grpc.CallOption) (BackgroundQueryService_GetResultsClient, error) {
	...
	x := &backgroundQueryServiceGetResultsClient{ClientStream: stream}
...
func _BackgroundQueryService_GetResults_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(BackgroundQueryServiceServer).GetResults(m, &backgroundQueryServiceGetResultsServer{ServerStream: stream})
}
