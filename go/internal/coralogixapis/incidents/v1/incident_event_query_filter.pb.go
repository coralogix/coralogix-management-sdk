...
const file_com_coralogixapis_incidents_v1_incident_event_query_filter_proto_rawDesc = "" +
	"\n" +
	"@com/coralogixapis/incidents/v1/incident_event_query_filter.proto\x12\x1ecom.coralogixapis.incidents.v1\x1a5com/coralogixapis/incidents/v1/filter_operators.proto\x1a6com/coralogixapis/incidents/v1/incident_severity.proto\x1a4com/coralogixapis/incidents/v1/incident_status.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a/com/coralogixapis/incidents/v1/meta_label.proto\x1a:com/coralogixapis/incidents/v1/incident_query_filter.proto\"\xa1\x05\n" +
	"\x18IncidentEventQueryFilter\x12F\n" +
	"\x06status\x18\x01 \x03(\x0e2..com.coralogixapis.incidents.v1.IncidentStatusR\x06status\x12L\n" +
	"\bseverity\x18\x02 \x03(\x0e20.com.coralogixapis.incidents.v1.IncidentSeverityR\bseverity\x12{\n" +
	"\x11contextual_labels\x18\x03 \x03(\v2N.com.coralogixapis.incidents.v1.IncidentEventQueryFilter.ContextualLabelsEntryR\x10contextualLabels\x120\n" +
	"\x04name\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\x04name\x125\n" +
	"\bis_muted\x18\x05 \x01(\v2\x1a.google.protobuf.BoolValueR\aisMuted\x12G\n" +
	"\ttimestamp\x18\x06 \x01(\v2).com.coralogixapis.incidents.v1.TimeRangeR\ttimestamp\x12D\n" +
	"\x06labels\x18\a \x01(\v2,.com.coralogixapis.incidents.v1.LabelsFilterR\x06labels\x1az\n" +
	"\x15ContextualLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12K\n" +
	"\x05value\x18\x02 \x01(\v25.com.coralogixapis.incidents.v1.ContextualLabelValuesR\x05value:\x028\x01\"\xa6\x01\n" +
	"\fLabelsFilter\x12J\n" +
	"\vmeta_labels\x18\x01 \x03(\v2).com.coralogixapis.incidents.v1.MetaLabelR\n" +
	"metaLabels\x12J\n" +
	"\boperator\x18\x02 \x01(\x0e2..com.coralogixapis.incidents.v1.FilterOperatorR\boperatorb\x06proto3"
