...
type IncidentEventAssign struct {
	...
	Assignment *v1.Assignment `protobuf:"bytes,1,opt,name=assignment,proto3" json:"assignment,omitempty"`
}
...
func (x *IncidentEventAssign) GetAssignment() *v1.Assignment {
	if x != nil {
		return x.Assignment
	}
	return nil
...
var file_com_coralogixapis_incidents_v1_incident_event_incident_event_assign_proto_goTypes = []any{
	...
	(*v1.Assignment)(nil),       // 1: com.coralogixapis.incidents.v1.Assignment
}
