...
type Incident struct {
	...
	Events              []*incident_event.IncidentEvent `protobuf:"bytes,10,rep,name=events,proto3" json:"events,omitempty"`                                                                                                                                     // The Incident's current events
...
func (x *Incident) GetEvents() []*incident_event.IncidentEvent {
	if x != nil {
		return x.Events
	}
	return nil
...
var file_com_coralogixapis_incidents_v1_incident_proto_goTypes = []any{
	...
	(*incident_event.IncidentEvent)(nil), // 18: com.coralogixapis.incidents.v1.IncidentEvent
