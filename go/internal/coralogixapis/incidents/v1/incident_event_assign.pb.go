...
const file_com_coralogixapis_incidents_v1_incident_event_incident_event_assign_proto_rawDesc = "" +
	"\n" +
	"Icom/coralogixapis/incidents/v1/incident_event/incident_event_assign.proto\x12\x1ecom.coralogixapis.incidents.v1\x1a-com/coralogixapis/incidents/v1/assignee.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\x8b\x01\n" +
...
var (
	...
	file_com_coralogixapis_incidents_v1_incident_event_incident_event_assign_proto_rawDescData []byte
)
...
func file_com_coralogixapis_incidents_v1_incident_event_incident_event_assign_proto_rawDescGZIP() []byte {
	file_com_coralogixapis_incidents_v1_incident_event_incident_event_assign_proto_rawDescOnce.Do(func() {
		file_com_coralogixapis_incidents_v1_incident_event_incident_event_assign_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogixapis_incidents_v1_incident_event_incident_event_assign_proto_rawDesc), len(file_com_coralogixapis_incidents_v1_incident_event_incident_event_assign_proto_rawDesc)))
	})
...
func file_com_coralogixapis_incidents_v1_incident_event_incident_event_assign_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogixapis_incidents_v1_incident_event_incident_event_assign_proto_rawDesc), len(file_com_coralogixapis_incidents_v1_incident_event_incident_event_assign_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
