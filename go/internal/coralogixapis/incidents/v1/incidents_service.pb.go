...
import (
	...
	incident_event_extended "github.com/coralogix/coralogix-management-sdk/go/internal/coralogixapis/incidents/v1/incident_event_extended"
...
type BatchGetIncidentResponse struct {
	...
	Incidents   map[string]*Incident      `protobuf:"bytes,1,rep,name=incidents,proto3" json:"incidents,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
type GetIncidentEventsResponse struct {
	...
	IncidentEvents []*incident_event.IncidentEvent `protobuf:"bytes,1,rep,name=incident_events,json=incidentEvents,proto3" json:"incident_events,omitempty"`
}
...
func (x *GetIncidentEventsResponse) GetIncidentEvents() []*incident_event.IncidentEvent {
	if x != nil {
...
type ListIncidentEventsResponse struct {
	...
	Items      []*incident_event_extended.IncidentEventExtended `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
	Pagination *PaginationResponse                              `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}
...
func (x *ListIncidentEventsResponse) GetItems() []*incident_event_extended.IncidentEventExtended {
	if x != nil {
		return x.Items
	}
	return nil
...
var file_com_coralogixapis_incidents_v1_incidents_service_proto_goTypes = []any{
	...
	(*incident_event.IncidentEvent)(nil), // 44: com.coralogixapis.incidents.v1.IncidentEvent
	...
	(*incident_event_extended.IncidentEventExtended)(nil), // 49: com.coralogixapis.incidents.v1.IncidentEventExtended
