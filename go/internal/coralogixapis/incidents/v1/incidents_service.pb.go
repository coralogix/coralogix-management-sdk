...
const file_com_coralogixapis_incidents_v1_incidents_service_proto_rawDesc = "" +
	...
	";INCIDENT_EVENT_ORDER_BY_FIELD_TYPE_TIMESTAMP_OR_UNSPECIFIED\x10\x002\x8fG\n" +
	...
	"\x13Batch get incidents\x82\xd3\xe4\x93\x029Z\x18\"\x16/v1/incidents:batchGet\x12\x1d/incidents/incidents/v1/batch\x12\x93\x04\n" +
	"\rListIncidents\x124.com.coralogixapis.incidents.v1.ListIncidentsRequest\x1a5.com.coralogixapis.incidents.v1.ListIncidentsResponse\"\x94\x03\x9aA\xc8\x02\n" +
	...
	"\x12Get incidents list\x82\xd3\xe4\x93\x02*Z\x0f\"\r/v1/incidents\"\x17/incidents/incidents/v1\x12\x99\x04\n" +
	"\x18ListIncidentAggregations\x12?.com.coralogixapis.incidents.v1.ListIncidentAggregationsRequest\x1a@.com.coralogixapis.incidents.v1.ListIncidentAggregationsResponse\"\xf9\x02\x9aA\xff\x01\n" +
	...
	"\x1aList incident aggregations\x82\xd3\xe4\x93\x02PZ(\"&/v1/incidents:listIncidentAggregations\x12$/incidents/incidents/v1/aggregations\x12\xa5\x03\n" +
	"\x0fGetFilterValues\x126.com.coralogixapis.incidents.v1.GetFilterValuesRequest\x1a7.com.coralogixapis.incidents.v1.GetFilterValuesResponse\"\xa0\x02\x9aA\xb5\x01\n" +
	...
	"\x11Get filter values\x82\xd3\xe4\x93\x02JZ!\"\x1f/v1/incidents:get-filter-values\"%/incidents/incidents/v1/filter-values\x12\xc6\x03\n" +
	"\x0fAssignIncidents\x126.com.coralogixapis.incidents.v1.AssignIncidentsRequest\x1a7.com.coralogixapis.incidents.v1.AssignIncidentsResponse\"\xc1\x02\x9aA\xe8\x01\n" +
	...
	"\x10Assign incidents\x82\xd3\xe4\x93\x029Z\x16\"\x14/v1/incidents:assign\"\x1f/incidents/incidents/v1/by-user\x12\xd9\x03\n" +
	"\x11UnassignIncidents\x128.com.coralogixapis.incidents.v1.UnassignIncidentsRequest\x1a9.com.coralogixapis.incidents.v1.UnassignIncidentsResponse\"\xce\x02\x9aA\xf1\x01\n" +
	...
	"\x12Unassign incidents\x82\xd3\xe4\x93\x02;Z\x18\"\x16/v1/incidents:unassign*\x1f/incidents/incidents/v1/by-user\x12\xde\x03\n" +
	"\x14AcknowledgeIncidents\x12;.com.coralogixapis.incidents.v1.AcknowledgeIncidentsRequest\x1a<.com.coralogixapis.incidents.v1.AcknowledgeIncidentsResponse\"\xca\x02\x9aA\xe3\x01\n" +
	...
	"\x15Acknowledge incidents\x82\xd3\xe4\x93\x02BZ\x1b\"\x19/v1/incidents:acknowledge\"#/incidents/incidents/v1/acknowledge\x12\x81\x03\n" +
	"\x0eCloseIncidents\x125.com.coralogixapis.incidents.v1.CloseIncidentsRequest\x1a6.com.coralogixapis.incidents.v1.CloseIncidentsResponse\"\xff\x01\x9aA\xaa\x01\n" +
	...
	"\x0fClose incidents\x82\xd3\xe4\x93\x026Z\x15\"\x13/v1/incidents:close\"\x1d/incidents/incidents/v1/close\x12\xdd\x04\n" +
	...
	"'Get all incident events of the incident\x82\xd3\xe4\x93\x02TZ$\x12\"/v1/incidents/{incident_id}/events\x12,/incidents/incidents/v1/{incident_id}/events\x12\xb8\x03\n" +
	"\x10ResolveIncidents\x127.com.coralogixapis.incidents.v1.ResolveIncidentsRequest\x1a8.com.coralogixapis.incidents.v1.ResolveIncidentsResponse\"\xb0\x02\x9aA\xd5\x01\n" +
	...
	"\x11Resolve incidents\x82\xd3\xe4\x93\x02:Z\x17\"\x15/v1/incidents:resolve\"\x1f/incidents/incidents/v1/resolve\x12\x90\x04\n" +
	...
	":Get incident by correlation key and specific point in time\x12\xff\x03\n" +
	"\x12ListIncidentEvents\x129.com.coralogixapis.incidents.v1.ListIncidentEventsRequest\x1a:.com.coralogixapis.incidents.v1.ListIncidentEventsResponse\"\xf1\x02\x9aA\x87\x02\n" +
	...
	"\x14List incident events\x82\xd3\xe4\x93\x02FZ$\"\"/v1/incidents:list-incident-events\x12\x1e/incidents/incidents/v1/events\x12\xb0\x04\n" +
	"\x1cListIncidentEventsTotalCount\x12C.com.coralogixapis.incidents.v1.ListIncidentEventsTotalCountRequest\x1aD.com.coralogixapis.incidents.v1.ListIncidentEventsTotalCountResponse\"\x84\x03\x9aA\xfc\x01\n" +
	...
	"\x16x-coralogixPermissions\x12\x142\x12\n" +
	"\x10\x1a\x0eincidents:readʸ\x02\"\n" +
	" List incident events total count\x82\xd3\xe4\x93\x02XZ0\"./v1/incidents:list-incident-events-total-count\x12$/incidents/incidents/v1/events/count\x12\x8a\x04\n" +
	"\x1eListIncidentEventsFilterValues\x12E.com.coralogixapis.incidents.v1.ListIncidentEventsFilterValuesRequest\x1aF.com.coralogixapis.incidents.v1.ListIncidentEventsFilterValuesResponse\"\xd8\x02\x9aA\xc4\x01\n" +
	...
	"\x16x-coralogixPermissions\x12\x142\x12\n" +
	"\x10\x1a\x0eincidents:readʸ\x02$\n" +
	"\"List incident events filter values\x82\xd3\xe4\x93\x02bZ2\"0/v1/incidents:list-incident-events-filter-values\x12,/incidents/incidents/v1/events/filter-values\x1a\xc4\x02\x9aA\xc0\x02\n" +
