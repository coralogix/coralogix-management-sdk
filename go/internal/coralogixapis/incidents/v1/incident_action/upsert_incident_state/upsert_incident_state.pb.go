...
type UpsertIncidentState struct {
	...
	Severity            v1.IncidentSeverity         `protobuf:"varint,4,opt,name=severity,proto3,enum=com.coralogixapis.incidents.v1.IncidentSeverity" json:"severity,omitempty"`
	...
	ScopeDetails        *v1.ScopeDetails            `protobuf:"bytes,8,opt,name=scope_details,json=scopeDetails,proto3" json:"scope_details,omitempty"`
...
func (x *UpsertIncidentState) GetSeverity() v1.IncidentSeverity {
	if x != nil {
		return x.Severity
	}
...
func (x *UpsertIncidentState) GetScopeDetails() *v1.ScopeDetails {
	if x != nil {
...
func (x *UpsertIncidentState) GetMetaLabels() []*v1.MetaLabel {
	if x != nil {
		return x.MetaLabels
	}
	return nil
...
var file_com_coralogixapis_incidents_v1_incident_action_upsert_incident_state_upsert_incident_state_proto_goTypes = []any{
	...
	(v1.IncidentSeverity)(0),           // 6: com.coralogixapis.incidents.v1.IncidentSeverity
	(*UpsertIncidentStatePayload)(nil), // 7: com.coralogixapis.incidents.v1.UpsertIncidentStatePayload
	(*v1.ScopeDetails)(nil),            // 8: com.coralogixapis.incidents.v1.ScopeDetails
	(*wrapperspb.BoolValue)(nil),       // 9: google.protobuf.BoolValue
	(*v1.MetaLabel)(nil),               // 10: com.coralogixapis.incidents.v1.MetaLabel
}
