...
func (x *IncidentAction) GetUpsertState() *upsert_incident_state.UpsertIncidentState {
...
type IncidentAction_UpsertState struct {
	UpsertState *upsert_incident_state.UpsertIncidentState `protobuf:"bytes,104,opt,name=upsert_state,json=upsertState,proto3,oneof"`
}
...
var file_com_coralogixapis_incidents_v1_incident_action_incident_action_proto_goTypes = []any{
	...
	(*upsert_incident_state.UpsertIncidentState)(nil), // 3: com.coralogixapis.incidents.v1.UpsertIncidentState
