...
package incident_event_extended

import (
	v1 "github.com/coralogix/coralogix-management-sdk/go/internal/coralogixapis/incidents/v1"
	incident_event "github.com/coralogix/coralogix-management-sdk/go/internal/coralogixapis/incidents/v1/incident_event"
...
type IncidentEventExtended struct {
	...
	IncidentEvent                 *incident_event.IncidentEvent  `protobuf:"bytes,2,opt,name=incident_event,json=incidentEvent,proto3" json:"incident_event,omitempty"`
...
func (x *IncidentEventExtended) GetIncidentEvent() *incident_event.IncidentEvent {
	if x != nil {
...
type IncidentEventExtendedMetadata struct {
	...
	IncidentSeverity    v1.IncidentSeverity       `protobuf:"varint,1,opt,name=incident_severity,json=incidentSeverity,proto3,enum=com.coralogixapis.incidents.v1.IncidentSeverity" json:"incident_severity,omitempty"`
	AlertId             *wrapperspb.StringValue   `protobuf:"bytes,2,opt,name=alert_id,json=alertId,proto3" json:"alert_id,omitempty"`
	IncidentState       v1.IncidentState          `protobuf:"varint,3,opt,name=incident_state,json=incidentState,proto3,enum=com.coralogixapis.incidents.v1.IncidentState" json:"incident_state,omitempty"`
	...
	IncidentStatus      v1.IncidentStatus         `protobuf:"varint,7,opt,name=incident_status,json=incidentStatus,proto3,enum=com.coralogixapis.incidents.v1.IncidentStatus" json:"incident_status,omitempty"`
	...
	AlertLabels         []*v1.MetaLabel           `protobuf:"bytes,9,rep,name=alert_labels,json=alertLabels,proto3" json:"alert_labels,omitempty"`
	IncidentPermutation map[string]string         `protobuf:"bytes,10,rep,name=incident_permutation,json=incidentPermutation,proto3" json:"incident_permutation,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *IncidentEventExtendedMetadata) GetIncidentSeverity() v1.IncidentSeverity {
	if x != nil {
		return x.IncidentSeverity
	}
	return v1.IncidentSeverity(0)
}
...
func (x *IncidentEventExtendedMetadata) GetIncidentState() v1.IncidentState {
	if x != nil {
		return x.IncidentState
	}
	return v1.IncidentState(0)
}
...
func (x *IncidentEventExtendedMetadata) GetIncidentStatus() v1.IncidentStatus {
	if x != nil {
		return x.IncidentStatus
	}
	return v1.IncidentStatus(0)
}
...
func (x *IncidentEventExtendedMetadata) GetAlertLabels() []*v1.MetaLabel {
	if x != nil {
...
var file_com_coralogixapis_incidents_v1_incident_event_extended_incident_event_extended_proto_goTypes = []any{
	...
	(*incident_event.IncidentEvent)(nil),  // 5: com.coralogixapis.incidents.v1.IncidentEvent
	(*timestamppb.Timestamp)(nil),         // 6: google.protobuf.Timestamp
	(v1.IncidentSeverity)(0),              // 7: com.coralogixapis.incidents.v1.IncidentSeverity
	(v1.IncidentState)(0),                 // 8: com.coralogixapis.incidents.v1.IncidentState
	(*wrapperspb.BoolValue)(nil),          // 9: google.protobuf.BoolValue
	(v1.IncidentStatus)(0),                // 10: com.coralogixapis.incidents.v1.IncidentStatus
	(*v1.MetaLabel)(nil),                  // 11: com.coralogixapis.incidents.v1.MetaLabel
}
