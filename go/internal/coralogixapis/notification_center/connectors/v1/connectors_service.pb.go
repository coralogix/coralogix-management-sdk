...
const file_com_coralogixapis_notification_center_connectors_v1_connectors_service_proto_rawDesc = "" +
	...
	"\x0fDeleteConnector\x12K.com.coralogixapis.notification_center.connectors.v1.DeleteConnectorRequest\x1aL.com.coralogixapis.notification_center.connectors.v1.DeleteConnectorResponse\"h\x82\xd3\xe4\x93\x02bZ)*'/v1/notification-center/connectors/{id}*5/notifications/notification-center/v1/connectors/{id}\x12\x8d\x02\n" +
	"\fGetConnector\x12H.com.coralogixapis.notification_center.connectors.v1.GetConnectorRequest\x1aI.com.coralogixapis.notification_center.connectors.v1.GetConnectorResponse\"h\x82\xd3\xe4\x93\x02bZ)\x12'/v1/notification-center/connectors/{id}\x125/notifications/notification-center/v1/connectors/{id}\x12\x89\x02\n" +
	"\x0eListConnectors\x12J.com.coralogixapis.notification_center.connectors.v1.ListConnectorsRequest\x1aK.com.coralogixapis.notification_center.connectors.v1.ListConnectorsResponse\"^\x82\xd3\xe4\x93\x02XZ$\x12\"/v1/notification-center/connectors\x120/notifications/notification-center/v1/connectors\x12\xa7\x02\n" +
