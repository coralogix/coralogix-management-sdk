...
const file_com_coralogixapis_notification_center_connectors_v1_connectors_service_proto_rawDesc = "" +
	"\n" +
	"Lcom/coralogixapis/notification_center/connectors/v1/connectors_service.proto\x123com.coralogixapis.notification_center.connectors.v1\x1a9com/coralogixapis/notification_center/common/common.proto\x1aCcom/coralogixapis/notification_center/connectors/v1/connector.proto\x1a\x1cgoogle/api/annotations.proto\x1a google/protobuf/descriptor.proto\x1a.protoc-gen-openapiv3/options/annotations.proto\"\xb9\x02\n" +
	...
	"\x12Connectors service\x12\x0fGet a Connector\x82\xd3\xe4\x93\x02bZ)\x12'/v1/notification-center/connectors/{id}\x125/notifications/notification-center/v1/connectors/{id}\x12\xb2\x02\n" +
	"\x0eListConnectors\x12J.com.coralogixapis.notification_center.connectors.v1.ListConnectorsRequest\x1aK.com.coralogixapis.notification_center.connectors.v1.ListConnectorsResponse\"\x86\x01\x9aA%\n" +
	"\x12Connectors service\x12\x0fList Connectors\x82\xd3\xe4\x93\x02XZ$\x12\"/v1/notification-center/connectors\x120/notifications/notification-center/v1/connectors\x12\xd5\x02\n" +
	"\x12BatchGetConnectors\x12N.com.coralogixapis.notification_center.connectors.v1.BatchGetConnectorsRequest\x1aO.com.coralogixapis.notification_center.connectors.v1.BatchGetConnectorsResponse\"\x9d\x01\x9aA*\n" +
	"\x12Connectors service\x12\x14Batch Get Connectors\x82\xd3\xe4\x93\x02jZ-\x12+/v1/notification-center/connectors:batchGet\x129/notifications/notification-center/v1/connectors:batchGet\x12\x89\x03\n" +
	"\x1aBatchGetConnectorSummaries\x12V.com.coralogixapis.notification_center.connectors.v1.BatchGetConnectorSummariesRequest\x1aW.com.coralogixapis.notification_center.connectors.v1.BatchGetConnectorSummariesResponse\"\xb9\x01\x9aA4\n" +
	"\x12Connectors service\x12\x1eBatch Get Connectors Summaries\x82\xd3\xe4\x93\x02|Z6\x124/v1/notification-center/connectors:batchGetSummaries\x12B/notifications/notification-center/v1/connectors:batchGetSummaries\x12\xef\x02\n" +
	"\x16ListConnectorSummaries\x12R.com.coralogixapis.notification_center.connectors.v1.ListConnectorSummariesRequest\x1aS.com.coralogixapis.notification_center.connectors.v1.ListConnectorSummariesResponse\"\xab\x01\x9aA.\n" +
	"\x12Connectors service\x12\x18List Connector Summaries\x82\xd3\xe4\x93\x02tZ2\x120/v1/notification-center/connectors:listSummaries\x12>/notifications/notification-center/v1/connectors:listSummaries\x12\x82\x03\n" +
	"\x19GetConnectorTypeSummaries\x12U.com.coralogixapis.notification_center.connectors.v1.GetConnectorTypeSummariesRequest\x1aV.com.coralogixapis.notification_center.connectors.v1.GetConnectorTypeSummariesResponse\"\xb5\x01\x9aA2\n" +
	"\x12Connectors service\x12\x1cGet Connector Type Summaries\x82\xd3\xe4\x93\x02zZ5\x123/v1/notification-center/connectors:getTypeSummaries\x12A/notifications/notification-center/v1/connectors:getTypeSummaries\x1a\xf8\x01\x9aA\xf4\x01\n" +
