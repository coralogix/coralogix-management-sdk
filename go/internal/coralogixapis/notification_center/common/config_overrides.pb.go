...
const file_com_coralogixapis_notification_center_common_config_overrides_proto_rawDesc = "" +
	"\n" +
	"Ccom/coralogixapis/notification_center/common/config_overrides.proto\x12%com.coralogixapis.notification_center\x1a9com/coralogixapis/notification_center/common/common.proto\x1aCcom/coralogixapis/notification_center/common/v1/config_fields.proto\"\xca\x02\n" +
	...
	"\x0emessage_config\x18\x03 \x01(\v24.com.coralogixapis.notification_center.MessageConfigR\rmessageConfig\x128\n" +
	"\x16is_default_output_type\x18\x04 \x01(\bH\x00R\x13isDefaultOutputType\x88\x01\x01B\x19\n" +
	"\x17_is_default_output_type\"\x9c\x02\n" +
	"\rConditionType\x12m\n" +
	...
	"\tcondition\"b\n" +
	"\rMessageConfig\x12Q\n" +
	"\x06fields\x18\x01 \x03(\v29.com.coralogixapis.notification_center.MessageConfigFieldR\x06fields\"\xa8\x01\n" +
	"\x18MatchEntityTypeCondition\x128\n" +
	"\x16deprecated_entity_type\x18\x01 \x01(\tB\x02\x18\x01R\x14deprecatedEntityType\x12R\n" +
	"\ventity_type\x18\x02 \x01(\x0e21.com.coralogixapis.notification_center.EntityTypeR\n" +
	"entityType\"\xda\x01\n" +
	"\"MatchEntityTypeAndSubTypeCondition\x128\n" +
	"\x16deprecated_entity_type\x18\x01 \x01(\tB\x02\x18\x01R\x14deprecatedEntityType\x12&\n" +
	"\x0fentity_sub_type\x18\x02 \x01(\tR\rentitySubType\x12R\n" +
	"\ventity_type\x18\x03 \x01(\x0e21.com.coralogixapis.notification_center.EntityTypeR\n" +
	"entityTypeb\x06proto3"
