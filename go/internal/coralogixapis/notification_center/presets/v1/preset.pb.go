...
const file_com_coralogixapis_notification_center_presets_v1_preset_proto_rawDesc = "" +
	...
	"\f_preset_typeB\f\n" +
	"\n" +
	"_parent_idJ\x04\b\x06\x10\aR\x06parent\"\xeb\a\n" +
	"\rPresetSummary\x12;\n" +
	"\x02id\x18\x01 \x01(\tB+\x92A(J&\"a16e24c8-4db2-4abf-ba3c-c9e1fc35a3b9\"R\x02id\x12?\n" +
	"\x0fuser_defined_id\x18\x02 \x01(\tB\x17\x92A\x12J\x10\"user-preset-id\"\x18\x01R\ruserDefinedId\x128\n" +
	"\x16deprecated_entity_type\x18\x03 \x01(\tB\x02\x18\x01R\x14deprecatedEntityType\x12[\n" +
