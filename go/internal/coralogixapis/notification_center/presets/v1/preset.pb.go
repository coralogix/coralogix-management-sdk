...
const file_com_coralogixapis_notification_center_presets_v1_preset_proto_rawDesc = "" +
	...
	"J\b\"ALERTS\"R\n" +
	"entityType:\xf6\x01\x92A\xf2\x01\n" +
	...
	"\x0fuser_defined_id\x18\x02 \x01(\tB\x15\x92A\x12J\x10\"user-preset-id\"R\ruserDefinedId\x128\n" +
	"\x16deprecated_entity_type\x18\x03 \x01(\tB\x02\x18\x01R\x14deprecatedEntityType\x12[\n" +
