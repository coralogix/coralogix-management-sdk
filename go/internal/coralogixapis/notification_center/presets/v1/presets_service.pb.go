...
const file_com_coralogixapis_notification_center_presets_v1_presets_service_proto_rawDesc = "" +
	...
	"\x0fPresets service\x12\x1cSet Custom Preset As Default\x82\xd3\xe4\x93\x02\x80\x01Z8\"6/v1/notification-center/presets/custom/{id}:defaultSet\"D/notifications/notification-center/v1/presets/custom/{id}:defaultSet\x88\x02\x01\x12\xd5\x02\n" +
	"\x12SetPresetAsDefault\x12K.com.coralogixapis.notification_center.presets.v1.SetPresetAsDefaultRequest\x1aL.com.coralogixapis.notification_center.presets.v1.SetPresetAsDefaultResponse\"\xa3\x01\x9aA(\n" +
	"\x0fPresets service\x12\x15Set Preset As Default\x82\xd3\xe4\x93\x02rZ1\"//v1/notification-center/presets/{id}:defaultSet\"=/notifications/notification-center/v1/presets/{id}:defaultSet\x12\x99\x02\n" +
	"\tGetPreset\x12B.com.coralogixapis.notification_center.presets.v1.GetPresetRequest\x1aC.com.coralogixapis.notification_center.presets.v1.GetPresetResponse\"\x82\x01\x9aA\x1d\n" +
	"\x0fPresets service\x12\n" +
	"Get Preset\x82\xd3\xe4\x93\x02\\Z&\x12$/v1/notification-center/presets/{id}\x122/notifications/notification-center/v1/presets/{id}\x12\xd4\x02\n" +
	"\x13ListPresetSummaries\x12L.com.coralogixapis.notification_center.presets.v1.ListPresetSummariesRequest\x1aM.com.coralogixapis.notification_center.presets.v1.ListPresetSummariesResponse\"\x9f\x01\x9aA(\n" +
	"\x0fPresets service\x12\x15List Preset Summaries\x82\xd3\xe4\x93\x02nZ/\x12-/v1/notification-center/presets:summariesList\x12;/notifications/notification-center/v1/presets:summariesList\x12\xba\x02\n" +
	"\x0fBatchGetPresets\x12H.com.coralogixapis.notification_center.presets.v1.BatchGetPresetsRequest\x1aI.com.coralogixapis.notification_center.presets.v1.BatchGetPresetsResponse\"\x91\x01\x9aA$\n" +
	"\x0fPresets service\x12\x11Batch Get Presets\x82\xd3\xe4\x93\x02dZ*\x12(/v1/notification-center/presets:batchGet\x126/notifications/notification-center/v1/presets:batchGet\x12\xed\x02\n" +
	"\x17GetDefaultPresetSummary\x12P.com.coralogixapis.notification_center.presets.v1.GetDefaultPresetSummaryRequest\x1aQ.com.coralogixapis.notification_center.presets.v1.GetDefaultPresetSummaryResponse\"\xac\x01\x9aA-\n" +
	"\x0fPresets service\x12\x1aGet Default Preset Summary\x82\xd3\xe4\x93\x02vZ3\x121/v1/notification-center/presets:defaultSummaryGet\x12?/notifications/notification-center/v1/presets:defaultSummaryGet\x12\x93\x03\n" +
	"\x1dGetSystemDefaultPresetSummary\x12V.com.coralogixapis.notification_center.presets.v1.GetSystemDefaultPresetSummaryRequest\x1aW.com.coralogixapis.notification_center.presets.v1.GetSystemDefaultPresetSummaryResponse\"\xc0\x01\x9aA4\n" +
	"\x0fPresets service\x12!Get System Default Preset Summary\x82\xd3\xe4\x93\x02\x82\x01Z9\x127/v1/notification-center/presets:systemDefaultSummaryGet\x12E/notifications/notification-center/v1/presets:systemDefaultSummaryGet\x1a\xf4\x01\x9aA\xf0\x01\n" +
