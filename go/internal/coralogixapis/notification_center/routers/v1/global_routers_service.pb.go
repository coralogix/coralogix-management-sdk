...
const file_com_coralogixapis_notification_center_routers_v1_global_routers_service_proto_rawDesc = "" +
	"\n" +
	"Mcom/coralogixapis/notification_center/routers/v1/global_routers_service.proto\x120com.coralogixapis.notification_center.routers.v1\x1a@com/coralogixapis/notification_center/common/v1/identifier.proto\x1a=com/coralogixapis/notification_center/common/v1/routing.proto\x1a=com/coralogixapis/notification_center/routers/v1/router.proto\x1a google/protobuf/descriptor.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xba\x02\n" +
	...
	"'Find out more about notification center\x12Phttps://coralogix.com/docs/user-guides/notification-center/introduction/welcome/\"\xd2\x03\n" +
	"\x19DeleteGlobalRouterRequest\x12~\n" +
	"\x15deprecated_identifier\x18\x01 \x01(\v2E.com.coralogixapis.notification_center.routing.GlobalRouterIdentifierB\x02\x18\x01R\x14deprecatedIdentifier\x12]\n" +
	"\n" +
	"identifier\x18\x02 \x01(\v2=.com.coralogixapis.notification_center.GlobalRouterIdentifierR\n" +
	...
	"\x1aDeleteGlobalRouterResponse\"\xd8\x03\n" +
	...
	"'Find out more about notification center\x12Phttps://coralogix.com/docs/user-guides/notification-center/introduction/welcome/\"\xb5\x03\n" +
	"\x1cBatchGetGlobalRoutersRequest\x12p\n" +
	"\x0edeprecated_ids\x18\x01 \x03(\v2E.com.coralogixapis.notification_center.routing.GlobalRouterIdentifierB\x02\x18\x01R\rdeprecatedIds\x12O\n" +
	"\x03ids\x18\x02 \x03(\v2=.com.coralogixapis.notification_center.GlobalRouterIdentifierR\x03ids:\xd1\x01\x92A\xcd\x01\n" +
	...
	"'Find out more about notification center\x12Phttps://coralogix.com/docs/user-guides/notification-center/introduction/welcome/2\xaa\f\n" +
	...
	"\x1bCreateOrReplaceGlobalRouter\x12T.com.coralogixapis.notification_center.routers.v1.CreateOrReplaceGlobalRouterRequest\x1aU.com.coralogixapis.notification_center.routers.v1.CreateOrReplaceGlobalRouterResponse\"/\x82\xd3\xe4\x93\x02):\x06router\x1a\x1f/v1/notification-center/routers\x12\xf5\x01\n" +
	"\x12DeleteGlobalRouter\x12K.com.coralogixapis.notification_center.routers.v1.DeleteGlobalRouterRequest\x1aL.com.coralogixapis.notification_center.routers.v1.DeleteGlobalRouterResponse\"D\x82\xd3\xe4\x93\x02>*</v1/notification-center/routers/{identifier.user_defined_id}\x12\xec\x01\n" +
	"\x0fGetGlobalRouter\x12H.com.coralogixapis.notification_center.routers.v1.GetGlobalRouterRequest\x1aI.com.coralogixapis.notification_center.routers.v1.GetGlobalRouterResponse\"D\x82\xd3\xe4\x93\x02>\x12</v1/notification-center/routers/{identifier.user_defined_id}\x12\xd5\x01\n" +
	...
	"\x15BatchGetGlobalRouters\x12N.com.coralogixapis.notification_center.routers.v1.BatchGetGlobalRoutersRequest\x1aO.com.coralogixapis.notification_center.routers.v1.BatchGetGlobalRoutersResponse\"\x00b\x06proto3"
