...
type TestNotification struct {
	...
	EntityData          *_struct.Struct            `protobuf:"bytes,5,opt,name=entity_data,json=entityData,proto3" json:"entity_data,omitempty"`
...
func (x *TestNotification) GetEntityData() *_struct.Struct {
	if x != nil {
		return x.EntityData
	}
	return nil
