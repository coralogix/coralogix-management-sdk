...
type CxEvent struct {
	...
	CxEventLabels      map[string]string       `protobuf:"bytes,3,rep,name=cx_event_labels,json=cxEventLabels,proto3" json:"cx_event_labels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	CxEventMetadata    map[string]string       `protobuf:"bytes,8,rep,name=cx_event_metadata,json=cxEventMetadata,proto3" json:"cx_event_metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
