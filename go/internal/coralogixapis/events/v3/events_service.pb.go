...
func (m *CxEventSingleOrMultiple) GetEvent() isCxEventSingleOrMultiple_Event {
	if m != nil {
		return m.Event
	}
	return nil
...
func (x *CxEventSingleOrMultiple) GetSingleEvent() *CxEvent {
	if x, ok := x.GetEvent().(*CxEventSingleOrMultiple_SingleEvent); ok {
...
func (x *CxEventSingleOrMultiple) GetMultipleEvents() *CxEventArray {
	if x, ok := x.GetEvent().(*CxEventSingleOrMultiple_MultipleEvents); ok {
...
type BatchGetEventResponse struct {
	...
	Events      map[string]*CxEventSingleOrMultiple `protobuf:"bytes,1,rep,name=events,proto3" json:"events,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
type GetEventsStatisticsResponse struct {
	...
	CxEventMetadataFieldStatistics map[string]*FieldStatistics `protobuf:"bytes,1,rep,name=cx_event_metadata_field_statistics,json=cxEventMetadataFieldStatistics,proto3" json:"cx_event_metadata_field_statistics,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type FieldStatistics struct {
	...
	FieldStatistics map[string]*wrapperspb.Int64Value `protobuf:"bytes,1,rep,name=field_statistics,json=fieldStatistics,proto3" json:"field_statistics,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
