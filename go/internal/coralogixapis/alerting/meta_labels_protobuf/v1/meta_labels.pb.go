...
type MetaLabel struct {
	...
	Id            *string                `protobuf:"bytes,1,opt,name=id,proto3,oneof" json:"id,omitempty"`       // MetaLabel id: The meta label id
	Key           string                 `protobuf:"bytes,2,opt,name=key,proto3" json:"key,omitempty"`           // MetaLabel key: The meta label key
	Value         *string                `protobuf:"bytes,3,opt,name=value,proto3,oneof" json:"value,omitempty"` // MetaLabel value: The meta label value
...
const file_com_coralogixapis_alerting_meta_labels_protobuf_v1_meta_labels_proto_rawDesc = "" +
	"\n" +
	"Dcom/coralogixapis/alerting/meta_labels_protobuf/v1/meta_labels.proto\x122com.coralogixapis.alerting.meta_labels_protobuf.v1\"^\n" +
	"\tMetaLabel\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tH\x00R\x02id\x88\x01\x01\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\x12\x19\n" +
	"\x05value\x18\x03 \x01(\tH\x01R\x05value\x88\x01\x01B\x05\n" +
	"\x03_idB\b\n" +
	"\x06_valueb\x06proto3"

var (
	file_com_coralogixapis_alerting_meta_labels_protobuf_v1_meta_labels_proto_rawDescOnce sync.Once
	file_com_coralogixapis_alerting_meta_labels_protobuf_v1_meta_labels_proto_rawDescData []byte
)
...
func file_com_coralogixapis_alerting_meta_labels_protobuf_v1_meta_labels_proto_rawDescGZIP() []byte {
	file_com_coralogixapis_alerting_meta_labels_protobuf_v1_meta_labels_proto_rawDescOnce.Do(func() {
		file_com_coralogixapis_alerting_meta_labels_protobuf_v1_meta_labels_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogixapis_alerting_meta_labels_protobuf_v1_meta_labels_proto_rawDesc), len(file_com_coralogixapis_alerting_meta_labels_protobuf_v1_meta_labels_proto_rawDesc)))
	})
...
var file_com_coralogixapis_alerting_meta_labels_protobuf_v1_meta_labels_proto_goTypes = []any{
...
func file_com_coralogixapis_alerting_meta_labels_protobuf_v1_meta_labels_proto_init() {
	...
	file_com_coralogixapis_alerting_meta_labels_protobuf_v1_meta_labels_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogixapis_alerting_meta_labels_protobuf_v1_meta_labels_proto_rawDesc), len(file_com_coralogixapis_alerting_meta_labels_protobuf_v1_meta_labels_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
