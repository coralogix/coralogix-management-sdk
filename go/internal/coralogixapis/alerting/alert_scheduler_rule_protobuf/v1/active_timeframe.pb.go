...
type ActiveTimeframe struct {
	...
	EndTime       string                 `protobuf:"bytes,2,opt,name=end_time,json=endTime,proto3" json:"end_time,omitempty"`       // Timeframe end time: The point in the time(date-time) when the rule will finish to be active.
	Timezone      string                 `protobuf:"bytes,3,opt,name=timezone,proto3" json:"timezone,omitempty"`                    // Timeframe timezone: The rule will be active according to a specific timezone.
...
const file_com_coralogixapis_alerting_alert_scheduler_rule_protobuf_v1_active_timeframe_proto_rawDesc = "" +
	"\n" +
	"Rcom/coralogixapis/alerting/alert_scheduler_rule_protobuf/v1/active_timeframe.proto\x12;com.coralogixapis.alerting.alert_scheduler_rule_protobuf.v1\"g\n" +
	"\x0fActiveTimeframe\x12\x1d\n" +
	"\n" +
	"start_time\x18\x01 \x01(\tR\tstartTime\x12\x19\n" +
	"\bend_time\x18\x02 \x01(\tR\aendTime\x12\x1a\n" +
	"\btimezone\x18\x03 \x01(\tR\btimezoneb\x06proto3"

var (
	file_com_coralogixapis_alerting_alert_scheduler_rule_protobuf_v1_active_timeframe_proto_rawDescOnce sync.Once
	file_com_coralogixapis_alerting_alert_scheduler_rule_protobuf_v1_active_timeframe_proto_rawDescData []byte
)
...
func file_com_coralogixapis_alerting_alert_scheduler_rule_protobuf_v1_active_timeframe_proto_rawDescGZIP() []byte {
	file_com_coralogixapis_alerting_alert_scheduler_rule_protobuf_v1_active_timeframe_proto_rawDescOnce.Do(func() {
		file_com_coralogixapis_alerting_alert_scheduler_rule_protobuf_v1_active_timeframe_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogixapis_alerting_alert_scheduler_rule_protobuf_v1_active_timeframe_proto_rawDesc), len(file_com_coralogixapis_alerting_alert_scheduler_rule_protobuf_v1_active_timeframe_proto_rawDesc)))
	})
...
var file_com_coralogixapis_alerting_alert_scheduler_rule_protobuf_v1_active_timeframe_proto_goTypes = []any{
...
func file_com_coralogixapis_alerting_alert_scheduler_rule_protobuf_v1_active_timeframe_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogixapis_alerting_alert_scheduler_rule_protobuf_v1_active_timeframe_proto_rawDesc), len(file_com_coralogixapis_alerting_alert_scheduler_rule_protobuf_v1_active_timeframe_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
