...
import (
	v1 "github.com/coralogix/coralogix-management-sdk/internal/coralogixapis/alerting/meta_labels_protobuf/v1"
...
func file_com_coralogixapis_alerting_alert_scheduler_rule_protobuf_v1_alert_scheduler_rule_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerting_alert_scheduler_rule_protobuf_v1_alert_scheduler_rule_proto_msgTypes[0].Exporter = func(v any, i int) any {
