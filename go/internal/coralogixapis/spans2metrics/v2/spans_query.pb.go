...
type SpansQuery struct {
	...
	ApplicationnameFilters []*wrappers.StringValue `protobuf:"bytes,2,rep,name=applicationname_filters,json=applicationnameFilters,proto3" json:"applicationname_filters,omitempty"`
	// subsystem name filters
	SubsystemnameFilters []*wrappers.StringValue `protobuf:"bytes,3,rep,name=subsystemname_filters,json=subsystemnameFilters,proto3" json:"subsystemname_filters,omitempty"`
	// action filters
	ActionFilters []*wrappers.StringValue `protobuf:"bytes,4,rep,name=action_filters,json=actionFilters,proto3" json:"action_filters,omitempty"`
	// service filters
	ServiceFilters []*wrappers.StringValue `protobuf:"bytes,5,rep,name=service_filters,json=serviceFilters,proto3" json:"service_filters,omitempty"`
}
...
func (x *SpansQuery) GetLucene() *wrappers.StringValue {
	if x != nil {
		return x.Lucene
	}
	return nil
...
func (x *SpansQuery) GetApplicationnameFilters() []*wrappers.StringValue {
	if x != nil {
...
func (x *SpansQuery) GetSubsystemnameFilters() []*wrappers.StringValue {
	if x != nil {
...
func (x *SpansQuery) GetActionFilters() []*wrappers.StringValue {
	if x != nil {
...
func (x *SpansQuery) GetServiceFilters() []*wrappers.StringValue {
	if x != nil {
