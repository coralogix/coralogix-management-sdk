...
func file_com_coralogixapis_service_catalog_v1_report_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_service_catalog_v1_report_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_service_catalog_v1_report_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_service_catalog_v1_report_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
