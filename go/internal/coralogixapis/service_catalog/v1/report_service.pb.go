...
var file_com_coralogixapis_service_catalog_v1_report_service_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_service_catalog_v1_report_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_service_catalog_v1_report_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_service_catalog_v1_report_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_service_catalog_v1_report_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CompanyReport); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
