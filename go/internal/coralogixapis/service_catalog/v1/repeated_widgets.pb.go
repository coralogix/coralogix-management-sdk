...
var file_com_coralogixapis_service_catalog_v1_repeated_widgets_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa2, 0x01, 0x0a, 0x11, 0x52, 0x65, 0x70, 0x65, 0x61,
	0x74, 0x65, 0x64, 0x4c, 0x69, 0x6e, 0x65, 0x43, 0x68, 0x61, 0x72, 0x74, 0x12, 0x4c, 0x0a, 0x0b,
	0x6c, 0x69, 0x6e, 0x65, 0x5f, 0x63, 0x68, 0x61, 0x72, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28,
	...
	0x6c, 0x69, 0x6e, 0x65, 0x43, 0x68, 0x61, 0x72, 0x74, 0x73, 0x12, 0x3f, 0x0a, 0x0c, 0x74, 0x6f,
	...
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_com_coralogixapis_service_catalog_v1_repeated_widgets_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_com_coralogixapis_service_catalog_v1_repeated_widgets_proto_goTypes = []interface{}{
...
var file_com_coralogixapis_service_catalog_v1_repeated_widgets_proto_depIdxs = []int32{
	1, // 0: com.coralogixapis.service_catalog.v1.RepeatedLineChart.line_charts:type_name -> com.coralogixapis.apm.widgets.v1.LineChart
	2, // 1: com.coralogixapis.service_catalog.v1.RepeatedLineChart.total_amount:type_name -> google.protobuf.UInt64Value
...
func file_com_coralogixapis_service_catalog_v1_repeated_widgets_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_service_catalog_v1_repeated_widgets_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RepeatedLineChart); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
