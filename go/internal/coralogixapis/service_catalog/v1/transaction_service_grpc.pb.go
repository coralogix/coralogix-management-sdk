...
func (c *transactionServiceClient) GetTransactionsMetricStream(ctx context.Context, in *GetTransactionsMetricStreamRequest, opts ...grpc.CallOption) (TransactionService_GetTransactionsMetricStreamClient, error) {
	...
	x := &transactionServiceGetTransactionsMetricStreamClient{ClientStream: stream}
...
func (c *transactionServiceClient) GetTransactionMetricStream(ctx context.Context, in *GetTransactionMetricStreamRequest, opts ...grpc.CallOption) (TransactionService_GetTransactionMetricStreamClient, error) {
	...
	x := &transactionServiceGetTransactionMetricStreamClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *transactionServiceClient) GetTransactionsErrorsStream(ctx context.Context, in *GetTransactionsErrorsStreamRequest, opts ...grpc.CallOption) (TransactionService_GetTransactionsErrorsStreamClient, error) {
	...
	x := &transactionServiceGetTransactionsErrorsStreamClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *transactionServiceClient) GetTransactionSegmentsErrorStream(ctx context.Context, in *GetTransactionSegmentsErrorStreamRequest, opts ...grpc.CallOption) (TransactionService_GetTransactionSegmentsErrorStreamClient, error) {
	...
	x := &transactionServiceGetTransactionSegmentsErrorStreamClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *transactionServiceClient) GetTransactionLatencyGraphStream(ctx context.Context, in *GetTransactionLatencyGraphStreamRequest, opts ...grpc.CallOption) (TransactionService_GetTransactionLatencyGraphStreamClient, error) {
	...
	x := &transactionServiceGetTransactionLatencyGraphStreamClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func _TransactionService_GetTransactionsMetricStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TransactionServiceServer).GetTransactionsMetricStream(m, &transactionServiceGetTransactionsMetricStreamServer{ServerStream: stream})
}
...
func _TransactionService_GetTransactionMetricStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TransactionServiceServer).GetTransactionMetricStream(m, &transactionServiceGetTransactionMetricStreamServer{ServerStream: stream})
}
...
func _TransactionService_GetTransactionsErrorsStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TransactionServiceServer).GetTransactionsErrorsStream(m, &transactionServiceGetTransactionsErrorsStreamServer{ServerStream: stream})
}
...
func _TransactionService_GetTransactionSegmentsErrorStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TransactionServiceServer).GetTransactionSegmentsErrorStream(m, &transactionServiceGetTransactionSegmentsErrorStreamServer{ServerStream: stream})
}
...
func _TransactionService_GetTransactionLatencyGraphStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TransactionServiceServer).GetTransactionLatencyGraphStream(m, &transactionServiceGetTransactionLatencyGraphStreamServer{ServerStream: stream})
}
