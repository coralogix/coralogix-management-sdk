...
const file_com_coralogixapis_slo_v1_slo_service_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:^\x9aA[\n" +
	...
	"\x03slo\x18\x01 \x01(\v2\x1d.com.coralogixapis.slo.v1.SloR\x03slo:m\x9aAj\n" +
	...
	"\x18alerts_validation_result\x18\x01 \x03(\v20.com.coralogixapis.slo.v1.SloAlertValidityResultR\x16alertsValidationResult:\x89\x01\x9aA\x85\x01\n" +
	...
	"\x18silence_data_validations\x18\x02 \x01(\bB\x02\x18\x01H\x00R\x16silenceDataValidations\x88\x01\x01:;\x9aA8\n" +
	...
	"\x03slo\x18\x01 \x01(\v2\x1d.com.coralogixapis.slo.v1.SloR\x03slo:B\x9aA?\n" +
	"=*\x11CreateSloResponse2\"Response after creating a new SLO.\xd2\x01\x03slo\"\xe9\x01\n" +
	"\x11ReplaceSloRequest\x12/\n" +
	"\x03slo\x18\x01 \x01(\v2\x1d.com.coralogixapis.slo.v1.SloR\x03slo\x12A\n" +
	"\x18silence_data_validations\x18\x02 \x01(\bB\x02\x18\x01H\x00R\x16silenceDataValidations\x88\x01\x01:C\x9aA@\n" +
	...
	"\x03ids\x18\x01 \x03(\tR\x03ids:Q\x9aAN\n" +
	...
	"\rnot_found_ids\x18\x02 \x03(\tR\vnotFoundIds:^\x9aA[\n" +
	...
	"\x12delete_slo_request\x18\x03 \x01(\v2*.com.coralogixapis.slo.v1.DeleteSloRequestH\x00R\x10deleteSloRequest:M\x9aAJ\n" +
	...
	"\x13delete_slo_response\x18\x03 \x01(\v2+.com.coralogixapis.slo.v1.DeleteSloResponseH\x00R\x11deleteSloResponse:D\x9aAA\n" +
	"?*\x14SloExecutionResponse2'Response for an executed SLO operation.B\n" +
	"\n" +
	"\bresponse\"\xc0\x01\n" +
	"\x16BatchExecuteSloRequest\x12I\n" +
	"\brequests\x18\x01 \x03(\v2-.com.coralogixapis.slo.v1.SloExecutionRequestR\brequests:[\x9aAX\n" +
	...
	"\x06status\x18\x02 \x01(\v2(.com.coralogixapis.slo.v1.ResponseStatusR\x06status:v\x9aAs\n" +
