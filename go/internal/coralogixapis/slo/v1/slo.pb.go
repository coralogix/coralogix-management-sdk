...
const file_com_coralogixapis_slo_v1_slo_proto_rawDesc = "" +
	"\n" +
	"\"com/coralogixapis/slo/v1/slo.proto\x12\x18com.coralogixapis.slo.v1\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\x93\x01\n" +
	"\x06Metric\x12M\n" +
	"\x05query\x18\x01 \x01(\tB7\x92A4J2\"sum(rate(http_requests_total{status=\"200\"}[5m]))\"R\x05query::\x92A7\n" +
