...
type Slo struct {
	...
	// Deprecated: Marked as deprecated in com/coralogixapis/slo/v1/slo.proto.
	Type          *SloType `protobuf:"varint,14,opt,name=type,proto3,enum=com.coralogixapis.slo.v1.SloType,oneof" json:"type,omitempty"`
	SloType       *SloType `protobuf:"varint,15,opt,name=slo_type,json=sloType,proto3,enum=com.coralogixapis.slo.v1.SloType,oneof" json:"slo_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Slo) GetSloType() SloType {
	if x != nil && x.SloType != nil {
		return *x.SloType
	}
	return SloType_SLO_TYPE_REQUEST
}
...
const file_com_coralogixapis_slo_v1_slo_proto_rawDesc = "" +
	...
	"1*\bGrouping2%Definition of the SLO grouping fields\"\xd5\n" +
	"\n" +
	"\x03Slo\x12@\n" +
	...
	"\x17window_based_metric_sli\x18\r \x01(\v2..com.coralogixapis.slo.v1.WindowBasedMetricSliH\x01R\x14windowBasedMetricSli\x12S\n" +
	"\x04type\x18\x0e \x01(\x0e2!.com.coralogixapis.slo.v1.SloTypeB\x17\x9aA\x12J\x10SLO_TYPE_REQUEST\x18\x01H\aR\x04type\x88\x01\x01\x12X\n" +
	"\bslo_type\x18\x0f \x01(\x0e2!.com.coralogixapis.slo.v1.SloTypeB\x15\x9aA\x12J\x10SLO_TYPE_REQUESTH\bR\asloType\x88\x01\x01\x1a9\n" +
...
var file_com_coralogixapis_slo_v1_slo_proto_depIdxs = []int32{
	...
	3,  // 16: com.coralogixapis.slo.v1.Slo.slo_type:type_name -> com.coralogixapis.slo.v1.SloType
	5,  // 17: com.coralogixapis.slo.v1.SloFilterField.const_filter:type_name -> com.coralogixapis.slo.v1.SloConstantFilterField
	14, // 18: com.coralogixapis.slo.v1.IsFilterPredicate.string_values:type_name -> com.coralogixapis.slo.v1.StringValues
	15, // 19: com.coralogixapis.slo.v1.IsFilterPredicate.type_values:type_name -> com.coralogixapis.slo.v1.TypeValues
	3,  // 20: com.coralogixapis.slo.v1.TypeValues.values:type_name -> com.coralogixapis.slo.v1.SloType
	13, // 21: com.coralogixapis.slo.v1.SloFilterPredicate.is:type_name -> com.coralogixapis.slo.v1.IsFilterPredicate
	12, // 22: com.coralogixapis.slo.v1.SloFilter.field:type_name -> com.coralogixapis.slo.v1.SloFilterField
	16, // 23: com.coralogixapis.slo.v1.SloFilter.predicate:type_name -> com.coralogixapis.slo.v1.SloFilterPredicate
