...
func (c *ruleGroupsClient) Fetch(ctx context.Context, in *FetchRuleGroup, opts ...grpc.CallOption) (*FetchRuleGroupResult, error) {
	...
	err := c.cc.Invoke(ctx, RuleGroups_Fetch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedRuleGroupsServer must be embedded to have
...
func (UnimplementedRuleGroupsServer) testEmbeddedByValue()                    {}
...
func RegisterRuleGroupsServer(s grpc.ServiceRegistrar, srv RuleGroupsServer) {
	// If the following call pancis, it indicates UnimplementedRuleGroupsServer was
...
var RuleGroups_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "com/coralogixapis/metrics_rule_manager/v1/groups.proto",
}
...
func (c *ruleGroupSetsClient) Create(ctx context.Context, in *CreateRuleGroupSet, opts ...grpc.CallOption) (*CreateRuleGroupSetResult, error) {
	...
	err := c.cc.Invoke(ctx, RuleGroupSets_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ruleGroupSetsClient) Fetch(ctx context.Context, in *FetchRuleGroupSet, opts ...grpc.CallOption) (*OutRuleGroupSet, error) {
	...
	err := c.cc.Invoke(ctx, RuleGroupSets_Fetch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedRuleGroupSetsServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedRuleGroupSetsServer) testEmbeddedByValue()                       {}
...
func RegisterRuleGroupSetsServer(s grpc.ServiceRegistrar, srv RuleGroupSetsServer) {
	// If the following call pancis, it indicates UnimplementedRuleGroupSetsServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
