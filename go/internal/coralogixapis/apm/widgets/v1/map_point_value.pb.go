...
var file_com_coralogixapis_apm_widgets_v1_map_point_value_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_apm_widgets_v1_map_point_value_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_apm_widgets_v1_map_point_value_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MapPointValue); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
