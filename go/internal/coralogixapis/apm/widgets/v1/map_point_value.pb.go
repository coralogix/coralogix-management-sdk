...
type MapPointValue struct {
	...
	Name        *wrappers.StringValue `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"` // This is the key name
	...
	Unit        *wrappers.StringValue `protobuf:"bytes,5,opt,name=unit,proto3" json:"unit,omitempty"` // The unit of measurement
}
...
func (x *MapPointValue) GetValue() *wrappers.FloatValue {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *MapPointValue) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *MapPointValue) GetDisplayName() *wrappers.StringValue {
	if x != nil {
...
func (x *MapPointValue) GetUnit() *wrappers.StringValue {
	if x != nil {
		return x.Unit
	}
	return nil
