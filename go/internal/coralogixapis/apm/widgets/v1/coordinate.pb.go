...
type Coordinate struct {
	...
	Lat  *wrappers.StringValue `protobuf:"bytes,1,opt,name=lat,proto3" json:"lat,omitempty"`
	Long *wrappers.StringValue `protobuf:"bytes,2,opt,name=long,proto3" json:"long,omitempty"`
}
...
func (x *Coordinate) GetLat() *wrappers.StringValue {
	if x != nil {
		return x.Lat
	}
	return nil
...
func (x *Coordinate) GetLong() *wrappers.StringValue {
	if x != nil {
		return x.Long
	}
	return nil
