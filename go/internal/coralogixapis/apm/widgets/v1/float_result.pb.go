...
type FloatResult struct {
	...
	Name        *wrappers.StringValue            `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"` // This is the key name
	...
	Unit        *wrappers.StringValue            `protobuf:"bytes,4,opt,name=unit,proto3" json:"unit,omitempty"` // The unit of measurement
	Query       *wrappers.StringValue            `protobuf:"bytes,5,opt,name=query,proto3" json:"query,omitempty"`
	Metric      map[string]*wrappers.StringValue `protobuf:"bytes,6,rep,name=metric,proto3" json:"metric,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *FloatResult) GetValue() *wrappers.FloatValue {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *FloatResult) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *FloatResult) GetDisplayName() *wrappers.StringValue {
	if x != nil {
...
func (x *FloatResult) GetUnit() *wrappers.StringValue {
	if x != nil {
		return x.Unit
	}
	return nil
...
func (x *FloatResult) GetQuery() *wrappers.StringValue {
	if x != nil {
		return x.Query
	}
	return nil
...
func (x *FloatResult) GetMetric() map[string]*wrappers.StringValue {
	if x != nil {
		return x.Metric
	}
	return nil
