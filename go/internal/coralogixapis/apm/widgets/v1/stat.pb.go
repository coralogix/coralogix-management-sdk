...
type Stat struct {
	...
	Color       *wrappers.StringValue `protobuf:"bytes,6,opt,name=color,proto3" json:"color,omitempty"`
...
func (x *Stat) GetDisplayName() *wrappers.StringValue {
	if x != nil {
...
func (x *Stat) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *Stat) GetQuery() *wrappers.StringValue {
	if x != nil {
		return x.Query
	}
	return nil
...
func (x *Stat) GetValue() *wrappers.StringValue {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *Stat) GetToolTip() *wrappers.StringValue {
	if x != nil {
		return x.ToolTip
	}
	return nil
...
func (x *Stat) GetColor() *wrappers.StringValue {
	if x != nil {
		return x.Color
	}
	return nil
