...
const file_com_coralogixapis_apm_widgets_v1_gauge_proto_rawDesc = "" +
	"\n" +
	",com/coralogixapis/apm/widgets/v1/gauge.proto\x12 com.coralogixapis.apm.widgets.v1\x1a\x1egoogle/protobuf/wrappers.proto\x1a3com/coralogixapis/apm/widgets/v1/float_result.proto\"\xd1\x02\n" +
	"\x05Gauge\x12?\n" +
	"\fdisplay_name\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\vdisplayName\x122\n" +
	"\x05query\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x05query\x12G\n" +
	"\aresults\x18\x03 \x03(\v2-.com.coralogixapis.apm.widgets.v1.FloatResultR\aresults\x12C\n" +
	"\x05total\x18\x04 \x01(\v2-.com.coralogixapis.apm.widgets.v1.FloatResultR\x05total\x12E\n" +
	"\x06header\x18\x05 \x01(\v2-.com.coralogixapis.apm.widgets.v1.FloatResultR\x06headerb\x06proto3"

var (
	file_com_coralogixapis_apm_widgets_v1_gauge_proto_rawDescOnce sync.Once
	file_com_coralogixapis_apm_widgets_v1_gauge_proto_rawDescData []byte
)
...
func file_com_coralogixapis_apm_widgets_v1_gauge_proto_rawDescGZIP() []byte {
	file_com_coralogixapis_apm_widgets_v1_gauge_proto_rawDescOnce.Do(func() {
		file_com_coralogixapis_apm_widgets_v1_gauge_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogixapis_apm_widgets_v1_gauge_proto_rawDesc), len(file_com_coralogixapis_apm_widgets_v1_gauge_proto_rawDesc)))
	})
...
func file_com_coralogixapis_apm_widgets_v1_gauge_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogixapis_apm_widgets_v1_gauge_proto_rawDesc), len(file_com_coralogixapis_apm_widgets_v1_gauge_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
