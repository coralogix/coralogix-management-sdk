...
type Gauge struct {
	...
	Query       *wrappers.StringValue `protobuf:"bytes,2,opt,name=query,proto3" json:"query,omitempty"`
...
func (x *Gauge) GetDisplayName() *wrappers.StringValue {
	if x != nil {
...
func (x *Gauge) GetQuery() *wrappers.StringValue {
	if x != nil {
		return x.Query
	}
	return nil
