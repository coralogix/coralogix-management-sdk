...
var file_com_coralogixapis_apm_widgets_v1_line_chart_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_apm_widgets_v1_line_chart_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_apm_widgets_v1_line_chart_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
