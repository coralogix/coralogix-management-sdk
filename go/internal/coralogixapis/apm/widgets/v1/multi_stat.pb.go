...
const file_com_coralogixapis_apm_widgets_v1_multi_stat_proto_rawDesc = "" +
	"\n" +
	"1com/coralogixapis/apm/widgets/v1/multi_stat.proto\x12 com.coralogixapis.apm.widgets.v1\x1a\x1egoogle/protobuf/wrappers.proto\x1a+com/coralogixapis/apm/widgets/v1/stat.proto\"\xf5\x01\n" +
	"\tMultiStat\x12?\n" +
	"\fdisplay_name\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\vdisplayName\x120\n" +
	"\x04name\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x04name\x127\n" +
	"\btool_tip\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\atoolTip\x12<\n" +
	"\x05stats\x18\x04 \x03(\v2&.com.coralogixapis.apm.widgets.v1.StatR\x05statsb\x06proto3"

var (
	file_com_coralogixapis_apm_widgets_v1_multi_stat_proto_rawDescOnce sync.Once
	file_com_coralogixapis_apm_widgets_v1_multi_stat_proto_rawDescData []byte
)
...
func file_com_coralogixapis_apm_widgets_v1_multi_stat_proto_rawDescGZIP() []byte {
	file_com_coralogixapis_apm_widgets_v1_multi_stat_proto_rawDescOnce.Do(func() {
		file_com_coralogixapis_apm_widgets_v1_multi_stat_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogixapis_apm_widgets_v1_multi_stat_proto_rawDesc), len(file_com_coralogixapis_apm_widgets_v1_multi_stat_proto_rawDesc)))
	})
...
func file_com_coralogixapis_apm_widgets_v1_multi_stat_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogixapis_apm_widgets_v1_multi_stat_proto_rawDesc), len(file_com_coralogixapis_apm_widgets_v1_multi_stat_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
