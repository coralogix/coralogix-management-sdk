...
type MultiStat struct {
	...
	ToolTip     *wrappers.StringValue `protobuf:"bytes,3,opt,name=tool_tip,json=toolTip,proto3" json:"tool_tip,omitempty"`
...
func (x *MultiStat) GetDisplayName() *wrappers.StringValue {
	if x != nil {
...
func (x *MultiStat) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *MultiStat) GetToolTip() *wrappers.StringValue {
	if x != nil {
		return x.ToolTip
	}
	return nil
