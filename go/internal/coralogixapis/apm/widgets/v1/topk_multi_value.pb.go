...
type TopkMultiValue struct {
	...
	Query       map[string]*wrappers.StringValue `protobuf:"bytes,5,rep,name=query,proto3" json:"query,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	ToolTip     *wrappers.StringValue            `protobuf:"bytes,6,opt,name=tool_tip,json=toolTip,proto3" json:"tool_tip,omitempty"`
}
...
func (x *TopkMultiValue) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *TopkMultiValue) GetDisplayName() *wrappers.StringValue {
	if x != nil {
...
func (x *TopkMultiValue) GetQuery() map[string]*wrappers.StringValue {
	if x != nil {
		return x.Query
	}
	return nil
...
func (x *TopkMultiValue) GetToolTip() *wrappers.StringValue {
	if x != nil {
		return x.ToolTip
	}
	return nil
