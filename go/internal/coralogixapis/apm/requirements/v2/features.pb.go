...
var file_com_coralogixapis_apm_requirements_v2_features_proto_rawDesc = []byte{
...
var (
	...
	file_com_coralogixapis_apm_requirements_v2_features_proto_rawDescData = file_com_coralogixapis_apm_requirements_v2_features_proto_rawDesc
)
...
func file_com_coralogixapis_apm_requirements_v2_features_proto_rawDescGZIP() []byte {
	file_com_coralogixapis_apm_requirements_v2_features_proto_rawDescOnce.Do(func() {
		file_com_coralogixapis_apm_requirements_v2_features_proto_rawDescData = protoimpl.X.CompressGZIP(file_com_coralogixapis_apm_requirements_v2_features_proto_rawDescData)
	})
...
var file_com_coralogixapis_apm_requirements_v2_features_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_apm_requirements_v2_features_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_com_coralogixapis_apm_requirements_v2_features_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_com_coralogixapis_apm_requirements_v2_features_proto_rawDesc = nil
