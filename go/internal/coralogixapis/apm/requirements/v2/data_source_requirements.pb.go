...
type LabelExistence struct {
	...
	Exists *wrappers.BoolValue   `protobuf:"bytes,2,opt,name=exists,proto3" json:"exists,omitempty"`
}
...
func (x *LabelExistence) GetLabel() *wrappers.StringValue {
	if x != nil {
		return x.Label
	}
	return nil
...
func (x *LabelExistence) GetExists() *wrappers.BoolValue {
	if x != nil {
		return x.Exists
	}
	return nil
...
func (x *MetricExistence) GetMetric() *wrappers.StringValue {
	if x != nil {
		return x.Metric
	}
	return nil
...
func (x *MetricExistence) GetExists() *wrappers.BoolValue {
	if x != nil {
		return x.Exists
	}
	return nil
...
func (x *MetricLabelsExistence) GetMetric() *wrappers.StringValue {
	if x != nil {
		return x.Metric
	}
	return nil
...
type PageRequirement struct {
	...
	PassedRequirements *wrappers.BoolValue `protobuf:"bytes,2,opt,name=passed_requirements,json=passedRequirements,proto3" json:"passed_requirements,omitempty"`
}
...
func (x *PageRequirement) GetPassedRequirements() *wrappers.BoolValue {
	if x != nil {
...
type DataSourceRequirements struct {
	...
	PassedRequirements *wrappers.BoolValue         `protobuf:"bytes,3,opt,name=passed_requirements,json=passedRequirements,proto3" json:"passed_requirements,omitempty"`
...
func (x *DataSourceRequirements) GetPassedRequirements() *wrappers.BoolValue {
	if x != nil {
		return x.PassedRequirements
	}
	return nil
