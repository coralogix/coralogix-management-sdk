...
type DataSourceRequirements struct {
	...
	PageRequirements   map[string]*PageRequirement `protobuf:"bytes,4,rep,name=page_requirements,json=pageRequirements,proto3" json:"page_requirements,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_com_coralogixapis_apm_requirements_v2_data_source_requirements_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_apm_requirements_v2_data_source_requirements_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_apm_requirements_v2_data_source_requirements_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LabelExistence); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_apm_requirements_v2_data_source_requirements_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MetricExistence); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_apm_requirements_v2_data_source_requirements_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MetricLabelsExistence); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_apm_requirements_v2_data_source_requirements_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_apm_requirements_v2_data_source_requirements_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MissingNothing); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_apm_requirements_v2_data_source_requirements_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PageRequirement); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_apm_requirements_v2_data_source_requirements_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DataSourceRequirements); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
