...
// UnimplementedFeatureRequirementsInternalServiceServer must be embedded to have
...
func (UnimplementedFeatureRequirementsInternalServiceServer) testEmbeddedByValue() {}
...
func RegisterFeatureRequirementsInternalServiceServer(s grpc.ServiceRegistrar, srv FeatureRequirementsInternalServiceServer) {
	// If the following call pancis, it indicates UnimplementedFeatureRequirementsInternalServiceServer was
