...
type SloStatusCount struct {
	...
	Ok           *wrappers.Int64Value `protobuf:"bytes,1,opt,name=ok,proto3" json:"ok,omitempty"`
	Breach       *wrappers.Int64Value `protobuf:"bytes,2,opt,name=breach,proto3" json:"breach,omitempty"`
	NotAvailable *wrappers.Int64Value `protobuf:"bytes,3,opt,name=not_available,json=notAvailable,proto3" json:"not_available,omitempty"`
}
...
func (x *SloStatusCount) GetOk() *wrappers.Int64Value {
	if x != nil {
		return x.Ok
	}
	return nil
...
func (x *SloStatusCount) GetBreach() *wrappers.Int64Value {
	if x != nil {
		return x.Breach
	}
	return nil
...
func (x *SloStatusCount) GetNotAvailable() *wrappers.Int64Value {
	if x != nil {
...
type ApmService struct {
	...
	Workloads      []*wrappers.StringValue `protobuf:"bytes,4,rep,name=workloads,proto3" json:"workloads,omitempty"`
	...
	Technology     *wrappers.StringValue   `protobuf:"bytes,6,opt,name=technology,proto3" json:"technology,omitempty"`
}
...
func (x *ApmService) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *ApmService) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *ApmService) GetType() *wrappers.StringValue {
	if x != nil {
		return x.Type
	}
	return nil
...
func (x *ApmService) GetWorkloads() []*wrappers.StringValue {
	if x != nil {
		return x.Workloads
	}
	return nil
...
func (x *ApmService) GetTechnology() *wrappers.StringValue {
	if x != nil {
		return x.Technology
	}
	return nil
