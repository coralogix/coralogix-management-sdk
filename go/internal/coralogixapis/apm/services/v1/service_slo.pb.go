...
func file_com_coralogixapis_apm_services_v1_service_slo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_apm_services_v1_service_slo_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_apm_services_v1_service_slo_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_apm_services_v1_service_slo_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_apm_services_v1_service_slo_proto_msgTypes[3].Exporter = func(v any, i int) any {
