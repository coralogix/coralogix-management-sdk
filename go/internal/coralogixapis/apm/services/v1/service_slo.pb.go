...
type LatencySli struct {
	...
	ThresholdMicroseconds *wrappers.StringValue `protobuf:"bytes,1,opt,name=threshold_microseconds,json=thresholdMicroseconds,proto3" json:"threshold_microseconds,omitempty"`
...
func (x *LatencySli) GetThresholdMicroseconds() *wrappers.StringValue {
	if x != nil {
...
type ServiceSlo struct {
	...
	TargetPercentage               *wrappers.UInt32Value `protobuf:"bytes,6,opt,name=target_percentage,json=targetPercentage,proto3" json:"target_percentage,omitempty"`
	CreatedAt                      *timestamp.Timestamp  `protobuf:"bytes,7,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	RemainingErrorBudgetPercentage *wrappers.UInt32Value `protobuf:"bytes,8,opt,name=remaining_error_budget_percentage,json=remainingErrorBudgetPercentage,proto3" json:"remaining_error_budget_percentage,omitempty"`
...
func (x *ServiceSlo) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *ServiceSlo) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *ServiceSlo) GetServiceName() *wrappers.StringValue {
	if x != nil {
...
func (x *ServiceSlo) GetDescription() *wrappers.StringValue {
	if x != nil {
...
func (x *ServiceSlo) GetTargetPercentage() *wrappers.UInt32Value {
	if x != nil {
...
func (x *ServiceSlo) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *ServiceSlo) GetRemainingErrorBudgetPercentage() *wrappers.UInt32Value {
	if x != nil {
...
var file_com_coralogixapis_apm_services_v1_service_slo_proto_rawDesc = []byte{
	...
	0x59, 0x53, 0x10, 0x03, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
