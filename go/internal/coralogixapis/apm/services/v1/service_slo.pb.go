...
const file_com_coralogixapis_apm_services_v1_service_slo_proto_rawDesc = "" +
	...
	"\x06period\x18\f \x01(\x0e2,.com.coralogixapis.apm.services.v1.SloPeriodR\x06period:\x83\x03\x92A\xff\x02\n" +
	"\xf4\x01*\vService SLO2PThis data structure represents a Service Level Objective (SLO) in Coralogix APM.\xd2\x01\x02id\xd2\x01\x04name\xd2\x01\fservice_name\xd2\x01\x06status\xd2\x01\vdescription\xd2\x01\x11target_percentage\xd2\x01\n" +
	"created_at\xd2\x01!remaining_error_budget_percentage\xd2\x01\bsli_type\xd2\x01\afilters\xd2\x01\x06period*\x85\x01\n" +
