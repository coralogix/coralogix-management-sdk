...
const (
	ApmServiceService_GetApmService_FullMethodName       = "/com.coralogixapis.apm.services.v1.ApmServiceService/GetApmService"
	ApmServiceService_BatchGetApmServices_FullMethodName = "/com.coralogixapis.apm.services.v1.ApmServiceService/BatchGetApmServices"
	ApmServiceService_DeleteApmService_FullMethodName    = "/com.coralogixapis.apm.services.v1.ApmServiceService/DeleteApmService"
...
func (c *apmServiceServiceClient) GetApmService(ctx context.Context, in *GetApmServiceRequest, opts ...grpc.CallOption) (*GetApmServiceResponse, error) {
	...
	err := c.cc.Invoke(ctx, ApmServiceService_GetApmService_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apmServiceServiceClient) BatchGetApmServices(ctx context.Context, in *BatchGetApmServicesRequest, opts ...grpc.CallOption) (*BatchGetApmServicesResponse, error) {
	...
	err := c.cc.Invoke(ctx, ApmServiceService_BatchGetApmServices_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apmServiceServiceClient) DeleteApmService(ctx context.Context, in *DeleteApmServiceRequest, opts ...grpc.CallOption) (*DeleteApmServiceResponse, error) {
	...
	err := c.cc.Invoke(ctx, ApmServiceService_DeleteApmService_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apmServiceServiceClient) ListApmServices(ctx context.Context, in *ListApmServicesRequest, opts ...grpc.CallOption) (*ListApmServicesResponse, error) {
	...
	err := c.cc.Invoke(ctx, ApmServiceService_ListApmServices_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedApmServiceServiceServer must be embedded to have
...
func (UnimplementedApmServiceServiceServer) testEmbeddedByValue()                           {}
...
func RegisterApmServiceServiceServer(s grpc.ServiceRegistrar, srv ApmServiceServiceServer) {
	// If the following call pancis, it indicates UnimplementedApmServiceServiceServer was
...
func _ApmServiceService_GetApmService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApmServiceService_GetApmService_FullMethodName,
	}
...
func _ApmServiceService_BatchGetApmServices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApmServiceService_BatchGetApmServices_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ApmServiceService_DeleteApmService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApmServiceService_DeleteApmService_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ApmServiceService_ListApmServices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApmServiceService_ListApmServices_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
