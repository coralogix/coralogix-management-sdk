...
func (x *GetApmServiceRequest) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *BatchGetApmServicesRequest) GetIds() []*wrappers.StringValue {
	if x != nil {
		return x.Ids
	}
	return nil
...
func (x *BatchGetApmServicesResponse) GetNotFoundIds() []*wrappers.StringValue {
	if x != nil {
...
func (x *DeleteApmServiceRequest) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
