...
type Filter struct {
	...
	Values map[string]bool `protobuf:"bytes,2,rep,name=values,proto3" json:"values,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"` // String represents the object's name, value represents if it is selected or not
}
...
var file_com_coralogixapis_apm_queries_k8s_v1_infra_filters_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_apm_queries_k8s_v1_infra_filters_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_apm_queries_k8s_v1_infra_filters_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Filter); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogixapis_apm_queries_k8s_v1_infra_filters_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SelectedFilter); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
