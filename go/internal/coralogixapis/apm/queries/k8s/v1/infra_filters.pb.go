...
func file_com_coralogixapis_apm_queries_k8s_v1_infra_filters_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_apm_queries_k8s_v1_infra_filters_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Filter); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogixapis_apm_queries_k8s_v1_infra_filters_proto_msgTypes[1].Exporter = func(v any, i int) any {
