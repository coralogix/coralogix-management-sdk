...
func (c *infraFiltersServiceClient) ListFilters(ctx context.Context, in *ListFiltersRequest, opts ...grpc.CallOption) (*ListFiltersResponse, error) {
	...
	err := c.cc.Invoke(ctx, InfraFiltersService_ListFilters_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedInfraFiltersServiceServer must be embedded to have
...
func (UnimplementedInfraFiltersServiceServer) testEmbeddedByValue()                             {}
...
func RegisterInfraFiltersServiceServer(s grpc.ServiceRegistrar, srv InfraFiltersServiceServer) {
	// If the following call pancis, it indicates UnimplementedInfraFiltersServiceServer was
