...
var file_com_coralogixapis_apm_queries_k8s_v1_cluster_widget_wrapper_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_apm_queries_k8s_v1_cluster_widget_wrapper_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_apm_queries_k8s_v1_cluster_widget_wrapper_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ClusterWidgetWrapper); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_com_coralogixapis_apm_queries_k8s_v1_cluster_widget_wrapper_proto_msgTypes[0].OneofWrappers = []interface{}{
