...
type ListClustersResponse struct {
	...
	Clusters []*wrappers.StringValue `protobuf:"bytes,1,rep,name=clusters,proto3" json:"clusters,omitempty"`
}
...
func (x *ListClustersResponse) GetClusters() []*wrappers.StringValue {
	if x != nil {
		return x.Clusters
	}
	return nil
...
type ListClusterStatsResponse struct {
	...
	Stats           map[string]*wrappers.Int32Value `protobuf:"bytes,1,rep,name=stats,proto3" json:"stats,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *ListClusterStatsResponse) GetStats() map[string]*wrappers.Int32Value {
	if x != nil {
		return x.Stats
	}
	return nil
...
type ListNamesRequest struct {
	...
	Widget        *wrappers.StringValue `protobuf:"bytes,1,opt,name=widget,proto3" json:"widget,omitempty"`
	SelectedSlice *wrappers.StringValue `protobuf:"bytes,2,opt,name=selected_slice,json=selectedSlice,proto3" json:"selected_slice,omitempty"`
...
func (x *ListNamesRequest) GetWidget() *wrappers.StringValue {
	if x != nil {
		return x.Widget
	}
	return nil
...
func (x *ListNamesRequest) GetSelectedSlice() *wrappers.StringValue {
	if x != nil {
...
type ListNamesResponse struct {
	...
	Names  []*wrappers.StringValue `protobuf:"bytes,2,rep,name=names,proto3" json:"names,omitempty"`
...
func (x *ListNamesResponse) GetNames() []*wrappers.StringValue {
	if x != nil {
		return x.Names
	}
	return nil
