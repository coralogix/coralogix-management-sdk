...
type ClusterFilters struct {
	...
	SelectedClusterName *wrappers.StringValue `protobuf:"bytes,1,opt,name=selected_cluster_name,json=selectedClusterName,proto3" json:"selected_cluster_name,omitempty"`
...
func (x *ClusterFilters) GetSelectedClusterName() *wrappers.StringValue {
	if x != nil {
