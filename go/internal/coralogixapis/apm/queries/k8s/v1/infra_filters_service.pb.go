...
type ListFiltersRequest struct {
	...
	IsInitialLoad   *wrappers.BoolValue `protobuf:"bytes,1,opt,name=is_initial_load,json=isInitialLoad,proto3" json:"is_initial_load,omitempty"`
...
func (x *ListFiltersRequest) GetIsInitialLoad() *wrappers.BoolValue {
	if x != nil {
