...
func file_com_coralogixapis_apm_queries_k8s_v1_infra_filters_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_apm_queries_k8s_v1_infra_filters_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_apm_queries_k8s_v1_infra_filters_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
