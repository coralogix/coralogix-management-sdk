...
var file_com_coralogixapis_apm_queries_v1_event_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_apm_queries_v1_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_apm_queries_v1_event_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Event); i {
			case 0:
				return &v.state
			case 1:
