...
type Event struct {
	...
	ObjectKind   *wrappers.StringValue `protobuf:"bytes,1,opt,name=object_kind,json=objectKind,proto3" json:"object_kind,omitempty"`
	ObjectName   *wrappers.StringValue `protobuf:"bytes,2,opt,name=object_name,json=objectName,proto3" json:"object_name,omitempty"`
	Namespace    *wrappers.StringValue `protobuf:"bytes,3,opt,name=namespace,proto3" json:"namespace,omitempty"`
	ClusterName  *wrappers.StringValue `protobuf:"bytes,4,opt,name=cluster_name,json=clusterName,proto3" json:"cluster_name,omitempty"`
	Message      *wrappers.StringValue `protobuf:"bytes,5,opt,name=message,proto3" json:"message,omitempty"`
	Severity     *wrappers.StringValue `protobuf:"bytes,6,opt,name=severity,proto3" json:"severity,omitempty"`
	Reason       *wrappers.StringValue `protobuf:"bytes,7,opt,name=reason,proto3" json:"reason,omitempty"`
	CreationTime *wrappers.StringValue `protobuf:"bytes,8,opt,name=creation_time,json=creationTime,proto3" json:"creation_time,omitempty"`
}
...
func (x *Event) GetObjectKind() *wrappers.StringValue {
	if x != nil {
		return x.ObjectKind
	}
	return nil
...
func (x *Event) GetObjectName() *wrappers.StringValue {
	if x != nil {
		return x.ObjectName
	}
	return nil
...
func (x *Event) GetNamespace() *wrappers.StringValue {
	if x != nil {
		return x.Namespace
	}
	return nil
...
func (x *Event) GetClusterName() *wrappers.StringValue {
	if x != nil {
...
func (x *Event) GetMessage() *wrappers.StringValue {
	if x != nil {
		return x.Message
	}
	return nil
...
func (x *Event) GetSeverity() *wrappers.StringValue {
	if x != nil {
		return x.Severity
	}
	return nil
...
func (x *Event) GetReason() *wrappers.StringValue {
	if x != nil {
		return x.Reason
	}
	return nil
...
func (x *Event) GetCreationTime() *wrappers.StringValue {
	if x != nil {
