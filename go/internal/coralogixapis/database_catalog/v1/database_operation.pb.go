...
type DatabaseOperationData struct {
	...
	Table     *wrappers.StringValue `protobuf:"bytes,10,opt,name=table,proto3" json:"table,omitempty"`
	Service   *wrappers.StringValue `protobuf:"bytes,12,opt,name=service,proto3" json:"service,omitempty"`
	// Types that are assignable to DatabaseOperationData:
	//
...
func (x *DatabaseOperationData) GetOperation() *wrappers.StringValue {
	if x != nil {
		return x.Operation
	}
	return nil
...
func (x *DatabaseOperationData) GetTable() *wrappers.StringValue {
	if x != nil {
		return x.Table
	}
	return nil
...
func (x *DatabaseOperationData) GetService() *wrappers.StringValue {
	if x != nil {
		return x.Service
	}
	return nil
...
func (m *DatabaseOperationData) GetDatabaseOperationData() isDatabaseOperationData_DatabaseOperationData {
	if m != nil {
		return m.DatabaseOperationData
	}
	return nil
}

func (x *DatabaseOperationData) GetP99Latency() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_P99Latency); ok {
		return x.P99Latency
	}
	return nil
}

func (x *DatabaseOperationData) GetP95Latency() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_P95Latency); ok {
		return x.P95Latency
	}
	return nil
}

func (x *DatabaseOperationData) GetP90Latency() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_P90Latency); ok {
		return x.P90Latency
	}
	return nil
}

func (x *DatabaseOperationData) GetP75Latency() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_P75Latency); ok {
		return x.P75Latency
	}
	return nil
}

func (x *DatabaseOperationData) GetP50Latency() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_P50Latency); ok {
		return x.P50Latency
	}
	return nil
}

func (x *DatabaseOperationData) GetAvgLatency() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_AvgLatency); ok {
		return x.AvgLatency
	}
	return nil
}

func (x *DatabaseOperationData) GetTotalRequests() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_TotalRequests); ok {
		return x.TotalRequests
	}
	return nil
}

func (x *DatabaseOperationData) GetTotalErrors() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_TotalErrors); ok {
		return x.TotalErrors
	}
	return nil
}

func (x *DatabaseOperationData) GetErrorsPercentage() *wrappers.FloatValue {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_ErrorsPercentage); ok {
		return x.ErrorsPercentage
	}
	return nil
}

func (x *DatabaseOperationData) GetTimeConsuming() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_TimeConsuming); ok {
		return x.TimeConsuming
	}
	return nil
}

func (x *DatabaseOperationData) GetTimeConsumingPercentage() *wrappers.FloatValue {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_TimeConsumingPercentage); ok {
		return x.TimeConsumingPercentage
	}
	return nil
}

func (x *DatabaseOperationData) GetOperationSource() *wrappers.StringValue {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_OperationSource); ok {
		return x.OperationSource
	}
	return nil
}

func (x *DatabaseOperationData) GetThroughput() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_Throughput); ok {
		return x.Throughput
	}
	return nil
}

func (x *DatabaseOperationData) GetMaxThroughput() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_MaxThroughput); ok {
		return x.MaxThroughput
	}
	return nil
}

func (x *DatabaseOperationData) GetErrorsPerMinute() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_ErrorsPerMinute); ok {
		return x.ErrorsPerMinute
	}
	return nil
}

func (x *DatabaseOperationData) GetMaxErrorsPerMinute() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_MaxErrorsPerMinute); ok {
		return x.MaxErrorsPerMinute
	}
	return nil
}

func (x *DatabaseOperationData) GetErrorsPerSecond() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_ErrorsPerSecond); ok {
		return x.ErrorsPerSecond
	}
	return nil
}

func (x *DatabaseOperationData) GetTotalActiveTables() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_TotalActiveTables); ok {
		return x.TotalActiveTables
	}
	return nil
}

func (x *DatabaseOperationData) GetP95LatencyTrend() *wrappers.FloatValue {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_P95LatencyTrend); ok {
		return x.P95LatencyTrend
	}
	return nil
}

func (x *DatabaseOperationData) GetTotalRequestsTrend() *wrappers.FloatValue {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_TotalRequestsTrend); ok {
		return x.TotalRequestsTrend
	}
	return nil
}

func (x *DatabaseOperationData) GetTotalErrorsTrend() *wrappers.FloatValue {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_TotalErrorsTrend); ok {
		return x.TotalErrorsTrend
	}
	return nil
}

func (x *DatabaseOperationData) GetErrorsPercentageTrend() *wrappers.FloatValue {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_ErrorsPercentageTrend); ok {
		return x.ErrorsPercentageTrend
	}
	return nil
}

func (x *DatabaseOperationData) GetP95LatencyWithOffset() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_P95LatencyWithOffset); ok {
		return x.P95LatencyWithOffset
	}
	return nil
}

func (x *DatabaseOperationData) GetTotalRequestsWithOffset() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_TotalRequestsWithOffset); ok {
		return x.TotalRequestsWithOffset
	}
	return nil
}

func (x *DatabaseOperationData) GetTotalErrorsWithOffset() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_TotalErrorsWithOffset); ok {
		return x.TotalErrorsWithOffset
	}
	return nil
}

func (x *DatabaseOperationData) GetErrorsPercentageWithOffset() *wrappers.Int64Value {
	if x, ok := x.GetDatabaseOperationData().(*DatabaseOperationData_ErrorsPercentageWithOffset); ok {
...
type DatabaseOperationData_P99Latency struct {
	P99Latency *wrappers.Int64Value `protobuf:"bytes,21,opt,name=p99_latency,json=p99Latency,proto3,oneof"`
}

type DatabaseOperationData_P95Latency struct {
	P95Latency *wrappers.Int64Value `protobuf:"bytes,4,opt,name=p95_latency,json=p95Latency,proto3,oneof"`
}

type DatabaseOperationData_P90Latency struct {
	P90Latency *wrappers.Int64Value `protobuf:"bytes,22,opt,name=p90_latency,json=p90Latency,proto3,oneof"`
}

type DatabaseOperationData_P75Latency struct {
	P75Latency *wrappers.Int64Value `protobuf:"bytes,23,opt,name=p75_latency,json=p75Latency,proto3,oneof"`
}

type DatabaseOperationData_P50Latency struct {
	P50Latency *wrappers.Int64Value `protobuf:"bytes,24,opt,name=p50_latency,json=p50Latency,proto3,oneof"`
}

type DatabaseOperationData_AvgLatency struct {
	AvgLatency *wrappers.Int64Value `protobuf:"bytes,25,opt,name=avg_latency,json=avgLatency,proto3,oneof"`
}

type DatabaseOperationData_TotalRequests struct {
	TotalRequests *wrappers.Int64Value `protobuf:"bytes,5,opt,name=total_requests,json=totalRequests,proto3,oneof"`
}

type DatabaseOperationData_TotalErrors struct {
	TotalErrors *wrappers.Int64Value `protobuf:"bytes,6,opt,name=total_errors,json=totalErrors,proto3,oneof"`
}

type DatabaseOperationData_ErrorsPercentage struct {
	ErrorsPercentage *wrappers.FloatValue `protobuf:"bytes,7,opt,name=errors_percentage,json=errorsPercentage,proto3,oneof"`
}

type DatabaseOperationData_TimeConsuming struct {
	TimeConsuming *wrappers.Int64Value `protobuf:"bytes,8,opt,name=time_consuming,json=timeConsuming,proto3,oneof"`
}

type DatabaseOperationData_TimeConsumingPercentage struct {
	TimeConsumingPercentage *wrappers.FloatValue `protobuf:"bytes,9,opt,name=time_consuming_percentage,json=timeConsumingPercentage,proto3,oneof"`
}

type DatabaseOperationData_OperationSource struct {
	OperationSource *wrappers.StringValue `protobuf:"bytes,11,opt,name=operation_source,json=operationSource,proto3,oneof"`
}

type DatabaseOperationData_Throughput struct {
	Throughput *wrappers.Int64Value `protobuf:"bytes,26,opt,name=throughput,proto3,oneof"`
}

type DatabaseOperationData_MaxThroughput struct {
	MaxThroughput *wrappers.Int64Value `protobuf:"bytes,27,opt,name=max_throughput,json=maxThroughput,proto3,oneof"`
}

type DatabaseOperationData_ErrorsPerMinute struct {
	ErrorsPerMinute *wrappers.Int64Value `protobuf:"bytes,28,opt,name=errors_per_minute,json=errorsPerMinute,proto3,oneof"`
}

type DatabaseOperationData_MaxErrorsPerMinute struct {
	MaxErrorsPerMinute *wrappers.Int64Value `protobuf:"bytes,29,opt,name=max_errors_per_minute,json=maxErrorsPerMinute,proto3,oneof"`
}

type DatabaseOperationData_ErrorsPerSecond struct {
	ErrorsPerSecond *wrappers.Int64Value `protobuf:"bytes,30,opt,name=errors_per_second,json=errorsPerSecond,proto3,oneof"`
}

type DatabaseOperationData_TotalActiveTables struct {
	TotalActiveTables *wrappers.Int64Value `protobuf:"bytes,31,opt,name=total_active_tables,json=totalActiveTables,proto3,oneof"`
}

type DatabaseOperationData_P95LatencyTrend struct {
	P95LatencyTrend *wrappers.FloatValue `protobuf:"bytes,13,opt,name=p95_latency_trend,json=p95LatencyTrend,proto3,oneof"`
}

type DatabaseOperationData_TotalRequestsTrend struct {
	TotalRequestsTrend *wrappers.FloatValue `protobuf:"bytes,14,opt,name=total_requests_trend,json=totalRequestsTrend,proto3,oneof"`
}

type DatabaseOperationData_TotalErrorsTrend struct {
	TotalErrorsTrend *wrappers.FloatValue `protobuf:"bytes,15,opt,name=total_errors_trend,json=totalErrorsTrend,proto3,oneof"`
}

type DatabaseOperationData_ErrorsPercentageTrend struct {
	ErrorsPercentageTrend *wrappers.FloatValue `protobuf:"bytes,16,opt,name=errors_percentage_trend,json=errorsPercentageTrend,proto3,oneof"`
}

type DatabaseOperationData_P95LatencyWithOffset struct {
	P95LatencyWithOffset *wrappers.Int64Value `protobuf:"bytes,17,opt,name=p95_latency_with_offset,json=p95LatencyWithOffset,proto3,oneof"`
}

type DatabaseOperationData_TotalRequestsWithOffset struct {
	TotalRequestsWithOffset *wrappers.Int64Value `protobuf:"bytes,18,opt,name=total_requests_with_offset,json=totalRequestsWithOffset,proto3,oneof"`
}

type DatabaseOperationData_TotalErrorsWithOffset struct {
	TotalErrorsWithOffset *wrappers.Int64Value `protobuf:"bytes,19,opt,name=total_errors_with_offset,json=totalErrorsWithOffset,proto3,oneof"`
}

type DatabaseOperationData_ErrorsPercentageWithOffset struct {
	ErrorsPercentageWithOffset *wrappers.Int64Value `protobuf:"bytes,20,opt,name=errors_percentage_with_offset,json=errorsPercentageWithOffset,proto3,oneof"`
}
...
type DatabaseOperation struct {
	...
	Operation *wrappers.StringValue `protobuf:"bytes,1,opt,name=operation,proto3" json:"operation,omitempty"`
	Table     *wrappers.StringValue `protobuf:"bytes,2,opt,name=table,proto3" json:"table,omitempty"`
}
...
func (x *DatabaseOperation) GetOperation() *wrappers.StringValue {
	if x != nil {
		return x.Operation
	}
	return nil
...
func (x *DatabaseOperation) GetTable() *wrappers.StringValue {
	if x != nil {
		return x.Table
	}
	return nil
