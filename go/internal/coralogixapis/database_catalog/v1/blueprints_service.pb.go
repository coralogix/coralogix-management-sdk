...
var file_com_coralogixapis_database_catalog_v1_blueprints_service_proto_rawDesc = string([]byte{
...
var (
	...
	file_com_coralogixapis_database_catalog_v1_blueprints_service_proto_rawDescData []byte
)
...
func file_com_coralogixapis_database_catalog_v1_blueprints_service_proto_rawDescGZIP() []byte {
	file_com_coralogixapis_database_catalog_v1_blueprints_service_proto_rawDescOnce.Do(func() {
		file_com_coralogixapis_database_catalog_v1_blueprints_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogixapis_database_catalog_v1_blueprints_service_proto_rawDesc), len(file_com_coralogixapis_database_catalog_v1_blueprints_service_proto_rawDesc)))
	})
...
func file_com_coralogixapis_database_catalog_v1_blueprints_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogixapis_database_catalog_v1_blueprints_service_proto_rawDesc), len(file_com_coralogixapis_database_catalog_v1_blueprints_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
