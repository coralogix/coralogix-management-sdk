...
func (x *GetBlueprintGraphsStreamResponse) GetSuccessesAndFailures() *v11.RepeatedLineChart {
...
func (x *GetBlueprintGraphsStreamResponse) GetLatency() *v11.RepeatedLineChart {
...
type GetBlueprintGraphsStreamResponse_SuccessesAndFailures struct {
	SuccessesAndFailures *v11.RepeatedLineChart `protobuf:"bytes,1,opt,name=successes_and_failures,json=successesAndFailures,proto3,oneof"`
}
...
var file_com_coralogixapis_database_catalog_v1_blueprints_service_proto_goTypes = []interface{}{
	...
	(*v11.RepeatedLineChart)(nil),              // 11: com.coralogixapis.service_catalog.v1.RepeatedLineChart
}
