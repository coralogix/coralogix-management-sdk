...
func (x *GetDatabaseOperationsErrorsStreamResponse) GetErrors() *v12.RepeatedLineChart {
...
func (x *GetDatabaseOperationsErrorsStreamResponse) GetErrorPercentage() *v12.RepeatedLineChart {
...
func (x *GetDatabaseOperationsErrorsStreamResponse) GetErrorsPerSeconds() *v12.RepeatedLineChart {
...
type GetDatabaseOperationsErrorsStreamResponse_Errors struct {
	Errors *v12.RepeatedLineChart `protobuf:"bytes,1,opt,name=errors,proto3,oneof"`
}

type GetDatabaseOperationsErrorsStreamResponse_ErrorPercentage struct {
	ErrorPercentage *v12.RepeatedLineChart `protobuf:"bytes,2,opt,name=error_percentage,json=errorPercentage,proto3,oneof"`
}

type GetDatabaseOperationsErrorsStreamResponse_ErrorsPerSeconds struct {
	ErrorsPerSeconds *v12.RepeatedLineChart `protobuf:"bytes,4,opt,name=errors_per_seconds,json=errorsPerSeconds,proto3,oneof"`
}
...
func (x *GetDatabaseOperationsResponseTimeStreamResponse) GetP95() *v12.RepeatedLineChart {
...
func (x *GetDatabaseOperationsResponseTimeStreamResponse) GetP99() *v12.RepeatedLineChart {
...
func (x *GetDatabaseOperationsResponseTimeStreamResponse) GetAvg() *v12.RepeatedLineChart {
...
func (x *GetDatabaseOperationsResponseTimeStreamResponse) GetMax() *v12.RepeatedLineChart {
...
func (x *GetDatabaseOperationsResponseTimeStreamResponse) GetP50() *v12.RepeatedLineChart {
...
func (x *GetDatabaseOperationsResponseTimeStreamResponse) GetP75() *v12.RepeatedLineChart {
...
type GetDatabaseOperationsResponseTimeStreamResponse_P95 struct {
	P95 *v12.RepeatedLineChart `protobuf:"bytes,1,opt,name=p95,proto3,oneof"`
}

type GetDatabaseOperationsResponseTimeStreamResponse_P99 struct {
	P99 *v12.RepeatedLineChart `protobuf:"bytes,2,opt,name=p99,proto3,oneof"`
}

type GetDatabaseOperationsResponseTimeStreamResponse_Avg struct {
	Avg *v12.RepeatedLineChart `protobuf:"bytes,3,opt,name=avg,proto3,oneof"`
}

type GetDatabaseOperationsResponseTimeStreamResponse_Max struct {
	Max *v12.RepeatedLineChart `protobuf:"bytes,4,opt,name=max,proto3,oneof"`
}

type GetDatabaseOperationsResponseTimeStreamResponse_P50 struct {
	P50 *v12.RepeatedLineChart `protobuf:"bytes,5,opt,name=p50,proto3,oneof"`
}

type GetDatabaseOperationsResponseTimeStreamResponse_P75 struct {
	P75 *v12.RepeatedLineChart `protobuf:"bytes,6,opt,name=p75,proto3,oneof"`
}
...
func (x *GetDatabaseOperationGraphsStreamResponse) GetRequestsAndErrors() *v12.RepeatedLineChart {
...
func (x *GetDatabaseOperationGraphsStreamResponse) GetLatency() *v12.RepeatedLineChart {
...
type GetDatabaseOperationGraphsStreamResponse_RequestsAndErrors struct {
	RequestsAndErrors *v12.RepeatedLineChart `protobuf:"bytes,1,opt,name=requests_and_errors,json=requestsAndErrors,proto3,oneof"`
}

type GetDatabaseOperationGraphsStreamResponse_Latency struct {
	Latency *v12.RepeatedLineChart `protobuf:"bytes,2,opt,name=latency,proto3,oneof"`
}
...
var file_com_coralogixapis_database_catalog_v1_operations_service_proto_goTypes = []interface{}{
	...
	(*v12.RepeatedLineChart)(nil),                           // 23: com.coralogixapis.service_catalog.v1.RepeatedLineChart
