...
type GetDatabaseOverviewStreamRequest struct {
	...
	DatabaseSystem         *wrappers.StringValue   `protobuf:"bytes,6,opt,name=database_system,json=databaseSystem,proto3" json:"database_system,omitempty"`
...
func (x *GetDatabaseOverviewStreamRequest) GetDatabaseName() *wrappers.StringValue {
	if x != nil {
...
func (x *GetDatabaseOverviewStreamRequest) GetDatabaseNameSource() *wrappers.StringValue {
	if x != nil {
...
func (x *GetDatabaseOverviewStreamRequest) GetCallingServices() []*wrappers.StringValue {
	if x != nil {
...
func (x *GetDatabaseOverviewStreamRequest) GetDatabaseSystem() *wrappers.StringValue {
	if x != nil {
...
func (x *GetDatabaseOverviewStreamRequest) GetTables() []*wrappers.StringValue {
	if x != nil {
		return x.Tables
	}
	return nil
...
func (x *GetDatabaseOverviewStreamRequest) GetTrendOffset() *wrappers.Int64Value {
	if x != nil {
...
func (x *GetApdexRequest) GetDatabaseName() *wrappers.StringValue {
	if x != nil {
		return x.DatabaseName
	}
	return nil
...
func (x *GetApdexRequest) GetDatabaseNameSource() *wrappers.StringValue {
	if x != nil {
		return x.DatabaseNameSource
	}
	return nil
...
func (x *GetApdexRequest) GetCallingServices() []*wrappers.StringValue {
	if x != nil {
		return x.CallingServices
	}
	return nil
