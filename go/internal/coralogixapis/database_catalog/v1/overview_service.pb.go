...
func (x *GetDatabaseOverviewStreamRequest) GetDatabaseCatalogFilters() []*DatabaseCatalogFilter {
	if x != nil {
...
func (x *GetDatabaseOverviewStreamResponse) GetAvgLatency() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetThroughput() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetErrorRpm() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetErrorPercentage() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetRequestsAndErrors() *v11.RepeatedLineChart {
...
func (x *GetDatabaseOverviewStreamResponse) GetErrorPercentageOverTime() *v11.RepeatedLineChart {
...
func (x *GetDatabaseOverviewStreamResponse) GetErrorRate() *v11.RepeatedLineChart {
...
func (x *GetDatabaseOverviewStreamResponse) GetLatencyPercentiles() *v11.RepeatedLineChart {
...
func (x *GetDatabaseOverviewStreamResponse) GetP50() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetP75() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetP95() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetP99() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetRequestRatePerMinute() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetTimeConsumingQueries() *v1.Topk {
...
func (x *GetDatabaseOverviewStreamResponse) GetApdexScore() *v1.LineChart {
...
func (x *GetDatabaseOverviewStreamResponse) GetAvgLatencyTrend() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetThroughputTrend() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetErrorRpmTrend() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetErrorPercentageTrend() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetP50Trend() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetP75Trend() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetP95Trend() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetP99Trend() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetRequestRatePerMinuteTrend() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetAvgLatencyWithOffset() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetThroughputWithOffset() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetErrorRpmWithOffset() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetErrorPercentageWithOffset() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetP50WithOffset() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetP75WithOffset() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetP95WithOffset() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetP99WithOffset() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetRequestRatePerMinuteWithOffset() *v1.Stat {
...
func (x *GetDatabaseOverviewStreamResponse) GetErrorsPerSeconds() *v11.RepeatedLineChart {
...
type GetDatabaseOverviewStreamResponse_AvgLatency struct {
	AvgLatency *v1.Stat `protobuf:"bytes,1,opt,name=avg_latency,json=avgLatency,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_Throughput struct {
	Throughput *v1.Stat `protobuf:"bytes,2,opt,name=throughput,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_ErrorRpm struct {
	ErrorRpm *v1.Stat `protobuf:"bytes,3,opt,name=error_rpm,json=errorRpm,proto3,oneof"`
}
...
type GetDatabaseOverviewStreamResponse_RequestsAndErrors struct {
	RequestsAndErrors *v11.RepeatedLineChart `protobuf:"bytes,5,opt,name=requests_and_errors,json=requestsAndErrors,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_ErrorPercentageOverTime struct {
	ErrorPercentageOverTime *v11.RepeatedLineChart `protobuf:"bytes,6,opt,name=error_percentage_over_time,json=errorPercentageOverTime,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_ErrorRate struct {
	ErrorRate *v11.RepeatedLineChart `protobuf:"bytes,7,opt,name=error_rate,json=errorRate,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_LatencyPercentiles struct {
	LatencyPercentiles *v11.RepeatedLineChart `protobuf:"bytes,8,opt,name=latency_percentiles,json=latencyPercentiles,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_P50 struct {
	P50 *v1.Stat `protobuf:"bytes,9,opt,name=p50,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_P75 struct {
	P75 *v1.Stat `protobuf:"bytes,10,opt,name=p75,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_P95 struct {
	P95 *v1.Stat `protobuf:"bytes,11,opt,name=p95,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_P99 struct {
	P99 *v1.Stat `protobuf:"bytes,12,opt,name=p99,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_RequestRatePerMinute struct {
	// Deprecated: Marked as deprecated in com/coralogixapis/database_catalog/v1/overview_service.proto.
	RequestRatePerMinute *v1.Stat `protobuf:"bytes,13,opt,name=request_rate_per_minute,json=requestRatePerMinute,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_TimeConsumingQueries struct {
	TimeConsumingQueries *v1.Topk `protobuf:"bytes,14,opt,name=time_consuming_queries,json=timeConsumingQueries,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_ApdexScore struct {
	ApdexScore *v1.LineChart `protobuf:"bytes,15,opt,name=apdex_score,json=apdexScore,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_AvgLatencyTrend struct {
	AvgLatencyTrend *v1.Stat `protobuf:"bytes,16,opt,name=avg_latency_trend,json=avgLatencyTrend,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_ThroughputTrend struct {
	ThroughputTrend *v1.Stat `protobuf:"bytes,17,opt,name=throughput_trend,json=throughputTrend,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_ErrorRpmTrend struct {
	ErrorRpmTrend *v1.Stat `protobuf:"bytes,18,opt,name=error_rpm_trend,json=errorRpmTrend,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_ErrorPercentageTrend struct {
	ErrorPercentageTrend *v1.Stat `protobuf:"bytes,19,opt,name=error_percentage_trend,json=errorPercentageTrend,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_P50Trend struct {
	P50Trend *v1.Stat `protobuf:"bytes,20,opt,name=p50_trend,json=p50Trend,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_P75Trend struct {
	P75Trend *v1.Stat `protobuf:"bytes,21,opt,name=p75_trend,json=p75Trend,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_P95Trend struct {
	P95Trend *v1.Stat `protobuf:"bytes,22,opt,name=p95_trend,json=p95Trend,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_P99Trend struct {
	P99Trend *v1.Stat `protobuf:"bytes,23,opt,name=p99_trend,json=p99Trend,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_RequestRatePerMinuteTrend struct {
	RequestRatePerMinuteTrend *v1.Stat `protobuf:"bytes,24,opt,name=request_rate_per_minute_trend,json=requestRatePerMinuteTrend,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_AvgLatencyWithOffset struct {
	AvgLatencyWithOffset *v1.Stat `protobuf:"bytes,25,opt,name=avg_latency_with_offset,json=avgLatencyWithOffset,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_ThroughputWithOffset struct {
	ThroughputWithOffset *v1.Stat `protobuf:"bytes,26,opt,name=throughput_with_offset,json=throughputWithOffset,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_ErrorRpmWithOffset struct {
	ErrorRpmWithOffset *v1.Stat `protobuf:"bytes,27,opt,name=error_rpm_with_offset,json=errorRpmWithOffset,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_ErrorPercentageWithOffset struct {
	ErrorPercentageWithOffset *v1.Stat `protobuf:"bytes,28,opt,name=error_percentage_with_offset,json=errorPercentageWithOffset,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_P50WithOffset struct {
	P50WithOffset *v1.Stat `protobuf:"bytes,29,opt,name=p50_with_offset,json=p50WithOffset,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_P75WithOffset struct {
	P75WithOffset *v1.Stat `protobuf:"bytes,30,opt,name=p75_with_offset,json=p75WithOffset,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_P95WithOffset struct {
	P95WithOffset *v1.Stat `protobuf:"bytes,31,opt,name=p95_with_offset,json=p95WithOffset,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_P99WithOffset struct {
	P99WithOffset *v1.Stat `protobuf:"bytes,32,opt,name=p99_with_offset,json=p99WithOffset,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_RequestRatePerMinuteWithOffset struct {
	RequestRatePerMinuteWithOffset *v1.Stat `protobuf:"bytes,33,opt,name=request_rate_per_minute_with_offset,json=requestRatePerMinuteWithOffset,proto3,oneof"`
}

type GetDatabaseOverviewStreamResponse_ErrorsPerSeconds struct {
	ErrorsPerSeconds *v11.RepeatedLineChart `protobuf:"bytes,34,opt,name=errors_per_seconds,json=errorsPerSeconds,proto3,oneof"`
}
...
func (x *GetApdexRequest) GetDatabaseCatalogFilters() []*DatabaseCatalogFilter {
	if x != nil {
		return x.DatabaseCatalogFilters
	}
	return nil
...
var file_com_coralogixapis_database_catalog_v1_overview_service_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xfe, 0x04, 0x0a, 0x20, 0x47, 0x65, 0x74,
	0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x4f, 0x76, 0x65, 0x72, 0x76, 0x69, 0x65, 0x77,
	0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x41, 0x0a,
	...
	0x65, 0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c,
	...
	0x12, 0x49, 0x0a, 0x0a, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x03,
	...
	0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3c, 0x2e,
	0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x72, 0x61, 0x6c, 0x6f, 0x67, 0x69, 0x78, 0x61, 0x70, 0x69,
	0x73, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x63, 0x61, 0x74, 0x61, 0x6c,
	...
	0x6c, 0x69, 0x6e, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x45, 0x0a, 0x0f,
	...
	0x74, 0x65, 0x6d, 0x12, 0x34, 0x0a, 0x06, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x18, 0x07, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x56, 0x61, 0x6c, 0x75,
	0x65, 0x52, 0x06, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x12, 0x3e, 0x0a, 0x0c, 0x74, 0x72, 0x65,
	...
	0x65, 0x6e, 0x64, 0x4f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x22, 0xa2, 0x17, 0x0a, 0x21, 0x47, 0x65,
	...
	0x6f, 0x6e, 0x64, 0x73, 0x42, 0x08, 0x0a, 0x06, 0x77, 0x69, 0x64, 0x67, 0x65, 0x74, 0x22, 0xb0,
	0x03, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x41, 0x70, 0x64, 0x65, 0x78, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x67, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x12, 0x47, 0x0a, 0x10, 0x63, 0x61, 0x6c, 0x6c,
	0x69, 0x6e, 0x67, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x56, 0x61, 0x6c, 0x75, 0x65,
	0x52, 0x0f, 0x63, 0x61, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x73, 0x22, 0x60, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x41, 0x70, 0x64, 0x65, 0x78, 0x52, 0x65, 0x73,
	...
	,
	...
	0x65, 0x74, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x4f, 0x76, 0x65, 0x72, 0x76, 0x69,
	0x65, 0x77, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x22, 0xc2, 0xb8, 0x02, 0x1e, 0x0a, 0x1c, 0x47, 0x65, 0x74, 0x20, 0x44, 0x61, 0x74, 0x61,
	0x62, 0x61, 0x73, 0x65, 0x20, 0x4f, 0x76, 0x65, 0x72, 0x76, 0x69, 0x65, 0x77, 0x20, 0x53, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x30, 0x01, 0x12, 0x8c, 0x01, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x41, 0x70,
	...
	0x70, 0x64, 0x65, 0x78, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x37, 0x2e, 0x63, 0x6f,
	0x6d, 0x2e, 0x63, 0x6f, 0x72, 0x61, 0x6c, 0x6f, 0x67, 0x69, 0x78, 0x61, 0x70, 0x69, 0x73, 0x2e,
...
var file_com_coralogixapis_database_catalog_v1_overview_service_proto_goTypes = []interface{}{
	...
	(*DatabaseCatalogFilter)(nil),             // 6: com.coralogixapis.database_catalog.v1.DatabaseCatalogFilter
	(*wrapperspb.Int64Value)(nil),             // 7: google.protobuf.Int64Value
	(*v1.Stat)(nil),                           // 8: com.coralogixapis.apm.widgets.v1.Stat
	(*v11.RepeatedLineChart)(nil),             // 9: com.coralogixapis.service_catalog.v1.RepeatedLineChart
	(*v1.Topk)(nil),                           // 10: com.coralogixapis.apm.widgets.v1.Topk
	(*v1.LineChart)(nil),                      // 11: com.coralogixapis.apm.widgets.v1.LineChart
}
var file_com_coralogixapis_database_catalog_v1_overview_service_proto_depIdxs = []int32{
	...
	6,  // 3: com.coralogixapis.database_catalog.v1.GetDatabaseOverviewStreamRequest.database_catalog_filters:type_name -> com.coralogixapis.database_catalog.v1.DatabaseCatalogFilter
	...
	6,  // 45: com.coralogixapis.database_catalog.v1.GetApdexRequest.database_catalog_filters:type_name -> com.coralogixapis.database_catalog.v1.DatabaseCatalogFilter
...
func file_com_coralogixapis_database_catalog_v1_overview_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_database_catalog_v1_overview_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetDatabaseOverviewStreamRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_database_catalog_v1_overview_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetDatabaseOverviewStreamResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_database_catalog_v1_overview_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_database_catalog_v1_overview_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_coralogixapis_database_catalog_v1_overview_service_proto_msgTypes[1].OneofWrappers = []interface{}{
