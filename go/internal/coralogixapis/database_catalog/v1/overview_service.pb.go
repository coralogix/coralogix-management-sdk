...
var file_com_coralogixapis_database_catalog_v1_overview_service_proto_rawDesc = string([]byte{
...
var (
	...
	file_com_coralogixapis_database_catalog_v1_overview_service_proto_rawDescData []byte
)
...
func file_com_coralogixapis_database_catalog_v1_overview_service_proto_rawDescGZIP() []byte {
	file_com_coralogixapis_database_catalog_v1_overview_service_proto_rawDescOnce.Do(func() {
		file_com_coralogixapis_database_catalog_v1_overview_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogixapis_database_catalog_v1_overview_service_proto_rawDesc), len(file_com_coralogixapis_database_catalog_v1_overview_service_proto_rawDesc)))
	})
...
var file_com_coralogixapis_database_catalog_v1_overview_service_proto_goTypes = []any{
	...
	(*v1.RepeatedLineChart)(nil),              // 9: com.coralogixapis.service_catalog.v1.RepeatedLineChart
...
func file_com_coralogixapis_database_catalog_v1_overview_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogixapis_database_catalog_v1_overview_service_proto_rawDesc), len(file_com_coralogixapis_database_catalog_v1_overview_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
