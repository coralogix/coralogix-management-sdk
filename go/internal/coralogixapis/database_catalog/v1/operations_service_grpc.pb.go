...
func (c *databaseOperationsServiceClient) GetDatabaseOperationsColumnsStream(ctx context.Context, in *GetDatabaseOperationsColumnsStreamRequest, opts ...grpc.CallOption) (DatabaseOperationsService_GetDatabaseOperationsColumnsStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &DatabaseOperationsService_ServiceDesc.Streams[0], DatabaseOperationsService_GetDatabaseOperationsColumnsStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &databaseOperationsServiceGetDatabaseOperationsColumnsStreamClient{stream}
...
func (c *databaseOperationsServiceClient) GetDatabaseOperationsRequests(ctx context.Context, in *GetDatabaseOperationsRequestsRequest, opts ...grpc.CallOption) (*GetDatabaseOperationsRequestsResponse, error) {
	...
	err := c.cc.Invoke(ctx, DatabaseOperationsService_GetDatabaseOperationsRequests_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *databaseOperationsServiceClient) GetDatabaseOperationsErrorsStream(ctx context.Context, in *GetDatabaseOperationsErrorsStreamRequest, opts ...grpc.CallOption) (DatabaseOperationsService_GetDatabaseOperationsErrorsStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &DatabaseOperationsService_ServiceDesc.Streams[1], DatabaseOperationsService_GetDatabaseOperationsErrorsStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &databaseOperationsServiceGetDatabaseOperationsErrorsStreamClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *databaseOperationsServiceClient) GetDatabaseOperationsTimeConsuming(ctx context.Context, in *GetDatabaseOperationsTimeConsumingRequest, opts ...grpc.CallOption) (*GetDatabaseOperationsTimeConsumingResponse, error) {
	...
	err := c.cc.Invoke(ctx, DatabaseOperationsService_GetDatabaseOperationsTimeConsuming_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *databaseOperationsServiceClient) GetDatabaseOperationsResponseTimeStream(ctx context.Context, in *GetDatabaseOperationsResponseTimeStreamRequest, opts ...grpc.CallOption) (DatabaseOperationsService_GetDatabaseOperationsResponseTimeStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &DatabaseOperationsService_ServiceDesc.Streams[2], DatabaseOperationsService_GetDatabaseOperationsResponseTimeStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &databaseOperationsServiceGetDatabaseOperationsResponseTimeStreamClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *databaseOperationsServiceClient) ListOperations(ctx context.Context, in *ListOperationsRequest, opts ...grpc.CallOption) (*ListOperationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, DatabaseOperationsService_ListOperations_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *databaseOperationsServiceClient) GetOperationStats(ctx context.Context, in *GetOperationStatsRequest, opts ...grpc.CallOption) (*GetOperationStatsResponse, error) {
	...
	err := c.cc.Invoke(ctx, DatabaseOperationsService_GetOperationStats_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *databaseOperationsServiceClient) GetDatabaseOperationGraphsStream(ctx context.Context, in *GetDatabaseOperationGraphsStreamRequest, opts ...grpc.CallOption) (DatabaseOperationsService_GetDatabaseOperationGraphsStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &DatabaseOperationsService_ServiceDesc.Streams[3], DatabaseOperationsService_GetDatabaseOperationGraphsStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &databaseOperationsServiceGetDatabaseOperationGraphsStreamClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func _DatabaseOperationsService_GetDatabaseOperationsColumnsStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DatabaseOperationsServiceServer).GetDatabaseOperationsColumnsStream(m, &databaseOperationsServiceGetDatabaseOperationsColumnsStreamServer{stream})
}
...
func _DatabaseOperationsService_GetDatabaseOperationsErrorsStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DatabaseOperationsServiceServer).GetDatabaseOperationsErrorsStream(m, &databaseOperationsServiceGetDatabaseOperationsErrorsStreamServer{stream})
}
...
func _DatabaseOperationsService_GetDatabaseOperationsResponseTimeStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DatabaseOperationsServiceServer).GetDatabaseOperationsResponseTimeStream(m, &databaseOperationsServiceGetDatabaseOperationsResponseTimeStreamServer{stream})
}
...
func _DatabaseOperationsService_GetDatabaseOperationGraphsStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DatabaseOperationsServiceServer).GetDatabaseOperationGraphsStream(m, &databaseOperationsServiceGetDatabaseOperationGraphsStreamServer{stream})
}
