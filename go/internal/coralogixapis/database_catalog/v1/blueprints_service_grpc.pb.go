...
type BlueprintsServiceClient interface {
	GetBlueprintsColumnsStream(ctx context.Context, in *GetBlueprintsColumnsStreamRequest, opts ...grpc.CallOption) (BlueprintsService_GetBlueprintsColumnsStreamClient, error)
	GetBlueprintStats(ctx context.Context, in *GetBlueprintStatsRequest, opts ...grpc.CallOption) (*GetBlueprintStatsResponse, error)
	GetBlueprintGraphsStream(ctx context.Context, in *GetBlueprintGraphsStreamRequest, opts ...grpc.CallOption) (BlueprintsService_GetBlueprintGraphsStreamClient, error)
}
...
func (c *blueprintsServiceClient) GetBlueprintsColumnsStream(ctx context.Context, in *GetBlueprintsColumnsStreamRequest, opts ...grpc.CallOption) (BlueprintsService_GetBlueprintsColumnsStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &BlueprintsService_ServiceDesc.Streams[0], BlueprintsService_GetBlueprintsColumnsStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &blueprintsServiceGetBlueprintsColumnsStreamClient{stream}
...
type BlueprintsService_GetBlueprintsColumnsStreamClient interface {
	Recv() (*GetBlueprintsColumnsStreamResponse, error)
	grpc.ClientStream
}

type blueprintsServiceGetBlueprintsColumnsStreamClient struct {
	grpc.ClientStream
}

func (x *blueprintsServiceGetBlueprintsColumnsStreamClient) Recv() (*GetBlueprintsColumnsStreamResponse, error) {
	m := new(GetBlueprintsColumnsStreamResponse)
...
func (c *blueprintsServiceClient) GetBlueprintStats(ctx context.Context, in *GetBlueprintStatsRequest, opts ...grpc.CallOption) (*GetBlueprintStatsResponse, error) {
	...
	err := c.cc.Invoke(ctx, BlueprintsService_GetBlueprintStats_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *blueprintsServiceClient) GetBlueprintGraphsStream(ctx context.Context, in *GetBlueprintGraphsStreamRequest, opts ...grpc.CallOption) (BlueprintsService_GetBlueprintGraphsStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &BlueprintsService_ServiceDesc.Streams[1], BlueprintsService_GetBlueprintGraphsStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &blueprintsServiceGetBlueprintGraphsStreamClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type BlueprintsService_GetBlueprintGraphsStreamClient interface {
	Recv() (*GetBlueprintGraphsStreamResponse, error)
	grpc.ClientStream
}

type blueprintsServiceGetBlueprintGraphsStreamClient struct {
	grpc.ClientStream
}

func (x *blueprintsServiceGetBlueprintGraphsStreamClient) Recv() (*GetBlueprintGraphsStreamResponse, error) {
	m := new(GetBlueprintGraphsStreamResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type BlueprintsServiceServer interface {
	GetBlueprintsColumnsStream(*GetBlueprintsColumnsStreamRequest, BlueprintsService_GetBlueprintsColumnsStreamServer) error
	GetBlueprintStats(context.Context, *GetBlueprintStatsRequest) (*GetBlueprintStatsResponse, error)
	GetBlueprintGraphsStream(*GetBlueprintGraphsStreamRequest, BlueprintsService_GetBlueprintGraphsStreamServer) error
	mustEmbedUnimplementedBlueprintsServiceServer()
}

// UnimplementedBlueprintsServiceServer must be embedded to have forward compatible implementations.
type UnimplementedBlueprintsServiceServer struct {
}

func (UnimplementedBlueprintsServiceServer) GetBlueprintsColumnsStream(*GetBlueprintsColumnsStreamRequest, BlueprintsService_GetBlueprintsColumnsStreamServer) error {
...
func (UnimplementedBlueprintsServiceServer) GetBlueprintGraphsStream(*GetBlueprintGraphsStreamRequest, BlueprintsService_GetBlueprintGraphsStreamServer) error {
...
func _BlueprintsService_GetBlueprintsColumnsStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(BlueprintsServiceServer).GetBlueprintsColumnsStream(m, &blueprintsServiceGetBlueprintsColumnsStreamServer{stream})
}

type BlueprintsService_GetBlueprintsColumnsStreamServer interface {
	Send(*GetBlueprintsColumnsStreamResponse) error
	grpc.ServerStream
}

type blueprintsServiceGetBlueprintsColumnsStreamServer struct {
	grpc.ServerStream
}

func (x *blueprintsServiceGetBlueprintsColumnsStreamServer) Send(m *GetBlueprintsColumnsStreamResponse) error {
...
func _BlueprintsService_GetBlueprintGraphsStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(BlueprintsServiceServer).GetBlueprintGraphsStream(m, &blueprintsServiceGetBlueprintGraphsStreamServer{stream})
}

type BlueprintsService_GetBlueprintGraphsStreamServer interface {
	Send(*GetBlueprintGraphsStreamResponse) error
	grpc.ServerStream
}

type blueprintsServiceGetBlueprintGraphsStreamServer struct {
	grpc.ServerStream
}

func (x *blueprintsServiceGetBlueprintGraphsStreamServer) Send(m *GetBlueprintGraphsStreamResponse) error {
	return x.ServerStream.SendMsg(m)
}
