...
func (x *BlueprintData) GetId() *wrappers.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *BlueprintData) GetBlueprint() *wrappers.StringValue {
...
func (x *BlueprintData) GetTotalClientServices() *wrappers.Int64Value {
...
func (x *BlueprintData) GetP95Latency() *wrappers.Int64Value {
...
func (x *BlueprintData) GetTotalQueries() *wrappers.Int64Value {
...
func (x *BlueprintData) GetTotalFailures() *wrappers.Int64Value {
...
func (x *BlueprintData) GetFailuresPercentage() *wrappers.FloatValue {
...
func (x *BlueprintData) GetTimeConsuming() *wrappers.Int64Value {
...
func (x *BlueprintData) GetTimeConsumingPercentage() *wrappers.Int64Value {
...
type BlueprintData_Blueprint struct {
	Blueprint *wrappers.StringValue `protobuf:"bytes,2,opt,name=blueprint,proto3,oneof"`
}

type BlueprintData_TotalClientServices struct {
	TotalClientServices *wrappers.Int64Value `protobuf:"bytes,3,opt,name=total_client_services,json=totalClientServices,proto3,oneof"`
}
...
type BlueprintData_TotalQueries struct {
	TotalQueries *wrappers.Int64Value `protobuf:"bytes,5,opt,name=total_queries,json=totalQueries,proto3,oneof"`
}

type BlueprintData_TotalFailures struct {
	TotalFailures *wrappers.Int64Value `protobuf:"bytes,6,opt,name=total_failures,json=totalFailures,proto3,oneof"`
}

type BlueprintData_FailuresPercentage struct {
	FailuresPercentage *wrappers.FloatValue `protobuf:"bytes,7,opt,name=failures_percentage,json=failuresPercentage,proto3,oneof"`
}
...
type BlueprintData_TimeConsumingPercentage struct {
	TimeConsumingPercentage *wrappers.Int64Value `protobuf:"bytes,9,opt,name=time_consuming_percentage,json=timeConsumingPercentage,proto3,oneof"`
}
