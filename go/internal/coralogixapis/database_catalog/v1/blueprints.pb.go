...
type BlueprintData struct {
	...
	// Types that are valid to be assigned to BlueprintData:
	//
...
func (x *BlueprintData) GetBlueprintData() isBlueprintData_BlueprintData {
	if x != nil {
		return x.BlueprintData
	}
	return nil
}
...
func (x *BlueprintData) GetBlueprint() *wrapperspb.StringValue {
	if x != nil {
		if x, ok := x.BlueprintData.(*BlueprintData_Blueprint); ok {
			return x.Blueprint
		}
	}
	return nil
...
func (x *BlueprintData) GetTotalClientServices() *wrapperspb.Int64Value {
	if x != nil {
		if x, ok := x.BlueprintData.(*BlueprintData_TotalClientServices); ok {
...
func (x *BlueprintData) GetP95Latency() *wrapperspb.Int64Value {
	if x != nil {
		if x, ok := x.BlueprintData.(*BlueprintData_P95Latency); ok {
			return x.P95Latency
		}
	}
	return nil
...
func (x *BlueprintData) GetTotalQueries() *wrapperspb.Int64Value {
	if x != nil {
		if x, ok := x.BlueprintData.(*BlueprintData_TotalQueries); ok {
...
func (x *BlueprintData) GetTotalFailures() *wrapperspb.Int64Value {
	if x != nil {
		if x, ok := x.BlueprintData.(*BlueprintData_TotalFailures); ok {
...
func (x *BlueprintData) GetFailuresPercentage() *wrapperspb.FloatValue {
	if x != nil {
		if x, ok := x.BlueprintData.(*BlueprintData_FailuresPercentage); ok {
...
func (x *BlueprintData) GetTimeConsuming() *wrapperspb.Int64Value {
	if x != nil {
		if x, ok := x.BlueprintData.(*BlueprintData_TimeConsuming); ok {
...
func (x *BlueprintData) GetTimeConsumingPercentage() *wrapperspb.Int64Value {
	if x != nil {
		if x, ok := x.BlueprintData.(*BlueprintData_TimeConsumingPercentage); ok {
...
var file_com_coralogixapis_database_catalog_v1_blueprints_proto_rawDesc = string([]byte{
...
var (
	...
	file_com_coralogixapis_database_catalog_v1_blueprints_proto_rawDescData []byte
)
...
func file_com_coralogixapis_database_catalog_v1_blueprints_proto_rawDescGZIP() []byte {
	file_com_coralogixapis_database_catalog_v1_blueprints_proto_rawDescOnce.Do(func() {
		file_com_coralogixapis_database_catalog_v1_blueprints_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_coralogixapis_database_catalog_v1_blueprints_proto_rawDesc), len(file_com_coralogixapis_database_catalog_v1_blueprints_proto_rawDesc)))
	})
...
func file_com_coralogixapis_database_catalog_v1_blueprints_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_coralogixapis_database_catalog_v1_blueprints_proto_rawDesc), len(file_com_coralogixapis_database_catalog_v1_blueprints_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
