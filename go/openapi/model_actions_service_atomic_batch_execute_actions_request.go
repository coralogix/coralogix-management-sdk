...
func (o *ActionsServiceAtomicBatchExecuteActionsRequest) GetRequests() []ComCoralogixapisActionsV2ActionExecutionRequest {
...
func (o *ActionsServiceAtomicBatchExecuteActionsRequest) GetRequestsOk() ([]ComCoralogixapisActionsV2ActionExecutionRequest, bool) {
	if o == nil || IsNil(o.Requests) {
		return nil, false
	}
...
func (o *ActionsServiceAtomicBatchExecuteActionsRequest) SetRequests(v []ComCoralogixapisActionsV2ActionExecutionRequest) {
	o.Requests = v
}
