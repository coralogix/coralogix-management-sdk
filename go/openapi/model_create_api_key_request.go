...
func NewCreateApiKeyRequest(hashed bool, keyPermissions ComCoralogixapisAaaApikeysV3CreateApiKeyRequestKeyPermissions, name string, owner ComCoralogixapisAaaApikeysV3Owner) *CreateApiKeyRequest {
...
func (o *CreateApiKeyRequest) GetKeyPermissions() ComCoralogixapisAaaApikeysV3CreateApiKeyRequestKeyPermissions {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *CreateApiKeyRequest) GetKeyPermissionsOk() (*ComCoralogixapisAaaApikeysV3CreateApiKeyRequestKeyPermissions, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateApiKeyRequest) SetKeyPermissions(v ComCoralogixapisAaaApikeysV3CreateApiKeyRequestKeyPermissions) {
	o.KeyPermissions = v
}
...
func (o *CreateApiKeyRequest) GetOwner() ComCoralogixapisAaaApikeysV3Owner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *CreateApiKeyRequest) GetOwnerOk() (*ComCoralogixapisAaaApikeysV3Owner, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Owner, true
...
func (o *CreateApiKeyRequest) SetOwner(v ComCoralogixapisAaaApikeysV3Owner) {
	o.Owner = v
}
