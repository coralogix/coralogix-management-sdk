...
type IntegrationRevision struct {
	CloudFormation *ComCoralogixIntegrationsV1IntegrationRevisionCloudFormationTemplate `json:"cloudFormation,omitempty"`
...
func (o *IntegrationRevision) GetCloudFormation() ComCoralogixIntegrationsV1IntegrationRevisionCloudFormationTemplate {
	if o == nil || IsNil(o.CloudFormation) {
		var ret ComCoralogixIntegrationsV1IntegrationRevisionCloudFormationTemplate
		return ret
	}
...
func (o *IntegrationRevision) GetCloudFormationOk() (*ComCoralogixIntegrationsV1IntegrationRevisionCloudFormationTemplate, bool) {
	if o == nil || IsNil(o.CloudFormation) {
		return nil, false
	}
...
// SetCloudFormation gets a reference to the given ComCoralogixIntegrationsV1IntegrationRevisionCloudFormationTemplate and assigns it to the CloudFormation field.
func (o *IntegrationRevision) SetCloudFormation(v ComCoralogixIntegrationsV1IntegrationRevisionCloudFormationTemplate) {
	o.CloudFormation = &v
}
...
func (o *IntegrationRevision) GetFields() []ComCoralogixIntegrationsV1IntegrationRevisionFieldInformation {
...
// and a boolean to check if the value has been set.
func (o *IntegrationRevision) GetFieldsOk() ([]ComCoralogixIntegrationsV1IntegrationRevisionFieldInformation, bool) {
	if o == nil || IsNil(o.Fields) {
		return nil, false
	}
...
func (o *IntegrationRevision) SetFields(v []ComCoralogixIntegrationsV1IntegrationRevisionFieldInformation) {
	o.Fields = v
}

// GetGroups returns the Groups field value if set, zero value otherwise.
func (o *IntegrationRevision) GetGroups() []ComCoralogixIntegrationsV1IntegrationRevisionGroup {
...
// and a boolean to check if the value has been set.
func (o *IntegrationRevision) GetGroupsOk() ([]ComCoralogixIntegrationsV1IntegrationRevisionGroup, bool) {
	if o == nil || IsNil(o.Groups) {
		return nil, false
	}
...
func (o *IntegrationRevision) SetGroups(v []ComCoralogixIntegrationsV1IntegrationRevisionGroup) {
	o.Groups = v
}
