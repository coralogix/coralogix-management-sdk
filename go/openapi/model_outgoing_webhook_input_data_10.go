...
func NewOutgoingWebhookInputData10(name string, type_ string) *OutgoingWebhookInputData10 {
...
func (o *OutgoingWebhookInputData10) GetIbmEventNotifications() ComCoralogixOutgoingWebhooksV1IbmEventNotificationsConfig {
...
func (o *OutgoingWebhookInputData10) GetIbmEventNotificationsOk() (*ComCoralogixOutgoingWebhooksV1IbmEventNotificationsConfig, bool) {
	if o == nil || IsNil(o.IbmEventNotifications) {
		return nil, false
	}
...
func (o *OutgoingWebhookInputData10) SetIbmEventNotifications(v ComCoralogixOutgoingWebhooksV1IbmEventNotificationsConfig) {
...
func (o *OutgoingWebhookInputData10) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OutgoingWebhookInputData10) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *OutgoingWebhookInputData10) SetType(v string) {
	o.Type = v
}
