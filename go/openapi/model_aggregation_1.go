...
type Aggregation1 struct {
	...
	Histogram *ComCoralogixapisEvents2metricsV2E2MAggHistogram `json:"histogram,omitempty"`
...
func (o *Aggregation1) GetAggType() string {
...
func (o *Aggregation1) GetAggTypeOk() (*string, bool) {
	if o == nil || IsNil(o.AggType) {
		return nil, false
	}
...
func (o *Aggregation1) SetAggType(v string) {
	o.AggType = &v
}
...
func (o *Aggregation1) GetHistogram() ComCoralogixapisEvents2metricsV2E2MAggHistogram {
	if o == nil || IsNil(o.Histogram) {
		var ret ComCoralogixapisEvents2metricsV2E2MAggHistogram
		return ret
	}
	return *o.Histogram
}
...
// and a boolean to check if the value has been set.
func (o *Aggregation1) GetHistogramOk() (*ComCoralogixapisEvents2metricsV2E2MAggHistogram, bool) {
	if o == nil || IsNil(o.Histogram) {
		return nil, false
	}
...
// SetHistogram gets a reference to the given ComCoralogixapisEvents2metricsV2E2MAggHistogram and assigns it to the Histogram field.
func (o *Aggregation1) SetHistogram(v ComCoralogixapisEvents2metricsV2E2MAggHistogram) {
	o.Histogram = &v
}
