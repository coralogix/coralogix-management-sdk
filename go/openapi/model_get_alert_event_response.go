...
type GetAlertEventResponse struct {
	...
	SinglePermutation *ComCoralogixapisAlertsV3AlertEvent `json:"singlePermutation,omitempty"`
}
...
func (o *GetAlertEventResponse) GetPagination() ComCoralogixapisAlertsV3PaginationResponse {
...
// and a boolean to check if the value has been set.
func (o *GetAlertEventResponse) GetPaginationOk() (*ComCoralogixapisAlertsV3PaginationResponse, bool) {
	if o == nil || IsNil(o.Pagination) {
		return nil, false
	}
...
func (o *GetAlertEventResponse) SetPagination(v ComCoralogixapisAlertsV3PaginationResponse) {
	o.Pagination = &v
}

// GetSinglePermutation returns the SinglePermutation field value if set, zero value otherwise.
func (o *GetAlertEventResponse) GetSinglePermutation() ComCoralogixapisAlertsV3AlertEvent {
...
// and a boolean to check if the value has been set.
func (o *GetAlertEventResponse) GetSinglePermutationOk() (*ComCoralogixapisAlertsV3AlertEvent, bool) {
	if o == nil || IsNil(o.SinglePermutation) {
		return nil, false
	}
...
// SetSinglePermutation gets a reference to the given ComCoralogixapisAlertsV3AlertEvent and assigns it to the SinglePermutation field.
func (o *GetAlertEventResponse) SetSinglePermutation(v ComCoralogixapisAlertsV3AlertEvent) {
