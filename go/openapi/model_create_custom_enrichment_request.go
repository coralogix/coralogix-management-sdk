...
func NewCreateCustomEnrichmentRequest(description string, file ComCoralogixEnrichmentV1File, name string) *CreateCustomEnrichmentRequest {
...
func (o *CreateCustomEnrichmentRequest) GetFile() ComCoralogixEnrichmentV1File {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *CreateCustomEnrichmentRequest) GetFileOk() (*ComCoralogixEnrichmentV1File, bool) {
	if o == nil {
		return nil, false
	}
	return &o.File, true
...
func (o *CreateCustomEnrichmentRequest) SetFile(v ComCoralogixEnrichmentV1File) {
	o.File = v
}
