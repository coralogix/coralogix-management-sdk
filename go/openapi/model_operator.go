...
type Operator struct {
	Equals *ComCoralogixapisDashboardsV1AstFiltersFilterEquals `json:"equals,omitempty"`
}
...
func (o *Operator) GetEquals() ComCoralogixapisDashboardsV1AstFiltersFilterEquals {
	if o == nil || IsNil(o.Equals) {
		var ret ComCoralogixapisDashboardsV1AstFiltersFilterEquals
		return ret
	}
	return *o.Equals
}
...
func (o *Operator) GetEqualsOk() (*ComCoralogixapisDashboardsV1AstFiltersFilterEquals, bool) {
	if o == nil || IsNil(o.Equals) {
		return nil, false
	}
...
// SetEquals gets a reference to the given ComCoralogixapisDashboardsV1AstFiltersFilterEquals and assigns it to the Equals field.
func (o *Operator) SetEquals(v ComCoralogixapisDashboardsV1AstFiltersFilterEquals) {
	o.Equals = &v
}
