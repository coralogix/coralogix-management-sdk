...
func TestAlertScheduler(t *testing.T) {
	...
	createdAlert, _, err := alertsClient.
		AlertDefsServiceCreateAlertDef(ctx).
	...
	schedule := scheduler.ScheduleOneOfAsSchedule(&scheduler.ScheduleOneOf{
		...
		OneTime: &scheduler.OneTime{
			Timeframe: &scheduler.Timeframe{
				AlertSchedulerRuleServiceGetBulkAlertSchedulerRuleActiveTimeframeParameter: &scheduler.AlertSchedulerRuleServiceGetBulkAlertSchedulerRuleActiveTimeframeParameter{
	...
	createResp, _, err := schedulerClient.
	...
	updateResp, _, err := schedulerClient.
