...
func NewConnector(name string, type_ string) *Connector {
	this := Connector{}
	this.Name = name
	this.Type = type_
	return &this
...
func (o *Connector) GetConfigOverrides() []ComCoralogixapisNotificationCenterConnectorsV1EntityTypeConfigOverrides {
...
func (o *Connector) GetConfigOverridesOk() ([]ComCoralogixapisNotificationCenterConnectorsV1EntityTypeConfigOverrides, bool) {
	if o == nil || IsNil(o.ConfigOverrides) {
		return nil, false
	}
...
func (o *Connector) SetConfigOverrides(v []ComCoralogixapisNotificationCenterConnectorsV1EntityTypeConfigOverrides) {
	o.ConfigOverrides = v
}

// GetConnectorConfig returns the ConnectorConfig field value if set, zero value otherwise.
func (o *Connector) GetConnectorConfig() ComCoralogixapisNotificationCenterConnectorsV1ConnectorConfig {
...
// and a boolean to check if the value has been set.
func (o *Connector) GetConnectorConfigOk() (*ComCoralogixapisNotificationCenterConnectorsV1ConnectorConfig, bool) {
	if o == nil || IsNil(o.ConnectorConfig) {
		return nil, false
	}
...
func (o *Connector) SetConnectorConfig(v ComCoralogixapisNotificationCenterConnectorsV1ConnectorConfig) {
	o.ConnectorConfig = &v
}
