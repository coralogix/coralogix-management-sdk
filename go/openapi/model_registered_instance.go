...
func (o *RegisteredInstance) GetIntegrationStatus() ComCoralogixIntegrationsV1IntegrationStatus {
...
// and a boolean to check if the value has been set.
func (o *RegisteredInstance) GetIntegrationStatusOk() (*ComCoralogixIntegrationsV1IntegrationStatus, bool) {
	if o == nil || IsNil(o.IntegrationStatus) {
		return nil, false
	}
...
func (o *RegisteredInstance) SetIntegrationStatus(v ComCoralogixIntegrationsV1IntegrationStatus) {
...
func (o *RegisteredInstance) GetParameters() []ComCoralogixIntegrationsV1Parameter {
...
// and a boolean to check if the value has been set.
func (o *RegisteredInstance) GetParametersOk() ([]ComCoralogixIntegrationsV1Parameter, bool) {
	if o == nil || IsNil(o.Parameters) {
		return nil, false
	}
...
func (o *RegisteredInstance) SetParameters(v []ComCoralogixIntegrationsV1Parameter) {
	o.Parameters = v
}
