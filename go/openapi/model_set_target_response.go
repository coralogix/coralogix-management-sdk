...
func (o *SetTargetResponse) GetS3() ComCoralogixArchiveV2S3TargetSpec {
	if o == nil || IsNil(o.S3) {
...
// and a boolean to check if the value has been set.
func (o *SetTargetResponse) GetS3Ok() (*ComCoralogixArchiveV2S3TargetSpec, bool) {
	if o == nil || IsNil(o.S3) {
		return nil, false
	}
	return o.S3, true
...
func (o *SetTargetResponse) SetS3(v ComCoralogixArchiveV2S3TargetSpec) {
	o.S3 = &v
}
