...
func (o *UpdateApiKeyRequest) GetPermissions() ComCoralogixapisAaaApikeysV3UpdateApiKeyRequestPermissions {
...
// and a boolean to check if the value has been set.
func (o *UpdateApiKeyRequest) GetPermissionsOk() (*ComCoralogixapisAaaApikeysV3UpdateApiKeyRequestPermissions, bool) {
	if o == nil || IsNil(o.Permissions) {
		return nil, false
	}
...
func (o *UpdateApiKeyRequest) SetPermissions(v ComCoralogixapisAaaApikeysV3UpdateApiKeyRequestPermissions) {
	o.Permissions = &v
}

// GetPresets returns the Presets field value if set, zero value otherwise.
func (o *UpdateApiKeyRequest) GetPresets() ComCoralogixapisAaaApikeysV3UpdateApiKeyRequestPresets {
...
// and a boolean to check if the value has been set.
func (o *UpdateApiKeyRequest) GetPresetsOk() (*ComCoralogixapisAaaApikeysV3UpdateApiKeyRequestPresets, bool) {
	if o == nil || IsNil(o.Presets) {
		return nil, false
	}
...
func (o *UpdateApiKeyRequest) SetPresets(v ComCoralogixapisAaaApikeysV3UpdateApiKeyRequestPresets) {
	o.Presets = &v
}
