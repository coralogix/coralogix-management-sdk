...
func NewTestIntegrationRequest(integrationData ComCoralogixIntegrationsV1IntegrationMetadata) *TestIntegrationRequest {
...
func (o *TestIntegrationRequest) GetIntegrationData() ComCoralogixIntegrationsV1IntegrationMetadata {
	if o == nil {
...
func (o *TestIntegrationRequest) GetIntegrationDataOk() (*ComCoralogixIntegrationsV1IntegrationMetadata, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TestIntegrationRequest) SetIntegrationData(v ComCoralogixIntegrationsV1IntegrationMetadata) {
	o.IntegrationData = v
}
