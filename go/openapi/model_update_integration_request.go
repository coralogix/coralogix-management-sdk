...
func NewUpdateIntegrationRequest(id string, metadata ComCoralogixIntegrationsV1IntegrationMetadata) *UpdateIntegrationRequest {
...
func (o *UpdateIntegrationRequest) GetMetadata() ComCoralogixIntegrationsV1IntegrationMetadata {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *UpdateIntegrationRequest) GetMetadataOk() (*ComCoralogixIntegrationsV1IntegrationMetadata, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *UpdateIntegrationRequest) SetMetadata(v ComCoralogixIntegrationsV1IntegrationMetadata) {
	o.Metadata = v
}
