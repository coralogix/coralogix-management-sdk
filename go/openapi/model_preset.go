...
func NewPreset(configOverrides []ComCoralogixapisNotificationCenterConfigOverrides, entityType string, name string) *Preset {
	this := Preset{}
...
func (o *Preset) GetConfigOverrides() []ComCoralogixapisNotificationCenterConfigOverrides {
	if o == nil {
...
func (o *Preset) GetConfigOverridesOk() ([]ComCoralogixapisNotificationCenterConfigOverrides, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Preset) SetConfigOverrides(v []ComCoralogixapisNotificationCenterConfigOverrides) {
	o.ConfigOverrides = v
}

// GetConnectorType returns the ConnectorType field value if set, zero value otherwise.
func (o *Preset) GetConnectorType() string {
...
// and a boolean to check if the value has been set.
func (o *Preset) GetConnectorTypeOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectorType) {
		return nil, false
	}
...
func (o *Preset) SetConnectorType(v string) {
	o.ConnectorType = &v
}
...
func (o *Preset) GetEntityType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Preset) GetEntityTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Preset) SetEntityType(v string) {
	o.EntityType = v
}
...
func (o *Preset) GetPresetType() string {
...
// and a boolean to check if the value has been set.
func (o *Preset) GetPresetTypeOk() (*string, bool) {
	if o == nil || IsNil(o.PresetType) {
		return nil, false
	}
...
func (o *Preset) SetPresetType(v string) {
	o.PresetType = &v
}
