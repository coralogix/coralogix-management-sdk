...
type Aggregation struct {
	...
	Samples *ComCoralogixapisEvents2metricsV2E2MAggSamples `json:"samples,omitempty"`
...
func (o *Aggregation) GetAggType() string {
...
func (o *Aggregation) GetAggTypeOk() (*string, bool) {
	if o == nil || IsNil(o.AggType) {
		return nil, false
	}
...
func (o *Aggregation) SetAggType(v string) {
	o.AggType = &v
}
...
func (o *Aggregation) GetSamples() ComCoralogixapisEvents2metricsV2E2MAggSamples {
	if o == nil || IsNil(o.Samples) {
		var ret ComCoralogixapisEvents2metricsV2E2MAggSamples
		return ret
	}
	return *o.Samples
}
...
// and a boolean to check if the value has been set.
func (o *Aggregation) GetSamplesOk() (*ComCoralogixapisEvents2metricsV2E2MAggSamples, bool) {
	if o == nil || IsNil(o.Samples) {
		return nil, false
	}
...
// SetSamples gets a reference to the given ComCoralogixapisEvents2metricsV2E2MAggSamples and assigns it to the Samples field.
func (o *Aggregation) SetSamples(v ComCoralogixapisEvents2metricsV2E2MAggSamples) {
	o.Samples = &v
}
