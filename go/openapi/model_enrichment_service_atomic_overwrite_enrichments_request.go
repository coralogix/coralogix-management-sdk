...
func (o *EnrichmentServiceAtomicOverwriteEnrichmentsRequest) GetEnrichmentFields() []ComCoralogixEnrichmentV1EnrichmentFieldDefinition {
...
func (o *EnrichmentServiceAtomicOverwriteEnrichmentsRequest) GetEnrichmentFieldsOk() ([]ComCoralogixEnrichmentV1EnrichmentFieldDefinition, bool) {
	if o == nil || IsNil(o.EnrichmentFields) {
		return nil, false
	}
...
func (o *EnrichmentServiceAtomicOverwriteEnrichmentsRequest) SetEnrichmentFields(v []ComCoralogixEnrichmentV1EnrichmentFieldDefinition) {
	o.EnrichmentFields = v
}

// GetEnrichmentType returns the EnrichmentType field value if set, zero value otherwise.
func (o *EnrichmentServiceAtomicOverwriteEnrichmentsRequest) GetEnrichmentType() ComCoralogixEnrichmentV1EnrichmentType {
...
// and a boolean to check if the value has been set.
func (o *EnrichmentServiceAtomicOverwriteEnrichmentsRequest) GetEnrichmentTypeOk() (*ComCoralogixEnrichmentV1EnrichmentType, bool) {
	if o == nil || IsNil(o.EnrichmentType) {
		return nil, false
	}
...
func (o *EnrichmentServiceAtomicOverwriteEnrichmentsRequest) SetEnrichmentType(v ComCoralogixEnrichmentV1EnrichmentType) {
	o.EnrichmentType = &v
}

// GetRequestEnrichments returns the RequestEnrichments field value if set, zero value otherwise.
func (o *EnrichmentServiceAtomicOverwriteEnrichmentsRequest) GetRequestEnrichments() []ComCoralogixEnrichmentV1EnrichmentRequestModel {
...
// and a boolean to check if the value has been set.
func (o *EnrichmentServiceAtomicOverwriteEnrichmentsRequest) GetRequestEnrichmentsOk() ([]ComCoralogixEnrichmentV1EnrichmentRequestModel, bool) {
	if o == nil || IsNil(o.RequestEnrichments) {
		return nil, false
	}
...
func (o *EnrichmentServiceAtomicOverwriteEnrichmentsRequest) SetRequestEnrichments(v []ComCoralogixEnrichmentV1EnrichmentRequestModel) {
