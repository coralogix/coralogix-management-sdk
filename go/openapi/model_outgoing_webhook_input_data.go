...
func NewOutgoingWebhookInputData(name string, type_ string) *OutgoingWebhookInputData {
...
func (o *OutgoingWebhookInputData) GetGenericWebhook() ComCoralogixOutgoingWebhooksV1GenericWebhookConfig {
...
func (o *OutgoingWebhookInputData) GetGenericWebhookOk() (*ComCoralogixOutgoingWebhooksV1GenericWebhookConfig, bool) {
	if o == nil || IsNil(o.GenericWebhook) {
		return nil, false
	}
...
func (o *OutgoingWebhookInputData) SetGenericWebhook(v ComCoralogixOutgoingWebhooksV1GenericWebhookConfig) {
	o.GenericWebhook = &v
}
...
func (o *OutgoingWebhookInputData) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OutgoingWebhookInputData) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *OutgoingWebhookInputData) SetType(v string) {
	o.Type = v
}
