...
func NewDashboard10(layout ComCoralogixapisDashboardsV1AstLayout, name string) *Dashboard10 {
	this := Dashboard10{}
	this.Layout = layout
	this.Name = name
	return &this
...
func (o *Dashboard10) GetActions() []ComCoralogixapisDashboardsV1CommonDashboardAction {
...
func (o *Dashboard10) GetActionsOk() ([]ComCoralogixapisDashboardsV1CommonDashboardAction, bool) {
	if o == nil || IsNil(o.Actions) {
		return nil, false
	}
...
func (o *Dashboard10) SetActions(v []ComCoralogixapisDashboardsV1CommonDashboardAction) {
	o.Actions = v
}

// GetAnnotations returns the Annotations field value if set, zero value otherwise.
func (o *Dashboard10) GetAnnotations() []ComCoralogixapisDashboardsV1AstAnnotationsAnnotation {
...
// and a boolean to check if the value has been set.
func (o *Dashboard10) GetAnnotationsOk() ([]ComCoralogixapisDashboardsV1AstAnnotationsAnnotation, bool) {
	if o == nil || IsNil(o.Annotations) {
		return nil, false
	}
...
func (o *Dashboard10) SetAnnotations(v []ComCoralogixapisDashboardsV1AstAnnotationsAnnotation) {
	o.Annotations = v
}
...
func (o *Dashboard10) GetFilters() []ComCoralogixapisDashboardsV1AstFiltersFilter {
...
// and a boolean to check if the value has been set.
func (o *Dashboard10) GetFiltersOk() ([]ComCoralogixapisDashboardsV1AstFiltersFilter, bool) {
	if o == nil || IsNil(o.Filters) {
		return nil, false
	}
...
func (o *Dashboard10) SetFilters(v []ComCoralogixapisDashboardsV1AstFiltersFilter) {
	o.Filters = v
}

// GetFolderPath returns the FolderPath field value if set, zero value otherwise.
func (o *Dashboard10) GetFolderPath() ComCoralogixapisDashboardsV1AstFolderPath {
...
// and a boolean to check if the value has been set.
func (o *Dashboard10) GetFolderPathOk() (*ComCoralogixapisDashboardsV1AstFolderPath, bool) {
	if o == nil || IsNil(o.FolderPath) {
		return nil, false
	}
...
func (o *Dashboard10) SetFolderPath(v ComCoralogixapisDashboardsV1AstFolderPath) {
	o.FolderPath = &v
}
...
func (o *Dashboard10) GetLayout() ComCoralogixapisDashboardsV1AstLayout {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *Dashboard10) GetLayoutOk() (*ComCoralogixapisDashboardsV1AstLayout, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Dashboard10) SetLayout(v ComCoralogixapisDashboardsV1AstLayout) {
	o.Layout = v
}
...
func (o *Dashboard10) GetTwoMinutes() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *Dashboard10) GetTwoMinutesOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.TwoMinutes) {
...
func (o *Dashboard10) HasTwoMinutes() bool {
	if o != nil && !IsNil(o.TwoMinutes) {
		return true
	}
...
func (o *Dashboard10) SetTwoMinutes(v map[string]interface{}) {
	o.TwoMinutes = v
}

// GetVariables returns the Variables field value if set, zero value otherwise.
func (o *Dashboard10) GetVariables() []ComCoralogixapisDashboardsV1AstVariablesVariable {
...
// and a boolean to check if the value has been set.
func (o *Dashboard10) GetVariablesOk() ([]ComCoralogixapisDashboardsV1AstVariablesVariable, bool) {
	if o == nil || IsNil(o.Variables) {
		return nil, false
	}
...
func (o *Dashboard10) SetVariables(v []ComCoralogixapisDashboardsV1AstVariablesVariable) {
	o.Variables = v
}

// GetVariablesV2 returns the VariablesV2 field value if set, zero value otherwise.
func (o *Dashboard10) GetVariablesV2() []ComCoralogixapisDashboardsV1AstVariablesV2VariableV2 {
...
// and a boolean to check if the value has been set.
func (o *Dashboard10) GetVariablesV2Ok() ([]ComCoralogixapisDashboardsV1AstVariablesV2VariableV2, bool) {
	if o == nil || IsNil(o.VariablesV2) {
		return nil, false
	}
...
func (o *Dashboard10) SetVariablesV2(v []ComCoralogixapisDashboardsV1AstVariablesV2VariableV2) {
	o.VariablesV2 = v
}
