...
type IntegrationType struct {
	Managed *ComCoralogixIntegrationsV1IntegrationTypeManaged `json:"managed,omitempty"`
}
...
func (o *IntegrationType) GetManaged() ComCoralogixIntegrationsV1IntegrationTypeManaged {
	if o == nil || IsNil(o.Managed) {
		var ret ComCoralogixIntegrationsV1IntegrationTypeManaged
		return ret
	}
	return *o.Managed
}
...
func (o *IntegrationType) GetManagedOk() (*ComCoralogixIntegrationsV1IntegrationTypeManaged, bool) {
	if o == nil || IsNil(o.Managed) {
		return nil, false
	}
...
// SetManaged gets a reference to the given ComCoralogixIntegrationsV1IntegrationTypeManaged and assigns it to the Managed field.
func (o *IntegrationType) SetManaged(v ComCoralogixIntegrationsV1IntegrationTypeManaged) {
	o.Managed = &v
}
