...
func (o *SetTeamGroupScopeRequest) GetScopeFilters() ComCoralogixPermissionsV1ScopeFilters {
...
func (o *SetTeamGroupScopeRequest) GetScopeFiltersOk() (*ComCoralogixPermissionsV1ScopeFilters, bool) {
	if o == nil || IsNil(o.ScopeFilters) {
		return nil, false
	}
...
func (o *SetTeamGroupScopeRequest) SetScopeFilters(v ComCoralogixPermissionsV1ScopeFilters) {
	o.ScopeFilters = &v
}
