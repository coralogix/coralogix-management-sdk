...
func NewTestExtensionRevisionRequest(extensionData ComCoralogixExtensionsV1ExtensionData) *TestExtensionRevisionRequest {
...
func (o *TestExtensionRevisionRequest) GetExtensionData() ComCoralogixExtensionsV1ExtensionData {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *TestExtensionRevisionRequest) GetExtensionDataOk() (*ComCoralogixExtensionsV1ExtensionData, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TestExtensionRevisionRequest) SetExtensionData(v ComCoralogixExtensionsV1ExtensionData) {
	o.ExtensionData = v
}
