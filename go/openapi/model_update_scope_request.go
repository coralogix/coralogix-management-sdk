...
func NewUpdateScopeRequest(defaultExpression string, displayName string, filters []ComCoralogixapisScopesV1Filter, id string) *UpdateScopeRequest {
...
func (o *UpdateScopeRequest) GetFilters() []ComCoralogixapisScopesV1Filter {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *UpdateScopeRequest) GetFiltersOk() ([]ComCoralogixapisScopesV1Filter, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *UpdateScopeRequest) SetFilters(v []ComCoralogixapisScopesV1Filter) {
	o.Filters = v
}
