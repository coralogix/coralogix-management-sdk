...
type FieldInformation struct {
	...
	Single *ComCoralogixIntegrationsV1IntegrationRevisionSingleValue `json:"single,omitempty"`
...
func NewFieldInformation(type_ string) *FieldInformation {
...
func (o *FieldInformation) GetApplicableIf() ComCoralogixIntegrationsV1IntegrationRevisionFieldCondition {
...
// and a boolean to check if the value has been set.
func (o *FieldInformation) GetApplicableIfOk() (*ComCoralogixIntegrationsV1IntegrationRevisionFieldCondition, bool) {
	if o == nil || IsNil(o.ApplicableIf) {
		return nil, false
	}
...
func (o *FieldInformation) SetApplicableIf(v ComCoralogixIntegrationsV1IntegrationRevisionFieldCondition) {
	o.ApplicableIf = &v
}
...
func (o *FieldInformation) GetSingle() ComCoralogixIntegrationsV1IntegrationRevisionSingleValue {
	if o == nil || IsNil(o.Single) {
		var ret ComCoralogixIntegrationsV1IntegrationRevisionSingleValue
		return ret
	}
	return *o.Single
}
...
// and a boolean to check if the value has been set.
func (o *FieldInformation) GetSingleOk() (*ComCoralogixIntegrationsV1IntegrationRevisionSingleValue, bool) {
	if o == nil || IsNil(o.Single) {
		return nil, false
	}
...
// SetSingle gets a reference to the given ComCoralogixIntegrationsV1IntegrationRevisionSingleValue and assigns it to the Single field.
func (o *FieldInformation) SetSingle(v ComCoralogixIntegrationsV1IntegrationRevisionSingleValue) {
	o.Single = &v
}
...
func (o *FieldInformation) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FieldInformation) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *FieldInformation) SetType(v string) {
	o.Type = v
}
