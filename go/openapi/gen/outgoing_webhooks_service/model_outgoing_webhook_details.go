...
func NewOutgoingWebhookDetails(label string, type_ string) *OutgoingWebhookDetails {
...
func (o *OutgoingWebhookDetails) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OutgoingWebhookDetails) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *OutgoingWebhookDetails) SetType(v string) {
	o.Type = v
}
