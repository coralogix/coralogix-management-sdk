...
func NewOutgoingWebhookType(count int64, label string, type_ string) *OutgoingWebhookType {
...
func (o *OutgoingWebhookType) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OutgoingWebhookType) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *OutgoingWebhookType) SetType(v string) {
	o.Type = v
}
