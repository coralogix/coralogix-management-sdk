...
func (r ApiExtensionServiceGetExtensionRequest) Execute() (*ExtensionMetadata, *http.Response, error) {
...
func (a *ExtensionServiceAPIService) ExtensionServiceGetExtensionExecute(r ApiExtensionServiceGetExtensionRequest) (*ExtensionMetadata, *http.Response, error) {
	var (
