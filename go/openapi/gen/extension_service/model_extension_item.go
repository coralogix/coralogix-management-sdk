...
func NewExtensionItem(data map[string]interface{}, id string, name string, permissionResource string, targetDomain string) *ExtensionItem {
	this := ExtensionItem{}
	this.Data = data
	this.Id = id
	this.Name = name
...
func (o *ExtensionItem) GetPermissionResource() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ExtensionItem) GetPermissionResourceOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ExtensionItem) SetPermissionResource(v string) {
...
func (o *ExtensionItem) GetTargetDomain() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ExtensionItem) GetTargetDomainOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ExtensionItem) SetTargetDomain(v string) {
	o.TargetDomain = v
}
