...
type GetConfigurationResponse struct {
	...
	IdpParameters GetConfigurationResponseIdpParameters `json:"idpParameters"`
	SpParameters ServiceProviderParameters `json:"spParameters"`
...
func NewGetConfigurationResponse(idpParameters GetConfigurationResponseIdpParameters, spParameters ServiceProviderParameters, teamId int64) *GetConfigurationResponse {
...
func (o *GetConfigurationResponse) GetIdpDetails() GetConfigurationResponseIdpDetails {
	if o == nil || IsNil(o.IdpDetails) {
		var ret GetConfigurationResponseIdpDetails
		return ret
	}
	return *o.IdpDetails
}
...
func (o *GetConfigurationResponse) GetIdpDetailsOk() (*GetConfigurationResponseIdpDetails, bool) {
	if o == nil || IsNil(o.IdpDetails) {
		return nil, false
	}
...
// SetIdpDetails gets a reference to the given GetConfigurationResponseIdpDetails and assigns it to the IdpDetails field.
func (o *GetConfigurationResponse) SetIdpDetails(v GetConfigurationResponseIdpDetails) {
	o.IdpDetails = &v
}

// GetIdpParameters returns the IdpParameters field value
func (o *GetConfigurationResponse) GetIdpParameters() GetConfigurationResponseIdpParameters {
	if o == nil {
		var ret GetConfigurationResponseIdpParameters
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetConfigurationResponse) GetIdpParametersOk() (*GetConfigurationResponseIdpParameters, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetConfigurationResponse) SetIdpParameters(v GetConfigurationResponseIdpParameters) {
	o.IdpParameters = v
}

// GetSpParameters returns the SpParameters field value
func (o *GetConfigurationResponse) GetSpParameters() ServiceProviderParameters {
	if o == nil {
		var ret ServiceProviderParameters
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetConfigurationResponse) GetSpParametersOk() (*ServiceProviderParameters, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetConfigurationResponse) SetSpParameters(v ServiceProviderParameters) {
	o.SpParameters = v
}
