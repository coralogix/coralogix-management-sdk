...
type SetIDPParametersRequest struct {
	Params GetConfigurationResponseIdpParameters `json:"params"`
...
func NewSetIDPParametersRequest(params GetConfigurationResponseIdpParameters, teamId int64) *SetIDPParametersRequest {
...
func (o *SetIDPParametersRequest) GetParams() GetConfigurationResponseIdpParameters {
	if o == nil {
...
func (o *SetIDPParametersRequest) GetParamsOk() (*GetConfigurationResponseIdpParameters, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SetIDPParametersRequest) SetParams(v GetConfigurationResponseIdpParameters) {
	o.Params = v
}
