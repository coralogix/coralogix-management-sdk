...
type GetSPParametersResponse struct {
	Params ServiceProviderParameters `json:"params"`
}
...
func NewGetSPParametersResponse(params ServiceProviderParameters) *GetSPParametersResponse {
...
func (o *GetSPParametersResponse) GetParams() ServiceProviderParameters {
	if o == nil {
...
func (o *GetSPParametersResponse) GetParamsOk() (*ServiceProviderParameters, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetSPParametersResponse) SetParams(v ServiceProviderParameters) {
	o.Params = v
}
