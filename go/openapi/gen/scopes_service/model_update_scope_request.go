...
func NewUpdateScopeRequest(defaultExpression string, displayName string, filters []Filter, id string) *UpdateScopeRequest {
...
func (o *UpdateScopeRequest) GetFilters() []Filter {
	if o == nil {
		var ret []Filter
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *UpdateScopeRequest) GetFiltersOk() ([]Filter, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *UpdateScopeRequest) SetFilters(v []Filter) {
	o.Filters = v
}
