...
func NewCreateScopeResponse(scope Scope) *CreateScopeResponse {
...
func (o *CreateScopeResponse) GetScope() Scope {
	if o == nil {
		var ret Scope
		return ret
	}
...
func (o *CreateScopeResponse) GetScopeOk() (*Scope, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Scope, true
...
func (o *CreateScopeResponse) SetScope(v Scope) {
	o.Scope = v
}
