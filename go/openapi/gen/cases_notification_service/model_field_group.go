...
func (o *FieldGroup) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *FieldGroup) GetValue() string {
...
// and a boolean to check if the value has been set.
func (o *FieldGroup) GetValueOk() (*string, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
func (o *FieldGroup) HasValue() bool {
	if o != nil && !IsNil(o.Value) {
		return true
	}
...
func (o *FieldGroup) SetValue(v string) {
	o.Value = &v
}
