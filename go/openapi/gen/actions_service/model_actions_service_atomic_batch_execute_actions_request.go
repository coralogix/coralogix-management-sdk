...
type ActionsServiceAtomicBatchExecuteActionsRequest struct {
	Requests []ActionsServiceAtomicBatchExecuteActionsRequestRequestsInner `json:"requests,omitempty"`
}
...
func (o *ActionsServiceAtomicBatchExecuteActionsRequest) GetRequests() []ActionsServiceAtomicBatchExecuteActionsRequestRequestsInner {
	if o == nil || IsNil(o.Requests) {
		var ret []ActionsServiceAtomicBatchExecuteActionsRequestRequestsInner
		return ret
	}
	return o.Requests
}
...
func (o *ActionsServiceAtomicBatchExecuteActionsRequest) GetRequestsOk() ([]ActionsServiceAtomicBatchExecuteActionsRequestRequestsInner, bool) {
	if o == nil || IsNil(o.Requests) {
		return nil, false
	}
...
// SetRequests gets a reference to the given []ActionsServiceAtomicBatchExecuteActionsRequestRequestsInner and assigns it to the Requests field.
func (o *ActionsServiceAtomicBatchExecuteActionsRequest) SetRequests(v []ActionsServiceAtomicBatchExecuteActionsRequestRequestsInner) {
	o.Requests = v
}
