...
type _CreateTeamGroupResponse CreateTeamGroupResponse
...
func (o *CreateTeamGroupResponse) UnmarshalJSON(data []byte) (err error) {
	varCreateTeamGroupResponse := _CreateTeamGroupResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varCreateTeamGroupResponse)

	if err != nil {
		return err
	}

	*o = CreateTeamGroupResponse(varCreateTeamGroupResponse)
