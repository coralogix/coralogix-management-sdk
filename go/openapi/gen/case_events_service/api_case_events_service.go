...
func (a *CaseEventsServiceAPIService) CaseEventsServiceDeleteCommentExecute(r ApiCaseEventsServiceDeleteCommentRequest) (map[string]interface{}, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if strlen(r.eventId) < 36 {
		return localVarReturnValue, nil, reportError("eventId must have at least 36 elements")
	}
	if strlen(r.eventId) > 36 {
		return localVarReturnValue, nil, reportError("eventId must have less than 36 elements")
	}
