...
type Aggregation1 struct {
	...
	Histogram *E2MAggregateHistogram `json:"histogram,omitempty"`
...
func (o *Aggregation1) GetHistogram() E2MAggregateHistogram {
	if o == nil || IsNil(o.Histogram) {
		var ret E2MAggregateHistogram
		return ret
	}
	return *o.Histogram
}
...
// and a boolean to check if the value has been set.
func (o *Aggregation1) GetHistogramOk() (*E2MAggregateHistogram, bool) {
	if o == nil || IsNil(o.Histogram) {
		return nil, false
	}
...
// SetHistogram gets a reference to the given E2MAggregateHistogram and assigns it to the Histogram field.
func (o *Aggregation1) SetHistogram(v E2MAggregateHistogram) {
	o.Histogram = &v
}
