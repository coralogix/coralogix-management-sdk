...
type Aggregation struct {
	...
	Samples *E2MAggregateSamples `json:"samples,omitempty"`
...
func (o *Aggregation) GetSamples() E2MAggregateSamples {
	if o == nil || IsNil(o.Samples) {
		var ret E2MAggregateSamples
		return ret
	}
	return *o.Samples
}
...
// and a boolean to check if the value has been set.
func (o *Aggregation) GetSamplesOk() (*E2MAggregateSamples, bool) {
	if o == nil || IsNil(o.Samples) {
		return nil, false
	}
...
// SetSamples gets a reference to the given E2MAggregateSamples and assigns it to the Samples field.
func (o *Aggregation) SetSamples(v E2MAggregateSamples) {
	o.Samples = &v
}
