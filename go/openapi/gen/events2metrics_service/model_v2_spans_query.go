...
// checks if the V2SpansQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2SpansQuery{}
...
// NewV2SpansQuery instantiates a new V2SpansQuery object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewV2SpansQuery() *V2SpansQuery {
	this := V2SpansQuery{}
	return &this
}

// NewV2SpansQueryWithDefaults instantiates a new V2SpansQuery object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewV2SpansQueryWithDefaults() *V2SpansQuery {
	this := V2SpansQuery{}
	return &this
}

// GetActionFilters returns the ActionFilters field value if set, zero value otherwise.
func (o *V2SpansQuery) GetActionFilters() []string {
...
func (o *V2SpansQuery) GetActionFiltersOk() ([]string, bool) {
	if o == nil || IsNil(o.ActionFilters) {
		return nil, false
	}
...
func (o *V2SpansQuery) HasActionFilters() bool {
	if o != nil && !IsNil(o.ActionFilters) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *V2SpansQuery) GetApplicationnameFiltersOk() ([]string, bool) {
	if o == nil || IsNil(o.ApplicationnameFilters) {
		return nil, false
	}
...
func (o *V2SpansQuery) HasApplicationnameFilters() bool {
	if o != nil && !IsNil(o.ApplicationnameFilters) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *V2SpansQuery) GetLuceneOk() (*string, bool) {
	if o == nil || IsNil(o.Lucene) {
		return nil, false
	}
...
func (o *V2SpansQuery) HasLucene() bool {
	if o != nil && !IsNil(o.Lucene) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *V2SpansQuery) GetServiceFiltersOk() ([]string, bool) {
	if o == nil || IsNil(o.ServiceFilters) {
		return nil, false
	}
...
func (o *V2SpansQuery) HasServiceFilters() bool {
	if o != nil && !IsNil(o.ServiceFilters) {
		return true
	}
...
func (o *V2SpansQuery) SetServiceFilters(v []string) {
	o.ServiceFilters = v
}

// GetSubsystemnameFilters returns the SubsystemnameFilters field value if set, zero value otherwise.
func (o *V2SpansQuery) GetSubsystemnameFilters() []string {
...
// and a boolean to check if the value has been set.
func (o *V2SpansQuery) GetSubsystemnameFiltersOk() ([]string, bool) {
	if o == nil || IsNil(o.SubsystemnameFilters) {
		return nil, false
	}
...
func (o *V2SpansQuery) HasSubsystemnameFilters() bool {
	if o != nil && !IsNil(o.SubsystemnameFilters) {
		return true
	}
...
func (o *V2SpansQuery) SetSubsystemnameFilters(v []string) {
...
func (o V2SpansQuery) ToMap() (map[string]interface{}, error) {
...
func (o *V2SpansQuery) UnmarshalJSON(data []byte) (err error) {
	varV2SpansQuery := _V2SpansQuery{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varV2SpansQuery)

	if err != nil {
		return err
	}

	*o = V2SpansQuery(varV2SpansQuery)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "actionFilters")
...
type NullableV2SpansQuery struct {
	value *V2SpansQuery
	isSet bool
}

func (v NullableV2SpansQuery) Get() *V2SpansQuery {
	return v.value
}

func (v *NullableV2SpansQuery) Set(val *V2SpansQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableV2SpansQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableV2SpansQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2SpansQuery(val *V2SpansQuery) *NullableV2SpansQuery {
	return &NullableV2SpansQuery{value: val, isSet: true}
}

func (v NullableV2SpansQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2SpansQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
