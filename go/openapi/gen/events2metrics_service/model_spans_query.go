...
func (o *SpansQuery) UnmarshalJSON(data []byte) (err error) {
	varSpansQuery := _SpansQuery{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varSpansQuery)

	if err != nil {
		return err
	}

	*o = SpansQuery(varSpansQuery)
