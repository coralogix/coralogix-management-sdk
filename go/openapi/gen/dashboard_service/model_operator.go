...
func (o *Operator) GetEquals() Equals {
...
func (o *Operator) GetEqualsOk() (*Equals, bool) {
	if o == nil || IsNil(o.Equals) {
		return nil, false
	}
...
// SetEquals gets a reference to the given Equals and assigns it to the Equals field.
func (o *Operator) SetEquals(v Equals) {
	o.Equals = &v
}
