...
// BarChartLogsQuery A logs variant of the query
type BarChartLogsQuery struct {
...
func NewBarChartLogsQuery() *BarChartLogsQuery {
	this := BarChartLogsQuery{}
	return &this
}

// NewBarChartLogsQueryWithDefaults instantiates a new BarChartLogsQuery object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewBarChartLogsQueryWithDefaults() *BarChartLogsQuery {
	this := BarChartLogsQuery{}
	return &this
}

// GetAggregation returns the Aggregation field value if set, zero value otherwise.
func (o *BarChartLogsQuery) GetAggregation() LogsAggregation {
...
func (o *BarChartLogsQuery) GetAggregationOk() (*LogsAggregation, bool) {
	if o == nil || IsNil(o.Aggregation) {
		return nil, false
	}
...
func (o *BarChartLogsQuery) HasAggregation() bool {
	if o != nil && !IsNil(o.Aggregation) {
		return true
	}
...
func (o *BarChartLogsQuery) SetAggregation(v LogsAggregation) {
	o.Aggregation = &v
}

// GetFilters returns the Filters field value if set, zero value otherwise.
func (o *BarChartLogsQuery) GetFilters() []FilterLogsFilter {
...
// and a boolean to check if the value has been set.
func (o *BarChartLogsQuery) GetFiltersOk() ([]FilterLogsFilter, bool) {
	if o == nil || IsNil(o.Filters) {
		return nil, false
	}
...
func (o *BarChartLogsQuery) HasFilters() bool {
	if o != nil && !IsNil(o.Filters) {
		return true
	}
...
func (o *BarChartLogsQuery) SetFilters(v []FilterLogsFilter) {
	o.Filters = v
}

// GetGroupNames returns the GroupNames field value if set, zero value otherwise.
func (o *BarChartLogsQuery) GetGroupNames() []string {
...
// and a boolean to check if the value has been set.
func (o *BarChartLogsQuery) GetGroupNamesOk() ([]string, bool) {
	if o == nil || IsNil(o.GroupNames) {
		return nil, false
	}
...
func (o *BarChartLogsQuery) HasGroupNames() bool {
	if o != nil && !IsNil(o.GroupNames) {
		return true
	}
...
func (o *BarChartLogsQuery) SetGroupNames(v []string) {
	o.GroupNames = v
}

// GetGroupNamesFields returns the GroupNamesFields field value if set, zero value otherwise.
func (o *BarChartLogsQuery) GetGroupNamesFields() []ObservationField {
...
// and a boolean to check if the value has been set.
func (o *BarChartLogsQuery) GetGroupNamesFieldsOk() ([]ObservationField, bool) {
	if o == nil || IsNil(o.GroupNamesFields) {
		return nil, false
	}
...
func (o *BarChartLogsQuery) HasGroupNamesFields() bool {
	if o != nil && !IsNil(o.GroupNamesFields) {
		return true
	}
...
func (o *BarChartLogsQuery) SetGroupNamesFields(v []ObservationField) {
	o.GroupNamesFields = v
}

// GetLuceneQuery returns the LuceneQuery field value if set, zero value otherwise.
func (o *BarChartLogsQuery) GetLuceneQuery() LuceneQuery {
...
// and a boolean to check if the value has been set.
func (o *BarChartLogsQuery) GetLuceneQueryOk() (*LuceneQuery, bool) {
	if o == nil || IsNil(o.LuceneQuery) {
		return nil, false
	}
...
func (o *BarChartLogsQuery) HasLuceneQuery() bool {
	if o != nil && !IsNil(o.LuceneQuery) {
		return true
	}
...
func (o *BarChartLogsQuery) SetLuceneQuery(v LuceneQuery) {
	o.LuceneQuery = &v
}

// GetStackedGroupName returns the StackedGroupName field value if set, zero value otherwise.
func (o *BarChartLogsQuery) GetStackedGroupName() string {
...
// and a boolean to check if the value has been set.
func (o *BarChartLogsQuery) GetStackedGroupNameOk() (*string, bool) {
	if o == nil || IsNil(o.StackedGroupName) {
		return nil, false
	}
...
func (o *BarChartLogsQuery) HasStackedGroupName() bool {
	if o != nil && !IsNil(o.StackedGroupName) {
		return true
	}
...
func (o *BarChartLogsQuery) SetStackedGroupName(v string) {
	o.StackedGroupName = &v
}

// GetStackedGroupNameField returns the StackedGroupNameField field value if set, zero value otherwise.
func (o *BarChartLogsQuery) GetStackedGroupNameField() ObservationField {
...
// and a boolean to check if the value has been set.
func (o *BarChartLogsQuery) GetStackedGroupNameFieldOk() (*ObservationField, bool) {
	if o == nil || IsNil(o.StackedGroupNameField) {
		return nil, false
	}
...
func (o *BarChartLogsQuery) HasStackedGroupNameField() bool {
	if o != nil && !IsNil(o.StackedGroupNameField) {
		return true
	}
...
func (o *BarChartLogsQuery) SetStackedGroupNameField(v ObservationField) {
	o.StackedGroupNameField = &v
}

// GetTimeFrame returns the TimeFrame field value if set, zero value otherwise.
func (o *BarChartLogsQuery) GetTimeFrame() TimeFrameSelect {
...
// and a boolean to check if the value has been set.
func (o *BarChartLogsQuery) GetTimeFrameOk() (*TimeFrameSelect, bool) {
	if o == nil || IsNil(o.TimeFrame) {
		return nil, false
	}
...
func (o *BarChartLogsQuery) HasTimeFrame() bool {
	if o != nil && !IsNil(o.TimeFrame) {
		return true
	}
...
func (o *BarChartLogsQuery) SetTimeFrame(v TimeFrameSelect) {
	o.TimeFrame = &v
}
...
func (o BarChartLogsQuery) ToMap() (map[string]interface{}, error) {
...
type NullableBarChartLogsQuery struct {
	value *BarChartLogsQuery
	isSet bool
}

func (v NullableBarChartLogsQuery) Get() *BarChartLogsQuery {
	return v.value
}

func (v *NullableBarChartLogsQuery) Set(val *BarChartLogsQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableBarChartLogsQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableBarChartLogsQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBarChartLogsQuery(val *BarChartLogsQuery) *NullableBarChartLogsQuery {
	return &NullableBarChartLogsQuery{value: val, isSet: true}
}

func (v NullableBarChartLogsQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBarChartLogsQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
