...
func NewDashboard5(layout Layout, name string) *Dashboard5 {
	this := Dashboard5{}
	this.Layout = layout
	this.Name = name
	return &this
...
func (o *Dashboard5) GetAbsoluteTimeFrame() TimeFrame {
...
func (o *Dashboard5) GetAbsoluteTimeFrameOk() (*TimeFrame, bool) {
	if o == nil || IsNil(o.AbsoluteTimeFrame) {
		return nil, false
	}
...
func (o *Dashboard5) SetAbsoluteTimeFrame(v TimeFrame) {
...
func (o *Dashboard5) GetAnnotations() []Annotation {
...
// and a boolean to check if the value has been set.
func (o *Dashboard5) GetAnnotationsOk() ([]Annotation, bool) {
	if o == nil || IsNil(o.Annotations) {
		return nil, false
	}
...
func (o *Dashboard5) SetAnnotations(v []Annotation) {
	o.Annotations = v
}
...
func (o *Dashboard5) GetFilters() []FiltersFilter {
...
// and a boolean to check if the value has been set.
func (o *Dashboard5) GetFiltersOk() ([]FiltersFilter, bool) {
	if o == nil || IsNil(o.Filters) {
		return nil, false
	}
...
func (o *Dashboard5) SetFilters(v []FiltersFilter) {
	o.Filters = v
}

// GetFolderPath returns the FolderPath field value if set, zero value otherwise.
func (o *Dashboard5) GetFolderPath() FolderPath {
...
// and a boolean to check if the value has been set.
func (o *Dashboard5) GetFolderPathOk() (*FolderPath, bool) {
	if o == nil || IsNil(o.FolderPath) {
		return nil, false
	}
...
func (o *Dashboard5) SetFolderPath(v FolderPath) {
	o.FolderPath = &v
}
...
func (o *Dashboard5) GetLayout() Layout {
	if o == nil {
		var ret Layout
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Dashboard5) GetLayoutOk() (*Layout, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Dashboard5) SetLayout(v Layout) {
	o.Layout = v
}
...
func (o *Dashboard5) GetTwoMinutes() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *Dashboard5) GetTwoMinutesOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.TwoMinutes) {
...
func (o *Dashboard5) HasTwoMinutes() bool {
	if o != nil && !IsNil(o.TwoMinutes) {
		return true
	}
...
func (o *Dashboard5) SetTwoMinutes(v map[string]interface{}) {
	o.TwoMinutes = v
}

// GetVariables returns the Variables field value if set, zero value otherwise.
func (o *Dashboard5) GetVariables() []Variable {
...
// and a boolean to check if the value has been set.
func (o *Dashboard5) GetVariablesOk() ([]Variable, bool) {
	if o == nil || IsNil(o.Variables) {
		return nil, false
	}
...
func (o *Dashboard5) SetVariables(v []Variable) {
	o.Variables = v
}

// GetVariablesV2 returns the VariablesV2 field value if set, zero value otherwise.
func (o *Dashboard5) GetVariablesV2() []VariableV2 {
...
// and a boolean to check if the value has been set.
func (o *Dashboard5) GetVariablesV2Ok() ([]VariableV2, bool) {
	if o == nil || IsNil(o.VariablesV2) {
		return nil, false
	}
...
func (o *Dashboard5) SetVariablesV2(v []VariableV2) {
	o.VariablesV2 = v
}
