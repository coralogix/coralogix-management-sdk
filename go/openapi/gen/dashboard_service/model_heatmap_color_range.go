...
func (o *HeatmapColorRange) GetXAxisTimeFormat() XAxisTimeFormat {
...
// and a boolean to check if the value has been set.
func (o *HeatmapColorRange) GetXAxisTimeFormatOk() (*XAxisTimeFormat, bool) {
	if o == nil || IsNil(o.XAxisTimeFormat) {
		return nil, false
	}
...
func (o *HeatmapColorRange) HasXAxisTimeFormat() bool {
	if o != nil && !IsNil(o.XAxisTimeFormat) {
		return true
	}
...
func (o *HeatmapColorRange) SetXAxisTimeFormat(v XAxisTimeFormat) {
	o.XAxisTimeFormat = &v
}
