...
// checks if the Gauge type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Gauge{}

// Gauge struct for Gauge
type Gauge struct {
...
// NewGauge instantiates a new Gauge object
...
// NewGaugeWithDefaults instantiates a new Gauge object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGaugeWithDefaults() *Gauge {
	this := Gauge{}
	return &this
}

// GetCustomUnit returns the CustomUnit field value if set, zero value otherwise.
func (o *Gauge) GetCustomUnit() string {
...
func (o *Gauge) GetCustomUnitOk() (*string, bool) {
	if o == nil || IsNil(o.CustomUnit) {
		return nil, false
	}
...
func (o *Gauge) HasCustomUnit() bool {
	if o != nil && !IsNil(o.CustomUnit) {
		return true
	}
...
func (o *Gauge) SetCustomUnit(v string) {
	o.CustomUnit = &v
}

// GetDataModeType returns the DataModeType field value if set, zero value otherwise.
func (o *Gauge) GetDataModeType() WidgetsCommonDataModeType {
...
// and a boolean to check if the value has been set.
func (o *Gauge) GetDataModeTypeOk() (*WidgetsCommonDataModeType, bool) {
	if o == nil || IsNil(o.DataModeType) {
		return nil, false
	}
...
func (o *Gauge) HasDataModeType() bool {
	if o != nil && !IsNil(o.DataModeType) {
		return true
	}
...
func (o *Gauge) SetDataModeType(v WidgetsCommonDataModeType) {
	o.DataModeType = &v
}

// GetDecimal returns the Decimal field value if set, zero value otherwise.
func (o *Gauge) GetDecimal() int32 {
...
// and a boolean to check if the value has been set.
func (o *Gauge) GetDecimalOk() (*int32, bool) {
	if o == nil || IsNil(o.Decimal) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Gauge) GetDecimalPrecisionOk() (*bool, bool) {
	if o == nil || IsNil(o.DecimalPrecision) {
		return nil, false
	}
...
func (o *Gauge) HasDecimalPrecision() bool {
	if o != nil && !IsNil(o.DecimalPrecision) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Gauge) GetDisplaySeriesNameOk() (*bool, bool) {
	if o == nil || IsNil(o.DisplaySeriesName) {
		return nil, false
	}
...
func (o *Gauge) HasDisplaySeriesName() bool {
	if o != nil && !IsNil(o.DisplaySeriesName) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Gauge) GetLegendOk() (*Legend, bool) {
	if o == nil || IsNil(o.Legend) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Gauge) GetLegendByOk() (*LegendBy, bool) {
	if o == nil || IsNil(o.LegendBy) {
		return nil, false
	}
...
func (o *Gauge) SetLegendBy(v LegendBy) {
	o.LegendBy = &v
}

// GetMax returns the Max field value if set, zero value otherwise.
func (o *Gauge) GetMax() float64 {
...
// and a boolean to check if the value has been set.
func (o *Gauge) GetMaxOk() (*float64, bool) {
	if o == nil || IsNil(o.Max) {
		return nil, false
	}
	return o.Max, true
...
func (o *Gauge) SetMax(v float64) {
	o.Max = &v
}

// GetMin returns the Min field value if set, zero value otherwise.
func (o *Gauge) GetMin() float64 {
...
// and a boolean to check if the value has been set.
func (o *Gauge) GetMinOk() (*float64, bool) {
	if o == nil || IsNil(o.Min) {
		return nil, false
	}
	return o.Min, true
...
func (o *Gauge) SetMin(v float64) {
	o.Min = &v
}

// GetQuery returns the Query field value if set, zero value otherwise.
func (o *Gauge) GetQuery() GaugeQuery {
...
// and a boolean to check if the value has been set.
func (o *Gauge) GetQueryOk() (*GaugeQuery, bool) {
	if o == nil || IsNil(o.Query) {
		return nil, false
	}
	return o.Query, true
...
// and a boolean to check if the value has been set.
func (o *Gauge) GetShowInnerArcOk() (*bool, bool) {
	if o == nil || IsNil(o.ShowInnerArc) {
		return nil, false
	}
...
func (o *Gauge) HasShowInnerArc() bool {
	if o != nil && !IsNil(o.ShowInnerArc) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Gauge) GetShowOuterArcOk() (*bool, bool) {
	if o == nil || IsNil(o.ShowOuterArc) {
		return nil, false
	}
...
func (o *Gauge) HasShowOuterArc() bool {
	if o != nil && !IsNil(o.ShowOuterArc) {
		return true
	}
...
func (o *Gauge) SetShowOuterArc(v bool) {
	o.ShowOuterArc = &v
}

// GetThresholdBy returns the ThresholdBy field value if set, zero value otherwise.
func (o *Gauge) GetThresholdBy() GaugeThresholdBy {
...
// and a boolean to check if the value has been set.
func (o *Gauge) GetThresholdByOk() (*GaugeThresholdBy, bool) {
	if o == nil || IsNil(o.ThresholdBy) {
		return nil, false
	}
...
func (o *Gauge) HasThresholdBy() bool {
	if o != nil && !IsNil(o.ThresholdBy) {
		return true
	}
...
func (o *Gauge) SetThresholdBy(v GaugeThresholdBy) {
	o.ThresholdBy = &v
}

// GetThresholdType returns the ThresholdType field value if set, zero value otherwise.
func (o *Gauge) GetThresholdType() ThresholdType {
...
// and a boolean to check if the value has been set.
func (o *Gauge) GetThresholdTypeOk() (*ThresholdType, bool) {
	if o == nil || IsNil(o.ThresholdType) {
		return nil, false
	}
...
func (o *Gauge) HasThresholdType() bool {
	if o != nil && !IsNil(o.ThresholdType) {
		return true
	}
...
func (o *Gauge) SetThresholdType(v ThresholdType) {
	o.ThresholdType = &v
}

// GetThresholds returns the Thresholds field value if set, zero value otherwise.
func (o *Gauge) GetThresholds() []GaugeThreshold {
...
// and a boolean to check if the value has been set.
func (o *Gauge) GetThresholdsOk() ([]GaugeThreshold, bool) {
	if o == nil || IsNil(o.Thresholds) {
		return nil, false
	}
...
func (o *Gauge) HasThresholds() bool {
	if o != nil && !IsNil(o.Thresholds) {
		return true
	}
...
func (o *Gauge) SetThresholds(v []GaugeThreshold) {
	o.Thresholds = v
}

// GetUnit returns the Unit field value if set, zero value otherwise.
func (o *Gauge) GetUnit() GaugeUnit {
...
// and a boolean to check if the value has been set.
func (o *Gauge) GetUnitOk() (*GaugeUnit, bool) {
	if o == nil || IsNil(o.Unit) {
		return nil, false
	}
	return o.Unit, true
...
func (o *Gauge) SetUnit(v GaugeUnit) {
	o.Unit = &v
}

func (o Gauge) MarshalJSON() ([]byte, error) {
...
func (o Gauge) ToMap() (map[string]interface{}, error) {
...
type NullableGauge struct {
	value *Gauge
	isSet bool
}

func (v NullableGauge) Get() *Gauge {
	return v.value
}

func (v *NullableGauge) Set(val *Gauge) {
	v.value = val
	v.isSet = true
}

func (v NullableGauge) IsSet() bool {
	return v.isSet
}

func (v *NullableGauge) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGauge(val *Gauge) *NullableGauge {
	return &NullableGauge{value: val, isSet: true}
}

func (v NullableGauge) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGauge) UnmarshalJSON(src []byte) error {
	v.isSet = true
