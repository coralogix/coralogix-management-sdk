...
type LineChart struct {
	...
	StackedLine *StackedLine `json:"stackedLine,omitempty"`
...
func (o *LineChart) GetStackedLine() StackedLine {
...
// and a boolean to check if the value has been set.
func (o *LineChart) GetStackedLineOk() (*StackedLine, bool) {
	if o == nil || IsNil(o.StackedLine) {
		return nil, false
	}
...
// SetStackedLine gets a reference to the given StackedLine and assigns it to the StackedLine field.
func (o *LineChart) SetStackedLine(v StackedLine) {
	o.StackedLine = &v
}
