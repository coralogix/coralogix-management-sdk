...
type LineChart struct {
	...
	QueryDefinitions []LineChart `json:"queryDefinitions"`
...
func NewLineChart(queryDefinitions []LineChart) *LineChart {
	this := LineChart{}
...
func (o *LineChart) GetLegend() LineChartLegend {
...
// and a boolean to check if the value has been set.
func (o *LineChart) GetLegendOk() (*LineChartLegend, bool) {
	if o == nil || IsNil(o.Legend) {
		return nil, false
	}
...
func (o *LineChart) SetLegend(v LineChartLegend) {
	o.Legend = &v
}

// GetQueryDefinitions returns the QueryDefinitions field value
func (o *LineChart) GetQueryDefinitions() []LineChart {
	if o == nil {
		var ret []LineChart
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LineChart) GetQueryDefinitionsOk() ([]LineChart, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *LineChart) GetStackedLineOk() (*string, bool) {
	if o == nil || IsNil(o.StackedLine) {
		return nil, false
	}
...
func (o *LineChart) SetStackedLine(v string) {
	o.StackedLine = &v
}

// GetTooltip returns the Tooltip field value if set, zero value otherwise.
func (o *LineChart) GetTooltip() LineChartTooltip {
	if o == nil || IsNil(o.Tooltip) {
		var ret LineChartTooltip
		return ret
	}
	return *o.Tooltip
}
...
// and a boolean to check if the value has been set.
func (o *LineChart) GetTooltipOk() (*LineChartTooltip, bool) {
	if o == nil || IsNil(o.Tooltip) {
		return nil, false
	}
...
// SetTooltip gets a reference to the given LineChartTooltip and assigns it to the Tooltip field.
func (o *LineChart) SetTooltip(v LineChartTooltip) {
	o.Tooltip = &v
}
