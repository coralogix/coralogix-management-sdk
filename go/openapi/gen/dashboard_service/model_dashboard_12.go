...
// checks if the Dashboard12 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Dashboard12{}

// Dashboard12 Dashboard represents the structure and configuration of a Coralogix Custom Dashboard.
type Dashboard12 struct {
...
type _Dashboard12 Dashboard12

// NewDashboard12 instantiates a new Dashboard12 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDashboard12(layout Layout, name string) *Dashboard12 {
	this := Dashboard12{}
	this.Layout = layout
	this.Name = name
	return &this
...
// NewDashboard12WithDefaults instantiates a new Dashboard12 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDashboard12WithDefaults() *Dashboard12 {
	this := Dashboard12{}
	return &this
}

// GetActions returns the Actions field value if set, zero value otherwise.
func (o *Dashboard12) GetActions() []DashboardAction {
...
func (o *Dashboard12) GetActionsOk() ([]DashboardAction, bool) {
	if o == nil || IsNil(o.Actions) {
		return nil, false
	}
...
func (o *Dashboard12) HasActions() bool {
	if o != nil && !IsNil(o.Actions) {
		return true
	}
...
func (o *Dashboard12) SetActions(v []DashboardAction) {
	o.Actions = v
}

// GetAnnotations returns the Annotations field value if set, zero value otherwise.
func (o *Dashboard12) GetAnnotations() []Annotation {
...
// and a boolean to check if the value has been set.
func (o *Dashboard12) GetAnnotationsOk() ([]Annotation, bool) {
	if o == nil || IsNil(o.Annotations) {
		return nil, false
	}
...
func (o *Dashboard12) HasAnnotations() bool {
	if o != nil && !IsNil(o.Annotations) {
		return true
	}
...
func (o *Dashboard12) SetAnnotations(v []Annotation) {
	o.Annotations = v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *Dashboard12) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *Dashboard12) GetDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.Description) {
		return nil, false
	}
...
func (o *Dashboard12) HasDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *Dashboard12) SetDescription(v string) {
	o.Description = &v
}

// GetFilters returns the Filters field value if set, zero value otherwise.
func (o *Dashboard12) GetFilters() []FiltersFilter {
...
// and a boolean to check if the value has been set.
func (o *Dashboard12) GetFiltersOk() ([]FiltersFilter, bool) {
	if o == nil || IsNil(o.Filters) {
		return nil, false
	}
...
func (o *Dashboard12) HasFilters() bool {
	if o != nil && !IsNil(o.Filters) {
		return true
	}
...
func (o *Dashboard12) SetFilters(v []FiltersFilter) {
	o.Filters = v
}

// GetFiveMinutes returns the FiveMinutes field value if set, zero value otherwise.
func (o *Dashboard12) GetFiveMinutes() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *Dashboard12) GetFiveMinutesOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.FiveMinutes) {
...
func (o *Dashboard12) HasFiveMinutes() bool {
	if o != nil && !IsNil(o.FiveMinutes) {
		return true
	}
...
func (o *Dashboard12) SetFiveMinutes(v map[string]interface{}) {
	o.FiveMinutes = v
}

// GetFolderPath returns the FolderPath field value if set, zero value otherwise.
func (o *Dashboard12) GetFolderPath() FolderPath {
...
// and a boolean to check if the value has been set.
func (o *Dashboard12) GetFolderPathOk() (*FolderPath, bool) {
	if o == nil || IsNil(o.FolderPath) {
		return nil, false
	}
...
func (o *Dashboard12) HasFolderPath() bool {
	if o != nil && !IsNil(o.FolderPath) {
		return true
	}
...
func (o *Dashboard12) SetFolderPath(v FolderPath) {
	o.FolderPath = &v
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *Dashboard12) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Dashboard12) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *Dashboard12) SetId(v string) {
	o.Id = &v
}

// GetLayout returns the Layout field value
func (o *Dashboard12) GetLayout() Layout {
	if o == nil {
		var ret Layout
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Dashboard12) GetLayoutOk() (*Layout, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Dashboard12) SetLayout(v Layout) {
	o.Layout = v
}

// GetName returns the Name field value
func (o *Dashboard12) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Dashboard12) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
// and a boolean to check if the value has been set.
func (o *Dashboard12) GetRelativeTimeFrameOk() (*string, bool) {
	if o == nil || IsNil(o.RelativeTimeFrame) {
		return nil, false
	}
...
func (o *Dashboard12) HasRelativeTimeFrame() bool {
	if o != nil && !IsNil(o.RelativeTimeFrame) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Dashboard12) GetSlugNameOk() (*string, bool) {
	if o == nil || IsNil(o.SlugName) {
		return nil, false
	}
...
func (o *Dashboard12) HasSlugName() bool {
	if o != nil && !IsNil(o.SlugName) {
		return true
	}
...
func (o *Dashboard12) SetSlugName(v string) {
	o.SlugName = &v
}

// GetVariables returns the Variables field value if set, zero value otherwise.
func (o *Dashboard12) GetVariables() []Variable {
...
// and a boolean to check if the value has been set.
func (o *Dashboard12) GetVariablesOk() ([]Variable, bool) {
	if o == nil || IsNil(o.Variables) {
		return nil, false
	}
...
func (o *Dashboard12) HasVariables() bool {
	if o != nil && !IsNil(o.Variables) {
		return true
	}
...
func (o *Dashboard12) SetVariables(v []Variable) {
	o.Variables = v
}

// GetVariablesV2 returns the VariablesV2 field value if set, zero value otherwise.
func (o *Dashboard12) GetVariablesV2() []VariableV2 {
...
// and a boolean to check if the value has been set.
func (o *Dashboard12) GetVariablesV2Ok() ([]VariableV2, bool) {
	if o == nil || IsNil(o.VariablesV2) {
		return nil, false
	}
...
func (o *Dashboard12) HasVariablesV2() bool {
	if o != nil && !IsNil(o.VariablesV2) {
		return true
	}
...
func (o *Dashboard12) SetVariablesV2(v []VariableV2) {
	o.VariablesV2 = v
}

func (o Dashboard12) MarshalJSON() ([]byte, error) {
...
func (o Dashboard12) ToMap() (map[string]interface{}, error) {
...
func (o *Dashboard12) UnmarshalJSON(data []byte) (err error) {
	...
	varDashboard12 := _Dashboard12{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDashboard12)

	if err != nil {
		return err
	}

	*o = Dashboard12(varDashboard12)

	return err
}

type NullableDashboard12 struct {
	value *Dashboard12
	isSet bool
}

func (v NullableDashboard12) Get() *Dashboard12 {
	return v.value
}

func (v *NullableDashboard12) Set(val *Dashboard12) {
	v.value = val
	v.isSet = true
}

func (v NullableDashboard12) IsSet() bool {
	return v.isSet
}

func (v *NullableDashboard12) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDashboard12(val *Dashboard12) *NullableDashboard12 {
	return &NullableDashboard12{value: val, isSet: true}
}

func (v NullableDashboard12) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDashboard12) UnmarshalJSON(src []byte) error {
	v.isSet = true
