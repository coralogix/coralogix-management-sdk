...
type _PieChartDataprimeQuery PieChartDataprimeQuery
...
func (o *PieChartDataprimeQuery) UnmarshalJSON(data []byte) (err error) {
	...
	varPieChartDataprimeQuery := _PieChartDataprimeQuery{}

	decoder := json.NewDecoder(bytes.NewReader(strippedData))
	err = decoder.Decode(&varPieChartDataprimeQuery)

	if err != nil {
		return err
	}

	*o = PieChartDataprimeQuery(varPieChartDataprimeQuery)
