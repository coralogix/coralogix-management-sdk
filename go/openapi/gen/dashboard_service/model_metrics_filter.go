...
func (o *MetricsFilter) GetOperator() LogsFilterOperator {
...
// and a boolean to check if the value has been set.
func (o *MetricsFilter) GetOperatorOk() (*LogsFilterOperator, bool) {
	if o == nil || IsNil(o.Operator) {
		return nil, false
	}
...
func (o *MetricsFilter) SetOperator(v LogsFilterOperator) {
	o.Operator = &v
}
