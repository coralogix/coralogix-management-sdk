...
func (o *PieChartMetricsQuery) UnmarshalJSON(data []byte) (err error) {
	...
	varPieChartMetricsQuery := _PieChartMetricsQuery{}

	decoder := json.NewDecoder(bytes.NewReader(strippedData))
	err = decoder.Decode(&varPieChartMetricsQuery)

	if err != nil {
		return err
	}

	*o = PieChartMetricsQuery(varPieChartMetricsQuery)
