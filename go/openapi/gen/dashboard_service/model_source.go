...
type Source struct {
	Logs *LogsFilter `json:"logs,omitempty"`
}
...
func (o *Source) GetLogs() LogsFilter {
...
func (o *Source) GetLogsOk() (*LogsFilter, bool) {
	if o == nil || IsNil(o.Logs) {
		return nil, false
	}
	return o.Logs, true
...
// SetLogs gets a reference to the given LogsFilter and assigns it to the Logs field.
func (o *Source) SetLogs(v LogsFilter) {
	o.Logs = &v
}
