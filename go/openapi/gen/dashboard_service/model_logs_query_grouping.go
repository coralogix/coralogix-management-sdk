...
type LogsQueryGrouping struct {
	Aggregations []LogsQueryGroupingAggregationsInner `json:"aggregations,omitempty"`
...
func (o *LogsQueryGrouping) GetAggregations() []LogsQueryGroupingAggregationsInner {
	if o == nil || IsNil(o.Aggregations) {
		var ret []LogsQueryGroupingAggregationsInner
		return ret
	}
...
func (o *LogsQueryGrouping) GetAggregationsOk() ([]LogsQueryGroupingAggregationsInner, bool) {
	if o == nil || IsNil(o.Aggregations) {
		return nil, false
	}
...
// SetAggregations gets a reference to the given []LogsQueryGroupingAggregationsInner and assigns it to the Aggregations field.
func (o *LogsQueryGrouping) SetAggregations(v []LogsQueryGroupingAggregationsInner) {
	o.Aggregations = v
}
...
func (o *LogsQueryGrouping) GetGroupBys() []DashboardAnnotationsInnerSourceOneOf1LogsLabelFieldsInner {
...
// and a boolean to check if the value has been set.
func (o *LogsQueryGrouping) GetGroupBysOk() ([]DashboardAnnotationsInnerSourceOneOf1LogsLabelFieldsInner, bool) {
	if o == nil || IsNil(o.GroupBys) {
		return nil, false
	}
...
func (o *LogsQueryGrouping) SetGroupBys(v []DashboardAnnotationsInnerSourceOneOf1LogsLabelFieldsInner) {
	o.GroupBys = v
}
