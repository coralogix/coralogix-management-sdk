...
type WidgetDefinitionOneOf1 struct {
	DataTable *WidgetDefinitionOneOf1DataTable `json:"dataTable,omitempty"`
}
...
func (o *WidgetDefinitionOneOf1) GetDataTable() WidgetDefinitionOneOf1DataTable {
	if o == nil || IsNil(o.DataTable) {
		var ret WidgetDefinitionOneOf1DataTable
		return ret
	}
	return *o.DataTable
}
...
func (o *WidgetDefinitionOneOf1) GetDataTableOk() (*WidgetDefinitionOneOf1DataTable, bool) {
	if o == nil || IsNil(o.DataTable) {
		return nil, false
	}
...
// SetDataTable gets a reference to the given WidgetDefinitionOneOf1DataTable and assigns it to the DataTable field.
func (o *WidgetDefinitionOneOf1) SetDataTable(v WidgetDefinitionOneOf1DataTable) {
	o.DataTable = &v
}
