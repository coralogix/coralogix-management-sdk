...
func (o *LineChartQueryDefinition) GetIntervalResolution() IntervalResolution {
...
// and a boolean to check if the value has been set.
func (o *LineChartQueryDefinition) GetIntervalResolutionOk() (*IntervalResolution, bool) {
	if o == nil || IsNil(o.IntervalResolution) {
		return nil, false
	}
...
func (o *LineChartQueryDefinition) HasIntervalResolution() bool {
	if o != nil && !IsNil(o.IntervalResolution) {
		return true
	}
...
func (o *LineChartQueryDefinition) SetIntervalResolution(v IntervalResolution) {
