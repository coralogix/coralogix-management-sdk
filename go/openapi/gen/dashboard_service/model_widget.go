...
func (o *Widget) GetId() DashboardAnnotationsInnerSourceOneOfMetricsPromqlQuery {
	if o == nil || IsNil(o.Id) {
...
// and a boolean to check if the value has been set.
func (o *Widget) GetIdOk() (*DashboardAnnotationsInnerSourceOneOfMetricsPromqlQuery, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *Widget) SetId(v DashboardAnnotationsInnerSourceOneOfMetricsPromqlQuery) {
	o.Id = &v
}
