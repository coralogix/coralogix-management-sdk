...
// NewDashboardOffAbsoluteTimeFrame instantiates a new DashboardOffAbsoluteTimeFrame object
...
// NewDashboardOffAbsoluteTimeFrameWithDefaults instantiates a new DashboardOffAbsoluteTimeFrame object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDashboardOffAbsoluteTimeFrameWithDefaults() *DashboardOffAbsoluteTimeFrame {
	this := DashboardOffAbsoluteTimeFrame{}
	return &this
}
...
func (o *DashboardOffAbsoluteTimeFrame) GetActions() []DashboardAction {
...
// and a boolean to check if the value has been set.
func (o *DashboardOffAbsoluteTimeFrame) GetActionsOk() ([]DashboardAction, bool) {
	if o == nil || IsNil(o.Actions) {
		return nil, false
	}
...
func (o *DashboardOffAbsoluteTimeFrame) HasActions() bool {
	if o != nil && !IsNil(o.Actions) {
		return true
	}
...
func (o *DashboardOffAbsoluteTimeFrame) SetActions(v []DashboardAction) {
	o.Actions = v
}

// GetAnnotations returns the Annotations field value if set, zero value otherwise.
func (o *DashboardOffAbsoluteTimeFrame) GetAnnotations() []Annotation {
...
// and a boolean to check if the value has been set.
func (o *DashboardOffAbsoluteTimeFrame) GetAnnotationsOk() ([]Annotation, bool) {
	if o == nil || IsNil(o.Annotations) {
		return nil, false
	}
...
func (o *DashboardOffAbsoluteTimeFrame) HasAnnotations() bool {
	if o != nil && !IsNil(o.Annotations) {
		return true
	}
...
func (o *DashboardOffAbsoluteTimeFrame) SetAnnotations(v []Annotation) {
	o.Annotations = v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *DashboardOffAbsoluteTimeFrame) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *DashboardOffAbsoluteTimeFrame) GetDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.Description) {
		return nil, false
	}
...
func (o *DashboardOffAbsoluteTimeFrame) HasDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *DashboardOffAbsoluteTimeFrame) SetDescription(v string) {
	o.Description = &v
}

// GetFilters returns the Filters field value if set, zero value otherwise.
func (o *DashboardOffAbsoluteTimeFrame) GetFilters() []FiltersFilter {
...
// and a boolean to check if the value has been set.
func (o *DashboardOffAbsoluteTimeFrame) GetFiltersOk() ([]FiltersFilter, bool) {
	if o == nil || IsNil(o.Filters) {
		return nil, false
	}
...
func (o *DashboardOffAbsoluteTimeFrame) HasFilters() bool {
	if o != nil && !IsNil(o.Filters) {
		return true
	}
...
func (o *DashboardOffAbsoluteTimeFrame) SetFilters(v []FiltersFilter) {
	o.Filters = v
}

// GetFolderId returns the FolderId field value if set, zero value otherwise.
func (o *DashboardOffAbsoluteTimeFrame) GetFolderId() UUID {
...
// and a boolean to check if the value has been set.
func (o *DashboardOffAbsoluteTimeFrame) GetFolderIdOk() (*UUID, bool) {
	if o == nil || IsNil(o.FolderId) {
		return nil, false
	}
...
func (o *DashboardOffAbsoluteTimeFrame) HasFolderId() bool {
	if o != nil && !IsNil(o.FolderId) {
		return true
	}
...
func (o *DashboardOffAbsoluteTimeFrame) SetFolderId(v UUID) {
	o.FolderId = &v
}

// GetFolderPath returns the FolderPath field value if set, zero value otherwise.
func (o *DashboardOffAbsoluteTimeFrame) GetFolderPath() FolderPath {
...
// and a boolean to check if the value has been set.
func (o *DashboardOffAbsoluteTimeFrame) GetFolderPathOk() (*FolderPath, bool) {
	if o == nil || IsNil(o.FolderPath) {
		return nil, false
	}
...
func (o *DashboardOffAbsoluteTimeFrame) HasFolderPath() bool {
	if o != nil && !IsNil(o.FolderPath) {
		return true
	}
...
func (o *DashboardOffAbsoluteTimeFrame) SetFolderPath(v FolderPath) {
	o.FolderPath = &v
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *DashboardOffAbsoluteTimeFrame) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DashboardOffAbsoluteTimeFrame) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *DashboardOffAbsoluteTimeFrame) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *DashboardOffAbsoluteTimeFrame) SetId(v string) {
	o.Id = &v
}

// GetLayout returns the Layout field value
func (o *DashboardOffAbsoluteTimeFrame) GetLayout() Layout {
	if o == nil {
		var ret Layout
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DashboardOffAbsoluteTimeFrame) GetLayoutOk() (*Layout, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DashboardOffAbsoluteTimeFrame) SetLayout(v Layout) {
	o.Layout = v
}

// GetName returns the Name field value
func (o *DashboardOffAbsoluteTimeFrame) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DashboardOffAbsoluteTimeFrame) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *DashboardOffAbsoluteTimeFrame) SetName(v string) {
	o.Name = v
}
...
func (o *DashboardOffAbsoluteTimeFrame) GetSlugName() string {
...
// and a boolean to check if the value has been set.
func (o *DashboardOffAbsoluteTimeFrame) GetSlugNameOk() (*string, bool) {
	if o == nil || IsNil(o.SlugName) {
		return nil, false
	}
...
func (o *DashboardOffAbsoluteTimeFrame) HasSlugName() bool {
	if o != nil && !IsNil(o.SlugName) {
		return true
	}
...
func (o *DashboardOffAbsoluteTimeFrame) SetSlugName(v string) {
	o.SlugName = &v
}

// GetVariables returns the Variables field value if set, zero value otherwise.
func (o *DashboardOffAbsoluteTimeFrame) GetVariables() []Variable {
...
// and a boolean to check if the value has been set.
func (o *DashboardOffAbsoluteTimeFrame) GetVariablesOk() ([]Variable, bool) {
	if o == nil || IsNil(o.Variables) {
		return nil, false
	}
...
func (o *DashboardOffAbsoluteTimeFrame) HasVariables() bool {
	if o != nil && !IsNil(o.Variables) {
		return true
	}
...
func (o *DashboardOffAbsoluteTimeFrame) SetVariables(v []Variable) {
	o.Variables = v
}

// GetVariablesV2 returns the VariablesV2 field value if set, zero value otherwise.
func (o *DashboardOffAbsoluteTimeFrame) GetVariablesV2() []VariableV2 {
...
// and a boolean to check if the value has been set.
func (o *DashboardOffAbsoluteTimeFrame) GetVariablesV2Ok() ([]VariableV2, bool) {
	if o == nil || IsNil(o.VariablesV2) {
		return nil, false
	}
...
func (o *DashboardOffAbsoluteTimeFrame) HasVariablesV2() bool {
	if o != nil && !IsNil(o.VariablesV2) {
		return true
	}
...
func (o *DashboardOffAbsoluteTimeFrame) SetVariablesV2(v []VariableV2) {
	o.VariablesV2 = v
}

func (o DashboardOffAbsoluteTimeFrame) MarshalJSON() ([]byte, error) {
...
func (o *DashboardOffAbsoluteTimeFrame) UnmarshalJSON(data []byte) (err error) {
...
type NullableDashboardOffAbsoluteTimeFrame struct {
	value *DashboardOffAbsoluteTimeFrame
	isSet bool
}

func (v NullableDashboardOffAbsoluteTimeFrame) Get() *DashboardOffAbsoluteTimeFrame {
	return v.value
}

func (v *NullableDashboardOffAbsoluteTimeFrame) Set(val *DashboardOffAbsoluteTimeFrame) {
	v.value = val
	v.isSet = true
}

func (v NullableDashboardOffAbsoluteTimeFrame) IsSet() bool {
	return v.isSet
}

func (v *NullableDashboardOffAbsoluteTimeFrame) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDashboardOffAbsoluteTimeFrame(val *DashboardOffAbsoluteTimeFrame) *NullableDashboardOffAbsoluteTimeFrame {
	return &NullableDashboardOffAbsoluteTimeFrame{value: val, isSet: true}
}

func (v NullableDashboardOffAbsoluteTimeFrame) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDashboardOffAbsoluteTimeFrame) UnmarshalJSON(src []byte) error {
	v.isSet = true
