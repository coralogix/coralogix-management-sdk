...
// checks if the PieChart type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PieChart{}

// PieChart struct for PieChart
type PieChart struct {
	...
	LabelDefinition *LabelDefinition `json:"labelDefinition,omitempty"`
...
// NewPieChart instantiates a new PieChart object
...
// NewPieChartWithDefaults instantiates a new PieChart object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPieChartWithDefaults() *PieChart {
	this := PieChart{}
	return &this
}

// GetColorScheme returns the ColorScheme field value if set, zero value otherwise.
func (o *PieChart) GetColorScheme() string {
...
func (o *PieChart) GetColorSchemeOk() (*string, bool) {
	if o == nil || IsNil(o.ColorScheme) {
		return nil, false
	}
...
func (o *PieChart) HasColorScheme() bool {
	if o != nil && !IsNil(o.ColorScheme) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PieChart) GetCustomUnitOk() (*string, bool) {
	if o == nil || IsNil(o.CustomUnit) {
		return nil, false
	}
...
func (o *PieChart) HasCustomUnit() bool {
	if o != nil && !IsNil(o.CustomUnit) {
		return true
	}
...
func (o *PieChart) SetCustomUnit(v string) {
	o.CustomUnit = &v
}

// GetDataModeType returns the DataModeType field value if set, zero value otherwise.
func (o *PieChart) GetDataModeType() WidgetsCommonDataModeType {
...
// and a boolean to check if the value has been set.
func (o *PieChart) GetDataModeTypeOk() (*WidgetsCommonDataModeType, bool) {
	if o == nil || IsNil(o.DataModeType) {
		return nil, false
	}
...
func (o *PieChart) HasDataModeType() bool {
	if o != nil && !IsNil(o.DataModeType) {
		return true
	}
...
func (o *PieChart) SetDataModeType(v WidgetsCommonDataModeType) {
	o.DataModeType = &v
}

// GetDecimal returns the Decimal field value if set, zero value otherwise.
func (o *PieChart) GetDecimal() int32 {
...
// and a boolean to check if the value has been set.
func (o *PieChart) GetDecimalOk() (*int32, bool) {
	if o == nil || IsNil(o.Decimal) {
		return nil, false
	}
...
func (o *PieChart) HasDecimal() bool {
	if o != nil && !IsNil(o.Decimal) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PieChart) GetDecimalPrecisionOk() (*bool, bool) {
	if o == nil || IsNil(o.DecimalPrecision) {
		return nil, false
	}
...
func (o *PieChart) HasDecimalPrecision() bool {
	if o != nil && !IsNil(o.DecimalPrecision) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PieChart) GetGroupNameTemplateOk() (*string, bool) {
	if o == nil || IsNil(o.GroupNameTemplate) {
		return nil, false
	}
...
func (o *PieChart) HasGroupNameTemplate() bool {
	if o != nil && !IsNil(o.GroupNameTemplate) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PieChart) GetHashColorsOk() (*bool, bool) {
	if o == nil || IsNil(o.HashColors) {
		return nil, false
	}
...
func (o *PieChart) HasHashColors() bool {
	if o != nil && !IsNil(o.HashColors) {
		return true
	}
...
func (o *PieChart) SetHashColors(v bool) {
	o.HashColors = &v
}

// GetLabelDefinition returns the LabelDefinition field value if set, zero value otherwise.
func (o *PieChart) GetLabelDefinition() LabelDefinition {
...
// and a boolean to check if the value has been set.
func (o *PieChart) GetLabelDefinitionOk() (*LabelDefinition, bool) {
	if o == nil || IsNil(o.LabelDefinition) {
		return nil, false
	}
...
func (o *PieChart) HasLabelDefinition() bool {
	if o != nil && !IsNil(o.LabelDefinition) {
		return true
	}
...
// SetLabelDefinition gets a reference to the given LabelDefinition and assigns it to the LabelDefinition field.
func (o *PieChart) SetLabelDefinition(v LabelDefinition) {
	o.LabelDefinition = &v
}

// GetLegend returns the Legend field value if set, zero value otherwise.
func (o *PieChart) GetLegend() Legend {
...
// and a boolean to check if the value has been set.
func (o *PieChart) GetLegendOk() (*Legend, bool) {
	if o == nil || IsNil(o.Legend) {
		return nil, false
	}
...
func (o *PieChart) HasLegend() bool {
	if o != nil && !IsNil(o.Legend) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PieChart) GetMaxSlicesPerChartOk() (*int32, bool) {
	if o == nil || IsNil(o.MaxSlicesPerChart) {
		return nil, false
	}
...
func (o *PieChart) HasMaxSlicesPerChart() bool {
	if o != nil && !IsNil(o.MaxSlicesPerChart) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PieChart) GetMinSlicePercentageOk() (*int32, bool) {
	if o == nil || IsNil(o.MinSlicePercentage) {
		return nil, false
	}
...
func (o *PieChart) HasMinSlicePercentage() bool {
	if o != nil && !IsNil(o.MinSlicePercentage) {
		return true
	}
...
func (o *PieChart) SetMinSlicePercentage(v int32) {
	o.MinSlicePercentage = &v
}

// GetQuery returns the Query field value if set, zero value otherwise.
func (o *PieChart) GetQuery() PieChartQuery {
...
// and a boolean to check if the value has been set.
func (o *PieChart) GetQueryOk() (*PieChartQuery, bool) {
	if o == nil || IsNil(o.Query) {
		return nil, false
	}
	return o.Query, true
...
// and a boolean to check if the value has been set.
func (o *PieChart) GetShowLegendOk() (*bool, bool) {
	if o == nil || IsNil(o.ShowLegend) {
		return nil, false
	}
...
func (o *PieChart) HasShowLegend() bool {
	if o != nil && !IsNil(o.ShowLegend) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PieChart) GetShowTotalOk() (*bool, bool) {
	if o == nil || IsNil(o.ShowTotal) {
		return nil, false
	}
...
func (o *PieChart) HasShowTotal() bool {
	if o != nil && !IsNil(o.ShowTotal) {
		return true
	}
...
func (o *PieChart) SetShowTotal(v bool) {
	o.ShowTotal = &v
}

// GetStackDefinition returns the StackDefinition field value if set, zero value otherwise.
func (o *PieChart) GetStackDefinition() PieChartStackDefinition {
...
// and a boolean to check if the value has been set.
func (o *PieChart) GetStackDefinitionOk() (*PieChartStackDefinition, bool) {
	if o == nil || IsNil(o.StackDefinition) {
		return nil, false
	}
...
func (o *PieChart) HasStackDefinition() bool {
	if o != nil && !IsNil(o.StackDefinition) {
		return true
	}
...
func (o *PieChart) SetStackDefinition(v PieChartStackDefinition) {
	o.StackDefinition = &v
}

// GetUnit returns the Unit field value if set, zero value otherwise.
func (o *PieChart) GetUnit() CommonUnit {
...
// and a boolean to check if the value has been set.
func (o *PieChart) GetUnitOk() (*CommonUnit, bool) {
	if o == nil || IsNil(o.Unit) {
		return nil, false
	}
	return o.Unit, true
...
func (o *PieChart) SetUnit(v CommonUnit) {
	o.Unit = &v
}

func (o PieChart) MarshalJSON() ([]byte, error) {
...
func (o PieChart) ToMap() (map[string]interface{}, error) {
...
type NullablePieChart struct {
	value *PieChart
	isSet bool
}

func (v NullablePieChart) Get() *PieChart {
	return v.value
}

func (v *NullablePieChart) Set(val *PieChart) {
	v.value = val
	v.isSet = true
}

func (v NullablePieChart) IsSet() bool {
	return v.isSet
}

func (v *NullablePieChart) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePieChart(val *PieChart) *NullablePieChart {
	return &NullablePieChart{value: val, isSet: true}
}

func (v NullablePieChart) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePieChart) UnmarshalJSON(src []byte) error {
	v.isSet = true
