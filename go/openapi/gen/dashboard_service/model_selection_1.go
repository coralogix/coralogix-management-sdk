...
func (o *Selection1) GetList() ListSelection {
	if o == nil || IsNil(o.List) {
		var ret ListSelection
		return ret
	}
	return *o.List
}
...
func (o *Selection1) GetListOk() (*ListSelection, bool) {
	if o == nil || IsNil(o.List) {
		return nil, false
	}
	return o.List, true
...
// SetList gets a reference to the given ListSelection and assigns it to the List field.
func (o *Selection1) SetList(v ListSelection) {
	o.List = &v
}
