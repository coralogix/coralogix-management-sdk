...
func NewDashboard10(layout DashboardLayout, name string) *Dashboard10 {
	this := Dashboard10{}
	this.Layout = layout
	this.Name = name
	return &this
...
func (o *Dashboard10) GetAnnotations() []DashboardAnnotationsInner {
...
// and a boolean to check if the value has been set.
func (o *Dashboard10) GetAnnotationsOk() ([]DashboardAnnotationsInner, bool) {
	if o == nil || IsNil(o.Annotations) {
		return nil, false
	}
...
func (o *Dashboard10) SetAnnotations(v []DashboardAnnotationsInner) {
	o.Annotations = v
}
...
func (o *Dashboard10) GetFilters() []Filter {
...
// and a boolean to check if the value has been set.
func (o *Dashboard10) GetFiltersOk() ([]Filter, bool) {
	if o == nil || IsNil(o.Filters) {
		return nil, false
	}
...
func (o *Dashboard10) SetFilters(v []Filter) {
	o.Filters = v
}

// GetFolderPath returns the FolderPath field value if set, zero value otherwise.
func (o *Dashboard10) GetFolderPath() Dashboard3FolderPath {
...
// and a boolean to check if the value has been set.
func (o *Dashboard10) GetFolderPathOk() (*Dashboard3FolderPath, bool) {
	if o == nil || IsNil(o.FolderPath) {
		return nil, false
	}
...
func (o *Dashboard10) SetFolderPath(v Dashboard3FolderPath) {
	o.FolderPath = &v
}
...
func (o *Dashboard10) GetLayout() DashboardLayout {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *Dashboard10) GetLayoutOk() (*DashboardLayout, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Dashboard10) SetLayout(v DashboardLayout) {
	o.Layout = v
}
...
func (o *Dashboard10) GetVariables() []DashboardVariablesInner {
...
// and a boolean to check if the value has been set.
func (o *Dashboard10) GetVariablesOk() ([]DashboardVariablesInner, bool) {
	if o == nil || IsNil(o.Variables) {
		return nil, false
	}
...
func (o *Dashboard10) SetVariables(v []DashboardVariablesInner) {
	o.Variables = v
}

// GetVariablesV2 returns the VariablesV2 field value if set, zero value otherwise.
func (o *Dashboard10) GetVariablesV2() []DashboardVariablesV2Inner {
...
// and a boolean to check if the value has been set.
func (o *Dashboard10) GetVariablesV2Ok() ([]DashboardVariablesV2Inner, bool) {
	if o == nil || IsNil(o.VariablesV2) {
		return nil, false
	}
...
func (o *Dashboard10) SetVariablesV2(v []DashboardVariablesV2Inner) {
	o.VariablesV2 = v
}
