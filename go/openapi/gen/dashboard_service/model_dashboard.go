...
func NewDashboard(layout DashboardLayout, name string) *Dashboard {
	this := Dashboard{}
	this.Layout = layout
	this.Name = name
	return &this
...
func (o *Dashboard) GetAbsoluteTimeFrame() DashboardAbsoluteTimeFrame {
...
func (o *Dashboard) GetAbsoluteTimeFrameOk() (*DashboardAbsoluteTimeFrame, bool) {
	if o == nil || IsNil(o.AbsoluteTimeFrame) {
		return nil, false
	}
...
func (o *Dashboard) SetAbsoluteTimeFrame(v DashboardAbsoluteTimeFrame) {
...
func (o *Dashboard) GetAnnotations() []DashboardAnnotationsInner {
...
// and a boolean to check if the value has been set.
func (o *Dashboard) GetAnnotationsOk() ([]DashboardAnnotationsInner, bool) {
	if o == nil || IsNil(o.Annotations) {
		return nil, false
	}
...
func (o *Dashboard) SetAnnotations(v []DashboardAnnotationsInner) {
	o.Annotations = v
}
...
func (o *Dashboard) GetFilters() []Filter {
...
// and a boolean to check if the value has been set.
func (o *Dashboard) GetFiltersOk() ([]Filter, bool) {
	if o == nil || IsNil(o.Filters) {
		return nil, false
	}
...
func (o *Dashboard) SetFilters(v []Filter) {
	o.Filters = v
}

// GetFolderId returns the FolderId field value if set, zero value otherwise.
func (o *Dashboard) GetFolderId() DashboardAnnotationsInnerSourceOneOfMetricsPromqlQuery {
...
// and a boolean to check if the value has been set.
func (o *Dashboard) GetFolderIdOk() (*DashboardAnnotationsInnerSourceOneOfMetricsPromqlQuery, bool) {
	if o == nil || IsNil(o.FolderId) {
		return nil, false
	}
...
func (o *Dashboard) SetFolderId(v DashboardAnnotationsInnerSourceOneOfMetricsPromqlQuery) {
	o.FolderId = &v
}
...
func (o *Dashboard) GetVariables() []DashboardVariablesInner {
...
// and a boolean to check if the value has been set.
func (o *Dashboard) GetVariablesOk() ([]DashboardVariablesInner, bool) {
	if o == nil || IsNil(o.Variables) {
		return nil, false
	}
...
func (o *Dashboard) SetVariables(v []DashboardVariablesInner) {
	o.Variables = v
}

// GetVariablesV2 returns the VariablesV2 field value if set, zero value otherwise.
func (o *Dashboard) GetVariablesV2() []DashboardVariablesV2Inner {
...
// and a boolean to check if the value has been set.
func (o *Dashboard) GetVariablesV2Ok() ([]DashboardVariablesV2Inner, bool) {
	if o == nil || IsNil(o.VariablesV2) {
		return nil, false
	}
...
func (o *Dashboard) SetVariablesV2(v []DashboardVariablesV2Inner) {
	o.VariablesV2 = v
}
