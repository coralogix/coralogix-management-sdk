...
type LineChartQueryOneOf3 struct {
	Dataprime *LineChartQueryOneOf3Dataprime `json:"dataprime,omitempty"`
}
...
func (o *LineChartQueryOneOf3) GetDataprime() LineChartQueryOneOf3Dataprime {
	if o == nil || IsNil(o.Dataprime) {
		var ret LineChartQueryOneOf3Dataprime
		return ret
	}
	return *o.Dataprime
}
...
func (o *LineChartQueryOneOf3) GetDataprimeOk() (*LineChartQueryOneOf3Dataprime, bool) {
	if o == nil || IsNil(o.Dataprime) {
		return nil, false
	}
...
// SetDataprime gets a reference to the given LineChartQueryOneOf3Dataprime and assigns it to the Dataprime field.
func (o *LineChartQueryOneOf3) SetDataprime(v LineChartQueryOneOf3Dataprime) {
	o.Dataprime = &v
}
