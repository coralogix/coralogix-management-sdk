...
type HorizontalBarChart struct {
	...
	YAxisViewBy *YAxisViewBy `json:"yAxisViewBy,omitempty"`
}
...
func (o *HorizontalBarChart) GetYAxisViewBy() YAxisViewBy {
...
// and a boolean to check if the value has been set.
func (o *HorizontalBarChart) GetYAxisViewByOk() (*YAxisViewBy, bool) {
	if o == nil || IsNil(o.YAxisViewBy) {
		return nil, false
	}
...
// SetYAxisViewBy gets a reference to the given YAxisViewBy and assigns it to the YAxisViewBy field.
func (o *HorizontalBarChart) SetYAxisViewBy(v YAxisViewBy) {
	o.YAxisViewBy = &v
}
