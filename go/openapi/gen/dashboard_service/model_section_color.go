...
type _SectionColor SectionColor
...
func (o *SectionColor) UnmarshalJSON(data []byte) (err error) {
	varSectionColor := _SectionColor{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varSectionColor)

	if err != nil {
		return err
	}

	*o = SectionColor(varSectionColor)
