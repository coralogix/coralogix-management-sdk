...
type LineChartQueryOneOf1 struct {
	Metrics *LineChartQueryOneOf1Metrics `json:"metrics,omitempty"`
}
...
func (o *LineChartQueryOneOf1) GetMetrics() LineChartQueryOneOf1Metrics {
	if o == nil || IsNil(o.Metrics) {
		var ret LineChartQueryOneOf1Metrics
		return ret
	}
	return *o.Metrics
}
...
func (o *LineChartQueryOneOf1) GetMetricsOk() (*LineChartQueryOneOf1Metrics, bool) {
	if o == nil || IsNil(o.Metrics) {
		return nil, false
	}
...
// SetMetrics gets a reference to the given LineChartQueryOneOf1Metrics and assigns it to the Metrics field.
func (o *LineChartQueryOneOf1) SetMetrics(v LineChartQueryOneOf1Metrics) {
	o.Metrics = &v
}
