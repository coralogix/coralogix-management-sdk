...
func (o *BarChart) GetBarValueDisplay() string {
...
func (o *BarChart) GetBarValueDisplayOk() (*string, bool) {
	if o == nil || IsNil(o.BarValueDisplay) {
		return nil, false
	}
...
func (o *BarChart) SetBarValueDisplay(v string) {
	o.BarValueDisplay = &v
}
...
func (o *BarChart) GetColorsBy() BarChartColorsBy {
...
// and a boolean to check if the value has been set.
func (o *BarChart) GetColorsByOk() (*BarChartColorsBy, bool) {
	if o == nil || IsNil(o.ColorsBy) {
		return nil, false
	}
...
func (o *BarChart) SetColorsBy(v BarChartColorsBy) {
	o.ColorsBy = &v
}
...
func (o *BarChart) GetDataModeType() string {
...
// and a boolean to check if the value has been set.
func (o *BarChart) GetDataModeTypeOk() (*string, bool) {
	if o == nil || IsNil(o.DataModeType) {
		return nil, false
	}
...
func (o *BarChart) SetDataModeType(v string) {
	o.DataModeType = &v
}
...
func (o *BarChart) GetLegend() LineChartLegend {
...
// and a boolean to check if the value has been set.
func (o *BarChart) GetLegendOk() (*LineChartLegend, bool) {
	if o == nil || IsNil(o.Legend) {
		return nil, false
	}
...
func (o *BarChart) SetLegend(v LineChartLegend) {
	o.Legend = &v
}
...
func (o *BarChart) GetQuery() WidgetDefinitionOneOf3PieChartQuery {
...
// and a boolean to check if the value has been set.
func (o *BarChart) GetQueryOk() (*WidgetDefinitionOneOf3PieChartQuery, bool) {
	if o == nil || IsNil(o.Query) {
		return nil, false
	}
	return o.Query, true
...
func (o *BarChart) SetQuery(v WidgetDefinitionOneOf3PieChartQuery) {
	o.Query = &v
}

// GetScaleType returns the ScaleType field value if set, zero value otherwise.
func (o *BarChart) GetScaleType() string {
...
// and a boolean to check if the value has been set.
func (o *BarChart) GetScaleTypeOk() (*string, bool) {
	if o == nil || IsNil(o.ScaleType) {
		return nil, false
	}
...
func (o *BarChart) SetScaleType(v string) {
	o.ScaleType = &v
}

// GetSortBy returns the SortBy field value if set, zero value otherwise.
func (o *BarChart) GetSortBy() string {
...
// and a boolean to check if the value has been set.
func (o *BarChart) GetSortByOk() (*string, bool) {
	if o == nil || IsNil(o.SortBy) {
		return nil, false
	}
...
func (o *BarChart) SetSortBy(v string) {
	o.SortBy = &v
}
...
func (o *BarChart) GetXAxis() BarChartXAxis {
	if o == nil || IsNil(o.XAxis) {
		var ret BarChartXAxis
		return ret
	}
	return *o.XAxis
}
...
// and a boolean to check if the value has been set.
func (o *BarChart) GetXAxisOk() (*BarChartXAxis, bool) {
	if o == nil || IsNil(o.XAxis) {
		return nil, false
	}
	return o.XAxis, true
...
// SetXAxis gets a reference to the given BarChartXAxis and assigns it to the XAxis field.
func (o *BarChart) SetXAxis(v BarChartXAxis) {
	o.XAxis = &v
}
