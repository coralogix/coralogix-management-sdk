...
type BarChart struct {
	BarValueDisplay *BarValueDisplay `json:"barValueDisplay,omitempty"`
...
func (o *BarChart) GetBarValueDisplay() BarValueDisplay {
	if o == nil || IsNil(o.BarValueDisplay) {
		var ret BarValueDisplay
		return ret
	}
...
func (o *BarChart) GetBarValueDisplayOk() (*BarValueDisplay, bool) {
	if o == nil || IsNil(o.BarValueDisplay) {
		return nil, false
	}
...
// SetBarValueDisplay gets a reference to the given BarValueDisplay and assigns it to the BarValueDisplay field.
func (o *BarChart) SetBarValueDisplay(v BarValueDisplay) {
	o.BarValueDisplay = &v
}
