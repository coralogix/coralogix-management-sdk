...
func (r ApiGlobalRoutersServiceValidateEntityLabelMatcherRequest) Execute() (*ValidateEntityLabelMatcherResponse, *http.Response, error) {
	return r.ApiService.GlobalRoutersServiceValidateEntityLabelMatcherExecute(r)
}
...
func (a *GlobalRoutersServiceAPIService) GlobalRoutersServiceValidateEntityLabelMatcherExecute(r ApiGlobalRoutersServiceValidateEntityLabelMatcherRequest) (*ValidateEntityLabelMatcherResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/notifications/notification-center/v1/routers/matcher/validate"
