...
func (o *ExternalUrl) UnmarshalJSON(data []byte) (err error) {
	varExternalUrl := _ExternalUrl{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varExternalUrl)

	if err != nil {
		return err
	}

	*o = ExternalUrl(varExternalUrl)
