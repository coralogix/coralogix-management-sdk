...
func (o *RegisteredInstance) GetArm() ARMStack {
...
func (o *RegisteredInstance) GetArmOk() (*ARMStack, bool) {
	if o == nil || IsNil(o.Arm) {
		return nil, false
	}
	return o.Arm, true
...
func (o *RegisteredInstance) HasArm() bool {
	if o != nil && !IsNil(o.Arm) {
		return true
	}
...
func (o *RegisteredInstance) SetArm(v ARMStack) {
	o.Arm = &v
}

// GetCloudformation returns the Cloudformation field value if set, zero value otherwise.
func (o *RegisteredInstance) GetCloudformation() CloudFormationStack {
...
// and a boolean to check if the value has been set.
func (o *RegisteredInstance) GetCloudformationOk() (*CloudFormationStack, bool) {
	if o == nil || IsNil(o.Cloudformation) {
		return nil, false
	}
...
func (o *RegisteredInstance) HasCloudformation() bool {
	if o != nil && !IsNil(o.Cloudformation) {
		return true
	}
...
func (o *RegisteredInstance) SetCloudformation(v CloudFormationStack) {
	o.Cloudformation = &v
}
...
func (o *RegisteredInstance) GetRevisionLifecycle() RevisionLifecycle {
...
// and a boolean to check if the value has been set.
func (o *RegisteredInstance) GetRevisionLifecycleOk() (*RevisionLifecycle, bool) {
	if o == nil || IsNil(o.RevisionLifecycle) {
		return nil, false
	}
...
func (o *RegisteredInstance) HasRevisionLifecycle() bool {
	if o != nil && !IsNil(o.RevisionLifecycle) {
		return true
	}
...
func (o *RegisteredInstance) SetRevisionLifecycle(v RevisionLifecycle) {
...
func (o *RegisteredInstance) UnmarshalJSON(data []byte) (err error) {
	varRegisteredInstance := _RegisteredInstance{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varRegisteredInstance)

	if err != nil {
		return err
	}

	*o = RegisteredInstance(varRegisteredInstance)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		optionalOneOfGroup0MatchesInPayload := 0
		if _, exists := additionalProperties["empty"]; exists {
		...
		if optionalOneOfGroup0MatchesInPayload > 1 {
			return GenericOpenAPIError{error: "at most one of [empty, cloudformation, arm] may be set"}
		}
