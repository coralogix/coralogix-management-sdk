...
func (o *RegisteredInstance) GetParameters() []DeployedIntegrationInformationParametersInner {
...
// and a boolean to check if the value has been set.
func (o *RegisteredInstance) GetParametersOk() ([]DeployedIntegrationInformationParametersInner, bool) {
	if o == nil || IsNil(o.Parameters) {
		return nil, false
	}
...
func (o *RegisteredInstance) SetParameters(v []DeployedIntegrationInformationParametersInner) {
	o.Parameters = v
}
