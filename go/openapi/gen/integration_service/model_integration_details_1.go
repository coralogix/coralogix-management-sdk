...
func (o *IntegrationDetails1) GetExtensions() []ExtensionMetadata {
	if o == nil || IsNil(o.Extensions) {
		var ret []ExtensionMetadata
		return ret
	}
	return o.Extensions
}
...
// and a boolean to check if the value has been set.
func (o *IntegrationDetails1) GetExtensionsOk() ([]ExtensionMetadata, bool) {
	if o == nil || IsNil(o.Extensions) {
		return nil, false
	}
...
// SetExtensions gets a reference to the given []ExtensionMetadata and assigns it to the Extensions field.
func (o *IntegrationDetails1) SetExtensions(v []ExtensionMetadata) {
	o.Extensions = v
}
