...
type IntegrationStatus struct {
	...
	Details []CloudFormationTemplateParametersInner `json:"details,omitempty"`
...
func NewIntegrationStatus(connectionStatus string) *IntegrationStatus {
...
func (o *IntegrationStatus) GetConnectionStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *IntegrationStatus) GetConnectionStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *IntegrationStatus) SetConnectionStatus(v string) {
	o.ConnectionStatus = v
}

// GetDetails returns the Details field value if set, zero value otherwise.
func (o *IntegrationStatus) GetDetails() []CloudFormationTemplateParametersInner {
...
// and a boolean to check if the value has been set.
func (o *IntegrationStatus) GetDetailsOk() ([]CloudFormationTemplateParametersInner, bool) {
	if o == nil || IsNil(o.Details) {
		return nil, false
	}
...
// SetDetails gets a reference to the given []CloudFormationTemplateParametersInner and assigns it to the Details field.
func (o *IntegrationStatus) SetDetails(v []CloudFormationTemplateParametersInner) {
	o.Details = v
}
