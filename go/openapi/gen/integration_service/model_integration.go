...
func (o *Integration) GetIntegrationType() IntegrationIntegrationType {
...
// and a boolean to check if the value has been set.
func (o *Integration) GetIntegrationTypeOk() (*IntegrationIntegrationType, bool) {
	if o == nil || IsNil(o.IntegrationType) {
		return nil, false
	}
...
func (o *Integration) SetIntegrationType(v IntegrationIntegrationType) {
	o.IntegrationType = &v
}
