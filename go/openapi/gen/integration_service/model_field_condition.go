...
func NewFieldCondition(type_ string) *FieldCondition {
	this := FieldCondition{}
	this.Type = type_
	return &this
}
...
func (o *FieldCondition) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *FieldCondition) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *FieldCondition) SetType(v string) {
	o.Type = v
}

// GetValues returns the Values field value if set, zero value otherwise.
func (o *FieldCondition) GetValues() []FieldValue {
...
// and a boolean to check if the value has been set.
func (o *FieldCondition) GetValuesOk() ([]FieldValue, bool) {
	if o == nil || IsNil(o.Values) {
		return nil, false
	}
...
// SetValues gets a reference to the given []FieldValue and assigns it to the Values field.
func (o *FieldCondition) SetValues(v []FieldValue) {
	o.Values = v
}
