...
type DefaultIntegrationDetails struct {
	Registered []DefaultIntegrationDetailsRegisteredInner `json:"registered,omitempty"`
}
...
func (o *DefaultIntegrationDetails) GetRegistered() []DefaultIntegrationDetailsRegisteredInner {
	if o == nil || IsNil(o.Registered) {
		var ret []DefaultIntegrationDetailsRegisteredInner
		return ret
	}
	return o.Registered
}
...
func (o *DefaultIntegrationDetails) GetRegisteredOk() ([]DefaultIntegrationDetailsRegisteredInner, bool) {
	if o == nil || IsNil(o.Registered) {
		return nil, false
	}
...
// SetRegistered gets a reference to the given []DefaultIntegrationDetailsRegisteredInner and assigns it to the Registered field.
func (o *DefaultIntegrationDetails) SetRegistered(v []DefaultIntegrationDetailsRegisteredInner) {
	o.Registered = v
}
