...
type IntegrationDefinition struct {
	...
	Revisions []IntegrationDefinitionRevisionsInner `json:"revisions,omitempty"`
}
...
func (o *IntegrationDefinition) GetIntegrationType() IntegrationIntegrationType {
	if o == nil || IsNil(o.IntegrationType) {
		var ret IntegrationIntegrationType
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *IntegrationDefinition) GetIntegrationTypeOk() (*IntegrationIntegrationType, bool) {
	if o == nil || IsNil(o.IntegrationType) {
		return nil, false
	}
...
// SetIntegrationType gets a reference to the given IntegrationIntegrationType and assigns it to the IntegrationType field.
func (o *IntegrationDefinition) SetIntegrationType(v IntegrationIntegrationType) {
	o.IntegrationType = &v
}
...
func (o *IntegrationDefinition) GetRevisions() []IntegrationDefinitionRevisionsInner {
	if o == nil || IsNil(o.Revisions) {
		var ret []IntegrationDefinitionRevisionsInner
		return ret
	}
	return o.Revisions
}
...
// and a boolean to check if the value has been set.
func (o *IntegrationDefinition) GetRevisionsOk() ([]IntegrationDefinitionRevisionsInner, bool) {
	if o == nil || IsNil(o.Revisions) {
		return nil, false
	}
...
// SetRevisions gets a reference to the given []IntegrationDefinitionRevisionsInner and assigns it to the Revisions field.
func (o *IntegrationDefinition) SetRevisions(v []IntegrationDefinitionRevisionsInner) {
	o.Revisions = v
}
