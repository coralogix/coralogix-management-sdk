...
type ListIncidentEventsResponse struct {
	Items []ExtendedIncidentEvent `json:"items"`
...
func NewListIncidentEventsResponse(items []ExtendedIncidentEvent) *ListIncidentEventsResponse {
...
func (o *ListIncidentEventsResponse) GetItems() []ExtendedIncidentEvent {
	if o == nil {
		var ret []ExtendedIncidentEvent
		return ret
	}
...
func (o *ListIncidentEventsResponse) GetItemsOk() ([]ExtendedIncidentEvent, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *ListIncidentEventsResponse) SetItems(v []ExtendedIncidentEvent) {
	o.Items = v
}

// GetPagination returns the Pagination field value if set, zero value otherwise.
func (o *ListIncidentEventsResponse) GetPagination() PaginationResponse {
...
// and a boolean to check if the value has been set.
func (o *ListIncidentEventsResponse) GetPaginationOk() (*PaginationResponse, bool) {
	if o == nil || IsNil(o.Pagination) {
		return nil, false
	}
...
func (o *ListIncidentEventsResponse) SetPagination(v PaginationResponse) {
	o.Pagination = &v
}
