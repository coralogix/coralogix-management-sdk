...
// IncidentEventAcknowledge Incident event acknowledge.
...
type _IncidentEventAcknowledge IncidentEventAcknowledge
...
func (o *IncidentEventAcknowledge) UnmarshalJSON(data []byte) (err error) {
	varIncidentEventAcknowledge := _IncidentEventAcknowledge{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varIncidentEventAcknowledge)

	if err != nil {
		return err
	}

	*o = IncidentEventAcknowledge(varIncidentEventAcknowledge)
