...
type IncidentAggregation struct {
	...
	GroupBysValue []IncidentAggregationGroupBysValueInner `json:"groupBysValue"`
...
func NewIncidentAggregation(aggAssignmentsCount []IncidentAssignmentCount, aggMetaLabelsCount []IncidentMetaLabelsCount, aggSeverityCount []IncidentSeverityCount, aggStateCount []IncidentStateCount, aggStatusCount []IncidentStatusCount, allValuesCount int64, firstCreatedAt time.Time, groupBysValue []IncidentAggregationGroupBysValueInner, lastClosedAt time.Time, lastStateUpdateTime time.Time, listIncidentsId []string) *IncidentAggregation {
...
func (o *IncidentAggregation) GetGroupBysValue() []IncidentAggregationGroupBysValueInner {
	if o == nil {
		var ret []IncidentAggregationGroupBysValueInner
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *IncidentAggregation) GetGroupBysValueOk() ([]IncidentAggregationGroupBysValueInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *IncidentAggregation) SetGroupBysValue(v []IncidentAggregationGroupBysValueInner) {
	o.GroupBysValue = v
}
