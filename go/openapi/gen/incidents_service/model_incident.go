...
type Incident struct {
	...
	ContextualLabels []IncidentContextualLabelsInner `json:"contextualLabels"`
	CreatedAt time.Time `json:"createdAt"`
	Description *string `json:"description,omitempty"`
	DisplayLabels []IncidentContextualLabelsInner `json:"displayLabels"`
	Duration string `json:"duration"`
	Events []IncidentEventsInner `json:"events"`
	Id string `json:"id"`
...
func NewIncident(assignments []Assignment, contextualLabels []IncidentContextualLabelsInner, createdAt time.Time, displayLabels []IncidentContextualLabelsInner, duration string, events []IncidentEventsInner, id string, lastStateUpdateKey string, lastStateUpdateTime time.Time, severity string, state string, status string) *Incident {
	this := Incident{}
...
func (o *Incident) GetContextualLabels() []IncidentContextualLabelsInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *Incident) GetContextualLabelsOk() ([]IncidentContextualLabelsInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Incident) SetContextualLabels(v []IncidentContextualLabelsInner) {
...
func (o *Incident) GetDisplayLabels() []IncidentContextualLabelsInner {
	if o == nil {
		var ret []IncidentContextualLabelsInner
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Incident) GetDisplayLabelsOk() ([]IncidentContextualLabelsInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Incident) SetDisplayLabels(v []IncidentContextualLabelsInner) {
	o.DisplayLabels = v
}
...
func (o *Incident) GetEvents() []IncidentEventsInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *Incident) GetEventsOk() ([]IncidentEventsInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Incident) SetEvents(v []IncidentEventsInner) {
	o.Events = v
}
...
func (o *Incident) GetMetaLabels() []IncidentMetaLabel {
...
// and a boolean to check if the value has been set.
func (o *Incident) GetMetaLabelsOk() ([]IncidentMetaLabel, bool) {
	if o == nil || IsNil(o.MetaLabels) {
		return nil, false
	}
...
func (o *Incident) SetMetaLabels(v []IncidentMetaLabel) {
	o.MetaLabels = v
}
