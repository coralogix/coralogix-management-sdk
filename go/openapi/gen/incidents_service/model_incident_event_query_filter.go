...
type IncidentEventQueryFilter struct {
	...
	Labels *LabelFilterConfiguration `json:"labels,omitempty"`
...
func (o *IncidentEventQueryFilter) GetContextualLabels() []IncidentQueryFilterContextualLabelsInner {
...
func (o *IncidentEventQueryFilter) GetContextualLabelsOk() ([]IncidentQueryFilterContextualLabelsInner, bool) {
	if o == nil || IsNil(o.ContextualLabels) {
		return nil, false
	}
...
func (o *IncidentEventQueryFilter) SetContextualLabels(v []IncidentQueryFilterContextualLabelsInner) {
	o.ContextualLabels = v
}

// GetDisplayLabels returns the DisplayLabels field value if set, zero value otherwise.
func (o *IncidentEventQueryFilter) GetDisplayLabels() []IncidentQueryFilterDisplayLabelsInner {
...
// and a boolean to check if the value has been set.
func (o *IncidentEventQueryFilter) GetDisplayLabelsOk() ([]IncidentQueryFilterDisplayLabelsInner, bool) {
	if o == nil || IsNil(o.DisplayLabels) {
		return nil, false
	}
...
func (o *IncidentEventQueryFilter) SetDisplayLabels(v []IncidentQueryFilterDisplayLabelsInner) {
	o.DisplayLabels = v
}
...
func (o *IncidentEventQueryFilter) GetLabels() LabelFilterConfiguration {
	if o == nil || IsNil(o.Labels) {
		var ret LabelFilterConfiguration
		return ret
	}
	return *o.Labels
}
...
// and a boolean to check if the value has been set.
func (o *IncidentEventQueryFilter) GetLabelsOk() (*LabelFilterConfiguration, bool) {
	if o == nil || IsNil(o.Labels) {
		return nil, false
	}
...
// SetLabels gets a reference to the given LabelFilterConfiguration and assigns it to the Labels field.
func (o *IncidentEventQueryFilter) SetLabels(v LabelFilterConfiguration) {
	o.Labels = &v
}
