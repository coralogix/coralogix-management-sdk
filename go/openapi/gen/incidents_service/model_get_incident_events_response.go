...
type GetIncidentEventsResponse struct {
	IncidentEvents []IncidentEventsInner `json:"incidentEvents,omitempty"`
}
...
func (o *GetIncidentEventsResponse) GetIncidentEvents() []IncidentEventsInner {
...
func (o *GetIncidentEventsResponse) GetIncidentEventsOk() ([]IncidentEventsInner, bool) {
	if o == nil || IsNil(o.IncidentEvents) {
		return nil, false
	}
...
// SetIncidentEvents gets a reference to the given []IncidentEventsInner and assigns it to the IncidentEvents field.
func (o *GetIncidentEventsResponse) SetIncidentEvents(v []IncidentEventsInner) {
	o.IncidentEvents = v
}
