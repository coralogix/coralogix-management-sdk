...
func (a *IncidentsServiceAPIService) IncidentsServiceAcknowledgeIncidentByEventIdExecute(r ApiIncidentsServiceAcknowledgeIncidentByEventIdRequest) (*AcknowledgeIncidentByEventIdResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/by:event/incidents:acknowledge/{event_id}"
...
func (r ApiIncidentsServiceBatchGetIncidentRequest) Execute() (*BatchGetIncidentsResponse, *http.Response, error) {
...
// Execute executes the request
//  @return BatchGetIncidentsResponse
func (a *IncidentsServiceAPIService) IncidentsServiceBatchGetIncidentExecute(r ApiIncidentsServiceBatchGetIncidentRequest) (*BatchGetIncidentsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *BatchGetIncidentsResponse
	)
...
/*
IncidentsServiceGetIncidentByEventId Get incident by ID
...
func (a *IncidentsServiceAPIService) IncidentsServiceGetIncidentByEventIdExecute(r ApiIncidentsServiceGetIncidentByEventIdRequest) (*GetIncidentByEventIdResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/incidents/by:event/{event_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"event_id"+"}", url.PathEscape(parameterValueToString(r.eventId, "eventId")), -1)
...
func (r ApiIncidentsServiceResolveIncidentByEventIdRequest) Execute() (*AcknowledgeIncidentByEventIdResponse1, *http.Response, error) {
...
// Execute executes the request
//  @return AcknowledgeIncidentByEventIdResponse1
func (a *IncidentsServiceAPIService) IncidentsServiceResolveIncidentByEventIdExecute(r ApiIncidentsServiceResolveIncidentByEventIdRequest) (*AcknowledgeIncidentByEventIdResponse1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AcknowledgeIncidentByEventIdResponse1
	)
	...
	localVarPath := localBasePath + "/v1/by:event/incidents:resolve/{event_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"event_id"+"}", url.PathEscape(parameterValueToString(r.eventId, "eventId")), -1)
