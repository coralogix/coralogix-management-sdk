...
// PaginationResponse Pagination information for list responses
...
func NewPaginationResponse(totalSize int64) *PaginationResponse {
...
func (o *PaginationResponse) GetTotalSize() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PaginationResponse) GetTotalSizeOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PaginationResponse) SetTotalSize(v int64) {
	o.TotalSize = v
}
