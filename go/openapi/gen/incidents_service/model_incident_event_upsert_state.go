...
type IncidentEventUpsertState struct {
	...
	Payload IncidentEventUpsertStatePayload `json:"payload"`
...
func NewIncidentEventUpsertState(payload IncidentEventUpsertStatePayload, stateType string) *IncidentEventUpsertState {
...
func (o *IncidentEventUpsertState) GetPayload() IncidentEventUpsertStatePayload {
	if o == nil {
		var ret IncidentEventUpsertStatePayload
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *IncidentEventUpsertState) GetPayloadOk() (*IncidentEventUpsertStatePayload, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *IncidentEventUpsertState) SetPayload(v IncidentEventUpsertStatePayload) {
	o.Payload = v
}

// GetStateType returns the StateType field value
func (o *IncidentEventUpsertState) GetStateType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *IncidentEventUpsertState) GetStateTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *IncidentEventUpsertState) SetStateType(v string) {
	o.StateType = v
}
