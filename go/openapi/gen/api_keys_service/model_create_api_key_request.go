...
type CreateApiKeyRequest struct {
	...
	KeyPermissions KeyPermissions `json:"keyPermissions"`
...
func NewCreateApiKeyRequest(hashed bool, keyPermissions KeyPermissions, name string, owner CreateApiKeyRequestOwner) *CreateApiKeyRequest {
...
func (o *CreateApiKeyRequest) GetKeyPermissions() KeyPermissions {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *CreateApiKeyRequest) GetKeyPermissionsOk() (*KeyPermissions, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateApiKeyRequest) SetKeyPermissions(v KeyPermissions) {
	o.KeyPermissions = v
}
...
func (o *CreateApiKeyRequest) GetOwner() CreateApiKeyRequestOwner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *CreateApiKeyRequest) GetOwnerOk() (*CreateApiKeyRequestOwner, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Owner, true
...
func (o *CreateApiKeyRequest) SetOwner(v CreateApiKeyRequestOwner) {
	o.Owner = v
}
