...
type KeyInfo struct {
	...
	Id string `json:"id"`
	KeyPermissions KeyPermissions1 `json:"keyPermissions"`
	Name string `json:"name"`
	Owner CreateApiKeyRequestOwner `json:"owner"`
...
func NewKeyInfo(active bool, hashed bool, id string, keyPermissions KeyPermissions1, name string, owner CreateApiKeyRequestOwner) *KeyInfo {
	this := KeyInfo{}
	this.Active = active
	this.Hashed = hashed
	this.Id = id
...
func (o *KeyInfo) GetKeyPermissions() KeyPermissions1 {
	if o == nil {
		var ret KeyPermissions1
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *KeyInfo) GetKeyPermissionsOk() (*KeyPermissions1, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *KeyInfo) SetKeyPermissions(v KeyPermissions1) {
	o.KeyPermissions = v
}
...
func (o *KeyInfo) GetOwner() CreateApiKeyRequestOwner {
	if o == nil {
		var ret CreateApiKeyRequestOwner
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *KeyInfo) GetOwnerOk() (*CreateApiKeyRequestOwner, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Owner, true
...
func (o *KeyInfo) SetOwner(v CreateApiKeyRequestOwner) {
	o.Owner = v
}
