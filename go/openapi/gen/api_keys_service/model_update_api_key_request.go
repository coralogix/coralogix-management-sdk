...
func (o *UpdateApiKeyRequest) GetPermissions() Permissions {
...
// and a boolean to check if the value has been set.
func (o *UpdateApiKeyRequest) GetPermissionsOk() (*Permissions, bool) {
	if o == nil || IsNil(o.Permissions) {
		return nil, false
	}
...
func (o *UpdateApiKeyRequest) SetPermissions(v Permissions) {
	o.Permissions = &v
}
