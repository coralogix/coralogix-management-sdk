...
type BatchGetSlosResponse struct {
	...
	Slos []ListSlosResponseSlosInner `json:"slos"`
}
...
func NewBatchGetSlosResponse(slos []ListSlosResponseSlosInner) *BatchGetSlosResponse {
...
func (o *BatchGetSlosResponse) GetSlos() []ListSlosResponseSlosInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *BatchGetSlosResponse) GetSlosOk() ([]ListSlosResponseSlosInner, bool) {
	if o == nil {
		return nil, false
	}
	return o.Slos, true
...
func (o *BatchGetSlosResponse) SetSlos(v []ListSlosResponseSlosInner) {
	o.Slos = v
}
