...
type ResponseStatus struct {
	Details []SloLabelsInner `json:"details,omitempty"`
...
func NewResponseStatus(statusCode string) *ResponseStatus {
	this := ResponseStatus{}
...
func (o *ResponseStatus) GetDetails() []SloLabelsInner {
...
func (o *ResponseStatus) GetDetailsOk() ([]SloLabelsInner, bool) {
	if o == nil || IsNil(o.Details) {
		return nil, false
	}
...
// SetDetails gets a reference to the given []SloLabelsInner and assigns it to the Details field.
func (o *ResponseStatus) SetDetails(v []SloLabelsInner) {
	o.Details = v
}
...
func (o *ResponseStatus) GetStatusCode() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ResponseStatus) GetStatusCodeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ResponseStatus) SetStatusCode(v string) {
	o.StatusCode = v
}
