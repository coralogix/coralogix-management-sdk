...
func NewWindowBasedMetricSli(comparisonOperator string, query Metric, threshold float32, window string) *WindowBasedMetricSli {
...
func (o *WindowBasedMetricSli) GetComparisonOperator() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *WindowBasedMetricSli) GetComparisonOperatorOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *WindowBasedMetricSli) GetMissingDataStrategyOk() (*string, bool) {
	if o == nil || IsNil(o.MissingDataStrategy) {
		return nil, false
	}
...
func (o *WindowBasedMetricSli) SetMissingDataStrategy(v string) {
...
func (o *WindowBasedMetricSli) GetWindow() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WindowBasedMetricSli) GetWindowOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WindowBasedMetricSli) SetWindow(v string) {
	o.Window = v
}
