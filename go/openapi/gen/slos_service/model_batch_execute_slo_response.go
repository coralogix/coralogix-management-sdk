...
type BatchExecuteSloResponse struct {
	MatchingResponses []BatchExecuteSloResponseMatchingResponsesInner `json:"matchingResponses"`
...
func NewBatchExecuteSloResponse(matchingResponses []BatchExecuteSloResponseMatchingResponsesInner) *BatchExecuteSloResponse {
...
func (o *BatchExecuteSloResponse) GetMatchingResponses() []BatchExecuteSloResponseMatchingResponsesInner {
	if o == nil {
		var ret []BatchExecuteSloResponseMatchingResponsesInner
		return ret
	}
...
func (o *BatchExecuteSloResponse) GetMatchingResponsesOk() ([]BatchExecuteSloResponseMatchingResponsesInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BatchExecuteSloResponse) SetMatchingResponses(v []BatchExecuteSloResponseMatchingResponsesInner) {
