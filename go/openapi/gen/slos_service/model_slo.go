...
func (o *Slo) GetGrouping() Grouping {
...
// and a boolean to check if the value has been set.
func (o *Slo) GetGroupingOk() (*Grouping, bool) {
	if o == nil || IsNil(o.Grouping) {
		return nil, false
	}
...
func (o *Slo) SetGrouping(v Grouping) {
	o.Grouping = &v
}
...
func (o *Slo) GetLabels() []SloLabelsInner {
...
// and a boolean to check if the value has been set.
func (o *Slo) GetLabelsOk() ([]SloLabelsInner, bool) {
	if o == nil || IsNil(o.Labels) {
		return nil, false
	}
...
func (o *Slo) SetLabels(v []SloLabelsInner) {
	o.Labels = v
}
...
func (o *Slo) GetRevision() Revision {
...
// and a boolean to check if the value has been set.
func (o *Slo) GetRevisionOk() (*Revision, bool) {
	if o == nil || IsNil(o.Revision) {
		return nil, false
	}
...
func (o *Slo) SetRevision(v Revision) {
	o.Revision = &v
}
