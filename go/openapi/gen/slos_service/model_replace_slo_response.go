...
func NewReplaceSloResponse(slo ListSlosResponseSlosInner) *ReplaceSloResponse {
...
func (o *ReplaceSloResponse) GetSlo() ListSlosResponseSlosInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ReplaceSloResponse) GetSloOk() (*ListSlosResponseSlosInner, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Slo, true
...
func (o *ReplaceSloResponse) SetSlo(v ListSlosResponseSlosInner) {
	o.Slo = v
}
