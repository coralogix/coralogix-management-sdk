...
func NewLogsThresholdCondition(conditionType string, threshold float64, timeWindow LogBasedAlertTimeWindow) *LogsThresholdCondition {
...
func (o *LogsThresholdCondition) GetConditionType() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *LogsThresholdCondition) GetConditionTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LogsThresholdCondition) SetConditionType(v string) {
	o.ConditionType = v
}
...
func (o *LogsThresholdCondition) GetTimeWindow() LogBasedAlertTimeWindow {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *LogsThresholdCondition) GetTimeWindowOk() (*LogBasedAlertTimeWindow, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LogsThresholdCondition) SetTimeWindow(v LogBasedAlertTimeWindow) {
	o.TimeWindow = v
}
