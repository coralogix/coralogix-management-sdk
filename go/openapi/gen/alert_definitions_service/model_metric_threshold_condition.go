...
func NewMetricThresholdCondition(conditionType string, forOverPct int64, ofTheLast MetricThresholdConditionOfTheLast, threshold float64) *MetricThresholdCondition {
...
func (o *MetricThresholdCondition) GetConditionType() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *MetricThresholdCondition) GetConditionTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MetricThresholdCondition) SetConditionType(v string) {
	o.ConditionType = v
}
...
func (o *MetricThresholdCondition) GetOfTheLast() MetricThresholdConditionOfTheLast {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *MetricThresholdCondition) GetOfTheLastOk() (*MetricThresholdConditionOfTheLast, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MetricThresholdCondition) SetOfTheLast(v MetricThresholdConditionOfTheLast) {
	o.OfTheLast = v
}
