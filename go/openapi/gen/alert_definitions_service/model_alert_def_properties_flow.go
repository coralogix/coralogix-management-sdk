...
func (o *AlertDefPropertiesFlow) GetDataSources() []AlertDefDataSource {
...
// and a boolean to check if the value has been set.
func (o *AlertDefPropertiesFlow) GetDataSourcesOk() ([]AlertDefDataSource, bool) {
	if o == nil || IsNil(o.DataSources) {
		return nil, false
	}
...
func (o *AlertDefPropertiesFlow) HasDataSources() bool {
	if o != nil && !IsNil(o.DataSources) {
		return true
	}
...
func (o *AlertDefPropertiesFlow) SetDataSources(v []AlertDefDataSource) {
	o.DataSources = v
}
