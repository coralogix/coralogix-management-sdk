...
type FlowStages struct {
	FlowStagesGroups *FlowStageGroups `json:"flowStagesGroups,omitempty"`
...
func NewFlowStages(timeframeMs string, timeframeType string) *FlowStages {
	this := FlowStages{}
...
func (o *FlowStages) GetFlowStagesGroups() FlowStageGroups {
	if o == nil || IsNil(o.FlowStagesGroups) {
		var ret FlowStageGroups
		return ret
	}
...
func (o *FlowStages) GetFlowStagesGroupsOk() (*FlowStageGroups, bool) {
	if o == nil || IsNil(o.FlowStagesGroups) {
		return nil, false
	}
...
// SetFlowStagesGroups gets a reference to the given FlowStageGroups and assigns it to the FlowStagesGroups field.
func (o *FlowStages) SetFlowStagesGroups(v FlowStageGroups) {
...
func (o *FlowStages) GetTimeframeType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FlowStages) GetTimeframeTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FlowStages) SetTimeframeType(v string) {
	o.TimeframeType = v
}
