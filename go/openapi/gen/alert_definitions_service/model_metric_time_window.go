...
type MetricTimeWindow struct {
	MetricTimeWindowSpecificValue *string `json:"metricTimeWindowSpecificValue,omitempty"`
}
...
func (o *MetricTimeWindow) GetMetricTimeWindowSpecificValue() string {
...
func (o *MetricTimeWindow) GetMetricTimeWindowSpecificValueOk() (*string, bool) {
	if o == nil || IsNil(o.MetricTimeWindowSpecificValue) {
		return nil, false
	}
...
// SetMetricTimeWindowSpecificValue gets a reference to the given string and assigns it to the MetricTimeWindowSpecificValue field.
func (o *MetricTimeWindow) SetMetricTimeWindowSpecificValue(v string) {
