...
func NewTracingFilterType(operation string, values []string) *TracingFilterType {
...
func (o *TracingFilterType) GetOperation() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *TracingFilterType) GetOperationOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TracingFilterType) SetOperation(v string) {
	o.Operation = v
}
