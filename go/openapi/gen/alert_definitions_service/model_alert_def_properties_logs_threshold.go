...
func (o *AlertDefPropertiesLogsThreshold) GetDataSources() []AlertDefDataSource {
...
// and a boolean to check if the value has been set.
func (o *AlertDefPropertiesLogsThreshold) GetDataSourcesOk() ([]AlertDefDataSource, bool) {
	if o == nil || IsNil(o.DataSources) {
		return nil, false
	}
...
func (o *AlertDefPropertiesLogsThreshold) HasDataSources() bool {
	if o != nil && !IsNil(o.DataSources) {
		return true
	}
...
func (o *AlertDefPropertiesLogsThreshold) SetDataSources(v []AlertDefDataSource) {
	o.DataSources = v
}
...
func (o *AlertDefPropertiesLogsThreshold) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *AlertDefPropertiesLogsThreshold) HasPriority() bool {
	if o != nil && !IsNil(o.Priority) {
		return true
	}
...
func (o *AlertDefPropertiesLogsThreshold) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
