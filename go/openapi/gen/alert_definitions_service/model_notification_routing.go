...
func (o *NotificationRouting) GetConfigOverrides() SourceOverrides {
	if o == nil || IsNil(o.ConfigOverrides) {
		var ret SourceOverrides
		return ret
	}
...
func (o *NotificationRouting) GetConfigOverridesOk() (*SourceOverrides, bool) {
	if o == nil || IsNil(o.ConfigOverrides) {
		return nil, false
	}
...
// SetConfigOverrides gets a reference to the given SourceOverrides and assigns it to the ConfigOverrides field.
func (o *NotificationRouting) SetConfigOverrides(v SourceOverrides) {
	o.ConfigOverrides = &v
}
