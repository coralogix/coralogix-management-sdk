...
func (o *AlertDefPropertiesLogsRatioThreshold) GetDataSources() []AlertDefDataSource {
...
// and a boolean to check if the value has been set.
func (o *AlertDefPropertiesLogsRatioThreshold) GetDataSourcesOk() ([]AlertDefDataSource, bool) {
	if o == nil || IsNil(o.DataSources) {
		return nil, false
	}
...
func (o *AlertDefPropertiesLogsRatioThreshold) HasDataSources() bool {
	if o != nil && !IsNil(o.DataSources) {
		return true
	}
...
func (o *AlertDefPropertiesLogsRatioThreshold) SetDataSources(v []AlertDefDataSource) {
	o.DataSources = v
}
