...
func (o *AlertDefPropertiesLogsAnomaly) GetDataSources() []AlertDefDataSource {
...
// and a boolean to check if the value has been set.
func (o *AlertDefPropertiesLogsAnomaly) GetDataSourcesOk() ([]AlertDefDataSource, bool) {
	if o == nil || IsNil(o.DataSources) {
		return nil, false
	}
...
func (o *AlertDefPropertiesLogsAnomaly) HasDataSources() bool {
	if o != nil && !IsNil(o.DataSources) {
		return true
	}
...
func (o *AlertDefPropertiesLogsAnomaly) SetDataSources(v []AlertDefDataSource) {
	o.DataSources = v
}
