...
func (o *AlertDefPropertiesLogsNewValue) GetDataSources() []AlertDefDataSource {
...
// and a boolean to check if the value has been set.
func (o *AlertDefPropertiesLogsNewValue) GetDataSourcesOk() ([]AlertDefDataSource, bool) {
	if o == nil || IsNil(o.DataSources) {
		return nil, false
	}
...
func (o *AlertDefPropertiesLogsNewValue) HasDataSources() bool {
	if o != nil && !IsNil(o.DataSources) {
		return true
	}
...
func (o *AlertDefPropertiesLogsNewValue) SetDataSources(v []AlertDefDataSource) {
	o.DataSources = v
}
