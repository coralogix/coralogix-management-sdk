...
func NewLogsThresholdRule(condition LogsThresholdCondition, override AlertDefinitionPriorityUpdate) *LogsThresholdRule {
...
func (o *LogsThresholdRule) GetOverride() AlertDefinitionPriorityUpdate {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *LogsThresholdRule) GetOverrideOk() (*AlertDefinitionPriorityUpdate, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LogsThresholdRule) SetOverride(v AlertDefinitionPriorityUpdate) {
	o.Override = v
}
