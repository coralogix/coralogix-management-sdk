...
type LogsUniqueCountCondition struct {
	...
	TimeWindow LogBasedUniqueValueAlertTimeWindow `json:"timeWindow"`
}
...
func NewLogsUniqueCountCondition(maxUniqueCount string, timeWindow LogBasedUniqueValueAlertTimeWindow) *LogsUniqueCountCondition {
...
func (o *LogsUniqueCountCondition) GetTimeWindow() LogBasedUniqueValueAlertTimeWindow {
	if o == nil {
		var ret LogBasedUniqueValueAlertTimeWindow
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LogsUniqueCountCondition) GetTimeWindowOk() (*LogBasedUniqueValueAlertTimeWindow, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LogsUniqueCountCondition) SetTimeWindow(v LogBasedUniqueValueAlertTimeWindow) {
	o.TimeWindow = v
}
