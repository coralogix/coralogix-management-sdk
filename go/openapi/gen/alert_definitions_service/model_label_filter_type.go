...
func NewLabelFilterType(operation string, value string) *LabelFilterType {
...
func (o *LabelFilterType) GetOperation() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *LabelFilterType) GetOperationOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LabelFilterType) SetOperation(v string) {
	o.Operation = v
}
