...
func (r ApiEnrichmentServiceAtomicOverwriteAllEnrichmentsRequest) EnrichmentServiceAtomicOverwriteAllEnrichmentsRequest(enrichmentServiceAtomicOverwriteAllEnrichmentsRequest EnrichmentServiceAtomicOverwriteAllEnrichmentsRequest) ApiEnrichmentServiceAtomicOverwriteAllEnrichmentsRequest {
	r.enrichmentServiceAtomicOverwriteAllEnrichmentsRequest = &enrichmentServiceAtomicOverwriteAllEnrichmentsRequest
	return r
}

func (r ApiEnrichmentServiceAtomicOverwriteAllEnrichmentsRequest) Execute() (*AtomicOverwriteAllEnrichmentsResponse, *http.Response, error) {
	return r.ApiService.EnrichmentServiceAtomicOverwriteAllEnrichmentsExecute(r)
}
...
func (a *EnrichmentsServiceAPIService) EnrichmentServiceAtomicOverwriteAllEnrichmentsExecute(r ApiEnrichmentServiceAtomicOverwriteAllEnrichmentsRequest) (*AtomicOverwriteAllEnrichmentsResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/enrichment-rules/enrichment-rules/v1/all"
	...
	// body params
	localVarPostBody = r.enrichmentServiceAtomicOverwriteAllEnrichmentsRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
