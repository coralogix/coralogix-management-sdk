...
func NewEnrichment(enrichmentType EnrichmentEnrichmentType, fieldName string, id int64) *Enrichment {
	this := Enrichment{}
...
func (o *Enrichment) GetEnrichmentType() EnrichmentEnrichmentType {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *Enrichment) GetEnrichmentTypeOk() (*EnrichmentEnrichmentType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Enrichment) SetEnrichmentType(v EnrichmentEnrichmentType) {
	o.EnrichmentType = v
}
