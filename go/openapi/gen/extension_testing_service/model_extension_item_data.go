...
func NewExtensionItemData(data map[string]interface{}, name string, targetDomain string) *ExtensionItemData {
...
func (o *ExtensionItemData) GetPermissionResource() string {
...
// and a boolean to check if the value has been set.
func (o *ExtensionItemData) GetPermissionResourceOk() (*string, bool) {
	if o == nil || IsNil(o.PermissionResource) {
		return nil, false
	}
...
func (o *ExtensionItemData) SetPermissionResource(v string) {
...
func (o *ExtensionItemData) GetTargetDomain() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ExtensionItemData) GetTargetDomainOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ExtensionItemData) SetTargetDomain(v string) {
	o.TargetDomain = v
}
