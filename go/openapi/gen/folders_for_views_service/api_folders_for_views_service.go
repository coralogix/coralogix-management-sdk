...
func (r ApiViewsFoldersServiceListViewFoldersRequest) Execute() (*ViewsFoldersServiceListViewFolders200Response, *http.Response, error) {
...
// Execute executes the request
//  @return ViewsFoldersServiceListViewFolders200Response
func (a *FoldersForViewsServiceAPIService) ViewsFoldersServiceListViewFoldersExecute(r ApiViewsFoldersServiceListViewFoldersRequest) (*ViewsFoldersServiceListViewFolders200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ViewsFoldersServiceListViewFolders200Response
	)
