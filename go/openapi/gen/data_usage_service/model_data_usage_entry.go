...
type DataUsageEntry struct {
	Dimensions []DataUsageEntryDimensionsInner `json:"dimensions,omitempty"`
...
func (o *DataUsageEntry) GetDimensions() []DataUsageEntryDimensionsInner {
	if o == nil || IsNil(o.Dimensions) {
		var ret []DataUsageEntryDimensionsInner
		return ret
	}
	return o.Dimensions
}
...
func (o *DataUsageEntry) GetDimensionsOk() ([]DataUsageEntryDimensionsInner, bool) {
	if o == nil || IsNil(o.Dimensions) {
		return nil, false
	}
...
// SetDimensions gets a reference to the given []DataUsageEntryDimensionsInner and assigns it to the Dimensions field.
func (o *DataUsageEntry) SetDimensions(v []DataUsageEntryDimensionsInner) {
	o.Dimensions = v
}
