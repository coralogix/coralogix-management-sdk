...
func (o *AddUsersToTeamGroup) GetUserIds() []UserUpdatesUserIdsInner {
...
// and a boolean to check if the value has been set.
func (o *AddUsersToTeamGroup) GetUserIdsOk() ([]UserUpdatesUserIdsInner, bool) {
	if o == nil || IsNil(o.UserIds) {
		return nil, false
	}
...
func (o *AddUsersToTeamGroup) SetUserIds(v []UserUpdatesUserIdsInner) {
	o.UserIds = v
}
