...
func (o *RoleUpdates) GetRoleIds() []GetTeamGroupsResponseGroupsInnerRolesInnerRoleId {
...
func (o *RoleUpdates) GetRoleIdsOk() ([]GetTeamGroupsResponseGroupsInnerRolesInnerRoleId, bool) {
	if o == nil || IsNil(o.RoleIds) {
		return nil, false
	}
...
func (o *RoleUpdates) SetRoleIds(v []GetTeamGroupsResponseGroupsInnerRolesInnerRoleId) {
	o.RoleIds = v
}
