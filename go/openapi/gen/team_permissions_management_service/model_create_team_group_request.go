...
type CreateTeamGroupRequest struct {
	...
	RoleIds []GetTeamGroupsResponseGroupsInnerRolesInnerRoleId `json:"roleIds,omitempty"`
	ScopeFilters *GetTeamGroupsResponseGroupsInnerScopeFilters `json:"scopeFilters,omitempty"`
	TeamId *GetTeamGroupsResponseGroupsInnerRolesInnerRoleId `json:"teamId,omitempty"`
	UserIds []UserUpdatesUserIdsInner `json:"userIds,omitempty"`
}
...
func (o *CreateTeamGroupRequest) GetGroupType() string {
...
// and a boolean to check if the value has been set.
func (o *CreateTeamGroupRequest) GetGroupTypeOk() (*string, bool) {
	if o == nil || IsNil(o.GroupType) {
		return nil, false
	}
...
func (o *CreateTeamGroupRequest) SetGroupType(v string) {
	o.GroupType = &v
}
...
func (o *CreateTeamGroupRequest) GetRoleIds() []GetTeamGroupsResponseGroupsInnerRolesInnerRoleId {
...
// and a boolean to check if the value has been set.
func (o *CreateTeamGroupRequest) GetRoleIdsOk() ([]GetTeamGroupsResponseGroupsInnerRolesInnerRoleId, bool) {
	if o == nil || IsNil(o.RoleIds) {
		return nil, false
	}
...
// SetRoleIds gets a reference to the given []GetTeamGroupsResponseGroupsInnerRolesInnerRoleId and assigns it to the RoleIds field.
func (o *CreateTeamGroupRequest) SetRoleIds(v []GetTeamGroupsResponseGroupsInnerRolesInnerRoleId) {
	o.RoleIds = v
}

// GetScopeFilters returns the ScopeFilters field value if set, zero value otherwise.
func (o *CreateTeamGroupRequest) GetScopeFilters() GetTeamGroupsResponseGroupsInnerScopeFilters {
...
// and a boolean to check if the value has been set.
func (o *CreateTeamGroupRequest) GetScopeFiltersOk() (*GetTeamGroupsResponseGroupsInnerScopeFilters, bool) {
	if o == nil || IsNil(o.ScopeFilters) {
		return nil, false
	}
...
// SetScopeFilters gets a reference to the given GetTeamGroupsResponseGroupsInnerScopeFilters and assigns it to the ScopeFilters field.
func (o *CreateTeamGroupRequest) SetScopeFilters(v GetTeamGroupsResponseGroupsInnerScopeFilters) {
	o.ScopeFilters = &v
}

// GetTeamId returns the TeamId field value if set, zero value otherwise.
func (o *CreateTeamGroupRequest) GetTeamId() GetTeamGroupsResponseGroupsInnerRolesInnerRoleId {
...
// and a boolean to check if the value has been set.
func (o *CreateTeamGroupRequest) GetTeamIdOk() (*GetTeamGroupsResponseGroupsInnerRolesInnerRoleId, bool) {
	if o == nil || IsNil(o.TeamId) {
		return nil, false
	}
...
func (o *CreateTeamGroupRequest) SetTeamId(v GetTeamGroupsResponseGroupsInnerRolesInnerRoleId) {
	o.TeamId = &v
}

// GetUserIds returns the UserIds field value if set, zero value otherwise.
func (o *CreateTeamGroupRequest) GetUserIds() []UserUpdatesUserIdsInner {
...
// and a boolean to check if the value has been set.
func (o *CreateTeamGroupRequest) GetUserIdsOk() ([]UserUpdatesUserIdsInner, bool) {
	if o == nil || IsNil(o.UserIds) {
		return nil, false
	}
...
// SetUserIds gets a reference to the given []UserUpdatesUserIdsInner and assigns it to the UserIds field.
func (o *CreateTeamGroupRequest) SetUserIds(v []UserUpdatesUserIdsInner) {
	o.UserIds = v
}
