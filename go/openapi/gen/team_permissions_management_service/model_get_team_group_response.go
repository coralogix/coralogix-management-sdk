...
func (o *GetTeamGroupResponse) GetGroup() GetTeamGroupsResponseGroupsInner {
...
func (o *GetTeamGroupResponse) GetGroupOk() (*GetTeamGroupsResponseGroupsInner, bool) {
	if o == nil || IsNil(o.Group) {
		return nil, false
	}
	return o.Group, true
...
func (o *GetTeamGroupResponse) SetGroup(v GetTeamGroupsResponseGroupsInner) {
	o.Group = &v
}
