...
func (o *UpdateTeamGroupRequest) GetScopeFilters() GetTeamGroupsResponseGroupsInnerScopeFilters {
...
// and a boolean to check if the value has been set.
func (o *UpdateTeamGroupRequest) GetScopeFiltersOk() (*GetTeamGroupsResponseGroupsInnerScopeFilters, bool) {
	if o == nil || IsNil(o.ScopeFilters) {
		return nil, false
	}
...
func (o *UpdateTeamGroupRequest) SetScopeFilters(v GetTeamGroupsResponseGroupsInnerScopeFilters) {
	o.ScopeFilters = &v
}
