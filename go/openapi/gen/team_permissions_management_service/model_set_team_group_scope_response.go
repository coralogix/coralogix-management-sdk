...
type SetTeamGroupScopeResponse struct {
	ScopeId *GetTeamGroupsResponseGroupsInnerRolesInnerRoleId `json:"scopeId,omitempty"`
}
...
func (o *SetTeamGroupScopeResponse) GetScopeId() GetTeamGroupsResponseGroupsInnerRolesInnerRoleId {
...
func (o *SetTeamGroupScopeResponse) GetScopeIdOk() (*GetTeamGroupsResponseGroupsInnerRolesInnerRoleId, bool) {
	if o == nil || IsNil(o.ScopeId) {
		return nil, false
	}
...
// SetScopeId gets a reference to the given GetTeamGroupsResponseGroupsInnerRolesInnerRoleId and assigns it to the ScopeId field.
func (o *SetTeamGroupScopeResponse) SetScopeId(v GetTeamGroupsResponseGroupsInnerRolesInnerRoleId) {
	o.ScopeId = &v
}
