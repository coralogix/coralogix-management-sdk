...
func (o *AddUsersToTeamGroupsRequest) GetTeamId() GetTeamGroupsResponseGroupsInnerRolesInnerRoleId {
...
// and a boolean to check if the value has been set.
func (o *AddUsersToTeamGroupsRequest) GetTeamIdOk() (*GetTeamGroupsResponseGroupsInnerRolesInnerRoleId, bool) {
	if o == nil || IsNil(o.TeamId) {
		return nil, false
	}
...
func (o *AddUsersToTeamGroupsRequest) SetTeamId(v GetTeamGroupsResponseGroupsInnerRolesInnerRoleId) {
	o.TeamId = &v
}
