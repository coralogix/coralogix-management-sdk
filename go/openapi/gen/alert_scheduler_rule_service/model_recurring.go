...
func (o Recurring) ToMap() (map[string]interface{}, error) {
	...
	if _, exists := o.AdditionalProperties["alwaysActive"]; exists {
		return map[string]interface{}{}, GenericOpenAPIError{error: "oneOf field alwaysActive must be set through the typed field, not AdditionalProperties"}
	}
	if _, exists := o.AdditionalProperties["schedule"]; exists {
		return map[string]interface{}{}, GenericOpenAPIError{error: "oneOf field schedule must be set through the typed field, not AdditionalProperties"}
	}
