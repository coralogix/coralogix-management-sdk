...
type LocalChangelog struct {
	Changes []RevisionReference `json:"changes,omitempty"`
}
...
func (o *LocalChangelog) GetChanges() []RevisionReference {
	if o == nil || IsNil(o.Changes) {
		var ret []RevisionReference
		return ret
	}
	return o.Changes
}
...
func (o *LocalChangelog) GetChangesOk() ([]RevisionReference, bool) {
	if o == nil || IsNil(o.Changes) {
		return nil, false
	}
...
// SetChanges gets a reference to the given []RevisionReference and assigns it to the Changes field.
func (o *LocalChangelog) SetChanges(v []RevisionReference) {
	o.Changes = v
}
