...
func (o *IntegrationDetails) GetExtensions() []ExtensionMetadata {
...
// and a boolean to check if the value has been set.
func (o *IntegrationDetails) GetExtensionsOk() ([]ExtensionMetadata, bool) {
	if o == nil || IsNil(o.Extensions) {
		return nil, false
	}
...
func (o *IntegrationDetails) SetExtensions(v []ExtensionMetadata) {
	o.Extensions = v
}
