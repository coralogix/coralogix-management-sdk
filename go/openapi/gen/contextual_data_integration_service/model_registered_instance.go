...
func (o *RegisteredInstance) GetParameters() []GenericIntegrationParametersParametersInner {
...
// and a boolean to check if the value has been set.
func (o *RegisteredInstance) GetParametersOk() ([]GenericIntegrationParametersParametersInner, bool) {
	if o == nil || IsNil(o.Parameters) {
		return nil, false
	}
...
func (o *RegisteredInstance) SetParameters(v []GenericIntegrationParametersParametersInner) {
	o.Parameters = v
}
