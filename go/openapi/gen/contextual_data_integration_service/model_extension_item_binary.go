...
func NewExtensionItemBinary(data string, fileName string, type_ string) *ExtensionItemBinary {
...
func (o *ExtensionItemBinary) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ExtensionItemBinary) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *ExtensionItemBinary) SetType(v string) {
	o.Type = v
}
