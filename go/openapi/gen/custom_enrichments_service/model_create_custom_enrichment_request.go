...
func NewCreateCustomEnrichmentRequest(description string, file UpdateCustomEnrichmentRequestFile, name string) *CreateCustomEnrichmentRequest {
...
func (o *CreateCustomEnrichmentRequest) GetFile() UpdateCustomEnrichmentRequestFile {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *CreateCustomEnrichmentRequest) GetFileOk() (*UpdateCustomEnrichmentRequestFile, bool) {
	if o == nil {
		return nil, false
	}
	return &o.File, true
...
func (o *CreateCustomEnrichmentRequest) SetFile(v UpdateCustomEnrichmentRequestFile) {
	o.File = v
}
