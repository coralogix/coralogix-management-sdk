...
func (r ApiViewsServiceListViewsRequest) Execute() (*ViewsServiceListViews200Response, *http.Response, error) {
...
// Execute executes the request
//  @return ViewsServiceListViews200Response
func (a *ViewsServiceAPIService) ViewsServiceListViewsExecute(r ApiViewsServiceListViewsRequest) (*ViewsServiceListViews200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ViewsServiceListViews200Response
	)
