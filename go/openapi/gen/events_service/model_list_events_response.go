...
func (o *ListEventsResponse) GetPagination() ListEventsResponsePagination {
...
// and a boolean to check if the value has been set.
func (o *ListEventsResponse) GetPaginationOk() (*ListEventsResponsePagination, bool) {
	if o == nil || IsNil(o.Pagination) {
		return nil, false
	}
...
func (o *ListEventsResponse) SetPagination(v ListEventsResponsePagination) {
	o.Pagination = &v
}
