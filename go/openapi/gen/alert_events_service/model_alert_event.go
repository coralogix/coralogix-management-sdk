...
type AlertEvent struct {
	ActivityAnalysis ActivityAnalysisDataStructure `json:"activityAnalysis"`
	AlertId string `json:"alertId"`
	GroupLabels []PermutationDataStructurePermutationLabelsInner `json:"groupLabels"`
	IncidentCorrelationKey string `json:"incidentCorrelationKey"`
	Payload map[string]interface{} `json:"payload"`
	PayloadType string `json:"payloadType"`
	PermutationId string `json:"permutationId"`
	PermutationLabels []PermutationDataStructurePermutationLabelsInner `json:"permutationLabels"`
...
func NewAlertEvent(activityAnalysis ActivityAnalysisDataStructure, alertId string, groupLabels []PermutationDataStructurePermutationLabelsInner, incidentCorrelationKey string, payload map[string]interface{}, payloadType string, permutationId string, permutationLabels []PermutationDataStructurePermutationLabelsInner, preGroupingEventId string, status string, timestamp time.Time) *AlertEvent {
	this := AlertEvent{}
...
func (o *AlertEvent) GetActivityAnalysis() ActivityAnalysisDataStructure {
	if o == nil {
		var ret ActivityAnalysisDataStructure
		return ret
	}
...
func (o *AlertEvent) GetActivityAnalysisOk() (*ActivityAnalysisDataStructure, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AlertEvent) SetActivityAnalysis(v ActivityAnalysisDataStructure) {
...
func (o *AlertEvent) GetGroupLabels() []PermutationDataStructurePermutationLabelsInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *AlertEvent) GetGroupLabelsOk() ([]PermutationDataStructurePermutationLabelsInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AlertEvent) SetGroupLabels(v []PermutationDataStructurePermutationLabelsInner) {
	o.GroupLabels = v
}
...
func (o *AlertEvent) GetPermutationLabels() []PermutationDataStructurePermutationLabelsInner {
	if o == nil {
		var ret []PermutationDataStructurePermutationLabelsInner
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AlertEvent) GetPermutationLabelsOk() ([]PermutationDataStructurePermutationLabelsInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AlertEvent) SetPermutationLabels(v []PermutationDataStructurePermutationLabelsInner) {
