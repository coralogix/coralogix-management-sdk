...
// NewGetAlertEventResponseSinglePermutationWithDefaults instantiates a new GetAlertEventResponseSinglePermutation object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetAlertEventResponseSinglePermutationWithDefaults() *GetAlertEventResponseSinglePermutation {
	this := GetAlertEventResponseSinglePermutation{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *GetAlertEventResponseSinglePermutation) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *GetAlertEventResponseSinglePermutation) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *GetAlertEventResponseSinglePermutation) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *GetAlertEventResponseSinglePermutation) SetId(v string) {
	o.Id = &v
}

// GetPagination returns the Pagination field value if set, zero value otherwise.
func (o *GetAlertEventResponseSinglePermutation) GetPagination() AlertsV3PaginationResponse {
...
// and a boolean to check if the value has been set.
func (o *GetAlertEventResponseSinglePermutation) GetPaginationOk() (*AlertsV3PaginationResponse, bool) {
	if o == nil || IsNil(o.Pagination) {
		return nil, false
	}
...
func (o *GetAlertEventResponseSinglePermutation) HasPagination() bool {
	if o != nil && !IsNil(o.Pagination) {
		return true
	}
...
func (o *GetAlertEventResponseSinglePermutation) SetPagination(v AlertsV3PaginationResponse) {
	o.Pagination = &v
}
...
func (o GetAlertEventResponseSinglePermutation) ToMap() (map[string]interface{}, error) {
...
type NullableGetAlertEventResponseSinglePermutation struct {
	value *GetAlertEventResponseSinglePermutation
	isSet bool
}

func (v NullableGetAlertEventResponseSinglePermutation) Get() *GetAlertEventResponseSinglePermutation {
	return v.value
}

func (v *NullableGetAlertEventResponseSinglePermutation) Set(val *GetAlertEventResponseSinglePermutation) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAlertEventResponseSinglePermutation) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAlertEventResponseSinglePermutation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAlertEventResponseSinglePermutation(val *GetAlertEventResponseSinglePermutation) *NullableGetAlertEventResponseSinglePermutation {
	return &NullableGetAlertEventResponseSinglePermutation{value: val, isSet: true}
}

func (v NullableGetAlertEventResponseSinglePermutation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAlertEventResponseSinglePermutation) UnmarshalJSON(src []byte) error {
	v.isSet = true
