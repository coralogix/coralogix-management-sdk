...
func (o *GetAlertEventResponse) GetPagination() GetAlertEventResponsePagination {
...
// and a boolean to check if the value has been set.
func (o *GetAlertEventResponse) GetPaginationOk() (*GetAlertEventResponsePagination, bool) {
	if o == nil || IsNil(o.Pagination) {
		return nil, false
	}
...
func (o *GetAlertEventResponse) SetPagination(v GetAlertEventResponsePagination) {
	o.Pagination = &v
}
