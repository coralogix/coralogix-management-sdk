...
func (r ApiConnectorSchemaServiceGetConnectorSchemaRequest) Execute() (*GetConnectorSchemaResponse, *http.Response, error) {
	return r.ApiService.ConnectorSchemaServiceGetConnectorSchemaExecute(r)
}
...
func (a *ConnectorSchemaServiceAPIService) ConnectorSchemaServiceGetConnectorSchemaExecute(r ApiConnectorSchemaServiceGetConnectorSchemaRequest) (*GetConnectorSchemaResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/notifications/notification-center/v1/connector-schemas"
