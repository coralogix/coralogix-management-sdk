...
type Selection1 struct {
	List *ComCoralogixapisDashboardsV1AstFiltersFilterEqualsSelectionListSelection `json:"list,omitempty"`
}
...
func (o *Selection1) GetList() ComCoralogixapisDashboardsV1AstFiltersFilterEqualsSelectionListSelection {
	if o == nil || IsNil(o.List) {
		var ret ComCoralogixapisDashboardsV1AstFiltersFilterEqualsSelectionListSelection
		return ret
	}
	return *o.List
}
...
func (o *Selection1) GetListOk() (*ComCoralogixapisDashboardsV1AstFiltersFilterEqualsSelectionListSelection, bool) {
	if o == nil || IsNil(o.List) {
		return nil, false
	}
	return o.List, true
...
// SetList gets a reference to the given ComCoralogixapisDashboardsV1AstFiltersFilterEqualsSelectionListSelection and assigns it to the List field.
func (o *Selection1) SetList(v ComCoralogixapisDashboardsV1AstFiltersFilterEqualsSelectionListSelection) {
	o.List = &v
}
