...
func (o *UpdateTeamGroupRequest) GetGroupId() ComCoralogixPermissionsV1TeamGroupId {
...
// and a boolean to check if the value has been set.
func (o *UpdateTeamGroupRequest) GetGroupIdOk() (*ComCoralogixPermissionsV1TeamGroupId, bool) {
	if o == nil || IsNil(o.GroupId) {
		return nil, false
	}
...
func (o *UpdateTeamGroupRequest) SetGroupId(v ComCoralogixPermissionsV1TeamGroupId) {
	o.GroupId = &v
}

// GetGroupType returns the GroupType field value if set, zero value otherwise.
func (o *UpdateTeamGroupRequest) GetGroupType() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateTeamGroupRequest) GetGroupTypeOk() (*string, bool) {
	if o == nil || IsNil(o.GroupType) {
		return nil, false
	}
...
func (o *UpdateTeamGroupRequest) SetGroupType(v string) {
	o.GroupType = &v
}
...
func (o *UpdateTeamGroupRequest) GetRoleUpdates() ComCoralogixPermissionsV1UpdateTeamGroupRequestRoleUpdates {
...
// and a boolean to check if the value has been set.
func (o *UpdateTeamGroupRequest) GetRoleUpdatesOk() (*ComCoralogixPermissionsV1UpdateTeamGroupRequestRoleUpdates, bool) {
	if o == nil || IsNil(o.RoleUpdates) {
		return nil, false
	}
...
func (o *UpdateTeamGroupRequest) SetRoleUpdates(v ComCoralogixPermissionsV1UpdateTeamGroupRequestRoleUpdates) {
	o.RoleUpdates = &v
}

// GetScopeFilters returns the ScopeFilters field value if set, zero value otherwise.
func (o *UpdateTeamGroupRequest) GetScopeFilters() ComCoralogixPermissionsV1ScopeFilters {
...
// and a boolean to check if the value has been set.
func (o *UpdateTeamGroupRequest) GetScopeFiltersOk() (*ComCoralogixPermissionsV1ScopeFilters, bool) {
	if o == nil || IsNil(o.ScopeFilters) {
		return nil, false
	}
...
func (o *UpdateTeamGroupRequest) SetScopeFilters(v ComCoralogixPermissionsV1ScopeFilters) {
	o.ScopeFilters = &v
}

// GetUserUpdates returns the UserUpdates field value if set, zero value otherwise.
func (o *UpdateTeamGroupRequest) GetUserUpdates() ComCoralogixPermissionsV1UpdateTeamGroupRequestUserUpdates {
...
// and a boolean to check if the value has been set.
func (o *UpdateTeamGroupRequest) GetUserUpdatesOk() (*ComCoralogixPermissionsV1UpdateTeamGroupRequestUserUpdates, bool) {
	if o == nil || IsNil(o.UserUpdates) {
		return nil, false
	}
...
func (o *UpdateTeamGroupRequest) SetUserUpdates(v ComCoralogixPermissionsV1UpdateTeamGroupRequestUserUpdates) {
	o.UserUpdates = &v
}
