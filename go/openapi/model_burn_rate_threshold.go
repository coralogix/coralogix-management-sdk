...
type BurnRateThreshold struct {
	Dual *ComCoralogixapisAlertsV3BurnRateTypeDual `json:"dual,omitempty"`
...
func NewBurnRateThreshold(rules []ComCoralogixapisAlertsV3SloThresholdRule) *BurnRateThreshold {
...
func (o *BurnRateThreshold) GetDual() ComCoralogixapisAlertsV3BurnRateTypeDual {
	if o == nil || IsNil(o.Dual) {
		var ret ComCoralogixapisAlertsV3BurnRateTypeDual
		return ret
	}
	return *o.Dual
}
...
func (o *BurnRateThreshold) GetDualOk() (*ComCoralogixapisAlertsV3BurnRateTypeDual, bool) {
	if o == nil || IsNil(o.Dual) {
		return nil, false
	}
	return o.Dual, true
...
// SetDual gets a reference to the given ComCoralogixapisAlertsV3BurnRateTypeDual and assigns it to the Dual field.
func (o *BurnRateThreshold) SetDual(v ComCoralogixapisAlertsV3BurnRateTypeDual) {
	o.Dual = &v
}

// GetRules returns the Rules field value
func (o *BurnRateThreshold) GetRules() []ComCoralogixapisAlertsV3SloThresholdRule {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *BurnRateThreshold) GetRulesOk() ([]ComCoralogixapisAlertsV3SloThresholdRule, bool) {
	if o == nil {
		return nil, false
	}
	return o.Rules, true
...
func (o *BurnRateThreshold) SetRules(v []ComCoralogixapisAlertsV3SloThresholdRule) {
	o.Rules = v
}
