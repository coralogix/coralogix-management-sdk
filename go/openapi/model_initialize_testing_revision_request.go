...
func NewInitializeTestingRevisionRequest(extensionData ComCoralogixExtensionsV1ExtensionData) *InitializeTestingRevisionRequest {
...
func (o *InitializeTestingRevisionRequest) GetExtensionData() ComCoralogixExtensionsV1ExtensionData {
	if o == nil {
...
func (o *InitializeTestingRevisionRequest) GetExtensionDataOk() (*ComCoralogixExtensionsV1ExtensionData, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InitializeTestingRevisionRequest) SetExtensionData(v ComCoralogixExtensionsV1ExtensionData) {
	o.ExtensionData = v
}
