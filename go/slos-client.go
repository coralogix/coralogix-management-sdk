...
// SloConstantFilter is an SLO constant filter.
...
// SloLabelNameFilter is an SLO label name filter.
...
// SloFilterIsPredicate is an SLO filter is predicate.
...
// SlotimeframEnum is an enum type for SLO time frames.
