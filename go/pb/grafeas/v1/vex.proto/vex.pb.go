...
type VulnerabilityAssessmentNote_Assessment struct {
	...
	//
	// Deprecated: Marked as deprecated in grafeas/v1/vex.proto.
	...
	RelatedUris []*common_proto.RelatedUrl `protobuf:"bytes,4,rep,name=related_uris,json=relatedUris,proto3" json:"related_uris,omitempty"`
	// Provides the state of this Vulnerability assessment.
...
func (x *VulnerabilityAssessmentNote_Assessment) GetRelatedUris() []*common_proto.RelatedUrl {
	if x != nil {
...
type VulnerabilityAssessmentNote_Assessment_Remediation struct {
	...
	RemediationUri *common_proto.RelatedUrl `protobuf:"bytes,3,opt,name=remediation_uri,json=remediationUri,proto3" json:"remediation_uri,omitempty"`
}
...
func (x *VulnerabilityAssessmentNote_Assessment_Remediation) GetRemediationUri() *common_proto.RelatedUrl {
	if x != nil {
...
var file_grafeas_v1_vex_proto_goTypes = []interface{}{
	...
	(*common_proto.RelatedUrl)(nil),                                             // 9: grafeas.v1.RelatedUrl
}
