...
import (
	...
	intoto_statement_proto "pb//grafeas/v1/intoto_statement.proto"
	reflect "reflect"
	sync "sync"
)
...
func (x *SBOMReferenceNote) Reset() {
	*x = SBOMReferenceNote{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grafeas_v1_sbom_proto_msgTypes[0]
...
func (*SBOMReferenceNote) Descriptor() ([]byte, []int) {
	return file_grafeas_v1_sbom_proto_rawDescGZIP(), []int{0}
}
...
type SBOMReferenceOccurrence struct {
	...
	Signatures []*common_proto.EnvelopeSignature `protobuf:"bytes,3,rep,name=signatures,proto3" json:"signatures,omitempty"`
}

func (x *SBOMReferenceOccurrence) Reset() {
	*x = SBOMReferenceOccurrence{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grafeas_v1_sbom_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SBOMReferenceOccurrence) Descriptor() ([]byte, []int) {
	return file_grafeas_v1_sbom_proto_rawDescGZIP(), []int{1}
}
...
func (x *SBOMReferenceOccurrence) GetSignatures() []*common_proto.EnvelopeSignature {
	if x != nil {
		return x.Signatures
	}
	return nil
...
type SbomReferenceIntotoPayload struct {
	...
	Subject []*intoto_statement_proto.Subject `protobuf:"bytes,3,rep,name=subject,proto3" json:"subject,omitempty"`
...
func (x *SbomReferenceIntotoPayload) Reset() {
	*x = SbomReferenceIntotoPayload{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grafeas_v1_sbom_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SbomReferenceIntotoPayload) Descriptor() ([]byte, []int) {
	return file_grafeas_v1_sbom_proto_rawDescGZIP(), []int{2}
}
...
func (x *SbomReferenceIntotoPayload) GetSubject() []*intoto_statement_proto.Subject {
	if x != nil {
		return x.Subject
	}
	return nil
...
func (x *SbomReferenceIntotoPredicate) Reset() {
	*x = SbomReferenceIntotoPredicate{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grafeas_v1_sbom_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SbomReferenceIntotoPredicate) Descriptor() ([]byte, []int) {
	return file_grafeas_v1_sbom_proto_rawDescGZIP(), []int{3}
}
...
var file_grafeas_v1_sbom_proto_rawDesc = []byte{
	0x0a, 0x15, 0x67, 0x72, 0x61, 0x66, 0x65, 0x61, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x73, 0x62, 0x6f,
	0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x67, 0x72, 0x61, 0x66, 0x65, 0x61, 0x73,
	0x2e, 0x76, 0x31, 0x1a, 0x17, 0x67, 0x72, 0x61, 0x66, 0x65, 0x61, 0x73, 0x2f, 0x76, 0x31, 0x2f,
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x21, 0x67, 0x72,
	...
	0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xbd, 0x01, 0x0a, 0x17, 0x53, 0x42, 0x4f, 0x4d, 0x52,
	0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x4f, 0x63, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e,
	0x63, 0x65, 0x12, 0x40, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x18, 0x01, 0x20,
	...
	0x74, 0x6f, 0x74, 0x6f, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x52, 0x07, 0x70, 0x61, 0x79,
	...
	,
	...
	0x12, 0x46, 0x0a, 0x09, 0x70, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x67, 0x72, 0x61, 0x66, 0x65, 0x61, 0x73, 0x2e, 0x76, 0x31,
	0x2e, 0x53, 0x62, 0x6f, 0x6d, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x49, 0x6e,
	0x74, 0x6f, 0x74, 0x6f, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x52, 0x09, 0x70,
	0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x22, 0x81, 0x02, 0x0a, 0x1c, 0x53, 0x62, 0x6f,
	...
	0x79, 0x70, 0x65, 0x12, 0x4c, 0x0a, 0x06, 0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x18, 0x04, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x34, 0x2e, 0x67, 0x72, 0x61, 0x66, 0x65, 0x61, 0x73, 0x2e, 0x76, 0x31,
	0x2e, 0x53, 0x62, 0x6f, 0x6d, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x49, 0x6e,
	0x74, 0x6f, 0x74, 0x6f, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x2e, 0x44, 0x69,
...
var (
	file_grafeas_v1_sbom_proto_rawDescOnce sync.Once
	file_grafeas_v1_sbom_proto_rawDescData = file_grafeas_v1_sbom_proto_rawDesc
)

func file_grafeas_v1_sbom_proto_rawDescGZIP() []byte {
	file_grafeas_v1_sbom_proto_rawDescOnce.Do(func() {
		file_grafeas_v1_sbom_proto_rawDescData = protoimpl.X.CompressGZIP(file_grafeas_v1_sbom_proto_rawDescData)
	})
	return file_grafeas_v1_sbom_proto_rawDescData
}

var file_grafeas_v1_sbom_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_grafeas_v1_sbom_proto_goTypes = []interface{}{
	...
	(*common_proto.EnvelopeSignature)(nil), // 5: grafeas.v1.EnvelopeSignature
	(*intoto_statement_proto.Subject)(nil), // 6: grafeas.v1.Subject
}
var file_grafeas_v1_sbom_proto_depIdxs = []int32{
...
func init() { file_grafeas_v1_sbom_proto_init() }
func file_grafeas_v1_sbom_proto_init() {
	if File_grafeas_v1_sbom_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_grafeas_v1_sbom_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_grafeas_v1_sbom_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_grafeas_v1_sbom_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_grafeas_v1_sbom_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_grafeas_v1_sbom_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_grafeas_v1_sbom_proto_goTypes,
		DependencyIndexes: file_grafeas_v1_sbom_proto_depIdxs,
		MessageInfos:      file_grafeas_v1_sbom_proto_msgTypes,
	}.Build()
	File_grafeas_v1_sbom_proto = out.File
	file_grafeas_v1_sbom_proto_rawDesc = nil
	file_grafeas_v1_sbom_proto_goTypes = nil
	file_grafeas_v1_sbom_proto_depIdxs = nil
}
