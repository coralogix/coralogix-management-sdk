...
type DSSEAttestationOccurrence struct {
	...
	// this metadata.
	Envelope *common_proto.Envelope `protobuf:"bytes,1,opt,name=envelope,proto3" json:"envelope,omitempty"`
...
func (x *DSSEAttestationOccurrence) GetEnvelope() *common_proto.Envelope {
	if x != nil {
		return x.Envelope
	}
	return nil
...
func (x *DSSEAttestationOccurrence) GetStatement() *intoto_statement_proto.InTotoStatement {
...
type DSSEAttestationOccurrence_Statement struct {
	Statement *intoto_statement_proto.InTotoStatement `protobuf:"bytes,2,opt,name=statement,proto3,oneof"`
}
...
var file_grafeas_v1_dsse_attestation_proto_goTypes = []interface{}{
	...
	(*common_proto.Envelope)(nil),                  // 3: grafeas.v1.Envelope
