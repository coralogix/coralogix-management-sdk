...
import (
	...
	status_proto "pb//google/rpc/status.proto"
...
func (DiscoveryOccurrence_SBOMStatus_SBOMState) Descriptor() protoreflect.EnumDescriptor {
	return file_grafeas_v1_discovery_proto_enumTypes[2].Descriptor()
}

func (DiscoveryOccurrence_SBOMStatus_SBOMState) Type() protoreflect.EnumType {
	return &file_grafeas_v1_discovery_proto_enumTypes[2]
}
...
func (DiscoveryOccurrence_SBOMStatus_SBOMState) EnumDescriptor() ([]byte, []int) {
	return file_grafeas_v1_discovery_proto_rawDescGZIP(), []int{1, 1, 0}
}
...
type DiscoveryNote struct {
	...
	// discovery.
	AnalysisKind common_proto.NoteKind `protobuf:"varint,1,opt,name=analysis_kind,json=analysisKind,proto3,enum=grafeas.v1.NoteKind" json:"analysis_kind,omitempty"`
}
...
func (x *DiscoveryNote) GetAnalysisKind() common_proto.NoteKind {
	if x != nil {
...
type DiscoveryOccurrence struct {
	...
	AnalysisError []*status_proto.Status `protobuf:"bytes,8,rep,name=analysis_error,json=analysisError,proto3" json:"analysis_error,omitempty"`
	// When an error is encountered this will contain a LocalizedMessage under
	// details to show to the user. The LocalizedMessage is output only and
	// populated by the API.
	AnalysisStatusError *status_proto.Status `protobuf:"bytes,3,opt,name=analysis_status_error,json=analysisStatusError,proto3" json:"analysis_status_error,omitempty"`
...
func (x *DiscoveryOccurrence) GetAnalysisError() []*status_proto.Status {
	if x != nil {
...
func (x *DiscoveryOccurrence) GetAnalysisStatusError() *status_proto.Status {
	if x != nil {
...
type DiscoveryOccurrence_SBOMStatus struct {
	...
	SbomState DiscoveryOccurrence_SBOMStatus_SBOMState `protobuf:"varint,1,opt,name=sbom_state,json=sbomState,proto3,enum=grafeas.v1.DiscoveryOccurrence_SBOMStatus_SBOMState" json:"sbom_state,omitempty"`
...
func (x *DiscoveryOccurrence_SBOMStatus) Reset() {
	*x = DiscoveryOccurrence_SBOMStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grafeas_v1_discovery_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_grafeas_v1_discovery_proto_rawDesc = []byte{
	...
	0x79, 0x73, 0x69, 0x73, 0x4b, 0x69, 0x6e, 0x64, 0x22, 0x90, 0x09, 0x0a, 0x13, 0x44, 0x69, 0x73,
	...
	0x61, 0x72, 0x63, 0x68, 0x69, 0x76, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x4b, 0x0a, 0x0b, 0x73,
	0x62, 0x6f, 0x6d, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x2a, 0x2e, 0x67, 0x72, 0x61, 0x66, 0x65, 0x61, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x69,
	...
	0x70, 0x65, 0x1a, 0xbb, 0x01, 0x0a, 0x0a, 0x53, 0x42, 0x4f, 0x4d, 0x53, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x12, 0x53, 0x0a, 0x0a, 0x73, 0x62, 0x6f, 0x6d, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x34, 0x2e, 0x67, 0x72, 0x61, 0x66, 0x65, 0x61, 0x73, 0x2e,
	...
	0x22, 0x53, 0x0a, 0x12, 0x43, 0x6f, 0x6e, 0x74, 0x69, 0x6e, 0x75, 0x6f, 0x75, 0x73, 0x41, 0x6e,
	0x61, 0x6c, 0x79, 0x73, 0x69, 0x73, 0x12, 0x23, 0x0a, 0x1f, 0x43, 0x4f, 0x4e, 0x54, 0x49, 0x4e,
	0x55, 0x4f, 0x55, 0x53, 0x5f, 0x41, 0x4e, 0x41, 0x4c, 0x59, 0x53, 0x49, 0x53, 0x5f, 0x55, 0x4e,
	...
	,
...
var file_grafeas_v1_discovery_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_grafeas_v1_discovery_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_grafeas_v1_discovery_proto_goTypes = []interface{}{
	...
	(DiscoveryOccurrence_SBOMStatus_SBOMState)(0), // 2: grafeas.v1.DiscoveryOccurrence.SBOMStatus.SBOMState
	(*DiscoveryNote)(nil),                         // 3: grafeas.v1.DiscoveryNote
	(*DiscoveryOccurrence)(nil),                   // 4: grafeas.v1.DiscoveryOccurrence
	(*DiscoveryOccurrence_AnalysisCompleted)(nil), // 5: grafeas.v1.DiscoveryOccurrence.AnalysisCompleted
	(*DiscoveryOccurrence_SBOMStatus)(nil),        // 6: grafeas.v1.DiscoveryOccurrence.SBOMStatus
	(common_proto.NoteKind)(0),                    // 7: grafeas.v1.NoteKind
	(*status_proto.Status)(nil),                   // 8: google.rpc.Status
	(*timestamppb.Timestamp)(nil),                 // 9: google.protobuf.Timestamp
}
var file_grafeas_v1_discovery_proto_depIdxs = []int32{
	7,  // 0: grafeas.v1.DiscoveryNote.analysis_kind:type_name -> grafeas.v1.NoteKind
	...
	5,  // 3: grafeas.v1.DiscoveryOccurrence.analysis_completed:type_name -> grafeas.v1.DiscoveryOccurrence.AnalysisCompleted
	8,  // 4: grafeas.v1.DiscoveryOccurrence.analysis_error:type_name -> google.rpc.Status
	8,  // 5: grafeas.v1.DiscoveryOccurrence.analysis_status_error:type_name -> google.rpc.Status
	9,  // 6: grafeas.v1.DiscoveryOccurrence.last_scan_time:type_name -> google.protobuf.Timestamp
	9,  // 7: grafeas.v1.DiscoveryOccurrence.archive_time:type_name -> google.protobuf.Timestamp
	6,  // 8: grafeas.v1.DiscoveryOccurrence.sbom_status:type_name -> grafeas.v1.DiscoveryOccurrence.SBOMStatus
	2,  // 9: grafeas.v1.DiscoveryOccurrence.SBOMStatus.sbom_state:type_name -> grafeas.v1.DiscoveryOccurrence.SBOMStatus.SBOMState
...
func file_grafeas_v1_discovery_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_grafeas_v1_discovery_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
