...
type AttestationOccurrence struct {
	...
	Signatures []*common_proto.Signature `protobuf:"bytes,2,rep,name=signatures,proto3" json:"signatures,omitempty"`
...
func (x *AttestationOccurrence) GetSignatures() []*common_proto.Signature {
	if x != nil {
		return x.Signatures
	}
	return nil
...
var file_grafeas_v1_attestation_proto_goTypes = []interface{}{
	...
	(*common_proto.Signature)(nil), // 4: grafeas.v1.Signature
}
