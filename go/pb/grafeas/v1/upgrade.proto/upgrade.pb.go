...
type UpgradeNote struct {
	...
	// readable form.
	Version *package_proto.Version `protobuf:"bytes,2,opt,name=version,proto3" json:"version,omitempty"`
...
func (x *UpgradeNote) GetVersion() *package_proto.Version {
	if x != nil {
		return x.Version
	}
	return nil
...
type UpgradeOccurrence struct {
	...
	// human readable form.
	ParsedVersion *package_proto.Version `protobuf:"bytes,3,opt,name=parsed_version,json=parsedVersion,proto3" json:"parsed_version,omitempty"`
...
func (x *UpgradeOccurrence) GetParsedVersion() *package_proto.Version {
	if x != nil {
...
var file_grafeas_v1_upgrade_proto_goTypes = []interface{}{
	...
	(*package_proto.Version)(nil),  // 6: grafeas.v1.Version
