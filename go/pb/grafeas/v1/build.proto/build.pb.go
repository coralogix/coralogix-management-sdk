...
import (
	...
	provenance_proto "pb//grafeas/v1/provenance.proto"
	reflect "reflect"
	sync "sync"
)
...
type BuildOccurrence struct {
	...
	Provenance *provenance_proto.BuildProvenance `protobuf:"bytes,1,opt,name=provenance,proto3" json:"provenance,omitempty"`
	...
	IntotoProvenance *intoto_provenance_proto.InTotoProvenance `protobuf:"bytes,3,opt,name=intoto_provenance,json=intotoProvenance,proto3" json:"intoto_provenance,omitempty"`
	// In-toto Statement representation as defined in spec.
	// The intoto_statement can contain any type of provenance. The serialized
	// payload of the statement can be stored and signed in the Occurrence's
	// envelope.
	IntotoStatement *intoto_statement_proto.InTotoStatement `protobuf:"bytes,4,opt,name=intoto_statement,json=intotoStatement,proto3" json:"intoto_statement,omitempty"`
	...
	// slsa provenance.
	InTotoSlsaProvenanceV1 *intoto_statement_proto.InTotoSlsaProvenanceV1 `protobuf:"bytes,5,opt,name=in_toto_slsa_provenance_v1,json=inTotoSlsaProvenanceV1,proto3" json:"in_toto_slsa_provenance_v1,omitempty"`
}
...
func (x *BuildOccurrence) GetProvenance() *provenance_proto.BuildProvenance {
	if x != nil {
		return x.Provenance
	}
	return nil
...
func (x *BuildOccurrence) GetIntotoProvenance() *intoto_provenance_proto.InTotoProvenance {
	if x != nil {
...
func (x *BuildOccurrence) GetIntotoStatement() *intoto_statement_proto.InTotoStatement {
	if x != nil {
...
func (x *BuildOccurrence) GetInTotoSlsaProvenanceV1() *intoto_statement_proto.InTotoSlsaProvenanceV1 {
	if x != nil {
...
var file_grafeas_v1_build_proto_rawDesc = []byte{
	...
	0x62, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xec,
	...
	0x74, 0x6f, 0x74, 0x6f, 0x53, 0x74, 0x61, 0x74, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x5e, 0x0a,
	...
	0x0b, 0x32, 0x22, 0x2e, 0x67, 0x72, 0x61, 0x66, 0x65, 0x61, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x49,
	0x6e, 0x54, 0x6f, 0x74, 0x6f, 0x53, 0x6c, 0x73, 0x61, 0x50, 0x72, 0x6f, 0x76, 0x65, 0x6e, 0x61,
	0x6e, 0x63, 0x65, 0x56, 0x31, 0x52, 0x16, 0x69, 0x6e, 0x54, 0x6f, 0x74, 0x6f, 0x53, 0x6c, 0x73,
	0x61, 0x50, 0x72, 0x6f, 0x76, 0x65, 0x6e, 0x61, 0x6e, 0x63, 0x65, 0x56, 0x31, 0x42, 0x51, 0x0a,
...
var file_grafeas_v1_build_proto_goTypes = []interface{}{
	...
	(*provenance_proto.BuildProvenance)(nil),              // 2: grafeas.v1.BuildProvenance
	(*intoto_provenance_proto.InTotoProvenance)(nil),      // 3: grafeas.v1.InTotoProvenance
	(*intoto_statement_proto.InTotoStatement)(nil),        // 4: grafeas.v1.InTotoStatement
	(*intoto_statement_proto.InTotoSlsaProvenanceV1)(nil), // 5: grafeas.v1.InTotoSlsaProvenanceV1
}
