...
package dashboard_folders_service_proto
...
import (
	...
	folder_proto "pb//com/coralogixapis/dashboards/v1/common/folder.proto"
	reflect "reflect"
	sync "sync"
)
...
type CreateDashboardFolderRequest struct {
	...
	Folder    *folder_proto.DashboardFolder `protobuf:"bytes,2,opt,name=folder,proto3" json:"folder,omitempty"`
}
...
func (x *CreateDashboardFolderRequest) GetFolder() *folder_proto.DashboardFolder {
	if x != nil {
		return x.Folder
	}
	return nil
...
func (x *ReplaceDashboardFolderRequest) GetFolder() *folder_proto.DashboardFolder {
	if x != nil {
		return x.Folder
	}
	return nil
...
type ListDashboardFoldersResponse struct {
	...
	Folder []*folder_proto.DashboardFolder `protobuf:"bytes,1,rep,name=folder,proto3" json:"folder,omitempty"`
}
...
func (x *ListDashboardFoldersResponse) GetFolder() []*folder_proto.DashboardFolder {
	if x != nil {
		return x.Folder
	}
	return nil
...
var file_com_coralogixapis_dashboards_v1_services_dashboard_folders_service_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x1c, 0xb2, 0xb8,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x1d, 0xb2, 0xb8, 0x02, 0x19, 0x0a, 0x17, 0x63, 0x72, 0x65,
	...
	0x73, 0x65, 0x22, 0x1e, 0xb2, 0xb8, 0x02, 0x1a, 0x0a, 0x18, 0x72, 0x65, 0x70, 0x6c, 0x61, 0x63,
	...
	0x6f, 0x6c, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x1d, 0xb2,
	0xb8, 0x02, 0x19, 0x0a, 0x17, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x20, 0x64, 0x61, 0x73, 0x68,
	0x62, 0x6f, 0x61, 0x72, 0x64, 0x20, 0x66, 0x6f, 0x6c, 0x64, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_com_coralogixapis_dashboards_v1_services_dashboard_folders_service_proto_goTypes = []interface{}{
	...
	(*folder_proto.DashboardFolder)(nil),   // 9: com.coralogixapis.dashboards.v1.common.DashboardFolder
}
