...
package dashboard_catalog_service_proto
...
type DashboardCatalogItem struct {
	...
	Folder      *folder_proto.DashboardFolder `protobuf:"bytes,8,opt,name=folder,proto3" json:"folder,omitempty"`
}
...
func (x *DashboardCatalogItem) GetFolder() *folder_proto.DashboardFolder {
	if x != nil {
		return x.Folder
	}
	return nil
...
var file_com_coralogixapis_dashboards_v1_services_dashboard_catalog_service_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x1b, 0xb2, 0xb8, 0x02, 0x17, 0x0a, 0x15, 0x67,
...
var file_com_coralogixapis_dashboards_v1_services_dashboard_catalog_service_proto_goTypes = []interface{}{
	...
	(*folder_proto.DashboardFolder)(nil), // 6: com.coralogixapis.dashboards.v1.common.DashboardFolder
}
