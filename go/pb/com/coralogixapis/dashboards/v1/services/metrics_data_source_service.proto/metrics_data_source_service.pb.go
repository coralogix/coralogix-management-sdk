...
package metrics_data_source_service_proto
...
import (
	...
	labelled_value_proto "pb//com/coralogixapis/dashboards/v1/common/labelled_value.proto"
...
type SearchMetricsTimeSeriesRequest struct {
	...
	Filters     []*filter_proto.Filter_MetricsFilter `protobuf:"bytes,5,rep,name=filters,proto3" json:"filters,omitempty"`
}
...
func (x *SearchMetricsTimeSeriesRequest) GetTimeFrame() *time_frame_proto.TimeFrame {
	if x != nil {
		return x.TimeFrame
	}
	return nil
...
func (x *SearchMetricsTimeSeriesRequest) GetFilters() []*filter_proto.Filter_MetricsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *SearchMetricsTimeSeriesResponse) GetTimeSeries() []*time_series_proto.TimeSeries {
	if x != nil {
		return x.TimeSeries
	}
	return nil
...
type SearchMetricsTimeValuesRequest struct {
	...
	Filters     []*filter_proto.Filter_MetricsFilter `protobuf:"bytes,4,rep,name=filters,proto3" json:"filters,omitempty"`
}
...
func (x *SearchMetricsTimeValuesRequest) GetTimeFrame() *time_frame_proto.TimeFrame {
	if x != nil {
		return x.TimeFrame
	}
	return nil
...
func (x *SearchMetricsTimeValuesRequest) GetFilters() []*filter_proto.Filter_MetricsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
type SearchMetricsTimeValuesResponse struct {
	...
	Values          []*labelled_value_proto.LabelledValue `protobuf:"bytes,1,rep,name=values,proto3" json:"values,omitempty"`
	IsLimitExceeded bool                                  `protobuf:"varint,2,opt,name=is_limit_exceeded,json=isLimitExceeded,proto3" json:"is_limit_exceeded,omitempty"`
	Total           *wrapperspb.Int64Value                `protobuf:"bytes,3,opt,name=total,proto3" json:"total,omitempty"`
}
...
func (x *SearchMetricsTimeValuesResponse) GetValues() []*labelled_value_proto.LabelledValue {
	if x != nil {
		return x.Values
	}
	return nil
...
func (x *SearchMetricsGroupedSeriesRequest) GetTimeFrame() *time_frame_proto.TimeFrame {
	if x != nil {
		return x.TimeFrame
	}
	return nil
...
func (x *SearchMetricsGroupedSeriesRequest) GetFilters() []*filter_proto.Filter_MetricsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *SearchMetricsGroupedSeriesResponse) GetSeries() []*grouped_series_proto.GroupedSeries {
	if x != nil {
		return x.Series
	}
	return nil
...
func (x *SearchMetricsGroupedTimeSeriesRequest) GetTimeFrame() *time_frame_proto.TimeFrame {
	if x != nil {
		return x.TimeFrame
	}
	return nil
...
func (x *SearchMetricsGroupedTimeSeriesRequest) GetFilters() []*filter_proto.Filter_MetricsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *SearchMetricsGroupedTimeSeriesResponse) GetSeries() []*grouped_series_proto.GroupedSeries {
	if x != nil {
		return x.Series
	}
	return nil
...
func (x *SearchMetricsEventsRequest) GetTimeFrame() *time_frame_proto.TimeFrame {
	if x != nil {
		return x.TimeFrame
	}
	return nil
...
func (x *SearchMetricsEventsRequest) GetFilters() []*filter_proto.Filter_MetricsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *MetricsEvent) GetTimeSeries() *time_series_proto.TimeSeries {
	if x != nil {
		return x.TimeSeries
	}
	return nil
...
type SearchMetricsAnnotationEventsRequest struct {
	...
	TimeFrame   *time_frame_proto.TimeFrame                         `protobuf:"bytes,1,opt,name=time_frame,json=timeFrame,proto3" json:"time_frame,omitempty"`
	Interval    *durationpb.Duration                                `protobuf:"bytes,2,opt,name=interval,proto3" json:"interval,omitempty"`
	Filters     []*filter_proto.Filter_MetricsFilter                `protobuf:"bytes,3,rep,name=filters,proto3" json:"filters,omitempty"`
	...
	Strategy    *annotation_proto.Annotation_MetricsSource_Strategy `protobuf:"bytes,5,opt,name=strategy,proto3" json:"strategy,omitempty"`
...
func (x *SearchMetricsAnnotationEventsRequest) GetTimeFrame() *time_frame_proto.TimeFrame {
	if x != nil {
		return x.TimeFrame
	}
	return nil
...
func (x *SearchMetricsAnnotationEventsRequest) GetFilters() []*filter_proto.Filter_MetricsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *SearchMetricsAnnotationEventsRequest) GetStrategy() *annotation_proto.Annotation_MetricsSource_Strategy {
	if x != nil {
		return x.Strategy
	}
	return nil
...
func (x *SearchMetricsAnnotationEventsResponse) GetAnnotationEvents() []*annotation_event_proto.AnnotationEvent {
	if x != nil {
...
type SearchMetricsEventsRequest_OrderBy struct {
	...
	Direction order_direction_proto.OrderDirection `protobuf:"varint,1,opt,name=direction,proto3,enum=com.coralogixapis.dashboards.v1.common.OrderDirection" json:"direction,omitempty"`
...
func (x *SearchMetricsEventsRequest_OrderBy) GetDirection() order_direction_proto.OrderDirection {
	if x != nil {
		return x.Direction
	}
...
var file_com_coralogixapis_dashboards_v1_services_metrics_data_source_service_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x65, 0x22, 0x18, 0xb2, 0xb8, 0x02, 0x14, 0x0a, 0x12, 0x73, 0x65, 0x61, 0x72, 0x63,
	...
	0xb2, 0xb8, 0x02, 0x17, 0x0a, 0x15, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x20, 0x69, 0x6e, 0x73,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x1b, 0xb2, 0xb8, 0x02, 0x17, 0x0a, 0x15, 0x73, 0x65, 0x61,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x20, 0xb2, 0xb8, 0x02, 0x1c, 0x0a, 0x1a,
	...
	0x1e, 0xb2, 0xb8, 0x02, 0x1a, 0x0a, 0x18, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x20, 0x6d, 0x65,
	...
	0x73, 0x65, 0x22, 0x26, 0xb2, 0xb8, 0x02, 0x22, 0x0a, 0x20, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68,
	0x20, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x20, 0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x20, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_com_coralogixapis_dashboards_v1_services_metrics_data_source_service_proto_goTypes = []interface{}{
	...
	(*time_frame_proto.TimeFrame)(nil),                         // 19: com.coralogixapis.dashboards.v1.common.TimeFrame
	...
	(*labelled_value_proto.LabelledValue)(nil),                 // 26: com.coralogixapis.dashboards.v1.common.LabelledValue
	(*grouped_series_proto.GroupedSeries)(nil),                 // 27: com.coralogixapis.dashboards.v1.common.GroupedSeries
	(*annotation_proto.Annotation_MetricsSource_Strategy)(nil), // 28: com.coralogixapis.dashboards.v1.ast.Annotation.MetricsSource.Strategy
	(*annotation_event_proto.AnnotationEvent)(nil),             // 29: com.coralogixapis.dashboards.v1.common.AnnotationEvent
	(order_direction_proto.OrderDirection)(0),                  // 30: com.coralogixapis.dashboards.v1.common.OrderDirection
