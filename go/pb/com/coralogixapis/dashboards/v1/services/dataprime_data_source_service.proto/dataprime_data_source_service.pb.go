...
package dataprime_data_source_service_proto
...
import (
	...
	dataprime_result_proto "pb//com/coralogixapis/dashboards/v1/common/dataprime_result.proto"
...
type SearchDataprimeRequest struct {
	...
	DataprimeQuery    *query_proto.SerializedDataprimeQuery `protobuf:"bytes,1,opt,name=dataprime_query,json=dataprimeQuery,proto3" json:"dataprime_query,omitempty"`
	DataprimeQueryRaw *query_proto.DataprimeQuery           `protobuf:"bytes,2,opt,name=dataprime_query_raw,json=dataprimeQueryRaw,proto3" json:"dataprime_query_raw,omitempty"`
	TimeFrame         *time_frame_proto.TimeFrame           `protobuf:"bytes,3,opt,name=time_frame,json=timeFrame,proto3" json:"time_frame,omitempty"`
...
func (x *SearchDataprimeRequest) GetDataprimeQuery() *query_proto.SerializedDataprimeQuery {
	if x != nil {
...
func (x *SearchDataprimeRequest) GetDataprimeQueryRaw() *query_proto.DataprimeQuery {
	if x != nil {
...
func (x *SearchDataprimeRequest) GetTimeFrame() *time_frame_proto.TimeFrame {
	if x != nil {
		return x.TimeFrame
	}
	return nil
...
type SearchDataprimeResponse struct {
	...
	Results []*dataprime_result_proto.DataprimeResult `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"`
}
...
func (x *SearchDataprimeResponse) GetResults() []*dataprime_result_proto.DataprimeResult {
	if x != nil {
		return x.Results
	}
	return nil
...
func (x *SearchDataprimeArchiveRequest) GetDataprimeQuery() *query_proto.SerializedDataprimeQuery {
	if x != nil {
		return x.DataprimeQuery
	}
	return nil
...
func (x *SearchDataprimeArchiveRequest) GetDataprimeQueryRaw() *query_proto.DataprimeQuery {
	if x != nil {
		return x.DataprimeQueryRaw
	}
	return nil
...
func (x *SearchDataprimeArchiveRequest) GetTimeFrame() *time_frame_proto.TimeFrame {
	if x != nil {
		return x.TimeFrame
	}
	return nil
...
func (x *SearchDataprimeArchiveResponse) GetResults() []*dataprime_result_proto.DataprimeResult {
	if x != nil {
		return x.Results
	}
	return nil
...
var file_com_coralogixapis_dashboards_v1_services_dataprime_data_source_service_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x16, 0xb2, 0xb8, 0x02, 0x12, 0x0a, 0x10,
	...
	0xb2, 0xb8, 0x02, 0x1a, 0x0a, 0x18, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x20, 0x44, 0x61, 0x74,
	0x61, 0x70, 0x72, 0x69, 0x6d, 0x65, 0x20, 0x61, 0x72, 0x63, 0x68, 0x69, 0x76, 0x65, 0x62, 0x06,
...
var file_com_coralogixapis_dashboards_v1_services_dataprime_data_source_service_proto_goTypes = []interface{}{
	...
	(*query_proto.SerializedDataprimeQuery)(nil),   // 4: com.coralogixapis.dashboards.v1.common.SerializedDataprimeQuery
	(*query_proto.DataprimeQuery)(nil),             // 5: com.coralogixapis.dashboards.v1.common.DataprimeQuery
	(*time_frame_proto.TimeFrame)(nil),             // 6: com.coralogixapis.dashboards.v1.common.TimeFrame
	(*wrapperspb.Int32Value)(nil),                  // 7: google.protobuf.Int32Value
	(*dataprime_result_proto.DataprimeResult)(nil), // 8: com.coralogixapis.dashboards.v1.common.DataprimeResult
