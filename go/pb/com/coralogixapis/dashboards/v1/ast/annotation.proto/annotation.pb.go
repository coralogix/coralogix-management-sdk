...
type Annotation_MetricsSource struct {
	...
	PromqlQuery     *query_proto.PromQlQuery           `protobuf:"bytes,1,opt,name=promql_query,json=promqlQuery,proto3" json:"promql_query,omitempty"`
...
func (x *Annotation_MetricsSource) GetPromqlQuery() *query_proto.PromQlQuery {
	if x != nil {
...
type Annotation_LogsSource struct {
	...
	LuceneQuery     *query_proto.LuceneQuery                    `protobuf:"bytes,1,opt,name=lucene_query,json=luceneQuery,proto3" json:"lucene_query,omitempty"`
	Strategy        *Annotation_LogsSource_Strategy             `protobuf:"bytes,2,opt,name=strategy,proto3" json:"strategy,omitempty"`
	MessageTemplate *wrapperspb.StringValue                     `protobuf:"bytes,3,opt,name=message_template,json=messageTemplate,proto3" json:"message_template,omitempty"`
	LabelFields     []*observation_field_proto.ObservationField `protobuf:"bytes,4,rep,name=label_fields,json=labelFields,proto3" json:"label_fields,omitempty"`
}
...
func (x *Annotation_LogsSource) GetLuceneQuery() *query_proto.LuceneQuery {
	if x != nil {
...
func (x *Annotation_LogsSource) GetLabelFields() []*observation_field_proto.ObservationField {
	if x != nil {
...
func (x *Annotation_SpansSource) GetLuceneQuery() *query_proto.LuceneQuery {
	if x != nil {
		return x.LuceneQuery
	}
	return nil
...
func (x *Annotation_SpansSource) GetLabelFields() []*observation_field_proto.ObservationField {
	if x != nil {
		return x.LabelFields
	}
	return nil
...
type Annotation_LogsSource_Strategy_Instant struct {
	...
	TimestampField *observation_field_proto.ObservationField `protobuf:"bytes,1,opt,name=timestamp_field,json=timestampField,proto3" json:"timestamp_field,omitempty"`
}
...
func (x *Annotation_LogsSource_Strategy_Instant) GetTimestampField() *observation_field_proto.ObservationField {
	if x != nil {
...
type Annotation_LogsSource_Strategy_Range struct {
	...
	StartTimestampField *observation_field_proto.ObservationField `protobuf:"bytes,1,opt,name=start_timestamp_field,json=startTimestampField,proto3" json:"start_timestamp_field,omitempty"`
	EndTimestampField   *observation_field_proto.ObservationField `protobuf:"bytes,2,opt,name=end_timestamp_field,json=endTimestampField,proto3" json:"end_timestamp_field,omitempty"`
}
...
func (x *Annotation_LogsSource_Strategy_Range) GetStartTimestampField() *observation_field_proto.ObservationField {
	if x != nil {
...
func (x *Annotation_LogsSource_Strategy_Range) GetEndTimestampField() *observation_field_proto.ObservationField {
	if x != nil {
...
type Annotation_LogsSource_Strategy_Duration struct {
	...
	StartTimestampField *observation_field_proto.ObservationField `protobuf:"bytes,1,opt,name=start_timestamp_field,json=startTimestampField,proto3" json:"start_timestamp_field,omitempty"`
	DurationField       *observation_field_proto.ObservationField `protobuf:"bytes,2,opt,name=duration_field,json=durationField,proto3" json:"duration_field,omitempty"`
}
...
func (x *Annotation_LogsSource_Strategy_Duration) GetStartTimestampField() *observation_field_proto.ObservationField {
	if x != nil {
		return x.StartTimestampField
	}
	return nil
...
func (x *Annotation_LogsSource_Strategy_Duration) GetDurationField() *observation_field_proto.ObservationField {
	if x != nil {
...
func (x *Annotation_SpansSource_Strategy_Instant) GetTimestampField() *observation_field_proto.ObservationField {
	if x != nil {
		return x.TimestampField
	}
	return nil
...
func (x *Annotation_SpansSource_Strategy_Range) GetStartTimestampField() *observation_field_proto.ObservationField {
	if x != nil {
		return x.StartTimestampField
	}
	return nil
...
func (x *Annotation_SpansSource_Strategy_Range) GetEndTimestampField() *observation_field_proto.ObservationField {
	if x != nil {
		return x.EndTimestampField
	}
	return nil
...
func (x *Annotation_SpansSource_Strategy_Duration) GetStartTimestampField() *observation_field_proto.ObservationField {
	if x != nil {
		return x.StartTimestampField
	}
	return nil
...
func (x *Annotation_SpansSource_Strategy_Duration) GetDurationField() *observation_field_proto.ObservationField {
	if x != nil {
		return x.DurationField
	}
	return nil
...
var file_com_coralogixapis_dashboards_v1_ast_annotation_proto_goTypes = []interface{}{
	...
	(*query_proto.PromQlQuery)(nil),                  // 17: com.coralogixapis.dashboards.v1.common.PromQlQuery
	(*query_proto.LuceneQuery)(nil),                  // 18: com.coralogixapis.dashboards.v1.common.LuceneQuery
	(*observation_field_proto.ObservationField)(nil), // 19: com.coralogixapis.dashboards.v1.common.ObservationField
}
