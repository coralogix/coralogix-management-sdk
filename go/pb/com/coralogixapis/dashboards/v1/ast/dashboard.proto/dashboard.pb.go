...
import (
	...
	folder_path_proto "pb//com/coralogixapis/dashboards/v1/ast/folder_path.proto"
	layout_proto "pb//com/coralogixapis/dashboards/v1/ast/layout.proto"
	variable_proto "pb//com/coralogixapis/dashboards/v1/ast/variable.proto"
...
type Dashboard struct {
	...
	Layout *layout_proto.Layout `protobuf:"bytes,4,opt,name=layout,proto3" json:"layout,omitempty"`
	// List of variables that can be used within the dashboard for dynamic content.
	Variables []*variable_proto.Variable `protobuf:"bytes,5,rep,name=variables,proto3" json:"variables,omitempty"`
	// List of filters that can be applied to the dashboard's data.
	Filters []*filter_proto.Filter `protobuf:"bytes,6,rep,name=filters,proto3" json:"filters,omitempty"`
	...
	Annotations []*annotation_proto.Annotation `protobuf:"bytes,11,rep,name=annotations,proto3" json:"annotations,omitempty"`
...
func (x *Dashboard) GetLayout() *layout_proto.Layout {
	if x != nil {
		return x.Layout
	}
	return nil
...
func (x *Dashboard) GetVariables() []*variable_proto.Variable {
	if x != nil {
		return x.Variables
	}
	return nil
...
func (x *Dashboard) GetFilters() []*filter_proto.Filter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *Dashboard) GetAbsoluteTimeFrame() *time_frame_proto.TimeFrame {
...
func (x *Dashboard) GetFolderId() *types_proto.UUID {
...
func (x *Dashboard) GetFolderPath() *folder_path_proto.FolderPath {
...
func (x *Dashboard) GetAnnotations() []*annotation_proto.Annotation {
	if x != nil {
...
type Dashboard_AbsoluteTimeFrame struct {
	...
	AbsoluteTimeFrame *time_frame_proto.TimeFrame `protobuf:"bytes,7,opt,name=absolute_time_frame,json=absoluteTimeFrame,proto3,oneof"`
}
...
type Dashboard_FolderId struct {
	FolderId *types_proto.UUID `protobuf:"bytes,9,opt,name=folder_id,json=folderId,proto3,oneof"`
}

type Dashboard_FolderPath struct {
	FolderPath *folder_path_proto.FolderPath `protobuf:"bytes,10,opt,name=folder_path,json=folderPath,proto3,oneof"`
}
...
var file_com_coralogixapis_dashboards_v1_ast_dashboard_proto_goTypes = []interface{}{
	...
	(*layout_proto.Layout)(nil),              // 5: com.coralogixapis.dashboards.v1.ast.Layout
	(*variable_proto.Variable)(nil),          // 6: com.coralogixapis.dashboards.v1.ast.Variable
	(*filter_proto.Filter)(nil),              // 7: com.coralogixapis.dashboards.v1.ast.Filter
	(*time_frame_proto.TimeFrame)(nil),       // 8: com.coralogixapis.dashboards.v1.common.TimeFrame
	(*durationpb.Duration)(nil),              // 9: google.protobuf.Duration
	(*types_proto.UUID)(nil),                 // 10: com.coralogixapis.dashboards.v1.UUID
	(*folder_path_proto.FolderPath)(nil),     // 11: com.coralogixapis.dashboards.v1.ast.FolderPath
	(*annotation_proto.Annotation)(nil),      // 12: com.coralogixapis.dashboards.v1.ast.Annotation
}
