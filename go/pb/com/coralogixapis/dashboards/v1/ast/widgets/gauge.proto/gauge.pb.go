...
type Gauge struct {
	...
	DataModeType data_mode_type_proto.DataModeType `protobuf:"varint,8,opt,name=data_mode_type,json=dataModeType,proto3,enum=com.coralogixapis.dashboards.v1.ast.widgets.common.DataModeType" json:"data_mode_type,omitempty"`
...
func (x *Gauge) GetDataModeType() data_mode_type_proto.DataModeType {
	if x != nil {
...
func (x *Gauge_MetricsQuery) GetPromqlQuery() *queries_proto.PromQlQuery {
	if x != nil {
...
func (x *Gauge_MetricsQuery) GetFilters() []*filter_proto.Filter_MetricsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
type Gauge_LogsQuery struct {
	...
	LogsAggregation *logs_aggregation_proto.LogsAggregation `protobuf:"bytes,2,opt,name=logs_aggregation,json=logsAggregation,proto3" json:"logs_aggregation,omitempty"`
...
func (x *Gauge_LogsQuery) GetLuceneQuery() *queries_proto.LuceneQuery {
	if x != nil {
...
func (x *Gauge_LogsQuery) GetLogsAggregation() *logs_aggregation_proto.LogsAggregation {
	if x != nil {
...
func (x *Gauge_LogsQuery) GetFilters() []*filter_proto.Filter_LogsFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
type Gauge_SpansQuery struct {
	...
	LuceneQuery      *queries_proto.LuceneQuery                `protobuf:"bytes,1,opt,name=lucene_query,json=luceneQuery,proto3" json:"lucene_query,omitempty"`
	SpansAggregation *spans_aggregation_proto.SpansAggregation `protobuf:"bytes,2,opt,name=spans_aggregation,json=spansAggregation,proto3" json:"spans_aggregation,omitempty"`
	// Deprecated: Marked as deprecated in com/coralogixapis/dashboards/v1/ast/widgets/gauge.proto.
	Aggregation Gauge_Aggregation                  `protobuf:"varint,3,opt,name=aggregation,proto3,enum=com.coralogixapis.dashboards.v1.ast.widgets.Gauge_Aggregation" json:"aggregation,omitempty"`
...
func (x *Gauge_SpansQuery) GetLuceneQuery() *queries_proto.LuceneQuery {
	if x != nil {
		return x.LuceneQuery
	}
	return nil
...
func (x *Gauge_SpansQuery) GetSpansAggregation() *spans_aggregation_proto.SpansAggregation {
	if x != nil {
...
func (x *Gauge_SpansQuery) GetFilters() []*filter_proto.Filter_SpansFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *Gauge_DataprimeQuery) GetDataprimeQuery() *query_proto.DataprimeQuery {
	if x != nil {
...
func (x *Gauge_DataprimeQuery) GetFilters() []*filter_proto.Filter_Source {
	if x != nil {
		return x.Filters
	}
	return nil
...
var file_com_coralogixapis_dashboards_v1_ast_widgets_gauge_proto_rawDesc = []byte{
	...
	0x4f, 0x55, 0x4e, 0x44, 0x10, 0x02, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_com_coralogixapis_dashboards_v1_ast_widgets_gauge_proto_goTypes = []interface{}{
	...
	(data_mode_type_proto.DataModeType)(0),           // 12: com.coralogixapis.dashboards.v1.ast.widgets.common.DataModeType
	(*queries_proto.PromQlQuery)(nil),                // 13: com.coralogixapis.dashboards.v1.ast.widgets.common.PromQlQuery
	(*filter_proto.Filter_MetricsFilter)(nil),        // 14: com.coralogixapis.dashboards.v1.ast.Filter.MetricsFilter
	(*queries_proto.LuceneQuery)(nil),                // 15: com.coralogixapis.dashboards.v1.ast.widgets.common.LuceneQuery
	(*logs_aggregation_proto.LogsAggregation)(nil),   // 16: com.coralogixapis.dashboards.v1.common.LogsAggregation
	(*filter_proto.Filter_LogsFilter)(nil),           // 17: com.coralogixapis.dashboards.v1.ast.Filter.LogsFilter
