...
type MultiSelect struct {
	...
	ValuesOrderDirection order_direction_proto.OrderDirection  `protobuf:"varint,4,opt,name=values_order_direction,json=valuesOrderDirection,proto3,enum=com.coralogixapis.dashboards.v1.common.OrderDirection" json:"values_order_direction,omitempty"`
...
func (x *MultiSelect) GetValuesOrderDirection() order_direction_proto.OrderDirection {
	if x != nil {
...
func (x *MultiSelect_LogsPathSource) GetObservationField() *observation_field_proto.ObservationField {
	if x != nil {
...
type MultiSelect_SpanFieldSource struct {
	...
	Value *span_field_proto.SpanField `protobuf:"bytes,1,opt,name=value,proto3" json:"value,omitempty"`
}
...
func (x *MultiSelect_SpanFieldSource) GetValue() *span_field_proto.SpanField {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *MultiSelect_Query_LogsQuery_Type_FieldValue) GetObservationField() *observation_field_proto.ObservationField {
	if x != nil {
		return x.ObservationField
	}
	return nil
...
func (x *MultiSelect_Query_SpansQuery_Type_FieldValue) GetValue() *span_field_proto.SpanField {
	if x != nil {
		return x.Value
	}
	return nil
...
var file_com_coralogixapis_dashboards_v1_ast_variable_proto_goTypes = []interface{}{
	...
	(order_direction_proto.OrderDirection)(0),                      // 40: com.coralogixapis.dashboards.v1.common.OrderDirection
	(*observation_field_proto.ObservationField)(nil),               // 41: com.coralogixapis.dashboards.v1.common.ObservationField
	(*span_field_proto.SpanField)(nil),                             // 42: com.coralogixapis.dashboards.v1.common.SpanField
}
