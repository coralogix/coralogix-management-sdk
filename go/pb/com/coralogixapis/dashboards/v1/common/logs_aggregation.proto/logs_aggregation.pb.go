...
package logs_aggregation_proto
...
type LogsAggregation_CountDistinct struct {
	...
	ObservationField *observation_field_proto.ObservationField `protobuf:"bytes,2,opt,name=observation_field,json=observationField,proto3" json:"observation_field,omitempty"`
}
...
func (x *LogsAggregation_CountDistinct) GetObservationField() *observation_field_proto.ObservationField {
	if x != nil {
...
func (x *LogsAggregation_Sum) GetObservationField() *observation_field_proto.ObservationField {
	if x != nil {
		return x.ObservationField
	}
	return nil
...
func (x *LogsAggregation_Average) GetObservationField() *observation_field_proto.ObservationField {
	if x != nil {
		return x.ObservationField
	}
	return nil
...
func (x *LogsAggregation_Min) GetObservationField() *observation_field_proto.ObservationField {
	if x != nil {
		return x.ObservationField
	}
	return nil
...
func (x *LogsAggregation_Max) GetObservationField() *observation_field_proto.ObservationField {
	if x != nil {
		return x.ObservationField
	}
	return nil
...
func (x *LogsAggregation_Percentile) GetObservationField() *observation_field_proto.ObservationField {
	if x != nil {
		return x.ObservationField
	}
	return nil
...
var file_com_coralogixapis_dashboards_v1_common_logs_aggregation_proto_goTypes = []interface{}{
	...
	(*observation_field_proto.ObservationField)(nil), // 9: com.coralogixapis.dashboards.v1.common.ObservationField
