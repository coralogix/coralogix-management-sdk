...
type GroupedSeries struct {
	...
	Groups []*group_proto.Group `protobuf:"bytes,2,rep,name=groups,proto3" json:"groups,omitempty"`
}
...
func (x *GroupedSeries) GetGroups() []*group_proto.Group {
	if x != nil {
		return x.Groups
	}
	return nil
...
var file_com_coralogixapis_dashboards_v1_common_grouped_series_proto_goTypes = []interface{}{
	...
	(*group_proto.Group)(nil), // 1: com.coralogixapis.dashboards.v1.common.Group
}
