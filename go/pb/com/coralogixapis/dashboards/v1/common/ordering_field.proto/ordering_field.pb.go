...
type OrderingField struct {
	...
	OrderDirection order_direction_proto.OrderDirection `protobuf:"varint,2,opt,name=order_direction,json=orderDirection,proto3,enum=com.coralogixapis.dashboards.v1.common.OrderDirection" json:"order_direction,omitempty"`
}
...
func (x *OrderingField) GetOrderDirection() order_direction_proto.OrderDirection {
	if x != nil {
...
var file_com_coralogixapis_dashboards_v1_common_ordering_field_proto_goTypes = []interface{}{
	...
	(order_direction_proto.OrderDirection)(0), // 2: com.coralogixapis.dashboards.v1.common.OrderDirection
}
