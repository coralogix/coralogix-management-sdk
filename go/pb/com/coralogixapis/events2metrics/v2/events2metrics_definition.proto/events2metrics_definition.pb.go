...
package events2metrics_definition_proto
...
func (x *E2M) GetSpansQuery() *spans_query_proto.SpansQuery {
...
func (x *E2M) GetLogsQuery() *logs_query_proto.LogsQuery {
...
type E2M_SpansQuery struct {
	// E2M spans query
	SpansQuery *spans_query_proto.SpansQuery `protobuf:"bytes,10,opt,name=spans_query,json=spansQuery,proto3,oneof"`
}

type E2M_LogsQuery struct {
	// E2M logs query
	LogsQuery *logs_query_proto.LogsQuery `protobuf:"bytes,11,opt,name=logs_query,json=logsQuery,proto3,oneof"`
}
...
func (x *E2MCreateParams) GetSpansQuery() *spans_query_proto.SpansQuery {
...
func (x *E2MCreateParams) GetLogsQuery() *logs_query_proto.LogsQuery {
...
type E2MCreateParams_SpansQuery struct {
	// E2M span query
	SpansQuery *spans_query_proto.SpansQuery `protobuf:"bytes,7,opt,name=spans_query,json=spansQuery,proto3,oneof"`
}

type E2MCreateParams_LogsQuery struct {
	// E2M logs query
	LogsQuery *logs_query_proto.LogsQuery `protobuf:"bytes,8,opt,name=logs_query,json=logsQuery,proto3,oneof"`
}
...
var file_com_coralogixapis_events2metrics_v2_events2metrics_definition_proto_goTypes = []interface{}{
	...
	(*spans_query_proto.SpansQuery)(nil), // 12: com.coralogixapis.spans2metrics.v2.SpansQuery
	(*logs_query_proto.LogsQuery)(nil),   // 13: com.coralogixapis.logs2metrics.v2.LogsQuery
