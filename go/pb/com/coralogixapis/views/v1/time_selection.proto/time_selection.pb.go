...
var file_com_coralogixapis_views_v1_time_selection_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_views_v1_time_selection_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_views_v1_time_selection_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TimeSelection); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_views_v1_time_selection_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QuickTimeSelection); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_views_v1_time_selection_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CustomTimeSelection); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_com_coralogixapis_views_v1_time_selection_proto_msgTypes[0].OneofWrappers = []interface{}{
