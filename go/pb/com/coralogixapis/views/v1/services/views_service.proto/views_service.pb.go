...
import (
	...
	filters_proto "pb//com/coralogixapis/views/v1/filters.proto"
	search_query_proto "pb//com/coralogixapis/views/v1/search_query.proto"
	time_selection_proto "pb//com/coralogixapis/views/v1/time_selection.proto"
	reflect "reflect"
	sync "sync"
)
...
type CreateViewRequest struct {
	...
	SearchQuery   *search_query_proto.SearchQuery     `protobuf:"bytes,2,opt,name=search_query,json=searchQuery,proto3" json:"search_query,omitempty"`
	TimeSelection *time_selection_proto.TimeSelection `protobuf:"bytes,3,opt,name=time_selection,json=timeSelection,proto3" json:"time_selection,omitempty"`
	Filters       *filters_proto.SelectedFilters      `protobuf:"bytes,4,opt,name=filters,proto3" json:"filters,omitempty"`
...
func (x *CreateViewRequest) GetSearchQuery() *search_query_proto.SearchQuery {
	if x != nil {
...
func (x *CreateViewRequest) GetTimeSelection() *time_selection_proto.TimeSelection {
	if x != nil {
...
func (x *CreateViewRequest) GetFilters() *filters_proto.SelectedFilters {
	if x != nil {
		return x.Filters
	}
	return nil
...
type View struct {
	...
	SearchQuery   *search_query_proto.SearchQuery     `protobuf:"bytes,3,opt,name=search_query,json=searchQuery,proto3" json:"search_query,omitempty"`
	TimeSelection *time_selection_proto.TimeSelection `protobuf:"bytes,4,opt,name=time_selection,json=timeSelection,proto3" json:"time_selection,omitempty"`
	Filters       *filters_proto.SelectedFilters      `protobuf:"bytes,5,opt,name=filters,proto3" json:"filters,omitempty"`
...
func (x *View) GetSearchQuery() *search_query_proto.SearchQuery {
	if x != nil {
		return x.SearchQuery
	}
	return nil
...
func (x *View) GetTimeSelection() *time_selection_proto.TimeSelection {
	if x != nil {
		return x.TimeSelection
	}
	return nil
...
func (x *View) GetFilters() *filters_proto.SelectedFilters {
	if x != nil {
		return x.Filters
	}
	return nil
...
var file_com_coralogixapis_views_v1_services_views_service_proto_goTypes = []interface{}{
	...
	(*search_query_proto.SearchQuery)(nil),     // 12: com.coralogixapis.views.v1.SearchQuery
	(*time_selection_proto.TimeSelection)(nil), // 13: com.coralogixapis.views.v1.TimeSelection
	(*filters_proto.SelectedFilters)(nil),      // 14: com.coralogixapis.views.v1.SelectedFilters
...
func file_com_coralogixapis_views_v1_services_views_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_views_v1_services_views_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_views_v1_services_views_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_views_v1_services_views_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReplaceViewRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_views_v1_services_views_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReplaceViewResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_views_v1_services_views_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_views_v1_services_views_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_views_v1_services_views_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_views_v1_services_views_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_views_v1_services_views_service_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_views_v1_services_views_service_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_views_v1_services_views_service_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*View); i {
			case 0:
				return &v.state
			case 1:
