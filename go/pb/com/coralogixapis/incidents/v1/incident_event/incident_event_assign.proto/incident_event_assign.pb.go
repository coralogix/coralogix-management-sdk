...
package incident_event_assign_proto
...
type IncidentEventAssign struct {
	...
	Assignment *assignee_proto.Assignment `protobuf:"bytes,1,opt,name=assignment,proto3" json:"assignment,omitempty"`
}
...
func (x *IncidentEventAssign) GetAssignment() *assignee_proto.Assignment {
	if x != nil {
		return x.Assignment
	}
	return nil
...
var file_com_coralogixapis_incidents_v1_incident_event_incident_event_assign_proto_goTypes = []interface{}{
	(*IncidentEventAssign)(nil),       // 0: com.coralogixapis.incidents.v1.IncidentEventAssign
	(*assignee_proto.Assignment)(nil), // 1: com.coralogixapis.incidents.v1.Assignment
}
...
func file_com_coralogixapis_incidents_v1_incident_event_incident_event_assign_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_incidents_v1_incident_event_incident_event_assign_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IncidentEventAssign); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
