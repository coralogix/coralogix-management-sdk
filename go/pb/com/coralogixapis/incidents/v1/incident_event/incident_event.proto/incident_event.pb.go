...
package incident_event_proto

import (
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"
	wrapperspb "google.golang.org/protobuf/types/known/wrapperspb"
	incident_event_acknowledge_proto "pb//com/coralogixapis/incidents/v1/incident_event/incident_event_acknowledge.proto"
	incident_event_assign_proto "pb//com/coralogixapis/incidents/v1/incident_event/incident_event_assign.proto"
	incident_event_close_proto "pb//com/coralogixapis/incidents/v1/incident_event/incident_event_close.proto"
	incident_event_originator_administrative_proto "pb//com/coralogixapis/incidents/v1/incident_event/incident_event_originator_administrative.proto"
	incident_event_originator_operational_proto "pb//com/coralogixapis/incidents/v1/incident_event/incident_event_originator_operational.proto"
	incident_event_originator_type_proto "pb//com/coralogixapis/incidents/v1/incident_event/incident_event_originator_type.proto"
	incident_event_snooze_indicator_proto "pb//com/coralogixapis/incidents/v1/incident_event/incident_event_snooze_indicator.proto"
	incident_event_type_proto "pb//com/coralogixapis/incidents/v1/incident_event/incident_event_type.proto"
	incident_event_unassign_proto "pb//com/coralogixapis/incidents/v1/incident_event/incident_event_unassign.proto"
	incident_event_upsert_state_proto "pb//com/coralogixapis/incidents/v1/incident_event/incident_event_upsert_state.proto"
	reflect "reflect"
	sync "sync"
)
...
type IncidentEvent struct {
	...
	IncidentEventType incident_event_type_proto.IncidentEventType `protobuf:"varint,2,opt,name=incident_event_type,json=incidentEventType,proto3,enum=com.coralogixapis.incidents.v1.IncidentEventType" json:"incident_event_type,omitempty"`
	...
	OriginatorType       incident_event_originator_type_proto.OriginatorType `protobuf:"varint,3,opt,name=originator_type,json=originatorType,proto3,enum=com.coralogixapis.incidents.v1.OriginatorType" json:"originator_type,omitempty"`
...
func (x *IncidentEvent) GetIncidentEventType() incident_event_type_proto.IncidentEventType {
	if x != nil {
		return x.IncidentEventType
	}
	return incident_event_type_proto.IncidentEventType(0)
}
...
func (x *IncidentEvent) GetSnoozeIndicator() *incident_event_snooze_indicator_proto.IncidentEventSnoozeIndicator {
...
func (x *IncidentEvent) GetAssignment() *incident_event_assign_proto.IncidentEventAssign {
...
func (x *IncidentEvent) GetUnassign() *incident_event_unassign_proto.IncidentEventUnassign {
...
func (x *IncidentEvent) GetUpsertState() *incident_event_upsert_state_proto.IncidentEventUpsertState {
...
func (x *IncidentEvent) GetAcknowledge() *incident_event_acknowledge_proto.IncidentEventAcknowledge {
...
func (x *IncidentEvent) GetClose() *incident_event_close_proto.IncidentEventClose {
...
func (x *IncidentEvent) GetOriginatorType() incident_event_originator_type_proto.OriginatorType {
	if x != nil {
		return x.OriginatorType
	}
	return incident_event_originator_type_proto.OriginatorType(0)
}
...
func (x *IncidentEvent) GetAdministrativeEvent() *incident_event_originator_administrative_proto.IncidentEventOriginatorAdministrative {
...
func (x *IncidentEvent) GetOperationalEvent() *incident_event_originator_operational_proto.IncidentEventOriginatorOperational {
...
type IncidentEvent_SnoozeIndicator struct {
	SnoozeIndicator *incident_event_snooze_indicator_proto.IncidentEventSnoozeIndicator `protobuf:"bytes,200,opt,name=snooze_indicator,json=snoozeIndicator,proto3,oneof"`
}

type IncidentEvent_Assignment struct {
	Assignment *incident_event_assign_proto.IncidentEventAssign `protobuf:"bytes,201,opt,name=assignment,proto3,oneof"`
}

type IncidentEvent_Unassign struct {
	Unassign *incident_event_unassign_proto.IncidentEventUnassign `protobuf:"bytes,205,opt,name=unassign,proto3,oneof"`
}

type IncidentEvent_UpsertState struct {
	UpsertState *incident_event_upsert_state_proto.IncidentEventUpsertState `protobuf:"bytes,202,opt,name=upsert_state,json=upsertState,proto3,oneof"`
}

type IncidentEvent_Acknowledge struct {
	Acknowledge *incident_event_acknowledge_proto.IncidentEventAcknowledge `protobuf:"bytes,203,opt,name=acknowledge,proto3,oneof"`
}

type IncidentEvent_Close struct {
	Close *incident_event_close_proto.IncidentEventClose `protobuf:"bytes,204,opt,name=close,proto3,oneof"`
}
...
type IncidentEvent_AdministrativeEvent struct {
	AdministrativeEvent *incident_event_originator_administrative_proto.IncidentEventOriginatorAdministrative `protobuf:"bytes,100,opt,name=administrative_event,json=administrativeEvent,proto3,oneof"`
}

type IncidentEvent_OperationalEvent struct {
	OperationalEvent *incident_event_originator_operational_proto.IncidentEventOriginatorOperational `protobuf:"bytes,101,opt,name=operational_event,json=operationalEvent,proto3,oneof"`
}
...
var file_com_coralogixapis_incidents_v1_incident_event_incident_event_proto_goTypes = []interface{}{
	(*IncidentEvent)(nil),                                                                        // 0: com.coralogixapis.incidents.v1.IncidentEvent
	(*wrapperspb.StringValue)(nil),                                                               // 1: google.protobuf.StringValue
	(incident_event_type_proto.IncidentEventType)(0),                                             // 2: com.coralogixapis.incidents.v1.IncidentEventType
	(*incident_event_snooze_indicator_proto.IncidentEventSnoozeIndicator)(nil),                   // 3: com.coralogixapis.incidents.v1.IncidentEventSnoozeIndicator
	(*incident_event_assign_proto.IncidentEventAssign)(nil),                                      // 4: com.coralogixapis.incidents.v1.IncidentEventAssign
	(*incident_event_unassign_proto.IncidentEventUnassign)(nil),                                  // 5: com.coralogixapis.incidents.v1.IncidentEventUnassign
	(*incident_event_upsert_state_proto.IncidentEventUpsertState)(nil),                           // 6: com.coralogixapis.incidents.v1.IncidentEventUpsertState
	(*incident_event_acknowledge_proto.IncidentEventAcknowledge)(nil),                            // 7: com.coralogixapis.incidents.v1.IncidentEventAcknowledge
	(*incident_event_close_proto.IncidentEventClose)(nil),                                        // 8: com.coralogixapis.incidents.v1.IncidentEventClose
	(incident_event_originator_type_proto.OriginatorType)(0),                                     // 9: com.coralogixapis.incidents.v1.OriginatorType
	(*incident_event_originator_administrative_proto.IncidentEventOriginatorAdministrative)(nil), // 10: com.coralogixapis.incidents.v1.IncidentEventOriginatorAdministrative
	(*incident_event_originator_operational_proto.IncidentEventOriginatorOperational)(nil),       // 11: com.coralogixapis.incidents.v1.IncidentEventOriginatorOperational
}
...
func file_com_coralogixapis_incidents_v1_incident_event_incident_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_incidents_v1_incident_event_incident_event_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_coralogixapis_incidents_v1_incident_event_incident_event_proto_msgTypes[0].OneofWrappers = []interface{}{
