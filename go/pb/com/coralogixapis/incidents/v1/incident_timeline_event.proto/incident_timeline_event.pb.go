...
package incident_timeline_event_proto
...
type IncidentTimelineEvent struct {
	...
	State     incident_state_proto.IncidentState `protobuf:"varint,4,opt,name=state,proto3,enum=com.coralogixapis.incidents.v1.IncidentState" json:"state,omitempty"`
}
...
func (x *IncidentTimelineEvent) GetState() incident_state_proto.IncidentState {
	if x != nil {
		return x.State
	}
...
var file_com_coralogixapis_incidents_v1_incident_timeline_event_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x80, 0x02, 0x0a, 0x15, 0x49, 0x6e, 0x63, 0x69, 0x64, 0x65, 0x6e,
	0x74, 0x54, 0x69, 0x6d, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x30,
	...
	0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_com_coralogixapis_incidents_v1_incident_timeline_event_proto_goTypes = []interface{}{
	(*IncidentTimelineEvent)(nil),           // 0: com.coralogixapis.incidents.v1.IncidentTimelineEvent
	(*wrapperspb.StringValue)(nil),          // 1: google.protobuf.StringValue
	(*timestamppb.Timestamp)(nil),           // 2: google.protobuf.Timestamp
	(incident_state_proto.IncidentState)(0), // 3: com.coralogixapis.incidents.v1.IncidentState
}
...
func file_com_coralogixapis_incidents_v1_incident_timeline_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_incidents_v1_incident_timeline_event_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IncidentTimelineEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
