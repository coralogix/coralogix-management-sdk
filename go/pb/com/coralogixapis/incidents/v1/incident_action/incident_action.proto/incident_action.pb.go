...
package incident_action_proto

import (
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"
	timestamppb "google.golang.org/protobuf/types/known/timestamppb"
	upsert_incident_state_proto "pb//com/coralogixapis/incidents/v1/incident_action/upsert_incident_state/upsert_incident_state.proto"
	reflect "reflect"
	sync "sync"
)
...
func (x *IncidentAction) GetUpsertState() *upsert_incident_state_proto.UpsertIncidentState {
...
type IncidentAction_UpsertState struct {
	UpsertState *upsert_incident_state_proto.UpsertIncidentState `protobuf:"bytes,104,opt,name=upsert_state,json=upsertState,proto3,oneof"`
}
...
var file_com_coralogixapis_incidents_v1_incident_action_incident_action_proto_goTypes = []interface{}{
	...
	(*upsert_incident_state_proto.UpsertIncidentState)(nil), // 3: com.coralogixapis.incidents.v1.UpsertIncidentState
...
func file_com_coralogixapis_incidents_v1_incident_action_incident_action_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_incidents_v1_incident_action_incident_action_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IncidentAction); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_com_coralogixapis_incidents_v1_incident_action_incident_action_proto_msgTypes[0].OneofWrappers = []interface{}{
