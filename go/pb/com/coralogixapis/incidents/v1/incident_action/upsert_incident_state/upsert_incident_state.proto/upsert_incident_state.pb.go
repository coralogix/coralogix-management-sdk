...
package upsert_incident_state_proto
...
import (
	...
	scoping_details_proto "pb//com/coralogixapis/incidents/v1/scoping_details.proto"
	reflect "reflect"
	sync "sync"
)
...
type UpsertIncidentState struct {
	...
	StateType           upsert_incident_state_type_proto.UpsertIncidentStateType        `protobuf:"varint,3,opt,name=state_type,json=stateType,proto3,enum=com.coralogixapis.incidents.v1.UpsertIncidentStateType" json:"state_type,omitempty"`
	Severity            incident_severity_proto.IncidentSeverity                        `protobuf:"varint,4,opt,name=severity,proto3,enum=com.coralogixapis.incidents.v1.IncidentSeverity" json:"severity,omitempty"`
	ContextualLabels    map[string]string                                               `protobuf:"bytes,9,rep,name=contextual_labels,json=contextualLabels,proto3" json:"contextual_labels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	DisplayLabels       map[string]string                                               `protobuf:"bytes,10,rep,name=display_labels,json=displayLabels,proto3" json:"display_labels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Payload             *upsert_incident_state_payload_proto.UpsertIncidentStatePayload `protobuf:"bytes,7,opt,name=payload,proto3" json:"payload,omitempty"`
	ScopeDetails        *scoping_details_proto.ScopeDetails                             `protobuf:"bytes,8,opt,name=scope_details,json=scopeDetails,proto3" json:"scope_details,omitempty"`
	...
	MetaLabels          []*meta_label_proto.MetaLabel                                   `protobuf:"bytes,13,rep,name=meta_labels,json=metaLabels,proto3" json:"meta_labels,omitempty"`
}
...
func (x *UpsertIncidentState) GetStateType() upsert_incident_state_type_proto.UpsertIncidentStateType {
	if x != nil {
		return x.StateType
	}
...
func (x *UpsertIncidentState) GetSeverity() incident_severity_proto.IncidentSeverity {
	if x != nil {
		return x.Severity
	}
...
func (x *UpsertIncidentState) GetPayload() *upsert_incident_state_payload_proto.UpsertIncidentStatePayload {
	if x != nil {
		return x.Payload
	}
	return nil
...
func (x *UpsertIncidentState) GetScopeDetails() *scoping_details_proto.ScopeDetails {
	if x != nil {
...
func (x *UpsertIncidentState) GetMetaLabels() []*meta_label_proto.MetaLabel {
	if x != nil {
		return x.MetaLabels
	}
	return nil
...
var file_com_coralogixapis_incidents_v1_incident_action_upsert_incident_state_upsert_incident_state_proto_goTypes = []interface{}{
	...
	(upsert_incident_state_type_proto.UpsertIncidentStateType)(0),          // 5: com.coralogixapis.incidents.v1.UpsertIncidentStateType
	(incident_severity_proto.IncidentSeverity)(0),                          // 6: com.coralogixapis.incidents.v1.IncidentSeverity
	(*upsert_incident_state_payload_proto.UpsertIncidentStatePayload)(nil), // 7: com.coralogixapis.incidents.v1.UpsertIncidentStatePayload
	(*scoping_details_proto.ScopeDetails)(nil),                             // 8: com.coralogixapis.incidents.v1.ScopeDetails
	(*wrapperspb.BoolValue)(nil),                                           // 9: google.protobuf.BoolValue
	(*meta_label_proto.MetaLabel)(nil),                                     // 10: com.coralogixapis.incidents.v1.MetaLabel
}
...
func file_com_coralogixapis_incidents_v1_incident_action_upsert_incident_state_upsert_incident_state_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_incidents_v1_incident_action_upsert_incident_state_upsert_incident_state_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpsertIncidentState); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
