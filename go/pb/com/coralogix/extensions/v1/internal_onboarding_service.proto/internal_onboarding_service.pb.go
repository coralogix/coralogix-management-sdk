...
package internal_onboarding_service_proto
...
var file_com_coralogix_extensions_v1_internal_onboarding_service_proto_goTypes = []interface{}{
...
func file_com_coralogix_extensions_v1_internal_onboarding_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_extensions_v1_internal_onboarding_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InternalDeployExtensionRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_extensions_v1_internal_onboarding_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InternalDeployExtensionResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
