...
package extension_service_proto
...
type GetExtensionResponse struct {
	...
	Extension *extension_proto.Extension `protobuf:"bytes,1,opt,name=extension,proto3" json:"extension,omitempty"`
}
...
func (x *GetExtensionResponse) GetExtension() *extension_proto.Extension {
	if x != nil {
		return x.Extension
	}
	return nil
...
type GetAllExtensionsResponse_RevisionSummary struct {
	...
	ItemCounts *extension_proto.ItemCounts `protobuf:"bytes,1,opt,name=item_counts,json=itemCounts,proto3" json:"item_counts,omitempty"`
...
func (x *GetAllExtensionsResponse_RevisionSummary) GetItemCounts() *extension_proto.ItemCounts {
	if x != nil {
		return x.ItemCounts
	}
	return nil
...
type GetAllExtensionsResponse_Revision struct {
	...
	IntegrationDetails []*extension_proto.IntegrationDetail      `protobuf:"bytes,5,rep,name=integration_details,json=integrationDetails,proto3" json:"integration_details,omitempty"`
...
func (x *GetAllExtensionsResponse_Revision) GetIntegrationDetails() []*extension_proto.IntegrationDetail {
	if x != nil {
...
type GetAllExtensionsResponse_Extension struct {
	...
	Deprecation   *extension_proto.Deprecation         `protobuf:"bytes,9,opt,name=deprecation,proto3" json:"deprecation,omitempty"`
}
...
func (x *GetAllExtensionsResponse_Extension) GetDeprecation() *extension_proto.Deprecation {
	if x != nil {
...
var file_com_coralogix_extensions_v1_extension_service_proto_goTypes = []interface{}{
	...
	(*extension_proto.Extension)(nil),                // 10: com.coralogix.extensions.v1.Extension
	(*extension_proto.ItemCounts)(nil),               // 11: com.coralogix.extensions.v1.ItemCounts
	(*extension_proto.IntegrationDetail)(nil),        // 12: com.coralogix.extensions.v1.IntegrationDetail
	(*extension_proto.Deprecation)(nil),              // 13: com.coralogix.extensions.v1.Deprecation
}
...
func file_com_coralogix_extensions_v1_extension_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_extensions_v1_extension_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_extensions_v1_extension_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_extensions_v1_extension_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_extensions_v1_extension_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_extensions_v1_extension_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_extensions_v1_extension_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_extensions_v1_extension_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_extensions_v1_extension_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
