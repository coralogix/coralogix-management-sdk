...
package extension_testing_service_proto
...
type InitializeTestingRevisionRequest struct {
	...
	ExtensionData *extension_proto.ExtensionData `protobuf:"bytes,1,opt,name=extension_data,json=extensionData,proto3" json:"extension_data,omitempty"`
}
...
func (x *InitializeTestingRevisionRequest) GetExtensionData() *extension_proto.ExtensionData {
	if x != nil {
...
func (x *TestExtensionRevisionRequest) GetExtensionData() *extension_proto.ExtensionData {
	if x != nil {
		return x.ExtensionData
	}
	return nil
...
var file_com_coralogix_extensions_v1_extension_testing_service_proto_goTypes = []interface{}{
	...
	(*extension_proto.ExtensionData)(nil),     // 6: com.coralogix.extensions.v1.ExtensionData
...
func file_com_coralogix_extensions_v1_extension_testing_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_extensions_v1_extension_testing_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_extensions_v1_extension_testing_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_extensions_v1_extension_testing_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_extensions_v1_extension_testing_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_extensions_v1_extension_testing_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_extensions_v1_extension_testing_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
