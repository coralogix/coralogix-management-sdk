...
type Tag struct {
	...
	Type        *tag_type_proto.TagType   `protobuf:"bytes,13,opt,name=type,proto3" json:"type,omitempty"`
}
...
func (x *Tag) GetType() *tag_type_proto.TagType {
	if x != nil {
		return x.Type
	}
	return nil
...
var file_com_coralogix_tags_v1_tag_proto_goTypes = []interface{}{
	...
	(*tag_type_proto.TagType)(nil), // 6: com.coralogix.tags.v1.TagType
}
...
func file_com_coralogix_tags_v1_tag_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_tags_v1_tag_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Tag); i {
			case 0:
				return &v.state
			case 1:
