...
package unauthenticated_internal_query_request_proto

import (
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"
	wrapperspb "google.golang.org/protobuf/types/known/wrapperspb"
	internal_metadata_proto "pb//com/coralogix/dataprime/v1/internal_metadata.proto"
	internal_query_request_proto "pb//com/coralogix/dataprime/v1/internal_query_request.proto"
	reflect "reflect"
	sync "sync"
)
...
type UnauthenticatedInternalDataprimeQueryServiceQueryRequest struct {
	...
	Metadata *internal_metadata_proto.QueryMetadata `protobuf:"bytes,4,opt,name=metadata,proto3,oneof" json:"metadata,omitempty"`
	...
	UserId *wrapperspb.StringValue `protobuf:"bytes,6,opt,name=user_id,json=userId,proto3,oneof" json:"user_id,omitempty"`
...
func (x *UnauthenticatedInternalDataprimeQueryServiceQueryRequest) GetAstQuery() *internal_query_request_proto.InternalAstQueryRequest {
...
func (x *UnauthenticatedInternalDataprimeQueryServiceQueryRequest) GetTextQuery() *internal_query_request_proto.InternalTextQueryRequest {
...
func (x *UnauthenticatedInternalDataprimeQueryServiceQueryRequest) GetMetadata() *internal_metadata_proto.QueryMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *UnauthenticatedInternalDataprimeQueryServiceQueryRequest) GetUserId() *wrapperspb.StringValue {
	if x != nil {
		return x.UserId
	}
	return nil
...
type UnauthenticatedInternalDataprimeQueryServiceQueryRequest_AstQuery struct {
	// AST query
	AstQuery *internal_query_request_proto.InternalAstQueryRequest `protobuf:"bytes,1,opt,name=ast_query,json=astQuery,proto3,oneof"`
}

type UnauthenticatedInternalDataprimeQueryServiceQueryRequest_TextQuery struct {
	// text query
	TextQuery *internal_query_request_proto.InternalTextQueryRequest `protobuf:"bytes,2,opt,name=text_query,json=textQuery,proto3,oneof"`
}
...
var file_com_coralogix_dataprime_v1_unauthenticated_internal_query_request_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xa1, 0x04, 0x0a, 0x38, 0x55, 0x6e, 0x61, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74,
	...
	,
}
...
var file_com_coralogix_dataprime_v1_unauthenticated_internal_query_request_proto_goTypes = []interface{}{
	...
	(*internal_query_request_proto.InternalAstQueryRequest)(nil),     // 1: com.coralogix.dataprime.v1.InternalAstQueryRequest
	(*internal_query_request_proto.InternalTextQueryRequest)(nil),    // 2: com.coralogix.dataprime.v1.InternalTextQueryRequest
	(*internal_metadata_proto.QueryMetadata)(nil),                    // 3: com.coralogix.dataprime.v1.QueryMetadata
...
var file_com_coralogix_dataprime_v1_unauthenticated_internal_query_request_proto_depIdxs = []int32{
	...
	4, // 4: com.coralogix.dataprime.v1.UnauthenticatedInternalDataprimeQueryServiceQueryRequest.user_id:type_name -> google.protobuf.StringValue
...
func file_com_coralogix_dataprime_v1_unauthenticated_internal_query_request_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_dataprime_v1_unauthenticated_internal_query_request_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UnauthenticatedInternalDataprimeQueryServiceQueryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_com_coralogix_dataprime_v1_unauthenticated_internal_query_request_proto_msgTypes[0].OneofWrappers = []interface{}{
