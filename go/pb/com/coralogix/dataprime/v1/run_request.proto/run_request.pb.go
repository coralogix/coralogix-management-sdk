...
type RunDataprimeQueryRequest struct {
	...
	Query           *query_proto.QueryPayload `protobuf:"bytes,2,opt,name=query,proto3" json:"query,omitempty"`
	...
	Backend         common_proto.Backend      `protobuf:"varint,8,opt,name=backend,proto3,enum=com.coralogix.dataprime.v1.Backend" json:"backend,omitempty"`
...
func (x *RunDataprimeQueryRequest) GetQuery() *query_proto.QueryPayload {
	if x != nil {
		return x.Query
	}
	return nil
...
func (x *RunDataprimeQueryRequest) GetBackend() common_proto.Backend {
	if x != nil {
		return x.Backend
	}
...
type Filter struct {
	...
	Field        *common_proto.UntypedKeypath `protobuf:"bytes,1,opt,name=field,proto3" json:"field,omitempty"`
...
func (x *Filter) GetField() *common_proto.UntypedKeypath {
	if x != nil {
		return x.Field
	}
	return nil
...
func (x *SortModelItem) GetField() *common_proto.UntypedKeypath {
	if x != nil {
		return x.Field
	}
	return nil
...
type Component_KeyDistribution struct {
	...
	KeyDistribution *common_proto.UntypedKeypath `protobuf:"bytes,1,opt,name=key_distribution,json=keyDistribution,proto3" json:"key_distribution,omitempty"`
}
...
func (x *Component_KeyDistribution) GetKeyDistribution() *common_proto.UntypedKeypath {
	if x != nil {
		return x.KeyDistribution
	}
	return nil
...
type Component_Histogram struct {
	...
	Aggregation *histogram_proto.Aggregation `protobuf:"bytes,1,opt,name=aggregation,proto3" json:"aggregation,omitempty"`
	GroupBy     *common_proto.UntypedKeypath `protobuf:"bytes,2,opt,name=group_by,json=groupBy,proto3" json:"group_by,omitempty"`
}
...
func (x *Component_Histogram) GetAggregation() *histogram_proto.Aggregation {
	if x != nil {
...
func (x *Component_Histogram) GetGroupBy() *common_proto.UntypedKeypath {
	if x != nil {
		return x.GroupBy
	}
	return nil
...
func (x *Component_ComparedHistogram) GetAggregation() *histogram_proto.Aggregation {
	if x != nil {
		return x.Aggregation
	}
	return nil
...
func (x *Component_ComparedHistogram) GetGroupBy() *common_proto.UntypedKeypath {
	if x != nil {
		return x.GroupBy
	}
	return nil
...
var file_com_coralogix_dataprime_v1_run_request_proto_goTypes = []interface{}{
	...
	(*query_proto.QueryPayload)(nil),       // 20: com.coralogix.dataprime.v1.QueryPayload
	(*timestamppb.Timestamp)(nil),          // 21: google.protobuf.Timestamp
	(common_proto.Backend)(0),              // 22: com.coralogix.dataprime.v1.Backend
	(*common_proto.UntypedKeypath)(nil),    // 23: com.coralogix.dataprime.v1.UntypedKeypath
	(*wrapperspb.Int64Value)(nil),          // 24: google.protobuf.Int64Value
	(*wrapperspb.Int32Value)(nil),          // 25: google.protobuf.Int32Value
	(*histogram_proto.Aggregation)(nil),    // 26: com.coralogix.dataprime.v1.Aggregation
}
