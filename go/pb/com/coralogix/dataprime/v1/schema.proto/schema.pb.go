...
type NamedSchema struct {
	...
	Source *query_proto.Source `protobuf:"bytes,1,opt,name=source,proto3" json:"source,omitempty"`
...
func (x *NamedSchema) GetSource() *query_proto.Source {
	if x != nil {
		return x.Source
	}
	return nil
...
type SchemaField struct {
	...
	Datatype   *types_proto.Datatype `protobuf:"bytes,3,opt,name=datatype,proto3,oneof" json:"datatype,omitempty"`
}
...
func (x *SchemaField) GetDatatype() *types_proto.Datatype {
	if x != nil {
		return x.Datatype
	}
	return nil
...
var file_com_coralogix_dataprime_v1_schema_proto_goTypes = []interface{}{
	...
	(*query_proto.Source)(nil),   // 5: com.coralogix.dataprime.ast.v1.Source
	(*types_proto.Datatype)(nil), // 6: com.coralogix.dataprime.ast.v1.Datatype
}
...
func file_com_coralogix_dataprime_v1_schema_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_dataprime_v1_schema_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_dataprime_v1_schema_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_dataprime_v1_schema_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Schema); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogix_dataprime_v1_schema_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_dataprime_v1_schema_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_coralogix_dataprime_v1_schema_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
