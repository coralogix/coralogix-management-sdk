...
package unauthenticated_internal_query_response_proto
...
func (x *UnauthenticatedInternalDataprimeQueryServiceQueryResponse) GetError() *response_proto.DataprimeError {
...
func (x *UnauthenticatedInternalDataprimeQueryServiceQueryResponse) GetResult() *response_proto.DataprimeResult {
...
func (x *UnauthenticatedInternalDataprimeQueryServiceQueryResponse) GetWarning() *response_proto.DataprimeWarning {
...
func (x *UnauthenticatedInternalDataprimeQueryServiceQueryResponse) GetQueryId() *response_proto.QueryId {
...
var file_com_coralogix_dataprime_v1_unauthenticated_internal_query_response_proto_goTypes = []interface{}{
...
func file_com_coralogix_dataprime_v1_unauthenticated_internal_query_response_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_dataprime_v1_unauthenticated_internal_query_response_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_coralogix_dataprime_v1_unauthenticated_internal_query_response_proto_msgTypes[0].OneofWrappers = []interface{}{
