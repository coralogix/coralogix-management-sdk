...
package internal_query_response_proto

import (
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"
	response_proto "pb//com/coralogixapis/dataprime/v1/response.proto"
	reflect "reflect"
	sync "sync"
)
...
func (x *QueryResponse) GetError() *response_proto.DataprimeError {
...
func (x *QueryResponse) GetResult() *response_proto.DataprimeResult {
...
func (x *QueryResponse) GetWarning() *response_proto.DataprimeWarning {
...
func (x *QueryResponse) GetQueryId() *response_proto.QueryId {
...
type QueryResponse_Error struct {
	Error *response_proto.DataprimeError `protobuf:"bytes,1,opt,name=error,proto3,oneof"`
}

type QueryResponse_Result struct {
	Result *response_proto.DataprimeResult `protobuf:"bytes,2,opt,name=result,proto3,oneof"`
}

type QueryResponse_Warning struct {
	Warning *response_proto.DataprimeWarning `protobuf:"bytes,3,opt,name=warning,proto3,oneof"`
}

type QueryResponse_QueryId struct {
	QueryId *response_proto.QueryId `protobuf:"bytes,4,opt,name=query_id,json=queryId,proto3,oneof"`
}
...
var file_com_coralogix_dataprime_v1_internal_query_response_proto_goTypes = []interface{}{
	...
	(*response_proto.DataprimeError)(nil),   // 1: com.coralogixapis.dataprime.v1.DataprimeError
	(*response_proto.DataprimeResult)(nil),  // 2: com.coralogixapis.dataprime.v1.DataprimeResult
	(*response_proto.DataprimeWarning)(nil), // 3: com.coralogixapis.dataprime.v1.DataprimeWarning
	(*response_proto.QueryId)(nil),          // 4: com.coralogixapis.dataprime.v1.QueryId
}
