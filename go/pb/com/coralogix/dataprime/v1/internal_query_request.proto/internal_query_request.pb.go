...
package internal_query_request_proto
...
func (x *QueryRequest) GetMetadata() *internal_metadata_proto.QueryMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
type InternalAstQueryRequest struct {
	...
	Ast *query_proto.SerializedDataprime `protobuf:"bytes,1,opt,name=ast,proto3" json:"ast,omitempty"`
}
...
func (x *InternalAstQueryRequest) GetAst() *query_proto.SerializedDataprime {
	if x != nil {
		return x.Ast
	}
	return nil
...
type InternalTextQueryRequest struct {
	...
	Metadata *internal_metadata_proto.TextQueryMetadata `protobuf:"bytes,2,opt,name=metadata,proto3,oneof" json:"metadata,omitempty"`
}
...
func (x *InternalTextQueryRequest) GetMetadata() *internal_metadata_proto.TextQueryMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
var file_com_coralogix_dataprime_v1_internal_query_request_proto_goTypes = []interface{}{
	...
	(*internal_metadata_proto.QueryMetadata)(nil),     // 5: com.coralogix.dataprime.v1.QueryMetadata
	(*query_proto.SerializedDataprime)(nil),           // 6: com.coralogix.dataprime.v1.SerializedDataprime
	(*wrapperspb.StringValue)(nil),                    // 7: google.protobuf.StringValue
	(*internal_metadata_proto.TextQueryMetadata)(nil), // 8: com.coralogix.dataprime.v1.TextQueryMetadata
}
