...
var file_com_coralogix_dataprime_v1_audit_log_proto_goTypes = []interface{}{
...
func file_com_coralogix_dataprime_v1_audit_log_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_dataprime_v1_audit_log_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_coralogix_dataprime_v1_audit_log_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
