...
var file_com_coralogix_dataprime_v1_list_queries_proto_goTypes = []interface{}{
...
func file_com_coralogix_dataprime_v1_list_queries_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_dataprime_v1_list_queries_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_dataprime_v1_list_queries_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_dataprime_v1_list_queries_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
