...
package histogram_proto

import (
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"
	wrapperspb "google.golang.org/protobuf/types/known/wrapperspb"
	aggregation_operators_proto "pb//com/coralogix/dataprime/v1/aggregation_operators.proto"
...
type Aggregation struct {
	...
	Type  aggregation_operators_proto.Operator `protobuf:"varint,2,opt,name=type,proto3,enum=com.coralogix.dataprime.v1.Operator" json:"type,omitempty"`
}
...
func (x *Aggregation) GetField() *common_proto.UntypedKeypath {
	if x != nil {
		return x.Field
	}
	return nil
...
func (x *Aggregation) GetType() aggregation_operators_proto.Operator {
	if x != nil {
		return x.Type
	}
	return aggregation_operators_proto.Operator(0)
}
...
var file_com_coralogix_dataprime_v1_histogram_proto_goTypes = []interface{}{
	...
	(*common_proto.UntypedKeypath)(nil),       // 4: com.coralogix.dataprime.v1.UntypedKeypath
	(aggregation_operators_proto.Operator)(0), // 5: com.coralogix.dataprime.v1.Operator
...
func file_com_coralogix_dataprime_v1_histogram_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_dataprime_v1_histogram_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_dataprime_v1_histogram_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Data); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogix_dataprime_v1_histogram_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ComparedData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_dataprime_v1_histogram_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HistogramSlice); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_com_coralogix_dataprime_v1_histogram_proto_msgTypes[1].OneofWrappers = []interface{}{}
	type x struct{}
