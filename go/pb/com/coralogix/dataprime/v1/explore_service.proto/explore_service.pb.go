...
import (
	...
	run_response_proto "pb//com/coralogix/dataprime/v1/run_response.proto"
...
var file_com_coralogix_dataprime_v1_explore_service_proto_goTypes = []interface{}{
	(*run_request_proto.RunDataprimeQueryRequest)(nil),   // 0: com.coralogix.dataprime.v1.RunDataprimeQueryRequest
	(*run_response_proto.RunDataprimeQueryResponse)(nil), // 1: com.coralogix.dataprime.v1.RunDataprimeQueryResponse
}
