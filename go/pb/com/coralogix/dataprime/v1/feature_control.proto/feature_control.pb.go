...
var file_com_coralogix_dataprime_v1_feature_control_proto_goTypes = []interface{}{
...
func file_com_coralogix_dataprime_v1_feature_control_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_dataprime_v1_feature_control_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FeatureControl); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_dataprime_v1_feature_control_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListFeatureControlRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_dataprime_v1_feature_control_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListFeatureControlResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_com_coralogix_dataprime_v1_feature_control_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
