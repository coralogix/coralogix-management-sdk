...
import (
	...
	types_proto "pb//com/coralogix/dataprime/ast/restricted/v1/types.proto"
	reflect "reflect"
	sync "sync"
)
...
type Expression struct {
	...
	Datatype *types_proto.Datatype `protobuf:"bytes,1,opt,name=datatype,proto3" json:"datatype,omitempty"`
...
type Expression_Boolean struct {
	Boolean *wrapperspb.BoolValue `protobuf:"bytes,4,opt,name=boolean,proto3,oneof"`
}

type Expression_Integer struct {
	Integer *wrapperspb.Int32Value `protobuf:"bytes,5,opt,name=integer,proto3,oneof"`
}
...
type Expression_Long struct {
	Long *wrapperspb.Int64Value `protobuf:"bytes,11,opt,name=long,proto3,oneof"`
}

type Expression_Double struct {
	Double *wrapperspb.DoubleValue `protobuf:"bytes,12,opt,name=double,proto3,oneof"`
}
...
var file_com_coralogix_dataprime_ast_restricted_v1_expression_proto_goTypes = []interface{}{
	...
	(*types_proto.Datatype)(nil),               // 13: com.coralogix.dataprime.ast.restricted.v1.Datatype
...
func file_com_coralogix_dataprime_ast_restricted_v1_expression_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_dataprime_ast_restricted_v1_expression_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_dataprime_ast_restricted_v1_expression_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_dataprime_ast_restricted_v1_expression_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_dataprime_ast_restricted_v1_expression_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_dataprime_ast_restricted_v1_expression_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_dataprime_ast_restricted_v1_expression_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_dataprime_ast_restricted_v1_expression_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_dataprime_ast_restricted_v1_expression_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Expression_FunctionCall_In); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_dataprime_ast_restricted_v1_expression_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Expression_FunctionCall_Contains); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_dataprime_ast_restricted_v1_expression_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Expression_FunctionCall_StartsWith); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_dataprime_ast_restricted_v1_expression_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Expression_FunctionCall_EndsWith); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_com_coralogix_dataprime_ast_restricted_v1_expression_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	file_com_coralogix_dataprime_ast_restricted_v1_expression_proto_msgTypes[5].OneofWrappers = []interface{}{
