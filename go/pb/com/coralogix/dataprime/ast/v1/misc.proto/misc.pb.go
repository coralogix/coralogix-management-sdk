...
func (x *KeypathType) GetPath() *expression_proto.Expression_Keypath {
	if x != nil {
		return x.Path
	}
	return nil
...
func (x *KeypathType) GetDatatype() *types_proto.Datatype {
	if x != nil {
		return x.Datatype
	}
	return nil
...
var file_com_coralogix_dataprime_ast_v1_misc_proto_goTypes = []interface{}{
	(*KeypathType)(nil),                         // 0: com.coralogix.dataprime.ast.v1.KeypathType
	(*expression_proto.Expression_Keypath)(nil), // 1: com.coralogix.dataprime.ast.v1.Expression.Keypath
	(*types_proto.Datatype)(nil),                // 2: com.coralogix.dataprime.ast.v1.Datatype
}
...
func file_com_coralogix_dataprime_ast_v1_misc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_dataprime_ast_v1_misc_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*KeypathType); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
