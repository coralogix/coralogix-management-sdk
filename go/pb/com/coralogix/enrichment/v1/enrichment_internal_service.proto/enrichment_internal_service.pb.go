...
package enrichment_internal_service_proto
...
func (x *GetInternalEnrichmentsResponse) GetEnrichments() []*enrichment_proto.Enrichment {
	if x != nil {
...
func (x *AddInternalEnrichmentsRequest) GetRequestEnrichments() []*enrichment_request_model_proto.EnrichmentRequestModel {
	if x != nil {
...
func (x *AddInternalEnrichmentsResponse) GetEnrichments() []*enrichment_proto.Enrichment {
	if x != nil {
		return x.Enrichments
	}
	return nil
...
func (x *RemoveInternalEnrichmentsResponse) GetRemainingEnrichments() []*enrichment_proto.Enrichment {
	if x != nil {
...
var file_com_coralogix_enrichment_v1_enrichment_internal_service_proto_goTypes = []interface{}{
	...
	(*enrichment_proto.Enrichment)(nil),                           // 6: com.coralogix.enrichment.v1.Enrichment
	(*enrichment_request_model_proto.EnrichmentRequestModel)(nil), // 7: com.coralogix.enrichment.v1.EnrichmentRequestModel
