...
package enrichment_request_model_proto
...
type EnrichmentRequestModel struct {
	...
	EnrichmentType    *enrichment_type_proto.EnrichmentType `protobuf:"bytes,2,opt,name=enrichment_type,json=enrichmentType,proto3" json:"enrichment_type,omitempty"`
...
func (x *EnrichmentRequestModel) GetEnrichmentType() *enrichment_type_proto.EnrichmentType {
	if x != nil {
...
var file_com_coralogix_enrichment_v1_enrichment_request_model_proto_goTypes = []interface{}{
	...
	(*enrichment_type_proto.EnrichmentType)(nil), // 3: com.coralogix.enrichment.v1.EnrichmentType
}
...
func file_com_coralogix_enrichment_v1_enrichment_request_model_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_com_coralogix_enrichment_v1_enrichment_request_model_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_coralogix_enrichment_v1_enrichment_request_model_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_com_coralogix_enrichment_v1_enrichment_request_model_proto_msgTypes[1].OneofWrappers = []interface{}{}
	type x struct{}
