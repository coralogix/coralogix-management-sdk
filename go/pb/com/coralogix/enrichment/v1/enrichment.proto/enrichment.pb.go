...
type Enrichment struct {
	...
	EnrichmentType    *enrichment_type_proto.EnrichmentType `protobuf:"bytes,3,opt,name=enrichment_type,json=enrichmentType,proto3" json:"enrichment_type,omitempty"`
...
func (x *Enrichment) GetEnrichmentType() *enrichment_type_proto.EnrichmentType {
	if x != nil {
...
var file_com_coralogix_enrichment_v1_enrichment_proto_goTypes = []interface{}{
	...
	(*enrichment_type_proto.EnrichmentType)(nil), // 1: com.coralogix.enrichment.v1.EnrichmentType
...
func file_com_coralogix_enrichment_v1_enrichment_proto_init() {
	...
	file_com_coralogix_enrichment_v1_enrichment_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
