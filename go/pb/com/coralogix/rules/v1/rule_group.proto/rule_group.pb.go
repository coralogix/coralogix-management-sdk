...
import (
	...
	rule_subgroup_proto "pb//com/coralogix/rules/v1/rule_subgroup.proto"
	reflect "reflect"
	sync "sync"
)
...
type RuleGroup struct {
	...
	RuleMatchers  []*rule_matcher_proto.RuleMatcher   `protobuf:"bytes,9,rep,name=rule_matchers,json=ruleMatchers,proto3" json:"rule_matchers,omitempty"`
	RuleSubgroups []*rule_subgroup_proto.RuleSubgroup `protobuf:"bytes,10,rep,name=rule_subgroups,json=ruleSubgroups,proto3" json:"rule_subgroups,omitempty"`
...
func (x *RuleGroup) GetRuleMatchers() []*rule_matcher_proto.RuleMatcher {
	if x != nil {
...
func (x *RuleGroup) GetRuleSubgroups() []*rule_subgroup_proto.RuleSubgroup {
	if x != nil {
...
var file_com_coralogix_rules_v1_rule_group_proto_goTypes = []interface{}{
	...
	(*rule_matcher_proto.RuleMatcher)(nil),   // 4: com.coralogix.rules.v1.RuleMatcher
	(*rule_subgroup_proto.RuleSubgroup)(nil), // 5: com.coralogix.rules.v1.RuleSubgroup
