...
type RuleSubgroup struct {
	...
	Rules   []*rule_proto.Rule      `protobuf:"bytes,2,rep,name=rules,proto3" json:"rules,omitempty"`
...
func (x *RuleSubgroup) GetRules() []*rule_proto.Rule {
	if x != nil {
		return x.Rules
	}
	return nil
...
var file_com_coralogix_rules_v1_rule_subgroup_proto_goTypes = []interface{}{
	...
	(*rule_proto.Rule)(nil),        // 2: com.coralogix.rules.v1.Rule
