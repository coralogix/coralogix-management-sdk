...
package integration_extensions_deployment_service_proto
...
import (
	...
	_ "pb//com/coralogix/integrations/v1/integration.proto"
...
var file_com_coralogix_integrations_v1_integration_extensions_deployment_service_proto_goTypes = []interface{}{
...
func file_com_coralogix_integrations_v1_integration_extensions_deployment_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_integrations_v1_integration_extensions_deployment_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeployIntegrationExtensionsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_integrations_v1_integration_extensions_deployment_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeployIntegrationExtensionsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
