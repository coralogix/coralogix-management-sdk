...
package external_token_service_proto
...
func (x *GenerateNewTokenRequest) GetPlatform() push_based_platform_proto.PushBasedPlatform {
	if x != nil {
		return x.Platform
	}
...
var file_com_coralogix_integrations_v1_external_token_service_proto_goTypes = []interface{}{
	...
	(push_based_platform_proto.PushBasedPlatform)(0), // 4: com.coralogix.integrations.v1.PushBasedPlatform
...
func file_com_coralogix_integrations_v1_external_token_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_integrations_v1_external_token_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GenerateNewTokenRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_integrations_v1_external_token_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GenerateNewTokenResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_integrations_v1_external_token_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_integrations_v1_external_token_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
