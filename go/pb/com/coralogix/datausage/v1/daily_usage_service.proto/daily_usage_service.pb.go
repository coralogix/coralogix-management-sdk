...
package daily_usage_service_proto
...
import (
	...
	daily_usage_proto "pb//com/coralogix/datausage/v1/daily_usage.proto"
...
func (x *DailyUsageRequest) GetRange() common_proto.Range {
...
func (x *DailyUsageRequest) GetDateRange() *common_proto.DateRange {
...
type DailyUsageRequest_Range struct {
	Range common_proto.Range `protobuf:"varint,1,opt,name=range,proto3,enum=com.coralogix.datausage.v1.Range,oneof"`
}

type DailyUsageRequest_DateRange struct {
	DateRange *common_proto.DateRange `protobuf:"bytes,2,opt,name=date_range,json=dateRange,proto3,oneof"`
}
...
type DailyUsageResponse struct {
	...
	Response []*daily_usage_proto.DetailedDailyUsage `protobuf:"bytes,1,rep,name=response,proto3" json:"response,omitempty"`
}
...
func (x *DailyUsageResponse) GetResponse() []*daily_usage_proto.DetailedDailyUsage {
	if x != nil {
		return x.Response
	}
	return nil
...
func (x *OverageDailyUsageRequest) GetRange() common_proto.Range {
...
func (x *OverageDailyUsageRequest) GetDateRange() *common_proto.DateRange {
...
type OverageDailyUsageResponse struct {
	...
	OverageDetail []*daily_usage_proto.OverageDailyReport `protobuf:"bytes,1,rep,name=overage_detail,json=overageDetail,proto3" json:"overage_detail,omitempty"`
}
...
func (x *OverageDailyUsageResponse) GetOverageDetail() []*daily_usage_proto.OverageDailyReport {
	if x != nil {
...
var file_com_coralogix_datausage_v1_daily_usage_service_proto_goTypes = []interface{}{
	...
	(common_proto.Range)(0),                      // 4: com.coralogix.datausage.v1.Range
	(*common_proto.DateRange)(nil),               // 5: com.coralogix.datausage.v1.DateRange
	(*daily_usage_proto.DetailedDailyUsage)(nil), // 6: com.coralogix.datausage.v1.DetailedDailyUsage
	(*daily_usage_proto.OverageDailyReport)(nil), // 7: com.coralogix.datausage.v1.OverageDailyReport
}
...
func file_com_coralogix_datausage_v1_daily_usage_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_datausage_v1_daily_usage_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_datausage_v1_daily_usage_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_datausage_v1_daily_usage_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_datausage_v1_daily_usage_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_coralogix_datausage_v1_daily_usage_service_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*DailyUsageRequest_Range)(nil),
		(*DailyUsageRequest_DateRange)(nil),
	}
	file_com_coralogix_datausage_v1_daily_usage_service_proto_msgTypes[2].OneofWrappers = []interface{}{
