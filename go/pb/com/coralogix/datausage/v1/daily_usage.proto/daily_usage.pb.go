...
var file_com_coralogix_datausage_v1_daily_usage_proto_goTypes = []interface{}{
...
func file_com_coralogix_datausage_v1_daily_usage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_datausage_v1_daily_usage_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DetailedDailyUsage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogix_datausage_v1_daily_usage_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OverageDailyReport); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
