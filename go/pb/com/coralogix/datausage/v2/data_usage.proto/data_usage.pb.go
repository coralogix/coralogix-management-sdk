...
var file_com_coralogix_datausage_v2_data_usage_proto_goTypes = []interface{}{
...
func file_com_coralogix_datausage_v2_data_usage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_datausage_v2_data_usage_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Team); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogix_datausage_v2_data_usage_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_datausage_v2_data_usage_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogix_datausage_v2_data_usage_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_coralogix_datausage_v2_data_usage_proto_msgTypes[3].OneofWrappers = []interface{}{
