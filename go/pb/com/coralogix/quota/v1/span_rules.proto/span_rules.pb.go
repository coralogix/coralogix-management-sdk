...
package span_rules_proto

import (
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"
	rule_proto "pb//com/coralogix/quota/v1/rule.proto"
	tag_rule_proto "pb//com/coralogix/quota/v1/tag_rule.proto"
	reflect "reflect"
	sync "sync"
)
...
type SpanRules struct {
	...
	ServiceRule *rule_proto.Rule          `protobuf:"bytes,1,opt,name=service_rule,json=serviceRule,proto3,oneof" json:"service_rule,omitempty"`
	ActionRule  *rule_proto.Rule          `protobuf:"bytes,2,opt,name=action_rule,json=actionRule,proto3,oneof" json:"action_rule,omitempty"`
	TagRules    []*tag_rule_proto.TagRule `protobuf:"bytes,3,rep,name=tag_rules,json=tagRules,proto3" json:"tag_rules,omitempty"`
}
...
func (x *SpanRules) GetServiceRule() *rule_proto.Rule {
	if x != nil {
...
func (x *SpanRules) GetActionRule() *rule_proto.Rule {
	if x != nil {
		return x.ActionRule
	}
	return nil
...
func (x *SpanRules) GetTagRules() []*tag_rule_proto.TagRule {
	if x != nil {
		return x.TagRules
	}
	return nil
...
var file_com_coralogix_quota_v1_span_rules_proto_goTypes = []interface{}{
	...
	(*rule_proto.Rule)(nil),        // 1: com.coralogix.quota.v1.Rule
	(*tag_rule_proto.TagRule)(nil), // 2: com.coralogix.quota.v1.TagRule
}
