...
package bulk_create_policy_request_proto
...
type AtomicBatchCreatePolicyRequest struct {
	...
	PolicyRequests []*create_policy_request_proto.CreatePolicyRequest `protobuf:"bytes,1,rep,name=policy_requests,json=policyRequests,proto3" json:"policy_requests,omitempty"`
}
...
func (x *AtomicBatchCreatePolicyRequest) GetPolicyRequests() []*create_policy_request_proto.CreatePolicyRequest {
	if x != nil {
