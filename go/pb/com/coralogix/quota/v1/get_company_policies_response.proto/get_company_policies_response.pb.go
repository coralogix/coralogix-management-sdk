...
package get_company_policies_response_proto
...
type GetCompanyPoliciesResponse struct {
	...
	Policies []*policy_proto.Policy `protobuf:"bytes,1,rep,name=policies,proto3" json:"policies,omitempty"`
}
...
func (x *GetCompanyPoliciesResponse) GetPolicies() []*policy_proto.Policy {
	if x != nil {
		return x.Policies
	}
	return nil
