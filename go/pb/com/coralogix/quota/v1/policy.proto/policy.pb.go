...
type Policy struct {
	...
	Priority        enums_proto.Priority    `protobuf:"varint,5,opt,name=priority,proto3,enum=com.coralogix.quota.v1.Priority" json:"priority,omitempty"`
	...
	ApplicationRule *rule_proto.Rule        `protobuf:"bytes,9,opt,name=application_rule,json=applicationRule,proto3,oneof" json:"application_rule,omitempty"`
	SubsystemRule   *rule_proto.Rule        `protobuf:"bytes,10,opt,name=subsystem_rule,json=subsystemRule,proto3,oneof" json:"subsystem_rule,omitempty"`
	...
	ArchiveRetention *archive_retention_proto.ArchiveRetention `protobuf:"bytes,15,opt,name=archive_retention,json=archiveRetention,proto3,oneof" json:"archive_retention,omitempty"`
}
...
func (x *Policy) GetPriority() enums_proto.Priority {
	if x != nil {
		return x.Priority
	}
...
func (x *Policy) GetApplicationRule() *rule_proto.Rule {
	if x != nil {
...
func (x *Policy) GetSubsystemRule() *rule_proto.Rule {
	if x != nil {
...
func (x *Policy) GetLogRules() *log_rules_proto.LogRules {
...
func (x *Policy) GetSpanRules() *span_rules_proto.SpanRules {
...
func (x *Policy) GetArchiveRetention() *archive_retention_proto.ArchiveRetention {
	if x != nil {
...
type Policy_LogRules struct {
	LogRules *log_rules_proto.LogRules `protobuf:"bytes,11,opt,name=log_rules,json=logRules,proto3,oneof"`
}

type Policy_SpanRules struct {
	SpanRules *span_rules_proto.SpanRules `protobuf:"bytes,12,opt,name=span_rules,json=spanRules,proto3,oneof"`
}
...
var file_com_coralogix_quota_v1_policy_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x6e, 0x74, 0x69, 0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_com_coralogix_quota_v1_policy_proto_goTypes = []interface{}{
	...
	(enums_proto.Priority)(0),                        // 3: com.coralogix.quota.v1.Priority
	(*wrapperspb.BoolValue)(nil),                     // 4: google.protobuf.BoolValue
	(*rule_proto.Rule)(nil),                          // 5: com.coralogix.quota.v1.Rule
	(*log_rules_proto.LogRules)(nil),                 // 6: com.coralogix.quota.v1.LogRules
	(*span_rules_proto.SpanRules)(nil),               // 7: com.coralogix.quota.v1.SpanRules
	(*archive_retention_proto.ArchiveRetention)(nil), // 8: com.coralogix.quota.v1.ArchiveRetention
}
