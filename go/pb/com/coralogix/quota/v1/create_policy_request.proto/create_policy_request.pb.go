...
package create_policy_request_proto
...
func (x *CreatePolicyRequest) GetPriority() enums_proto.Priority {
	if x != nil {
		return x.Priority
	}
...
func (x *CreatePolicyRequest) GetApplicationRule() *rule_proto.Rule {
	if x != nil {
...
func (x *CreatePolicyRequest) GetSubsystemRule() *rule_proto.Rule {
	if x != nil {
...
func (x *CreatePolicyRequest) GetArchiveRetention() *archive_retention_proto.ArchiveRetention {
	if x != nil {
...
func (x *CreatePolicyRequest) GetLogRules() *log_rules_proto.LogRules {
...
func (x *CreatePolicyRequest) GetSpanRules() *span_rules_proto.SpanRules {
...
type CreatePolicyRequest_LogRules struct {
	LogRules *log_rules_proto.LogRules `protobuf:"bytes,7,opt,name=log_rules,json=logRules,proto3,oneof"`
}

type CreatePolicyRequest_SpanRules struct {
	SpanRules *span_rules_proto.SpanRules `protobuf:"bytes,8,opt,name=span_rules,json=spanRules,proto3,oneof"`
}
