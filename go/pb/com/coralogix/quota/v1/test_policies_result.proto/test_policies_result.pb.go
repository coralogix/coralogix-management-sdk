...
package test_policies_result_proto
...
type TestPoliciesResult struct {
	...
	MetaFieldsValues *log_meta_field_values_proto.LogMetaFieldsValues `protobuf:"bytes,1,opt,name=meta_fields_values,json=metaFieldsValues,proto3" json:"meta_fields_values,omitempty"`
	Matched          *wrapperspb.BoolValue                            `protobuf:"bytes,2,opt,name=matched,proto3" json:"matched,omitempty"`
	Policy           *policy_proto.Policy                             `protobuf:"bytes,3,opt,name=policy,proto3" json:"policy,omitempty"`
}
...
func (x *TestPoliciesResult) GetMetaFieldsValues() *log_meta_field_values_proto.LogMetaFieldsValues {
	if x != nil {
...
func (x *TestPoliciesResult) GetPolicy() *policy_proto.Policy {
	if x != nil {
		return x.Policy
	}
	return nil
...
var file_com_coralogix_quota_v1_test_policies_result_proto_goTypes = []interface{}{
	...
	(*policy_proto.Policy)(nil),                             // 3: com.coralogix.quota.v1.Policy
}
