...
package update_policy_request_proto

import (
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"
	wrapperspb "google.golang.org/protobuf/types/known/wrapperspb"
	archive_retention_proto "pb//com/coralogix/quota/v1/archive_retention.proto"
	enums_proto "pb//com/coralogix/quota/v1/enums.proto"
	log_rules_proto "pb//com/coralogix/quota/v1/log_rules.proto"
	rule_proto "pb//com/coralogix/quota/v1/rule.proto"
	span_rules_proto "pb//com/coralogix/quota/v1/span_rules.proto"
	reflect "reflect"
	sync "sync"
)
...
type UpdatePolicyRequest struct {
	...
	Priority         enums_proto.Priority                      `protobuf:"varint,4,opt,name=priority,proto3,enum=com.coralogix.quota.v1.Priority" json:"priority,omitempty"`
	ApplicationRule  *rule_proto.Rule                          `protobuf:"bytes,5,opt,name=application_rule,json=applicationRule,proto3,oneof" json:"application_rule,omitempty"`
	SubsystemRule    *rule_proto.Rule                          `protobuf:"bytes,6,opt,name=subsystem_rule,json=subsystemRule,proto3,oneof" json:"subsystem_rule,omitempty"`
	ArchiveRetention *archive_retention_proto.ArchiveRetention `protobuf:"bytes,7,opt,name=archive_retention,json=archiveRetention,proto3,oneof" json:"archive_retention,omitempty"`
...
func (x *UpdatePolicyRequest) GetPriority() enums_proto.Priority {
	if x != nil {
		return x.Priority
	}
	return enums_proto.Priority(0)
}

func (x *UpdatePolicyRequest) GetApplicationRule() *rule_proto.Rule {
	if x != nil {
...
func (x *UpdatePolicyRequest) GetSubsystemRule() *rule_proto.Rule {
	if x != nil {
...
func (x *UpdatePolicyRequest) GetArchiveRetention() *archive_retention_proto.ArchiveRetention {
	if x != nil {
...
func (x *UpdatePolicyRequest) GetLogRules() *log_rules_proto.LogRules {
...
func (x *UpdatePolicyRequest) GetSpanRules() *span_rules_proto.SpanRules {
...
type UpdatePolicyRequest_LogRules struct {
	LogRules *log_rules_proto.LogRules `protobuf:"bytes,8,opt,name=log_rules,json=logRules,proto3,oneof"`
}

type UpdatePolicyRequest_SpanRules struct {
	SpanRules *span_rules_proto.SpanRules `protobuf:"bytes,9,opt,name=span_rules,json=spanRules,proto3,oneof"`
}
...
var file_com_coralogix_quota_v1_update_policy_request_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf5, 0x05, 0x0a, 0x13, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50,
	...
	,
}
...
var file_com_coralogix_quota_v1_update_policy_request_proto_goTypes = []interface{}{
	...
	(enums_proto.Priority)(0),                        // 2: com.coralogix.quota.v1.Priority
	(*rule_proto.Rule)(nil),                          // 3: com.coralogix.quota.v1.Rule
	(*archive_retention_proto.ArchiveRetention)(nil), // 4: com.coralogix.quota.v1.ArchiveRetention
	(*log_rules_proto.LogRules)(nil),                 // 5: com.coralogix.quota.v1.LogRules
	(*span_rules_proto.SpanRules)(nil),               // 6: com.coralogix.quota.v1.SpanRules
