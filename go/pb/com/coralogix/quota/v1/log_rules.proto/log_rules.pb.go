...
type LogRules struct {
	...
	Severities []enums_proto.Severity `protobuf:"varint,1,rep,packed,name=severities,proto3,enum=com.coralogix.quota.v1.Severity" json:"severities,omitempty"`
}
...
func (x *LogRules) GetSeverities() []enums_proto.Severity {
	if x != nil {
		return x.Severities
	}
	return nil
...
var file_com_coralogix_quota_v1_log_rules_proto_goTypes = []interface{}{
	...
	(enums_proto.Severity)(0), // 1: com.coralogix.quota.v1.Severity
}
