...
package atomic_overwrite_policies_request_proto
...
type CreateSpanPolicyRequest struct {
	...
	SpanRules *span_rules_proto.SpanRules `protobuf:"bytes,2,opt,name=span_rules,json=spanRules,proto3" json:"span_rules,omitempty"`
}
...
func (x *CreateSpanPolicyRequest) GetSpanRules() *span_rules_proto.SpanRules {
	if x != nil {
		return x.SpanRules
	}
	return nil
...
type CreateLogPolicyRequest struct {
	...
	Policy   *CreateGenericPolicyRequest `protobuf:"bytes,1,opt,name=policy,proto3" json:"policy,omitempty"`
	LogRules *log_rules_proto.LogRules   `protobuf:"bytes,2,opt,name=log_rules,json=logRules,proto3" json:"log_rules,omitempty"`
}
...
func (x *CreateLogPolicyRequest) GetLogRules() *log_rules_proto.LogRules {
	if x != nil {
		return x.LogRules
	}
	return nil
...
type CreateGenericPolicyRequest struct {
	...
	Priority         enums_proto.Priority                      `protobuf:"varint,3,opt,name=priority,proto3,enum=com.coralogix.quota.v1.Priority" json:"priority,omitempty"`
	ApplicationRule  *rule_proto.Rule                          `protobuf:"bytes,4,opt,name=application_rule,json=applicationRule,proto3,oneof" json:"application_rule,omitempty"`
	SubsystemRule    *rule_proto.Rule                          `protobuf:"bytes,5,opt,name=subsystem_rule,json=subsystemRule,proto3,oneof" json:"subsystem_rule,omitempty"`
	ArchiveRetention *archive_retention_proto.ArchiveRetention `protobuf:"bytes,6,opt,name=archive_retention,json=archiveRetention,proto3,oneof" json:"archive_retention,omitempty"`
}
...
func (x *CreateGenericPolicyRequest) GetPriority() enums_proto.Priority {
	if x != nil {
		return x.Priority
	}
...
func (x *CreateGenericPolicyRequest) GetApplicationRule() *rule_proto.Rule {
	if x != nil {
...
func (x *CreateGenericPolicyRequest) GetSubsystemRule() *rule_proto.Rule {
	if x != nil {
...
func (x *CreateGenericPolicyRequest) GetArchiveRetention() *archive_retention_proto.ArchiveRetention {
	if x != nil {
...
var file_com_coralogix_quota_v1_atomic_overwrite_policies_request_proto_goTypes = []interface{}{
	...
	(*span_rules_proto.SpanRules)(nil),               // 5: com.coralogix.quota.v1.SpanRules
	(*log_rules_proto.LogRules)(nil),                 // 6: com.coralogix.quota.v1.LogRules
	(*wrapperspb.StringValue)(nil),                   // 7: google.protobuf.StringValue
	(enums_proto.Priority)(0),                        // 8: com.coralogix.quota.v1.Priority
	(*rule_proto.Rule)(nil),                          // 9: com.coralogix.quota.v1.Rule
	(*archive_retention_proto.ArchiveRetention)(nil), // 10: com.coralogix.quota.v1.ArchiveRetention
}
