...
const (
	...
	LegacyViewsService_ListLegacyViews_FullMethodName   = "/com.coralogixapis.views.v1.services.LegacyViewsService/ListLegacyViews"
)
...
type LegacyViewsServiceClient interface {
	...
	ListLegacyViews(ctx context.Context, in *ListLegacyViewsRequest, opts ...grpc.CallOption) (*ListLegacyViewsResponse, error)
}
...
func (c *legacyViewsServiceClient) ListLegacyViews(ctx context.Context, in *ListLegacyViewsRequest, opts ...grpc.CallOption) (*ListLegacyViewsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListLegacyViewsResponse)
	err := c.cc.Invoke(ctx, LegacyViewsService_ListLegacyViews_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LegacyViewsServiceServer interface {
	...
	ListLegacyViews(context.Context, *ListLegacyViewsRequest) (*ListLegacyViewsResponse, error)
...
func (UnimplementedLegacyViewsServiceServer) ListLegacyViews(context.Context, *ListLegacyViewsRequest) (*ListLegacyViewsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListLegacyViews not implemented")
}
...
func _LegacyViewsService_ListLegacyViews_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListLegacyViewsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LegacyViewsServiceServer).ListLegacyViews(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LegacyViewsService_ListLegacyViews_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LegacyViewsServiceServer).ListLegacyViews(ctx, req.(*ListLegacyViewsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LegacyViewsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListLegacyViews",
			Handler:    _LegacyViewsService_ListLegacyViews_Handler,
		},
	},
