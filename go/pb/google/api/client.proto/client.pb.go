...
import (
	...
	launch_stage_proto "pb//google/api/launch_stage.proto"
	reflect "reflect"
	sync "sync"
)
...
type ClientLibrarySettings struct {
	...
	LaunchStage launch_stage_proto.LaunchStage `protobuf:"varint,2,opt,name=launch_stage,json=launchStage,proto3,enum=google.api.LaunchStage" json:"launch_stage,omitempty"`
...
func (x *ClientLibrarySettings) GetLaunchStage() launch_stage_proto.LaunchStage {
	if x != nil {
		return x.LaunchStage
	}
	return launch_stage_proto.LaunchStage(0)
}
...
var file_google_api_client_proto_goTypes = []interface{}{
	...
	(launch_stage_proto.LaunchStage)(0), // 18: google.api.LaunchStage
