...
func TestViews(t *testing.T) {
	...
	view, e := c.Create(context.Background(), &cxsdk.CreateViewRequest{
		Name: &wrapperspb.StringValue{Value: "MyView"},
	...
	view.View.Name = &wrapperspb.StringValue{Value: "MyViewUpdated"}
...
func TestViewFolders(t *testing.T) {
	...
	createResponse, e := c.Create(context.Background(), &cxsdk.CreateViewFolderRequest{
		Name: &wrapperspb.StringValue{Value: "MyViewFolder"},
	})
	assertNilAndPrintError(t, e)

	createResponse.Folder.Name = &wrapperspb.StringValue{Value: "MyViewFolderUpdated"}
	...
	assertNilAndPrintError(t, e)
	assert.Equal(t, updatedFolder.Folder.Name.Value, "MyViewFolderUpdated")
